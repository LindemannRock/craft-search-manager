...
final class TestToolI18nTest extends TestCase
{
    ...
    public function testSearchTestToolUsesTranslatedStringsObject(): void
    {
        ...
        foreach ([
            ...
            "snippetMatchedIn: {{ 'Snippet matched in'|t('search-manager')|json_encode|raw }}",
            "snippetMode: {{ 'Snippet Mode'|t('search-manager')|json_encode|raw }}",
            "snippetSource: {{ 'Snippet source'|t('search-manager')|json_encode|raw }}",
            "documentKeyLabel: {{ 'Document Key'|t('search-manager')|json_encode|raw }}",
            "elementIdLabel: {{ 'Element ID'|t('search-manager')|json_encode|raw }}",
            "backendIdLabel: {{ 'Backend ID'|t('search-manager')|json_encode|raw }}",
            "siteIdLabel: {{ 'Site ID'|t('search-manager')|json_encode|raw }}",
            "categoryIdsLabel: {{ 'Category IDs'|t('search-manager')|json_encode|raw }}",
            "headingsLabel: {{ 'Headings'|t('search-manager')|json_encode|raw }}",
