...
* add batch processing for section and category boosts in QueryRuleService ([d0447f6](https://github.com/LindemannRock/craft-search-manager/commit/d0447f61dd8bd556be7b63e30fc5ffe211ff2f13))
* add PostgreSQL storage ([a432c14](https://github.com/LindemannRock/craft-search-manager/commit/a432c141c180d8a17b3b113a81705d9e3a200bf3))
* add TwigSearchOptionsHelper for search limit normalization ([61a37df](https://github.com/LindemannRock/craft-search-manager/commit/61a37df34b73aec40d0b569d2519e0d7345df003))
* **analytics:** add date-bounded logic for popular query caching ([46a395f](https://github.com/LindemannRock/craft-search-manager/commit/46a395f3bdd87a838b9305c9cddcd4fff803f29b))
* **analytics:** require JSON acceptance for analytics endpoints ([eab5379](https://github.com/LindemannRock/craft-search-manager/commit/eab5379b45b4475780e1b9f1bd3c004cb24110af))
* **api-keys:** add stable handles for widget key selection ([95b3297](https://github.com/LindemannRock/craft-search-manager/commit/95b3297c8fc3ad8ac974bc7039239070557b8aac))
* **commerce:** add shared Commerce element type helper ([93419ac](https://github.com/LindemannRock/craft-search-manager/commit/93419ac069cece32fca2257be47ccaf576c8a103))
* **commerce:** support commerce promotion and rule targets ([c1490d9](https://github.com/LindemannRock/craft-search-manager/commit/c1490d9f7f0594676ddae93e3bd35f1ad9fcbd43))
* **controllers:** require JSON acceptance for delete and clear actions ([f821fd4](https://github.com/LindemannRock/craft-search-manager/commit/f821fd4d0b697f07839bade0adf6b9e4b7862116))
* **cp:** add duplicate actions for search objects ([36b97c9](https://github.com/LindemannRock/craft-search-manager/commit/36b97c9359ff2db59bba7e569874c26b859d6e11))
* **dependencies:** add style usage check before deleting widget styles ([3fd5700](https://github.com/LindemannRock/craft-search-manager/commit/3fd57004c5bf0dbba3d8e28e53a0c14df23437e5))
* **deps:** add DependencyService for backend usage management ([a562dd9](https://github.com/LindemannRock/craft-search-manager/commit/a562dd960bdd91d3aea22ca586b5bba0029cf109))
* **gql:** add search manager queries ([f4f9d0e](https://github.com/LindemannRock/craft-search-manager/commit/f4f9d0e1b34c18f7a158f48ca3c370b41aa41771))
* **gql:** restore GraphQL cache setting after search queries ([dea6bbd](https://github.com/LindemannRock/craft-search-manager/commit/dea6bbd1b2b84d6d82e78c87c8068bf26f9ec58e))
* **i18n:** add internationalization strings for analytics dashboard ([2e6e7b9](https://github.com/LindemannRock/craft-search-manager/commit/2e6e7b9fbf727beae0c13a8f51f9f6f31381ae8f))
* **i18n:** add new translation keys across multiple locales ([9ff439a](https://github.com/LindemannRock/craft-search-manager/commit/9ff439a2db9598198388e3705180bd96c6f74cba))
* **i18n:** add new translations and strings for search manager ([7d29de2](https://github.com/LindemannRock/craft-search-manager/commit/7d29de2e6b4293c2249d7967dcfe6292ded62839))
* **i18n:** add setup-related translations across multiple locales ([9d92893](https://github.com/LindemannRock/craft-search-manager/commit/9d92893d7316ad3d0a8e332e96a5c72c96674900))
* **i18n:** add translations for analytics tooltips and intent labels ([fc5adc2](https://github.com/LindemannRock/craft-search-manager/commit/fc5adc28da46160be7bbe9bfabf32416815b979b))
* **i18n:** add translations for pending sync status badge labels ([9e2794d](https://github.com/LindemannRock/craft-search-manager/commit/9e2794d617c69379d006f4ea9609add29e5f233e))
* **i18n:** rename promotion keys across multiple locales ([1ce81ee](https://github.com/LindemannRock/craft-search-manager/commit/1ce81ee14a201f914b71a735c5b2d244de3f155c))
* **i18n:** update behavior labels for widget settings ([2f4de77](https://github.com/LindemannRock/craft-search-manager/commit/2f4de778e5afae7a9f6ea6ff9eebd0d0b0a4fff4))
* **indices:** add Commerce index transformer support ([2956e18](https://github.com/LindemannRock/craft-search-manager/commit/2956e18efe75e275a55bc29f9a69aa4cdaead7c0))
* **indices:** expose Commerce element types ([e545a61](https://github.com/LindemannRock/craft-search-manager/commit/e545a610052380127eeaf2133ae8197f5d8de374))
* **jobs:** add claim token handling in BatchSyncJob ([c3ad2ab](https://github.com/LindemannRock/craft-search-manager/commit/c3ad2abbe07d757c985dad349ef14cb4510d779b))
* **jobs:** avoid custom field hydration in status sync queries ([7a7d627](https://github.com/LindemannRock/craft-search-manager/commit/7a7d6277ac8114ac2cf31740fcc7f3cd7c4aa508))
* **results:** add hierarchical layout support in results widget ([fc27565](https://github.com/LindemannRock/craft-search-manager/commit/fc27565dd5ac31cac77c7e9ebc4b827a817451cf))
* **search-manager:** restructure settings pages and navigation ([3202f78](https://github.com/LindemannRock/craft-search-manager/commit/3202f780e0de2da0eb2ca1d17cc3bb674bf745c1))
* **search-manager:** unify search and autocomplete on a shared term-resolution core ([16332e4](https://github.com/LindemannRock/craft-search-manager/commit/16332e44e016d2e8bb4ab403816fe6b815b44e92))
* **search:** add attribute change handling for theme and state preservation ([18fea08](https://github.com/LindemannRock/craft-search-manager/commit/18fea08d4d17abd504e3adc07aad2ea0fd9477c9))
* **search:** add autocomplete term selection functionality ([a093d0b](https://github.com/LindemannRock/craft-search-manager/commit/a093d0be2c2dafedbd6c44eaf34cca38270cbbf3))
* **search:** add document-key storage operations ([3717312](https://github.com/LindemannRock/craft-search-manager/commit/37173126fd3d28d439fba8a73ac470f275930487))
* **search:** add hierarchy and path context to search hits ([cbdb56c](https://github.com/LindemannRock/craft-search-manager/commit/cbdb56c267eb886a97db3afd0100c78a798d5a3f))
* **search:** add language matching logic for document filtering ([fdc32c7](https://github.com/LindemannRock/craft-search-manager/commit/fdc32c730e8c27a283f56754f5d1c894e53d5f38))
* **search:** add leading snippet fallback for empty headings ([59a7692](https://github.com/LindemannRock/craft-search-manager/commit/59a7692497e5de8a01241f288908ed18566a89fb))
* **search:** add native catch-all index creation ([b93b1de](https://github.com/LindemannRock/craft-search-manager/commit/b93b1deda36031b46fb2cb64cf57493da7b5a4f6))
* **search:** add native search replacement settings and coverage report ([c9d38d7](https://github.com/LindemannRock/craft-search-manager/commit/c9d38d7bb7653fe5f694ec84eb5f4bbf56c3d27c))
* **search:** add query length validation and limit normalization ([bd4ae1f](https://github.com/LindemannRock/craft-search-manager/commit/bd4ae1f0ce4cf137067e5843e17c1d82947ddb20))
* **search:** add retrievable fields for public hits ([70943fe](https://github.com/LindemannRock/craft-search-manager/commit/70943fec276978b733f4172ab00e938d51805422))
* **search:** add section metadata rendering for search results ([94c3231](https://github.com/LindemannRock/craft-search-manager/commit/94c3231187895fa664f69923a1a7116ee09e81e3))
* **search:** add SourceDoc section-split indexing ([043fb48](https://github.com/LindemannRock/craft-search-manager/commit/043fb487cde23ac4c2bca18e8bcd815d48275e83))
* **search:** add support for term boosting in search queries ([02d8361](https://github.com/LindemannRock/craft-search-manager/commit/02d8361ead3004defc965c1b0ddc1d8711a4f01a))
* **search:** drop public elementType hit key ([98ccebb](https://github.com/LindemannRock/craft-search-manager/commit/98ccebb45bb1d6e4ee32763e5728124c4227cd8a))
* **search:** enhance search functionality with hit presentation options ([42a29d5](https://github.com/LindemannRock/craft-search-manager/commit/42a29d5b003dce0649a84558ed50f53753cb55c5))
* **search:** expose indexed field values and normalize hit metadata contract ([2402f8d](https://github.com/LindemannRock/craft-search-manager/commit/2402f8d7b851980b3c5d96766420dafb2adf5091))
* **search:** finalize public asset hit contract ([ba63669](https://github.com/LindemannRock/craft-search-manager/commit/ba6366981613d76a9825f95af105b203a470e879))
* **search:** implement cleanup of orphaned term n-grams after indexing ([7869145](https://github.com/LindemannRock/craft-search-manager/commit/7869145a3fc6cbb9ac5fb656c579d622989faad3))
* **search:** normalize language handling across services ([90161c4](https://github.com/LindemannRock/craft-search-manager/commit/90161c420e3fbf23faa524c8329da90e9d526062))
* **search:** normalize tracking site ID and add validation logic ([151529b](https://github.com/LindemannRock/craft-search-manager/commit/151529b445b972334fbcd419a97a3ef908dec005))
* **search:** replace KEYS with SCAN for non-blocking key retrieval ([66ecfc8](https://github.com/LindemannRock/craft-search-manager/commit/66ecfc853b6786ff22c990d541cbd75d49fb5b35))
* **search:** split AutoTransformer section records ([fcea0ac](https://github.com/LindemannRock/craft-search-manager/commit/fcea0acf4823ea65fca4c6469c2fa6c94f0489b8))
* **search:** split stored search record projections ([6ff0fc8](https://github.com/LindemannRock/craft-search-manager/commit/6ff0fc8895d664731e1901e05626462775467843))
* **setup:** add setup checklist and service for readiness verification ([5cc6206](https://github.com/LindemannRock/craft-search-manager/commit/5cc62063260df832aa305515609a0b60883dc426))
* **setup:** include full name in setup completion message include ([e30265a](https://github.com/LindemannRock/craft-search-manager/commit/e30265a92c29523f0cbea5a6078f655e8e744048))
* **snippets:** add settings for search-result snippets configuration ([bab621a](https://github.com/LindemannRock/craft-search-manager/commit/bab621a538353a411d0774c3133b62baccd46e90))
* **tests:** add GraphQL search and autocomplete tests with site handling ([3620219](https://github.com/LindemannRock/craft-search-manager/commit/362021979b98e34668a103b410b6dae77ff704ca))
* **tests:** add trafficType handling in analytics session dedup test ([2707996](https://github.com/LindemannRock/craft-search-manager/commit/270799662a26d4f413c7ad57aea1db4edd95e519))
* **widget:** add promotion display modes with themable debug panel ([14d5755](https://github.com/LindemannRock/craft-search-manager/commit/14d575558676a7d3713413cd9a46694362e765e9))
* **widget:** overhaul style system with icon, footer, and chrome controls ([f2397b7](https://github.com/LindemannRock/craft-search-manager/commit/f2397b7541ce6c9b0bb6bc9e9808447c4d6d9707))
* **widget:** remove line clamping, titles and snippets wrap naturally ([15da1c9](https://github.com/LindemannRock/craft-search-manager/commit/15da1c96a8b10fbc660155df1f8035531a8c21da))
* **widget:** validate API key format in widget configuration ([584b4e4](https://github.com/LindemannRock/craft-search-manager/commit/584b4e4bdedfec06a7445ce33d4dd2d1187efec4))


### Fixed

* **analytics:** harden robustness boundaries ([98aefb7](https://github.com/LindemannRock/craft-search-manager/commit/98aefb739c8b57c8c7ade2770c914cf4e4d0473e))
* **analytics:** include all sources in unique query counts ([05f884e](https://github.com/LindemannRock/craft-search-manager/commit/05f884eb0929fa846f6facefd99c6e88ce5c6abe))
* **analytics:** remove orphan analytics endpoints ([1fa4947](https://github.com/LindemannRock/craft-search-manager/commit/1fa4947d1e9f3054541e5760f9be9bf104ee430b))
* **analytics:** resolve effective site ID for export queries ([590d526](https://github.com/LindemannRock/craft-search-manager/commit/590d526e6133cdfd4a2b805b2b7ba101699ba07c))
* **analytics:** sanitize analytics parameters to prevent injection ([aa51903](https://github.com/LindemannRock/craft-search-manager/commit/aa5190329b80b23cc78d7497cbb07cfde68af409))
* **analytics:** sanitize backend entry counts and move tab flags to controller ([bf3ea28](https://github.com/LindemannRock/craft-search-manager/commit/bf3ea28b8820044baf4f47863b8a2fadf2f79386))
* **analytics:** stop defaulting unknown geo data to Dubai ([c875ffa](https://github.com/LindemannRock/craft-search-manager/commit/c875ffaa3b6641b8595a5aebc67bc79aa01d5a3b))
* **api-keys:** align widget key handle UX ([1f6546f](https://github.com/LindemannRock/craft-search-manager/commit/1f6546f9d417ca30f96702303d9742358fadfeef))
* **api-keys:** block deleting keys used by widgets ([85d2ff1](https://github.com/LindemannRock/craft-search-manager/commit/85d2ff1625b8f36655dcd9101b329e6e6fff3557))
* **api-keys:** reject server keys on public widget endpoints ([c319d78](https://github.com/LindemannRock/craft-search-manager/commit/c319d78731a236e9fdb242630e9fb739f70c23e7))
* **api:** harden rate limiting and geo defaults ([fd63a01](https://github.com/LindemannRock/craft-search-manager/commit/fd63a01c66e6b8f9e6efc76e0d32ef51df25d679))
* **autocomplete:** dedupe merged results and honor backend proxy suggestions ([04b316d](https://github.com/LindemannRock/craft-search-manager/commit/04b316d260bda165a17b17c6394200ee41bc85d8))
* **autocomplete:** prefix filtering storage path ([c5122be](https://github.com/LindemannRock/craft-search-manager/commit/c5122bec5ffa15eabd1bd85d0b9614d24a35f2c8))
* **backends:** escape storage path display ([a02e0fd](https://github.com/LindemannRock/craft-search-manager/commit/a02e0fd2152c7f62be27e9678daf69104686359b))
* **backends:** harden external filter merging ([5752c1d](https://github.com/LindemannRock/craft-search-manager/commit/5752c1d12d879e4f1b81c963229405bc2e66c751))
* **backends:** split external backend API keys ([5646824](https://github.com/LindemannRock/craft-search-manager/commit/5646824ed2030bc161d2bfe87b32957e0d582715))
* **cache:** normalize analytics identity for popular queries ([0b16bd6](https://github.com/LindemannRock/craft-search-manager/commit/0b16bd601add7cebb04eb2eaade44f4dd74fce80))
* **controllers:** improve error handling in Backends and Indices controllers ([08cf011](https://github.com/LindemannRock/craft-search-manager/commit/08cf01149794072d00b9a79cc061272afd978ca3))
* **deletes:** standardize bulk delete guards ([1f0499a](https://github.com/LindemannRock/craft-search-manager/commit/1f0499a0877c8ca2d301719f695e044d2fc3dcd7))
* **dependency:** enhance usage retrieval with permission checks and kind mapping ([08f2a65](https://github.com/LindemannRock/craft-search-manager/commit/08f2a65429455e927b301cbafb953e96a5799c10))
* **frontend:** harden widget and test-tool rendering ([787d1d2](https://github.com/LindemannRock/craft-search-manager/commit/787d1d27794dc9d5d9aa4676266650a38513ae16))
* **i18n:** complete search-manager coverage sweep ([b1ca924](https://github.com/LindemannRock/craft-search-manager/commit/b1ca92458debeabb27de0b7e346ed3739cea8b28))
* **i18n:** correct error messages in controllers for JSON responses ([d757bbc](https://github.com/LindemannRock/craft-search-manager/commit/d757bbc7428d99febe903bad335036723767fa04))
* **i18n:** correct label casing for manage settings button ([e0220f6](https://github.com/LindemannRock/craft-search-manager/commit/e0220f606953fa917478f64d0d5df1affca9e6c3))
* **i18n:** correct label translation for backend settings ([d0a2664](https://github.com/LindemannRock/craft-search-manager/commit/d0a2664398feac75286a63665e4bd13e343db806))
* **i18n:** correct referrer pattern validation message format ([9629d66](https://github.com/LindemannRock/craft-search-manager/commit/9629d6626436d246c4f28dbfc6b9ecf8e4ffdbc5))
* **i18n:** correct status label translations in pending syncs table ([e7401ff](https://github.com/LindemannRock/craft-search-manager/commit/e7401ffa0019f8fdb9487358d082fab0d6601a64))
* **i18n:** correct Swedish translation for browser engine ([2ffc81d](https://github.com/LindemannRock/craft-search-manager/commit/2ffc81d14fd2c59b3f2f6f912d155944afd7eb24))
* **i18n:** correct translations across multiple locales ([a725dec](https://github.com/LindemannRock/craft-search-manager/commit/a725dec63a4e1323e44db241e0f661399e76dc82))
* **i18n:** correct translations across multiple locales ([b810d7f](https://github.com/LindemannRock/craft-search-manager/commit/b810d7fe9ad3fcbfd7a4b3d495b4df044867b484))
* **i18n:** correct translations across multiple locales ([4a925b0](https://github.com/LindemannRock/craft-search-manager/commit/4a925b09f7763db0514c73177ff92e97bb6f50c1))
* **i18n:** correct translations for "Developer resources" across locales ([2b7e6ed](https://github.com/LindemannRock/craft-search-manager/commit/2b7e6ed518b0c6a6dec7ffbc68676fdba21669db))
* **i18n:** correct validation messages and descriptions in WidgetConfig ([39708b0](https://github.com/LindemannRock/craft-search-manager/commit/39708b0030a00a698300ade3a6127ce965976e5f))
* **i18n:** correct validation messages in WidgetStyle model ([a3fba1f](https://github.com/LindemannRock/craft-search-manager/commit/a3fba1fc04e5f0c46f5c947469d91db877f94c17))
* **i18n:** escape dynamic inner HTML values in search test tool ([b7bad47](https://github.com/LindemannRock/craft-search-manager/commit/b7bad47ed982d94399be31967effd397d01c2487))
* **i18n:** localize analytics and test tool labels ([94a8aae](https://github.com/LindemannRock/craft-search-manager/commit/94a8aae286d90a5acfb3ac17569337624049c6fc))
* **i18n:** translate query length labels ([548baea](https://github.com/LindemannRock/craft-search-manager/commit/548baea93c5c396a70d118a899525b67c94ff600))
* **i18n:** update analytics settings instructions for clarity ([e5a9a5f](https://github.com/LindemannRock/craft-search-manager/commit/e5a9a5f8a263f2b4b1896891a25f5d5ff9e9180c))
* **indexing:** gate adapter sync behind auto-index ([f9481e8](https://github.com/LindemannRock/craft-search-manager/commit/f9481e8161368d1c72520486dafd0c089197cfb2))
* **indexing:** guard batch sync lifecycle consistency ([7a9345e](https://github.com/LindemannRock/craft-search-manager/commit/7a9345e6bc649541a6c5363e6daf97c1c9b60f41))
* **indexing:** limit URL-less skip to entries ([fc7c742](https://github.com/LindemannRock/craft-search-manager/commit/fc7c742bf13c9b997582c29c709379052b7fdf19))
* **indexing:** reduce indexing and enrichment round trips ([e6de81b](https://github.com/LindemannRock/craft-search-manager/commit/e6de81b9e19f623baf839ef9efa94d68e6ae21d6))
* **indexing:** report document creation inside index lock ([594d429](https://github.com/LindemannRock/craft-search-manager/commit/594d42933a71900f865007249d979e6129dcba2e))
* **indexing:** use canonical availability for rebuild counts ([079f201](https://github.com/LindemannRock/craft-search-manager/commit/079f2017415c01e34ec49e0dbb57780bbb38ab56))
* **indices:** harden SearchIndex malformed data loading ([008a5de](https://github.com/LindemannRock/craft-search-manager/commit/008a5dec4e974000823c5a08aaa0403c1f59832e))
* **models:** normalize audit date and analytics schema fixes ([8a2aad2](https://github.com/LindemannRock/craft-search-manager/commit/8a2aad22a1fd34c022b9b005dbbbe7cade9d9e7a))
* **promotions:** preserve site context for all-sites promoted results ([fcf081e](https://github.com/LindemannRock/craft-search-manager/commit/fcf081e4d4f952bdc6573ea301a9c98b3430793e))
* **promotions:** resolve Commerce Variant live status ([0bf4c9b](https://github.com/LindemannRock/craft-search-manager/commit/0bf4c9bdebb492472f4bf217ce0e3ecb9cfe29a8))
* **queue:** complete rebuild progress reporting ([97aeb30](https://github.com/LindemannRock/craft-search-manager/commit/97aeb3074e7d4f090b9d220a8c370eb9055666ac))
* **redis:** replace blocking KEYS command with SCAN for key retrieval ([f7f51b3](https://github.com/LindemannRock/craft-search-manager/commit/f7f51b397428a4aa77f9f064841a09399c4a528d))
* remove Redis blocking key scans ([0b46f87](https://github.com/LindemannRock/craft-search-manager/commit/0b46f87f5eff7b5bbe6729349557ea8ae4d64298))
* **robustness:** tighten controller and job error handling ([15d1f01](https://github.com/LindemannRock/craft-search-manager/commit/15d1f01076320297a5ca5196afa27bb876b1cf9b))
* **search-manager:** clear stale index storage on index changes ([c797877](https://github.com/LindemannRock/craft-search-manager/commit/c797877bc165258023967dc12619c7d78b5a3c52))
* **search-manager:** reject malformed GraphQL filters ([cc1bd5a](https://github.com/LindemannRock/craft-search-manager/commit/cc1bd5a29088b90b3e70caa7b7ea3e89e0c73529))
* **search-manager:** reject oversized indexHandles fan-out ([17b0615](https://github.com/LindemannRock/craft-search-manager/commit/17b06155eca811247ddb1d61e34ac4edbf45042e))
* **search:** add main snippet fallback ([c221da0](https://github.com/LindemannRock/craft-search-manager/commit/c221da0f5d7cd7fe5817ee9825aefc04e9aa74a5))
* **search:** align autocomplete compound ranking ([15f625a](https://github.com/LindemannRock/craft-search-manager/commit/15f625ac2914799b34beb1773af6921f69d68a00))
* **search:** apply dark widget style aliases ([ec55da5](https://github.com/LindemannRock/craft-search-manager/commit/ec55da5eba8b9ff351d5c0c182c91b825d61cf07))
* **search:** auto-queue rebuilds after config and enable changes ([1881cfc](https://github.com/LindemannRock/craft-search-manager/commit/1881cfc049e332cb8c4b66990c2fb84f76a06568))
* **search:** auto-queue rebuilds after index identity changes ([fe2ec49](https://github.com/LindemannRock/craft-search-manager/commit/fe2ec4946822d6f0bf51b2637aae87bbf98fe8c2))
* **search:** auto-queue rebuilds after index shape changes ([27140e6](https://github.com/LindemannRock/craft-search-manager/commit/27140e6d2d000ab6d9e1358d5e414a63b6b62486))
* **search:** clean docs snippet sources ([6d492ba](https://github.com/LindemannRock/craft-search-manager/commit/6d492ba79fa1ee88cdfb1097f5b8fefe466a40a2))
* **search:** clean indexed hit metadata contract ([7700933](https://github.com/LindemannRock/craft-search-manager/commit/7700933cca1a6c6e8be9830359dbbe10171d7ab0))
* **search:** clean up batch seven audit findings ([91ff6b7](https://github.com/LindemannRock/craft-search-manager/commit/91ff6b79b38d4e7a6db67084e262bc6793f34e4a))
* **search:** clear cached index instances in AbstractSearchEngineBackend ([2626c80](https://github.com/LindemannRock/craft-search-manager/commit/2626c807bac3c942406f1d529f38fa674dc7938f))
* **search:** close audit finding 330 ([210d9af](https://github.com/LindemannRock/craft-search-manager/commit/210d9af1ab06ae7b9d87be9db08e81f7b7c85d91))
* **search:** close audit findings 323-326 ([95711a5](https://github.com/LindemannRock/craft-search-manager/commit/95711a5dc06d26b5df191c7279afb7bec9ed4fe6))
* **search:** close audit findings 327-329 ([4076643](https://github.com/LindemannRock/craft-search-manager/commit/4076643d31a7013c7d6cbca90a2b24a3ada3baa4))
* **search:** close post-refactor audit regressions ([7d486b5](https://github.com/LindemannRock/craft-search-manager/commit/7d486b59630809e0d196565c982e09a03eb9b00a))
* **search:** correct element info retrieval in search results ([45edb70](https://github.com/LindemannRock/craft-search-manager/commit/45edb70d3a898cc48249fec2fb825d652f92b2b5))
* **search:** correct local type filtering and tracking source caps ([0dc0064](https://github.com/LindemannRock/craft-search-manager/commit/0dc006465545457de1d9f534d9a5aece6bf1763f))
* **search:** enhance regex patterns for better term matching ([71fe4d5](https://github.com/LindemannRock/craft-search-manager/commit/71fe4d5f3225d5d01792d3915b4ceb33c2b995fd))
* **search:** exclude non-searchable custom fields from the index ([088cacb](https://github.com/LindemannRock/craft-search-manager/commit/088cacbb2950c57793fc617222084c90fa8c1d31))
* **search:** gate CP exception messages ([89e8f82](https://github.com/LindemannRock/craft-search-manager/commit/89e8f82f9f78d15ae34745c578d546837d654ba5))
* **search:** harden analytics metadata and translate residual CP labels ([9a0dc7d](https://github.com/LindemannRock/craft-search-manager/commit/9a0dc7dc7661fcb11d9b615b9954ee75cb5d4ea9))
* **search:** harden highlight tags and backend resolution ([988c48a](https://github.com/LindemannRock/craft-search-manager/commit/988c48ad27504973a8dcfca719a9ff0aa677a2b7))
* **search:** harden modal widget surface ([dc8a392](https://github.com/LindemannRock/craft-search-manager/commit/dc8a392019cb369ce27187b0f0ea5d37049b6e1b))
* **search:** isolate index stats in tests ([dbd4eea](https://github.com/LindemannRock/craft-search-manager/commit/dbd4eea71ec7894f1a05bd65a3ff4318b0813880))
* **search:** keep Control Panel search native ([cc475d8](https://github.com/LindemannRock/craft-search-manager/commit/cc475d8300aaac28feca50d6a2057a163e4b1448))
* **search:** localize DB model validation labels ([8923859](https://github.com/LindemannRock/craft-search-manager/commit/89238597a185d7de3ce0f02ce4cee4d011f3860f))
* **search:** maintain native index for manual adapter indexing ([9d8a72f](https://github.com/LindemannRock/craft-search-manager/commit/9d8a72fea1a71b7ab0f947c2af700ca485505e62))
* **search:** make exact match boost phrase aware ([914a7b5](https://github.com/LindemannRock/craft-search-manager/commit/914a7b53c679c2a185e42b151fe168fb6c42ea5f))
* **search:** normalize hit identity and provider filters ([d66240a](https://github.com/LindemannRock/craft-search-manager/commit/d66240a2b4042a5790509a8ae3bed52b84968901))
* **search:** normalize search hit document types ([625055c](https://github.com/LindemannRock/craft-search-manager/commit/625055c3bbb1e99cfc44038a913977261bc34c0e))
* **search:** normalize Unicode whitespace in query identity ([7a92d3c](https://github.com/LindemannRock/craft-search-manager/commit/7a92d3caf6bcf33a582fb4d35688632f131ee2ee))
* **search:** preserve promotion site mapping and escape prefix queries ([5ff0626](https://github.com/LindemannRock/craft-search-manager/commit/5ff0626eb7f931ea9f587bafbf6f85eb5274acbf))
* **search:** purge orphaned storage and clear caches on settings save ([fd74176](https://github.com/LindemannRock/craft-search-manager/commit/fd74176b294ba70476dc490a3947c7356491614f))
* **search:** remove popular-only cache gate ([19c699c](https://github.com/LindemannRock/craft-search-manager/commit/19c699c6dc12f875ada1c27f28d3839fdd44bd0d))
* **search:** remove vestigial queueEnabled setting ([54ac66e](https://github.com/LindemannRock/craft-search-manager/commit/54ac66e8d396e4fbfa9e7ab7f0687a9eba056464))
* **search:** repair native multi-site search adapter ([87d33c2](https://github.com/LindemannRock/craft-search-manager/commit/87d33c2326c4ac2475ac3cc9978e12b353cbec76))
* **search:** repair native replacement fallback coverage ([794c31a](https://github.com/LindemannRock/craft-search-manager/commit/794c31a34651f501bc485e82f9034ae5d5d696b8))
* **search:** resolve index handle parsing and validation logic ([6ccadf4](https://github.com/LindemannRock/craft-search-manager/commit/6ccadf4baddcd7243839d05d0ce49f258f37f7a2))
* **search:** restore exact-match boosts after stop-word filtering ([a75f9e1](https://github.com/LindemannRock/craft-search-manager/commit/a75f9e152b31c525326cb4281ddac3abcc2d43fb))
* **search:** reuse promotions and translated rule descriptions ([f2a00ff](https://github.com/LindemannRock/craft-search-manager/commit/f2a00ffbbaaa778c4740008d50fb9f965c167f1c))
* **search:** scope native coverage UI to meaningful states ([15003d6](https://github.com/LindemannRock/craft-search-manager/commit/15003d66cd12615f37654c226deeb26ed2874d14))
* **search:** scope orphan document cleanup by element ([5206e3a](https://github.com/LindemannRock/craft-search-manager/commit/5206e3a2d5f28d8a2fa9c51d2bfeef7a09b1376b))
* **search:** slim CP test result cards ([01750a4](https://github.com/LindemannRock/craft-search-manager/commit/01750a477263cf456637b716497cbf6299118b1e))
* **search:** support filename-like dotted queries ([bdc6d86](https://github.com/LindemannRock/craft-search-manager/commit/bdc6d867511ee91781dff2abce91c9fa5587f4a0))
* **search:** support selected multi-site search scope ([2a0478d](https://github.com/LindemannRock/craft-search-manager/commit/2a0478d398e1a7aee1cc333f15b265f803484d77))
* **searchwidget:** sync keyboard and mouse navigation on item hover ([d3db18d](https://github.com/LindemannRock/craft-search-manager/commit/d3db18da9015c109aa399ac1ef3bc1497da0e09f))
* **security:** harden public search surfaces ([7542adf](https://github.com/LindemannRock/craft-search-manager/commit/7542adf90f4be7e12a5d15e04f5357fc3656d4d6))
* **security:** harden widget highlight markup ([cd9e1bf](https://github.com/LindemannRock/craft-search-manager/commit/cd9e1bfd56ef42ca1f74c8b8cee2b0af1ca8fc90))
* **security:** neutralize executable URL schemes and close audit batch ([b695b8e](https://github.com/LindemannRock/craft-search-manager/commit/b695b8e52874df8ff068d2bd8126e7f9fa3dcc18))
* **security:** neutralize executable URL schemes in public search hits ([1efefaa](https://github.com/LindemannRock/craft-search-manager/commit/1efefaa8f0fc8916d97fc196e5a32a2d749ee28c))
* **security:** validate query rule redirects with base helper ([c251a48](https://github.com/LindemannRock/craft-search-manager/commit/c251a48c1a45aa352b756cc866bdc87b0e055ca6))
* **settings:** require JSON accept header for analytics cleanup ([ce6686c](https://github.com/LindemannRock/craft-search-manager/commit/ce6686ccc471f893de9e735f2840b51fbeac5959))
* **settings:** validate highlightClass as plain CSS class tokens ([3b9c68a](https://github.com/LindemannRock/craft-search-manager/commit/3b9c68ac4e68f2b8e9f5fcf52fa95a255b1013a3))
* **storage:** avoid logging Redis secrets ([0c028ac](https://github.com/LindemannRock/craft-search-manager/commit/0c028aca1716f9cdbdc47985775c3f47f4f02282))
* **storage:** exclude language metadata from terms ([9211539](https://github.com/LindemannRock/craft-search-manager/commit/9211539e486534e9bf70e5aa75a044202b39ecaa))
* **storage:** handle invalid file backend storage paths gracefully ([8527dd6](https://github.com/LindemannRock/craft-search-manager/commit/8527dd6c15a140e9d7be391b170bef1ee18eec06))
* **storage:** index File and Redis lookup paths ([8e8afd8](https://github.com/LindemannRock/craft-search-manager/commit/8e8afd89ba5a9dba1faf204b6c3cec77f9838bd3))
* **storage:** lock file backend shared index updates ([f8d2cbe](https://github.com/LindemannRock/craft-search-manager/commit/f8d2cbe7e60fb91d98280ae38633a40cfa792f3a))
* **storage:** make Redis compound indexes atomic ([c60efb1](https://github.com/LindemannRock/craft-search-manager/commit/c60efb1cff5b63aeaf852043177b869d9797274b))
* **storage:** preserve Unicode file-backend terms ([cb7df35](https://github.com/LindemannRock/craft-search-manager/commit/cb7df3520bf2eeeecc01fab473bb061184f352d4))
* **storage:** serialize deletes and atomic stats ([21523d7](https://github.com/LindemannRock/craft-search-manager/commit/21523d700216bd289f880776a7a64cee99b78a52))
* **storage:** use shared lock for file reads in FileStorage ([bee3f76](https://github.com/LindemannRock/craft-search-manager/commit/bee3f76310cad008920954217be80dc246c7a19a))
* **sync:** batch status sync element queries ([5e83877](https://github.com/LindemannRock/craft-search-manager/commit/5e83877f2bb8daa4f7d5043d8ec8d18c0514a3cb))
* **sync:** clear caches and reduce repeated index lookups ([78d576a](https://github.com/LindemannRock/craft-search-manager/commit/78d576a009ea77c038609b4425af5372b892319e))
* **sync:** consolidate queued element indexing ([5bdb1c5](https://github.com/LindemannRock/craft-search-manager/commit/5bdb1c51b4f4098757ef236ed4e871fc1dd74d62))
* **sync:** remove unnecessary dirty row checks in PendingSyncRepository ([aab0274](https://github.com/LindemannRock/craft-search-manager/commit/aab02741105ad920c94f1e51808ac02f236b6576))
* **test-tool:** hydrate Commerce promotion targets correctly ([7d6fc96](https://github.com/LindemannRock/craft-search-manager/commit/7d6fc96c7d6933844d391d7cda87e9e4c556b4c9))
* validate backend settings regardless of enabled state ([805d727](https://github.com/LindemannRock/craft-search-manager/commit/805d72789bc974fa450a302072bf0f7204521e8d))
* **widget:** derive debug styling from theme tokens ([df809c0](https://github.com/LindemannRock/craft-search-manager/commit/df809c01ae1dade24af189e0d5f017a1bb0b46fd))
* **widget:** relabel history section from Recent searches to Recently viewed ([e3b6405](https://github.com/LindemannRock/craft-search-manager/commit/e3b6405a2b58e6a996562563f3c806490e172017))
* **widget:** render SourceDoc section hits as grouped results ([2ea47b3](https://github.com/LindemannRock/craft-search-manager/commit/2ea47b3387b192d0747cb8bb727ea8b3b53e8915))
* **widgets:** align API key selection with widget scope ([1075167](https://github.com/LindemannRock/craft-search-manager/commit/10751670f8158ecc06743efcbfb68507cd0ab9f9))
* **widgets:** harden config deletion and API key validation ([928dcd5](https://github.com/LindemannRock/craft-search-manager/commit/928dcd5a27fe03320f51a3aa03b311e85d9d867d))


### Security

* **analytics:** escape HTML in analytics dashboard to prevent XSS ([009166d](https://github.com/LindemannRock/craft-search-manager/commit/009166df994a0cb0b5ce89c6f198251271eecd13))


### Changed

* **dashboard:** count records in database ([a415895](https://github.com/LindemannRock/craft-search-manager/commit/a415895b3786fdbf8b578d1a6bfde8138911d5a4))
* **query-rules:** batch legacy category boost lookup ([c62f46f](https://github.com/LindemannRock/craft-search-manager/commit/c62f46f998c91a5258e4cc0eda90289cc0b1619e))
* **search:** batch all-sites element lookups ([dbca4ed](https://github.com/LindemannRock/craft-search-manager/commit/dbca4ed38adabf5fb82717eb51fe919df58c4cc4))
* **search:** batch local filter and analytics lookups ([3be872a](https://github.com/LindemannRock/craft-search-manager/commit/3be872a62d3e44d8f62be4bac13ef1acd041582c))
* **search:** batch test tool element lookups ([0d2a3a0](https://github.com/LindemannRock/craft-search-manager/commit/0d2a3a0f31699dd49f0771a21423313c52e809cf))
* **search:** reduce analytics and local backend query load ([023cac5](https://github.com/LindemannRock/craft-search-manager/commit/023cac5fb2a810805353109dea48ea73fc7432ab))
* **search:** reuse query rule matches ([5be5bc7](https://github.com/LindemannRock/craft-search-manager/commit/5be5bc76d1628d7692d5f2dbcda0747182075b08))
* **sync:** batch pending sync element loading ([4bed5f5](https://github.com/LindemannRock/craft-search-manager/commit/4bed5f51650f3e793e56f1c98b69efce8c2e9566))
