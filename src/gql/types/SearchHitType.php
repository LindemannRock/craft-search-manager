...
class SearchHitType extends ObjectType
{
    ...
    public static function getFieldDefinitions(): array
    {
        return [
            ...
            'elementType' => ['name' => 'elementType', 'type' => Type::string(), 'description' => 'The indexed element type or section handle.'],
            ...
            'type' => ['name' => 'type', 'type' => Type::string(), 'description' => 'The result type.'],
