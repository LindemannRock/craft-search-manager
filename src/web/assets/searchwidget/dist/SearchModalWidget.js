"use strict";var SearchModalWidget=(()=>{var ee=Object.defineProperty;var Je=Object.getOwnPropertyDescriptor;var Ze=Object.getOwnPropertyNames;var et=Object.prototype.hasOwnProperty;var tt=(e,t)=>{for(var n in t)ee(e,n,{get:t[n],enumerable:!0})},rt=(e,t,n,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of Ze(t))!et.call(e,o)&&o!==n&&ee(e,o,{get:()=>t[o],enumerable:!(r=Je(t,o))||r.enumerable});return e};var nt=e=>rt(ee({},"__esModule",{value:!0}),e);var jt={};tt(jt,{default:()=>qt});var ot={indices:[],placeholder:"Search...",theme:"light",maxResults:20,debounce:200,minChars:2,showRecent:!0,maxRecentSearches:5,groupResults:!0,siteId:"",apiKey:"",searchEndpoint:"/actions/search-manager/api/search",trackClickEndpoint:"/actions/search-manager/search/track-click",trackSearchEndpoint:"/actions/search-manager/search/track-search",idleTimeout:1500,source:"",enableHighlighting:!0,highlightTag:"mark",highlightClass:"",hideResultsWithoutUrl:!1,showCodeSnippets:!1,snippetMode:"balanced",showLoadingIndicator:!0,debug:!1,resultTitleLines:1,resultDescLines:1,snippetLength:150,parseMarkdownSnippets:!1,persistQueryInUrl:!0,queryParamName:"smq",highlightDestinationPage:!0,destinationHighlightSelector:"main, article, [data-search-content]",resultLayout:"default",hierarchyGroupBy:"",hierarchyStyle:"tree",hierarchyDisplay:"individual",maxHeadingsPerResult:3,styles:{},promotions:{showBadge:!0,badgeText:"Featured",badgePosition:"top-right"}},st={hotkey:"k",showTrigger:!0,triggerSelector:"",backdropOpacity:50,enableBackdropBlur:!0,preventBodyScroll:!0},at={showFilters:!0,paginationType:"numbered",resultsPerPage:20,updateUrl:!0,sortOptions:["relevance","date-desc","date-asc","title"]},it={dropdownPosition:"below",dropdownMaxHeight:400,showOnFocus:!0};function lt(e){return{...ot,...{modal:st,page:at,inline:it}[e]||{}}}function y(e,t=!1){if(e==null)return t;if(typeof e=="boolean")return e;if(typeof e=="number")return e!==0;if(e==="")return!0;let n=String(e).trim().toLowerCase();return["1","true","on","yes"].includes(n)?!0:["0","false","off","no"].includes(n)?!1:t}function C(e,t=0){if(e==null)return t;let n=Number.parseInt(e,10);return Number.isNaN(n)?t:n}function te(e,t={}){if(!e)return t;try{return JSON.parse(e)}catch(n){return console.warn("SearchWidget: Invalid JSON attribute",n),t}}function be(e){return e?e.split(",").map(t=>t.trim()).filter(Boolean):[]}function V(e){return e.indices.length>0?e.indices.join(","):"all"}function fe(e){return e.indices.length===1?e.indices[0]:""}function re(e,t="modal"){let n=te(e.getAttribute("snippet-defaults"),{}),r={...lt(t),...Object.fromEntries(Object.entries(n).filter(([m])=>["showCodeSnippets","snippetMode","snippetLength","parseMarkdownSnippets","minSnippetLength","maxSnippetLength","snippetModes"].includes(m)))},o=Array.isArray(r.snippetModes)?r.snippetModes:["early","balanced","deep"],s=Number.isFinite(Number(r.minSnippetLength))?Number(r.minSnippetLength):50,a=Number.isFinite(Number(r.maxSnippetLength))?Number(r.maxSnippetLength):1e3,l=Math.min(a,Math.max(s,C(e.getAttribute("snippet-length"),r.snippetLength))),i=e.getAttribute("snippet-mode")||r.snippetMode,c=e.getAttribute("indices")||"",h={indices:be(c),placeholder:e.getAttribute("placeholder")||r.placeholder,theme:e.getAttribute("theme")||r.theme,siteId:e.getAttribute("site-id")||r.siteId,apiKey:e.getAttribute("api-key")||r.apiKey,source:e.getAttribute("source")||r.source,highlightTag:e.getAttribute("highlight-tag")||r.highlightTag,highlightClass:e.getAttribute("highlight-class")||r.highlightClass,searchEndpoint:r.searchEndpoint,trackClickEndpoint:r.trackClickEndpoint,trackSearchEndpoint:r.trackSearchEndpoint,maxResults:C(e.getAttribute("max-results"),r.maxResults),debounce:C(e.getAttribute("debounce"),r.debounce),minChars:C(e.getAttribute("min-chars"),r.minChars),maxRecentSearches:C(e.getAttribute("max-recent-searches"),r.maxRecentSearches),idleTimeout:C(e.getAttribute("idle-timeout"),r.idleTimeout),showRecent:y(e.getAttribute("show-recent"),r.showRecent),groupResults:y(e.getAttribute("group-results"),r.groupResults),enableHighlighting:y(e.getAttribute("enable-highlighting"),r.enableHighlighting),showLoadingIndicator:y(e.getAttribute("show-loading-indicator"),r.showLoadingIndicator),hideResultsWithoutUrl:y(e.getAttribute("hide-results-without-url"),r.hideResultsWithoutUrl),showCodeSnippets:y(e.getAttribute("show-code-snippets"),r.showCodeSnippets),debug:y(e.getAttribute("debug"),r.debug),snippetMode:o.includes(i)?i:r.snippetMode,snippetLength:l,parseMarkdownSnippets:y(e.getAttribute("parse-markdown-snippets"),r.parseMarkdownSnippets),persistQueryInUrl:y(e.getAttribute("persist-query-in-url"),r.persistQueryInUrl),highlightDestinationPage:y(e.getAttribute("highlight-destination-page"),r.highlightDestinationPage),resultTitleLines:C(e.getAttribute("result-title-lines"),r.resultTitleLines),resultDescLines:C(e.getAttribute("result-desc-lines"),r.resultDescLines),queryParamName:e.getAttribute("query-param-name")||r.queryParamName,destinationHighlightSelector:e.getAttribute("destination-highlight-selector")||r.destinationHighlightSelector,resultLayout:e.getAttribute("result-layout")||r.resultLayout,hierarchyGroupBy:e.getAttribute("hierarchy-group-by")||r.hierarchyGroupBy,hierarchyStyle:e.getAttribute("hierarchy-style")||r.hierarchyStyle,hierarchyDisplay:e.getAttribute("hierarchy-display")||r.hierarchyDisplay,maxHeadingsPerResult:C(e.getAttribute("max-headings-per-result"),r.maxHeadingsPerResult),styles:te(e.getAttribute("styles"),r.styles),promotions:te(e.getAttribute("promotions"),r.promotions)};return t==="modal"&&Object.assign(h,{hotkey:e.getAttribute("hotkey")||r.hotkey,triggerSelector:e.getAttribute("trigger-selector")||r.triggerSelector,backdropOpacity:C(e.getAttribute("backdrop-opacity"),r.backdropOpacity),showTrigger:y(e.getAttribute("show-trigger"),r.showTrigger),enableBackdropBlur:y(e.getAttribute("enable-backdrop-blur"),r.enableBackdropBlur),preventBodyScroll:y(e.getAttribute("prevent-body-scroll"),r.preventBodyScroll)}),t==="page"&&Object.assign(h,{resultsPerPage:C(e.getAttribute("results-per-page"),r.resultsPerPage),paginationType:e.getAttribute("pagination-type")||r.paginationType,showFilters:y(e.getAttribute("show-filters"),r.showFilters),updateUrl:y(e.getAttribute("update-url"),r.updateUrl),sortOptions:be(e.getAttribute("sort-options"))||r.sortOptions}),t==="inline"&&Object.assign(h,{dropdownPosition:e.getAttribute("dropdown-position")||r.dropdownPosition,dropdownMaxHeight:C(e.getAttribute("dropdown-max-height"),r.dropdownMaxHeight),showOnFocus:y(e.getAttribute("show-on-focus"),r.showOnFocus)}),h}function ye(e="modal"){let t=["indices","placeholder","theme","max-results","debounce","min-chars","show-recent","max-recent-searches","group-results","site-id","idle-timeout","source","enable-highlighting","highlight-tag","highlight-class","hide-results-without-url","show-code-snippets","snippet-mode","show-loading-indicator","debug","styles","promotions","result-layout","hierarchy-group-by","hierarchy-style","hierarchy-display","max-headings-per-result","result-title-lines","result-desc-lines","snippet-length","parse-markdown-snippets","persist-query-in-url","query-param-name","highlight-destination-page","destination-highlight-selector"],s={modal:["hotkey","show-trigger","trigger-selector","backdrop-opacity","enable-backdrop-blur","prevent-body-scroll"],page:["show-filters","pagination-type","results-per-page","update-url","sort-options"],inline:["dropdown-position","dropdown-max-height","show-on-focus"]};return[...t,...s[e]||[]]}var X={isOpen:!1,query:"",results:[],recentSearches:[],selectedIndex:-1,loading:!1,error:null,meta:null};function ve(e={},t=null){let n={...X,...e};return{get(r){return n[r]},getAll(){return{...n}},set(r){let o=[];return Object.keys(r).forEach(s=>{let a=n[s],l=r[s];Q(a,l)||o.push(s)}),o.length>0&&(n={...n,...r},t&&t(n,o)),o},reset(r=e){let o={...X,...r},s=Object.keys(o).filter(a=>!Q(n[a],o[a]));s.length>0&&(n=o,t&&t(n,s))},is(r,o){return n[r]===o},toggle(r){let o=!n[r];return this.set({[r]:o}),o}}}function Q(e,t){if(e===t)return!0;if(e==null||t==null)return!1;if(Array.isArray(e)&&Array.isArray(t))return e.length!==t.length?!1:e.every((n,r)=>Q(n,t[r]));if(typeof e=="object"&&typeof t=="object"){let n=Object.keys(e),r=Object.keys(t);return n.length!==r.length?!1:n.every(o=>Q(e[o],t[o]))}return!1}async function ke({query:e,endpoint:t,indices:n=[],siteId:r="",maxResults:o=10,hideResultsWithoutUrl:s=!1,showCodeSnippets:a=!1,snippetMode:l="",snippetLength:i=0,parseMarkdownSnippets:c=!1,debug:d=!1,apiKey:h="",signal:m}){let g=new URLSearchParams({q:e,hitsPerPage:o.toString()});n.length>0&&g.append("indices",n.join(",")),r&&g.append("siteId",r),s&&g.append("hideResultsWithoutUrl","1"),a&&g.append("showCodeSnippets","1"),l&&g.append("snippetMode",l),i&&g.append("snippetLength",String(i)),c&&g.append("parseMarkdownSnippets","1"),d&&g.append("debug","1"),g.append("skipAnalytics","1");let b=t.includes("?")?"&":"?",x={Accept:"application/json"};h&&(x["X-Search-Manager-Key"]=h);let f=await fetch(`${t}${b}${g}`,{signal:m,headers:x});if(!f.ok)throw new Error(await dt(f));let p=await f.json();return p.error&&console.warn("Search warning:",p.error),{results:p.results||p.hits||[],total:p.total||0,meta:p.meta||null,error:p.error||null}}async function dt(e){let t=await ct(e);return e.status===401?t||"Search requires an API key.":e.status===403?t||"This API key cannot access this search.":e.status===429?t||"Search rate limit exceeded. Try again in a moment.":t||"Search failed."}async function ct(e){try{if((e.headers.get("content-type")||"").includes("application/json")){let n=await e.json(),r=n.error||n.message||"";return typeof r=="string"?r.slice(0,240):""}}catch{return""}return""}function xe({endpoint:e,elementId:t,query:n,index:r,apiKey:o=""}){if(!(!t||!e))try{let s=new FormData;s.append("elementId",t),s.append("query",n),s.append("index",r);let a={Accept:"application/json"};o&&(a["X-Search-Manager-Key"]=o),fetch(e,{method:"POST",body:s,headers:a}).catch(()=>{})}catch{}}function we({endpoint:e,query:t,indices:n=[],resultsCount:r=0,trigger:o="unknown",source:s="",siteId:a="",cached:l,took:i,apiKey:c=""}){if(!(!t||!e))try{let d=new FormData;d.append("q",t),d.append("indices",n.join(",")),d.append("resultsCount",r.toString()),d.append("trigger",o),d.append("source",s||"frontend-widget"),a&&d.append("siteId",a),typeof l=="boolean"&&d.append("cached",l?"1":"0"),typeof i=="number"&&Number.isFinite(i)&&i>=0&&d.append("took",i.toString());let h={Accept:"application/json"};c&&(h["X-Search-Manager-Key"]=c),fetch(e,{method:"POST",body:d,headers:h}).catch(()=>{})}catch{}}function Se(e){let t={};return e.forEach(n=>{let r=n.source||n.entrySection||n.type||"Results";t[r]||(t[r]=[]),t[r].push(n)}),t}function Ce(e,t){let n={};return e.forEach(r=>{let o=(t?r[t]:null)||r.source||r.entrySection||r.type||"Results";n[o]||(n[o]=[]),n[o].push(r)}),n}var ht="sm-recent-";function ne(e){return`${ht}${e||"default"}`}function J(e){try{let t=ne(e),n=localStorage.getItem(t);return n?JSON.parse(n):[]}catch{return[]}}function Te(e,t,n=null,r=5){if(!t||!t.trim())return J(e);let o=ne(e),s={query:t.trim(),title:n?.title||t,url:n?.url||null,timestamp:Date.now()},a=J(e);a=a.filter(l=>l.query!==s.query),a.unshift(s),a=a.slice(0,r);try{localStorage.setItem(o,JSON.stringify(a))}catch{}return a}function Ae(e){try{let t=ne(e);localStorage.removeItem(t)}catch{}}var De={spinnerColor:"#3b82f6",spinnerColorDark:"#60a5fa",modalBg:"#ffffff",modalBgDark:"#1f2937",modalBorderRadius:"12",modalBorderWidth:"1",modalBorderColor:"#e5e7eb",modalBorderColorDark:"#374151",modalShadow:"0 25px 50px -12px rgba(0, 0, 0, 0.25)",modalShadowDark:"0 25px 50px -12px rgba(0, 0, 0, 0.5)",modalMaxWidth:"640",modalMaxHeight:"80",modalPaddingX:"16",modalPaddingY:"16",headerBg:"transparent",headerBgDark:"transparent",headerBorderColor:"#e5e7eb",headerBorderColorDark:"#374151",headerBorderWidth:"1",headerBorderRadius:"0",headerPaddingX:"16",headerPaddingY:"12",inputBg:"#ffffff",inputBgDark:"#1f2937",inputTextColor:"#111827",inputTextColorDark:"#f9fafb",inputPlaceholderColor:"#9ca3af",inputPlaceholderColorDark:"#9ca3af",inputBorderColor:"transparent",inputBorderColorDark:"transparent",inputFontSize:"16",inputBorderRadius:"0",inputBorderWidth:"0",inputPaddingX:"0",inputPaddingY:"0",resultBg:"transparent",resultBgDark:"transparent",resultBorderColor:"#e5e7eb",resultBorderColorDark:"#374151",resultActiveBg:"#e5e7eb",resultActiveBgDark:"#4b5563",resultActiveBorderColor:"#e5e7eb",resultActiveBorderColorDark:"#374151",resultActiveTextColor:"#111827",resultActiveTextColorDark:"#f9fafb",resultActiveDescColor:"#4b5563",resultActiveDescColorDark:"#d1d5db",resultActiveMutedColor:"#6b7280",resultActiveMutedColorDark:"#d1d5db",resultTextColor:"#111827",resultTextColorDark:"#f9fafb",resultDescColor:"#4b5563",resultDescColorDark:"#d1d5db",resultMutedColor:"#6b7280",resultMutedColorDark:"#d1d5db",resultGap:"8",resultBorderWidth:"0",resultPaddingX:"12",resultPaddingY:"12",resultBorderRadius:"8",triggerBg:"#ffffff",triggerBgDark:"#374151",triggerTextColor:"#374151",triggerTextColorDark:"#d1d5db",triggerBorderRadius:"8",triggerBorderWidth:"1",triggerBorderColor:"#d1d5db",triggerBorderColorDark:"#4b5563",triggerHoverBg:"#f9fafb",triggerHoverBgDark:"#4b5563",triggerHoverTextColor:"#111827",triggerHoverTextColorDark:"#f9fafb",triggerHoverBorderColor:"#3b82f6",triggerHoverBorderColorDark:"#60a5fa",triggerPaddingX:"12",triggerPaddingY:"8",triggerFontSize:"14",kbdBg:"#f3f4f6",kbdBgDark:"#4b5563",kbdTextColor:"#4b5563",kbdTextColorDark:"#e5e7eb",kbdBorderRadius:"4",backdropOpacity:"50",backdropBlur:"1",highlightEnabled:"1",highlightTag:"",highlightClass:"",highlightBgLight:"fef08a",highlightColorLight:"854d0e",highlightBgDark:"854d0e",highlightColorDark:"fef08a",iconColor:"#3b82f6",iconColorDark:"#60a5fa",promotedBg:"#2563eb",promotedBgDark:"#2563eb",promotedColor:"#ffffff",promotedColorDark:"#ffffff"};var Ie={modalBg:"--sm-modal-bg",modalBgDark:"--sm-modal-bg-dark",modalBorderRadius:"--sm-modal-radius",modalBorderWidth:"--sm-modal-border-width",modalBorderColor:"--sm-modal-border-color",modalBorderColorDark:"--sm-modal-border-color-dark",modalShadow:"--sm-modal-shadow",modalShadowDark:"--sm-modal-shadow-dark",modalMaxWidth:"--sm-modal-width",modalMaxHeight:"--sm-modal-max-height",modalPaddingX:"--sm-modal-px",modalPaddingY:"--sm-modal-py",headerBg:"--sm-header-bg",headerBgDark:"--sm-header-bg-dark",headerBorderColor:"--sm-header-border-color",headerBorderColorDark:"--sm-header-border-color-dark",headerBorderWidth:"--sm-header-border-width",headerBorderRadius:"--sm-header-radius",headerPaddingX:"--sm-header-px",headerPaddingY:"--sm-header-py",inputBg:"--sm-input-bg",inputBgDark:"--sm-input-bg-dark",inputTextColor:"--sm-input-color",inputTextColorDark:"--sm-input-color-dark",inputPlaceholderColor:"--sm-input-placeholder",inputPlaceholderColorDark:"--sm-input-placeholder-dark",inputBorderColor:"--sm-input-border-color",inputBorderColorDark:"--sm-input-border-color-dark",inputFontSize:"--sm-input-font-size",inputBorderRadius:"--sm-input-radius",inputBorderWidth:"--sm-input-border-width",inputPaddingX:"--sm-input-px",inputPaddingY:"--sm-input-py",resultBg:"--sm-result-bg",resultBgDark:"--sm-result-bg-dark",resultBorderColor:"--sm-result-border-color",resultBorderColorDark:"--sm-result-border-color-dark",resultActiveBg:"--sm-result-active-bg",resultActiveBgDark:"--sm-result-active-bg-dark",resultActiveBorderColor:"--sm-result-active-border-color",resultActiveBorderColorDark:"--sm-result-active-border-color-dark",resultActiveTextColor:"--sm-result-active-text-color",resultActiveTextColorDark:"--sm-result-active-text-color-dark",resultActiveDescColor:"--sm-result-active-desc-color",resultActiveDescColorDark:"--sm-result-active-desc-color-dark",resultActiveMutedColor:"--sm-result-active-muted-color",resultActiveMutedColorDark:"--sm-result-active-muted-color-dark",resultTextColor:"--sm-result-text-color",resultTextColorDark:"--sm-result-text-color-dark",resultDescColor:"--sm-result-desc-color",resultDescColorDark:"--sm-result-desc-color-dark",resultMutedColor:"--sm-result-muted-color",resultMutedColorDark:"--sm-result-muted-color-dark",resultGap:"--sm-result-gap",resultBorderWidth:"--sm-result-border-width",resultPaddingX:"--sm-result-px",resultPaddingY:"--sm-result-py",resultBorderRadius:"--sm-result-radius",triggerBg:"--sm-trigger-bg",triggerBgDark:"--sm-trigger-bg-dark",triggerTextColor:"--sm-trigger-text-color",triggerTextColorDark:"--sm-trigger-text-color-dark",triggerBorderRadius:"--sm-trigger-radius",triggerBorderWidth:"--sm-trigger-border-width",triggerBorderColor:"--sm-trigger-border-color",triggerBorderColorDark:"--sm-trigger-border-color-dark",triggerHoverBg:"--sm-trigger-hover-bg",triggerHoverBgDark:"--sm-trigger-hover-bg-dark",triggerHoverTextColor:"--sm-trigger-hover-text-color",triggerHoverTextColorDark:"--sm-trigger-hover-text-color-dark",triggerHoverBorderColor:"--sm-trigger-hover-border-color",triggerHoverBorderColorDark:"--sm-trigger-hover-border-color-dark",triggerPaddingX:"--sm-trigger-px",triggerPaddingY:"--sm-trigger-py",triggerFontSize:"--sm-trigger-font-size",kbdBg:"--sm-kbd-bg",kbdBgDark:"--sm-kbd-bg-dark",kbdTextColor:"--sm-kbd-text-color",kbdTextColorDark:"--sm-kbd-text-color-dark",kbdBorderRadius:"--sm-kbd-radius",iconColor:"--sm-icon-color",iconColorDark:"--sm-icon-color-dark",highlightBgLight:"--sm-highlight-bg",highlightColorLight:"--sm-highlight-color",highlightBgDark:"--sm-highlight-bg-dark",highlightColorDark:"--sm-highlight-color-dark",promotedBg:"--sm-promoted-bg",promotedBgDark:"--sm-promoted-bg-dark",promotedColor:"--sm-promoted-color",promotedColorDark:"--sm-promoted-color-dark",spinnerColor:"--sm-spinner-color-light",spinnerColorDark:"--sm-spinner-color-dark"},oe=["modalBorderRadius","modalBorderWidth","modalMaxWidth","modalPaddingX","modalPaddingY","headerBorderWidth","headerBorderRadius","headerPaddingX","headerPaddingY","inputFontSize","inputBorderRadius","inputBorderWidth","inputPaddingX","inputPaddingY","resultGap","resultBorderWidth","resultPaddingX","resultPaddingY","resultBorderRadius","triggerBorderRadius","triggerBorderWidth","triggerPaddingX","triggerPaddingY","triggerFontSize","kbdBorderRadius"],se=["modalMaxHeight"],Be=["modalBg","modalBgDark","modalBorderColor","modalBorderColorDark","headerBg","headerBgDark","headerBorderColor","headerBorderColorDark","inputBg","inputBgDark","inputTextColor","inputTextColorDark","inputPlaceholderColor","inputPlaceholderColorDark","inputBorderColor","inputBorderColorDark","resultBg","resultBgDark","resultBorderColor","resultBorderColorDark","resultActiveBg","resultActiveBgDark","resultActiveBorderColor","resultActiveBorderColorDark","resultTextColor","resultTextColorDark","resultActiveTextColor","resultActiveTextColorDark","resultActiveDescColor","resultActiveDescColorDark","resultActiveMutedColor","resultActiveMutedColorDark","resultDescColor","resultDescColorDark","resultMutedColor","resultMutedColorDark","triggerBg","triggerBgDark","triggerTextColor","triggerTextColorDark","triggerBorderColor","triggerBorderColorDark","triggerHoverBg","triggerHoverBgDark","triggerHoverTextColor","triggerHoverTextColorDark","triggerHoverBorderColor","triggerHoverBorderColorDark","kbdBg","kbdBgDark","kbdTextColor","kbdTextColorDark","iconColor","iconColorDark","highlightBgLight","highlightColorLight","highlightBgDark","highlightColorDark","promotedBg","promotedBgDark","promotedColor","promotedColorDark","spinnerColor","spinnerColorDark"],Qt={...De,highlightBgLight:"#fef08a",highlightColorLight:"#854d0e",highlightBgDark:"#854d0e",highlightColorDark:"#fef08a"};function gt(e){return typeof e=="string"&&/^(var|light-dark|calc|env|clamp|min|max|rgb|hsl)\s*\(/.test(e.trim())}function mt(e){return/^[0-9a-fA-F]{6}$/.test(e)}function pt(e,t){if(t==null||t==="")return null;let n=String(t);return gt(n)||(Be.includes(e)&&mt(n)&&(n="#"+n),oe.includes(e)&&(n=n+"px"),se.includes(e)&&(n=n+"vh")),n}function Re(e,t,n="light"){if(!t||typeof t!="object")return;let r=n==="dark",o=Object.entries(Ie),s=new Set([...oe,...se]);for(let[a,l]of o){let i=a.endsWith("Dark");if(r){if(!i&&!s.has(a))continue}else if(i)continue;if(t[a]!==void 0&&t[a]!==null&&t[a]!==""){let c=pt(a,t[a]);c&&e.style.setProperty(l,c)}}}var bt=new Set(["mark","em","strong","u","b","i","span"]),ft=/^[A-Za-z0-9_-]+$/;function u(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function $e(e){return e?e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"):""}function ae(e){if(!e)return[];let t=[],n=/"([^"]+)"/g,r;for(;(r=n.exec(e))!==null;)r[1].trim()&&t.push(r[1].trim());let o=e.replace(/"[^"]*"/g,""),s=new Set(["and","or","not","und","oder","nicht","et","ou","sauf","y","o","no"]);o.split(/\s+/).filter(l=>l.length>0).forEach(l=>{l=l.replace(/^[a-zA-Z]+:/,""),l=l.replace(/\*/g,""),l=l.replace(/\^\d+(\.\d+)?/,""),l=l.replace(/"/g,""),!(!l||s.has(l.toLowerCase()))&&t.push(l)});let a=[];return t.forEach(l=>{a.push(l);let i=l.split(/(?<=[a-z])(?=[A-Z])/);i.length>1&&i.forEach(c=>{c.length>=3&&a.push(c)})}),a}function G(e,t,n={}){let{enabled:r=!0,tag:o="mark",className:s="",terms:a=null}=n;if(!r)return u(e);let l=yt(o),c=["sm-highlight",...vt(s)],d=` class="${u(c.join(" "))}"`,h=kt(t,a);return h.length===0?u(e):xt(e,h,l,d)}function yt(e){let t=String(e||"mark").trim().toLowerCase();return bt.has(t)?t:"mark"}function vt(e){return String(e||"").trim().split(/\s+/).filter(t=>t&&ft.test(t))}function kt(e,t){return Array.isArray(t)&&t.length>0?Ee(t):e?Ee(ae(e)):[]}function Ee(e){let t=new Set;return e.filter(n=>typeof n=="string"&&n.length>0).sort((n,r)=>r.length-n.length).filter(n=>{let r=n.toLowerCase();return t.has(r)?!1:(t.add(r),!0)})}function xt(e,t,n,r){let o=e.toLowerCase(),s=[];if(t.forEach(d=>{let h=d.toLowerCase();if(!h)return;let m=0;for(;m<o.length;){let g=o.indexOf(h,m);if(g===-1)break;s.push({start:g,end:g+h.length}),m=g+h.length}}),s.length===0)return u(e);s.sort((d,h)=>d.start!==h.start?d.start-h.start:h.end-h.start-(d.end-d.start));let a=[],l=-1;s.forEach(d=>{d.start>=l&&(a.push(d),l=d.end)});let i="",c=0;return a.forEach(d=>{c<d.start&&(i+=u(e.slice(c,d.start))),i+=`<${n}${r}>${u(e.slice(d.start,d.end))}</${n}>`,c=d.end}),c<e.length&&(i+=u(e.slice(c))),i}function q(e,t,n="smq"){if(!e||e==="#")return e;if(wt(e))return"#";let r=(t||"").trim();if(!r||!n||/^(mailto:|tel:)/i.test(e))return e;let[o,s]=e.split("#",2),[a,l]=o.split("?",2),i=new URLSearchParams(l||"");i.set(n,r);let c=i.toString(),d=s?`#${s}`:"";return`${a}${c?`?${c}`:""}${d}`}function wt(e){let t=String(e).replace(/[\t\n\r]/g,"").replace(/^[\u0000-\u0020]+/,"");return/^(javascript|data|vbscript):/i.test(t)}var St=0;function ie(e="sm"){return`${e}-${++St}-${Date.now().toString(36)}`}function Le(e){let t=document.createElement("div");return t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-atomic","true"),t.className="sm-sr-only",e.appendChild(t),t}function W(e,t,n=100){e&&(e.textContent="",setTimeout(()=>{e.textContent=t},n))}function le(e,t){return e===0?`No results found for "${t}"`:e===1?`1 result found for "${t}"`:`${e} results found for "${t}"`}function Pe(){return"Searching..."}function He(e){return e===0?"No recent searches":e===1?"1 recent search available":`${e} recent searches available`}function Z(e,{expanded:t,activeDescendant:n,listboxId:r}){e.setAttribute("aria-expanded",String(t)),e.setAttribute("aria-controls",r),n?e.setAttribute("aria-activedescendant",n):e.removeAttribute("aria-activedescendant")}function O(e,t){return`${e}-option-${t}`}function Me(e,t){if(!e||!t)return;let n=e.getBoundingClientRect(),r=t.getBoundingClientRect();n.top<r.top?e.scrollIntoView({block:"nearest",behavior:"smooth"}):n.bottom>r.bottom&&e.scrollIntoView({block:"nearest",behavior:"smooth"})}function Ct(e,t,n={}){let{groupResults:r=!1,resultLayout:o="default",listboxId:s}=n;if(!e||e.length===0)return"";if(o==="hierarchical")return Pt(e,t,n);if(r){let a=Se(e),l=0;return Object.entries(a).map(([i,c])=>`
        ...
        `:`
        <a class="sm-result-item${T}" id="${k}" role="option" aria-selected="false" href="${u(p)}" data-index="${t}" data-source-index="${u(I)}"${B} data-title="${u(b)}">
            ${L}
            <div class="sm-result-content">
                <span class="sm-result-title">${_}</span>
                ${$?`<span class="sm-result-desc">${$}</span>`:""}
    ...
    `}function _e(e){let t=[],n=e.backend?e.backend.toLowerCase():"";if((e._index||e.index)&&t.push(w("index",e._index||e.index,"index")),e.backend&&t.push(w("backend",n,"backend",n)),e.elementId&&t.push(w("element",e.elementId,"generic")),e.backendId&&t.push(w("hit",e.backendId,"generic")),e.score!==void 0&&e.score!==null){let r=typeof e.score=="number"?e.score.toFixed(2):e.score;t.push(w("score",r,"score"))}if(e.site&&t.push(w("site",e.site,"generic")),e.language&&t.push(w("lang",e.language,"generic")),e.matchedIn&&Array.isArray(e.matchedIn)&&e.matchedIn.length>0){let r=e.matchedIn.join(", ");t.push(w("matched",r,"matched"))}return e.promoted&&t.push(w("promoted","yes","promoted")),e.boosted&&t.push(w("boosted","yes","boosted")),t.length===0?"":`<div class="sm-debug-info">${t.join("")}</div>`}function N(e,t){let n=Array.isArray(e.matchedPhrases)?e.matchedPhrases:[],r=e.matchedTerms,o=[];r&&(t==="title"&&Array.isArray(r.title)&&r.title.length>0?o=r.title:t==="snippet"&&Array.isArray(r.content)&&r.content.length>0?o=r.content:o=[...Array.isArray(r.title)?r.title:[],...Array.isArray(r.content)?r.content:[]]);let s=[...n,...o];return s.length>0?s:null}function ce(e,t,n,r){return G(t,n,r)}function w(e,t,n,r=""){let o=r?` data-backend="${u(r)}"`:"";return`<span class="sm-debug-item"><span class="sm-debug-label">${u(e)}</span><span class="sm-debug-value" data-type="${u(n)}"${o}>${u(String(t))}</span></span>`}function Tt(e,t={}){let{showBadge:n=!0,badgeText:r="Featured",badgePosition:o="top-right"}=t;return!e.promoted||!n?"":`<span class="sm-promoted-badge ${`sm-promoted-badge--${o}`}">${u(r)}</span>`}function he(e){return!!(e&&typeof e=="object"&&["heading","intro","promoted-page"].includes(String(e.sectionType||"")))}function At(e){return Array.isArray(e)&&e.some(he)}function Dt(e,t){let n=new Map,r=[];return e.forEach((o,s)=>{if(!he(o)){r.push({type:"single",item:o,order:s,score:M(o)});return}let a=Rt(o);if(!n.has(a)){let c={hits:[],order:s,score:M(o)};n.set(a,c),r.push({type:"section-group",key:a,order:s,score:c.score})}let l=n.get(a);l.hits.push(o),l.score=Math.max(l.score,M(o));let i=r.find(c=>c.type==="section-group"&&c.key===a);i&&(i.score=l.score)}),r.map(o=>{if(o.type==="section-group"){let s=n.get(o.key);return{...o,item:It(s.hits,t)}}return o}).sort((o,s)=>{let a=de(s.score,o.score);return a!==0?a:o.order-s.order}).map(o=>o.item)}function It(e,t){let n=[...e].sort((d,h)=>H(d)-H(h)),r=n.find(d=>d.sectionType==="intro")||null,o=[...e].sort((d,h)=>{let m=de(M(h),M(d));return m!==0?m:H(d)-H(h)})[0]||n[0]||{},s=r||o,a=j(s),l=s.siteId??"",i=Number.isFinite(t)&&t>0?t:3,c=n.filter(d=>d.sectionType==="heading").sort((d,h)=>{let m=de(M(h),M(d));return m!==0?m:H(d)-H(h)}).slice(0,i).sort((d,h)=>H(d)-H(h)).map(Bt);return{...s,elementId:a||s.elementId,backendId:r?.backendId||s.backendId||Et(a,l),title:s.title||s.sectionTitle||s.name||"Untitled",url:s.url||"#",snippet:r&&r.snippet||null,score:M(o),headings:c,__sectionHitGroup:!0,__useBackendDomId:!0}}function Bt(e){let t=Number.parseInt(e.sectionLevel,10),n=Number.isFinite(t)?t:2;return{title:e.sectionTitle||e.title||"",text:e.sectionTitle||e.title||"",id:e.sectionAnchor||e.sectionId||"",level:n,url:e.sectionUrl||e.url||null,snippet:e.snippet||null,backendId:e.backendId||"",elementId:j(e),sectionType:e.sectionType,_index:e._index,index:e.index,matchedTerms:e.matchedTerms,matchedPhrases:e.matchedPhrases,__useBackendDomId:!0}}function Rt(e){return[j(e)||Ue(e)||"",e.siteId??""].join(":")}function H(e){let t=Number.parseInt(e.sectionIndex,10);return Number.isFinite(t)?t:Number.MAX_SAFE_INTEGER}function M(e){let t=Number(e?.score);return Number.isFinite(t)?t:Number.NEGATIVE_INFINITY}function de(e,t){return e===t?0:e>t?1:-1}function Et(e,t){let n=e||"unknown";return t!=null&&String(t)!==""?`${n}_${t}`:String(n)}function Ue(e,t=null){return e?.backendId||t?.backendId||""}function j(e,t=null){return e?.elementId||t?.elementId||""}function ue(e,t=null){let n=Ue(e,t)||j(e,t),r=j(e,t);return` data-id="${u(n)}" data-element-id="${u(r)}"`}function F(){return`<svg class="sm-result-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
        <path d="M5 12h14M12 5l7 7-7 7"/>
    </svg>`}function $t(){return`<svg class="sm-hierarchy-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
    ...
    </svg>`}function Oe(){return`<svg class="sm-hierarchy-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
        <line x1="4" y1="9" x2="20" y2="9"/>
        <line x1="4" y1="15" x2="20" y2="15"/>
        <line x1="10" y1="3" x2="8" y2="21"/>
        <line x1="16" y1="3" x2="14" y2="21"/>
    </svg>`}function Pt(e,t,n={}){let{hierarchyGroupBy:r="",hierarchyStyle:o="tree",hierarchyDisplay:s="individual",maxHeadingsPerResult:a=3,listboxId:l}=n,i=o==="tree",c=o!=="none",d=At(e)?Dt(e,a):e,m=Ce(d,r||""),g=0;return Object.entries(m).map(([b,x])=>{let f=x.map(p=>{let D=g++,k=Ht(p,D,t,n),v="",I=p.headings||[],B=p.__sectionHitGroup?I:I.slice(0,a);if(B.length>0){let $=Math.min(...B.map(T=>T.level||2)),L=B.map(T=>i?(T.level||2)-$:0);v=B.map((T,P)=>{let R=L[P],K=!L.slice(P+1).some(U=>U===R),z=[];if(i){let U=L.slice(P+1);for(let A=0;A<R;A++)U.some(Y=>Y===A)&&z.push(A)}return Mt(p,T,g++,t,n,K,R,z)}).join("")}let S=!!v;return`
                <div class="sm-hierarchy-block${S?" sm-hierarchy-block--has-children":""}${s==="unified"?" sm-hierarchy-block--unified":""}">
                    ${S?k.replace("sm-result-item sm-hierarchy-parent","sm-result-item sm-hierarchy-parent sm-hierarchy-parent--has-children"):k}
                    ${S?`<div class="sm-hierarchy-children${c?"":" sm-hierarchy-children--no-connectors"}">${v}</div>`:""}
                </div>
            `}).join("");return`
        ...
        `}).join("")}function Ht(e,t,n,r={}){let{listboxId:o,enableHighlighting:s=!0,highlightTag:a="mark",highlightClass:l="",debug:i=!1,persistQueryInUrl:c=!1,queryParamName:d="smq"}=r,h=e.title||e.name||"Untitled",m=e.snippet||"",g=e.url||"#",b=q(g,n,c?d:""),x=O(o,t),f=e._index||e.index||"",p=ue(e),D={enabled:s,tag:a,className:l},k=G(h,n,{...D,terms:N(e,"title")}),v=m?ce(e,m,n,{...D,terms:N(e,"snippet")}):"",I=i?_e(e):"",S=e.headings&&e.headings.length>0?$t():Lt();return i?`
    ...
    `}function Mt(e,t,n,r,o={},s=!1,a=0,l=[]){let{listboxId:i,enableHighlighting:c=!0,highlightTag:d="mark",highlightClass:h="",debug:m=!1,persistQueryInUrl:g=!1,queryParamName:b="smq"}=o,f=(t.title||t.text||"").replace(/^#+\s*/,""),p=t.snippet||"",D=Number.parseInt(t.level,10),k=Number.isFinite(D)?Math.min(Math.max(D,1),6):2,v=t.id||(f?Nt(f):""),I=e.url||"#",B=t.url||(v?`${I}#${v}`:I),S=q(B,r,g?b:""),_=O(i,n),$=t._index||t.index||e._index||e.index||"",L=ue(t,e),T={enabled:c,tag:d,className:h},P=G(f,r,{...T,terms:N(t,"title")||N(e,"title")}),R=p?ce(e,p,r,{...T,terms:N(t,"snippet")||N(e,"snippet")}):"",K=s?" sm-hierarchy-child-row-last":"",z=l.map(A=>`<div class="sm-hierarchy-guide" style="--sm-guide-depth:${A}" aria-hidden="true"></div>`).join(""),U="";if(m){let A=[];A.push(w("h",k,"generic")),v&&A.push(w("anchor",v,"generic"));let Y=j(t,e);Y&&A.push(w("parent",Y,"generic")),U=`<div class="sm-debug-info">${A.join("")}</div>`}return m?`
            <div class="sm-hierarchy-child-row sm-hierarchy-level-${k} sm-hierarchy-depth-${a}${K}" style="--sm-hierarchy-depth:${a}">
                ${z}
                <a class="sm-result-item sm-hierarchy-child sm-hierarchy-level-${k} sm-debug-enabled" id="${_}" role="option" aria-selected="false" href="${u(S)}" data-index="${n}" data-source-index="${u($)}"${L} data-title="${u(f)}">
                    <div class="sm-result-main">
                        ${Oe()}
                        <div class="sm-result-content">
        ...
        <div class="sm-hierarchy-child-row sm-hierarchy-level-${k} sm-hierarchy-depth-${a}${K}" style="--sm-hierarchy-depth:${a}">
            ${z}
            <a class="sm-result-item sm-hierarchy-child sm-hierarchy-level-${k}" id="${_}" role="option" aria-selected="false" href="${u(S)}" data-index="${n}" data-source-index="${u($)}"${L} data-title="${u(f)}">
                ${Oe()}
                <div class="sm-result-content">
                    <span class="sm-result-title">${P}</span>
                    ${R?`<span class="sm-result-desc">${R}</span>`:""}
    ...
    `}function Nt(e){let t=e.normalize("NFKD").toLowerCase();try{return t.replace(/[^\p{L}\p{N}]+/gu,"-").replace(/^-+|-+$/g,"")}catch{return t.replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}}function Ot(e,t){return!e||e.length===0?"":`
        <div class="sm-section">
            ...
            ${e.map((n,r)=>`
                <div class="sm-result-item sm-recent-item" id="${O(t,r)}" role="option" aria-selected="false" data-index="${r}" data-url="${u(n.url||"")}" data-query="${u(n.query)}">
