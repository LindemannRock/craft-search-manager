"use strict";var SearchModalWidget=(()=>{var te=Object.defineProperty;var Ze=Object.getOwnPropertyDescriptor;var et=Object.getOwnPropertyNames;var tt=Object.prototype.hasOwnProperty;var rt=(e,t)=>{for(var r in t)te(e,r,{get:t[r],enumerable:!0})},nt=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of et(t))!tt.call(e,o)&&o!==r&&te(e,o,{get:()=>t[o],enumerable:!(n=Ze(t,o))||n.enumerable});return e};var ot=e=>nt(te({},"__esModule",{value:!0}),e);var zt={};rt(zt,{default:()=>jt});var st={indices:[],placeholder:"Search...",theme:"light",maxResults:20,debounce:200,minChars:2,showRecent:!0,maxRecentSearches:5,groupResults:!0,siteId:"",apiKey:"",searchEndpoint:"/actions/search-manager/api/search",trackClickEndpoint:"/actions/search-manager/search/track-click",trackSearchEndpoint:"/actions/search-manager/search/track-search",idleTimeout:1500,source:"",enableHighlighting:!0,highlightTag:"mark",highlightClass:"",hideResultsWithoutUrl:!1,showCodeSnippets:!1,snippetMode:"balanced",showLoadingIndicator:!0,debug:!1,resultTitleLines:1,resultDescLines:1,snippetLength:150,parseMarkdownSnippets:!1,persistQueryInUrl:!0,queryParamName:"smq",highlightDestinationPage:!0,destinationHighlightSelector:"main, article, [data-search-content]",resultLayout:"default",hierarchyGroupBy:"",hierarchyStyle:"tree",hierarchyDisplay:"individual",maxHeadingsPerResult:3,styles:{},promotions:{showBadge:!0,badgeText:"Featured",badgePosition:"top-right"}},at={hotkey:"k",showTrigger:!0,triggerSelector:"",backdropOpacity:50,enableBackdropBlur:!0,preventBodyScroll:!0},it={showFilters:!0,paginationType:"numbered",resultsPerPage:20,updateUrl:!0,sortOptions:["relevance","date-desc","date-asc","title"]},lt={dropdownPosition:"below",dropdownMaxHeight:400,showOnFocus:!0};function dt(e){return{...st,...{modal:at,page:it,inline:lt}[e]||{}}}function y(e,t=!1){if(e==null)return t;if(typeof e=="boolean")return e;if(typeof e=="number")return e!==0;if(e==="")return!0;let r=String(e).trim().toLowerCase();return["1","true","on","yes"].includes(r)?!0:["0","false","off","no"].includes(r)?!1:t}function C(e,t=0){if(e==null)return t;let r=Number.parseInt(e,10);return Number.isNaN(r)?t:r}function pe(e,t={}){if(!e)return t;try{return JSON.parse(e)}catch(r){return console.warn("SearchWidget: Invalid JSON attribute",r),t}}function be(e){return e?e.split(",").map(t=>t.trim()).filter(Boolean):[]}function V(e){return e.indices.length>0?e.indices.join(","):"all"}function fe(e){return e.indices.length===1?e.indices[0]:""}function re(e,t="modal"){let r=dt(t),n=e.getAttribute("indices")||"",s={indices:be(n),placeholder:e.getAttribute("placeholder")||r.placeholder,theme:e.getAttribute("theme")||r.theme,siteId:e.getAttribute("site-id")||r.siteId,apiKey:e.getAttribute("api-key")||r.apiKey,source:e.getAttribute("source")||r.source,highlightTag:e.getAttribute("highlight-tag")||r.highlightTag,highlightClass:e.getAttribute("highlight-class")||r.highlightClass,searchEndpoint:r.searchEndpoint,trackClickEndpoint:r.trackClickEndpoint,trackSearchEndpoint:r.trackSearchEndpoint,maxResults:C(e.getAttribute("max-results"),r.maxResults),debounce:C(e.getAttribute("debounce"),r.debounce),minChars:C(e.getAttribute("min-chars"),r.minChars),maxRecentSearches:C(e.getAttribute("max-recent-searches"),r.maxRecentSearches),idleTimeout:C(e.getAttribute("idle-timeout"),r.idleTimeout),showRecent:y(e.getAttribute("show-recent"),r.showRecent),groupResults:y(e.getAttribute("group-results"),r.groupResults),enableHighlighting:y(e.getAttribute("enable-highlighting"),r.enableHighlighting),showLoadingIndicator:y(e.getAttribute("show-loading-indicator"),r.showLoadingIndicator),hideResultsWithoutUrl:y(e.getAttribute("hide-results-without-url"),r.hideResultsWithoutUrl),showCodeSnippets:y(e.getAttribute("show-code-snippets"),r.showCodeSnippets),debug:y(e.getAttribute("debug"),r.debug),snippetMode:e.getAttribute("snippet-mode")||r.snippetMode,snippetLength:C(e.getAttribute("snippet-length"),r.snippetLength),parseMarkdownSnippets:y(e.getAttribute("parse-markdown-snippets"),r.parseMarkdownSnippets),persistQueryInUrl:y(e.getAttribute("persist-query-in-url"),r.persistQueryInUrl),highlightDestinationPage:y(e.getAttribute("highlight-destination-page"),r.highlightDestinationPage),resultTitleLines:C(e.getAttribute("result-title-lines"),r.resultTitleLines),resultDescLines:C(e.getAttribute("result-desc-lines"),r.resultDescLines),queryParamName:e.getAttribute("query-param-name")||r.queryParamName,destinationHighlightSelector:e.getAttribute("destination-highlight-selector")||r.destinationHighlightSelector,resultLayout:e.getAttribute("result-layout")||r.resultLayout,hierarchyGroupBy:e.getAttribute("hierarchy-group-by")||r.hierarchyGroupBy,hierarchyStyle:e.getAttribute("hierarchy-style")||r.hierarchyStyle,hierarchyDisplay:e.getAttribute("hierarchy-display")||r.hierarchyDisplay,maxHeadingsPerResult:C(e.getAttribute("max-headings-per-result"),r.maxHeadingsPerResult),styles:pe(e.getAttribute("styles"),r.styles),promotions:pe(e.getAttribute("promotions"),r.promotions)};return t==="modal"&&Object.assign(s,{hotkey:e.getAttribute("hotkey")||r.hotkey,triggerSelector:e.getAttribute("trigger-selector")||r.triggerSelector,backdropOpacity:C(e.getAttribute("backdrop-opacity"),r.backdropOpacity),showTrigger:y(e.getAttribute("show-trigger"),r.showTrigger),enableBackdropBlur:y(e.getAttribute("enable-backdrop-blur"),r.enableBackdropBlur),preventBodyScroll:y(e.getAttribute("prevent-body-scroll"),r.preventBodyScroll)}),t==="page"&&Object.assign(s,{resultsPerPage:C(e.getAttribute("results-per-page"),r.resultsPerPage),paginationType:e.getAttribute("pagination-type")||r.paginationType,showFilters:y(e.getAttribute("show-filters"),r.showFilters),updateUrl:y(e.getAttribute("update-url"),r.updateUrl),sortOptions:be(e.getAttribute("sort-options"))||r.sortOptions}),t==="inline"&&Object.assign(s,{dropdownPosition:e.getAttribute("dropdown-position")||r.dropdownPosition,dropdownMaxHeight:C(e.getAttribute("dropdown-max-height"),r.dropdownMaxHeight),showOnFocus:y(e.getAttribute("show-on-focus"),r.showOnFocus)}),s}function ye(e="modal"){let t=["indices","placeholder","theme","max-results","debounce","min-chars","show-recent","max-recent-searches","group-results","site-id","idle-timeout","source","enable-highlighting","highlight-tag","highlight-class","hide-results-without-url","show-code-snippets","snippet-mode","show-loading-indicator","debug","styles","promotions","result-layout","hierarchy-group-by","hierarchy-style","hierarchy-display","max-headings-per-result","result-title-lines","result-desc-lines","snippet-length","parse-markdown-snippets","persist-query-in-url","query-param-name","highlight-destination-page","destination-highlight-selector"],s={modal:["hotkey","show-trigger","trigger-selector","backdrop-opacity","enable-backdrop-blur","prevent-body-scroll"],page:["show-filters","pagination-type","results-per-page","update-url","sort-options"],inline:["dropdown-position","dropdown-max-height","show-on-focus"]};return[...t,...s[e]||[]]}var X={isOpen:!1,query:"",results:[],recentSearches:[],selectedIndex:-1,loading:!1,error:null,meta:null};function ve(e={},t=null){let r={...X,...e};return{get(n){return r[n]},getAll(){return{...r}},set(n){let o=[];return Object.keys(n).forEach(s=>{let a=r[s],l=n[s];Q(a,l)||o.push(s)}),o.length>0&&(r={...r,...n},t&&t(r,o)),o},reset(n=e){let o={...X,...n},s=Object.keys(o).filter(a=>!Q(r[a],o[a]));s.length>0&&(r=o,t&&t(r,s))},is(n,o){return r[n]===o},toggle(n){let o=!r[n];return this.set({[n]:o}),o}}}function Q(e,t){if(e===t)return!0;if(e==null||t==null)return!1;if(Array.isArray(e)&&Array.isArray(t))return e.length!==t.length?!1:e.every((r,n)=>Q(r,t[n]));if(typeof e=="object"&&typeof t=="object"){let r=Object.keys(e),n=Object.keys(t);return r.length!==n.length?!1:r.every(o=>Q(e[o],t[o]))}return!1}async function ke({query:e,endpoint:t,indices:r=[],siteId:n="",maxResults:o=10,hideResultsWithoutUrl:s=!1,showCodeSnippets:a=!1,snippetMode:l="balanced",snippetLength:i=150,parseMarkdownSnippets:c=!1,debug:d=!1,apiKey:u="",signal:m}){let g=new URLSearchParams({q:e,hitsPerPage:o.toString()});r.length>0&&g.append("indices",r.join(",")),n&&g.append("siteId",n),s&&g.append("hideResultsWithoutUrl","1"),a&&g.append("showCodeSnippets","1"),l&&l!=="balanced"&&g.append("snippetMode",l),i&&i!==150&&g.append("snippetLength",String(i)),c&&g.append("parseMarkdownSnippets","1"),d&&g.append("debug","1"),g.append("skipAnalytics","1");let b=t.includes("?")?"&":"?",x={Accept:"application/json"};u&&(x["X-Search-Manager-Key"]=u);let f=await fetch(`${t}${b}${g}`,{signal:m,headers:x});if(!f.ok)throw new Error(await ct(f));let p=await f.json();return p.error&&console.warn("Search warning:",p.error),{results:p.results||p.hits||[],total:p.total||0,meta:p.meta||null,error:p.error||null}}async function ct(e){let t=await ht(e);return e.status===401?t||"Search requires an API key.":e.status===403?t||"This API key cannot access this search.":e.status===429?t||"Search rate limit exceeded. Try again in a moment.":t||"Search failed."}async function ht(e){try{if((e.headers.get("content-type")||"").includes("application/json")){let r=await e.json(),n=r.error||r.message||"";return typeof n=="string"?n.slice(0,240):""}}catch{return""}return""}function xe({endpoint:e,elementId:t,query:r,index:n,apiKey:o=""}){if(!(!t||!e))try{let s=new FormData;s.append("elementId",t),s.append("query",r),s.append("index",n);let a={Accept:"application/json"};o&&(a["X-Search-Manager-Key"]=o),fetch(e,{method:"POST",body:s,headers:a}).catch(()=>{})}catch{}}function we({endpoint:e,query:t,indices:r=[],resultsCount:n=0,trigger:o="unknown",source:s="",siteId:a="",cached:l,took:i,apiKey:c=""}){if(!(!t||!e))try{let d=new FormData;d.append("q",t),d.append("indices",r.join(",")),d.append("resultsCount",n.toString()),d.append("trigger",o),d.append("source",s||"frontend-widget"),a&&d.append("siteId",a),typeof l=="boolean"&&d.append("cached",l?"1":"0"),typeof i=="number"&&Number.isFinite(i)&&i>=0&&d.append("took",i.toString());let u={Accept:"application/json"};c&&(u["X-Search-Manager-Key"]=c),fetch(e,{method:"POST",body:d,headers:u}).catch(()=>{})}catch{}}function Ce(e){let t={};return e.forEach(r=>{let n=r.section||r.type||"Results";t[n]||(t[n]=[]),t[n].push(r)}),t}function Se(e,t){let r={};return e.forEach(n=>{let o=n[t]||n.section||n.type||"Results";r[o]||(r[o]=[]),r[o].push(n)}),r}var ut="sm-recent-";function ne(e){return`${ut}${e||"default"}`}function J(e){try{let t=ne(e),r=localStorage.getItem(t);return r?JSON.parse(r):[]}catch{return[]}}function Te(e,t,r=null,n=5){if(!t||!t.trim())return J(e);let o=ne(e),s={query:t.trim(),title:r?.title||t,url:r?.url||null,timestamp:Date.now()},a=J(e);a=a.filter(l=>l.query!==s.query),a.unshift(s),a=a.slice(0,n);try{localStorage.setItem(o,JSON.stringify(a))}catch{}return a}function Ae(e){try{let t=ne(e);localStorage.removeItem(t)}catch{}}var De={spinnerColor:"#3b82f6",spinnerColorDark:"#60a5fa",modalBg:"#ffffff",modalBgDark:"#1f2937",modalBorderRadius:"12",modalBorderWidth:"1",modalBorderColor:"#e5e7eb",modalBorderColorDark:"#374151",modalShadow:"0 25px 50px -12px rgba(0, 0, 0, 0.25)",modalShadowDark:"0 25px 50px -12px rgba(0, 0, 0, 0.5)",modalMaxWidth:"640",modalMaxHeight:"80",modalPaddingX:"16",modalPaddingY:"16",headerBg:"transparent",headerBgDark:"transparent",headerBorderColor:"#e5e7eb",headerBorderColorDark:"#374151",headerBorderWidth:"1",headerBorderRadius:"0",headerPaddingX:"16",headerPaddingY:"12",inputBg:"#ffffff",inputBgDark:"#1f2937",inputTextColor:"#111827",inputTextColorDark:"#f9fafb",inputPlaceholderColor:"#9ca3af",inputPlaceholderColorDark:"#9ca3af",inputBorderColor:"transparent",inputBorderColorDark:"transparent",inputFontSize:"16",inputBorderRadius:"0",inputBorderWidth:"0",inputPaddingX:"0",inputPaddingY:"0",resultBg:"transparent",resultBgDark:"transparent",resultBorderColor:"#e5e7eb",resultBorderColorDark:"#374151",resultActiveBg:"#e5e7eb",resultActiveBgDark:"#4b5563",resultActiveBorderColor:"#e5e7eb",resultActiveBorderColorDark:"#374151",resultActiveTextColor:"#111827",resultActiveTextColorDark:"#f9fafb",resultActiveDescColor:"#4b5563",resultActiveDescColorDark:"#d1d5db",resultActiveMutedColor:"#6b7280",resultActiveMutedColorDark:"#d1d5db",resultTextColor:"#111827",resultTextColorDark:"#f9fafb",resultDescColor:"#4b5563",resultDescColorDark:"#d1d5db",resultMutedColor:"#6b7280",resultMutedColorDark:"#d1d5db",resultGap:"8",resultBorderWidth:"0",resultPaddingX:"12",resultPaddingY:"12",resultBorderRadius:"8",triggerBg:"#ffffff",triggerBgDark:"#374151",triggerTextColor:"#374151",triggerTextColorDark:"#d1d5db",triggerBorderRadius:"8",triggerBorderWidth:"1",triggerBorderColor:"#d1d5db",triggerBorderColorDark:"#4b5563",triggerHoverBg:"#f9fafb",triggerHoverBgDark:"#4b5563",triggerHoverTextColor:"#111827",triggerHoverTextColorDark:"#f9fafb",triggerHoverBorderColor:"#3b82f6",triggerHoverBorderColorDark:"#60a5fa",triggerPaddingX:"12",triggerPaddingY:"8",triggerFontSize:"14",kbdBg:"#f3f4f6",kbdBgDark:"#4b5563",kbdTextColor:"#4b5563",kbdTextColorDark:"#e5e7eb",kbdBorderRadius:"4",backdropOpacity:"50",backdropBlur:"1",highlightEnabled:"1",highlightTag:"",highlightClass:"",highlightBgLight:"fef08a",highlightColorLight:"854d0e",highlightBgDark:"854d0e",highlightColorDark:"fef08a",iconColor:"#3b82f6",iconColorDark:"#60a5fa",promotedBg:"#2563eb",promotedBgDark:"#2563eb",promotedColor:"#ffffff",promotedColorDark:"#ffffff"};var Ie={modalBg:"--sm-modal-bg",modalBgDark:"--sm-modal-bg-dark",modalBorderRadius:"--sm-modal-radius",modalBorderWidth:"--sm-modal-border-width",modalBorderColor:"--sm-modal-border-color",modalBorderColorDark:"--sm-modal-border-color-dark",modalShadow:"--sm-modal-shadow",modalShadowDark:"--sm-modal-shadow-dark",modalMaxWidth:"--sm-modal-width",modalMaxHeight:"--sm-modal-max-height",modalPaddingX:"--sm-modal-px",modalPaddingY:"--sm-modal-py",headerBg:"--sm-header-bg",headerBgDark:"--sm-header-bg-dark",headerBorderColor:"--sm-header-border-color",headerBorderColorDark:"--sm-header-border-color-dark",headerBorderWidth:"--sm-header-border-width",headerBorderRadius:"--sm-header-radius",headerPaddingX:"--sm-header-px",headerPaddingY:"--sm-header-py",inputBg:"--sm-input-bg",inputBgDark:"--sm-input-bg-dark",inputTextColor:"--sm-input-color",inputTextColorDark:"--sm-input-color-dark",inputPlaceholderColor:"--sm-input-placeholder",inputPlaceholderColorDark:"--sm-input-placeholder-dark",inputBorderColor:"--sm-input-border-color",inputBorderColorDark:"--sm-input-border-color-dark",inputFontSize:"--sm-input-font-size",inputBorderRadius:"--sm-input-radius",inputBorderWidth:"--sm-input-border-width",inputPaddingX:"--sm-input-px",inputPaddingY:"--sm-input-py",resultBg:"--sm-result-bg",resultBgDark:"--sm-result-bg-dark",resultBorderColor:"--sm-result-border-color",resultBorderColorDark:"--sm-result-border-color-dark",resultActiveBg:"--sm-result-active-bg",resultActiveBgDark:"--sm-result-active-bg-dark",resultActiveBorderColor:"--sm-result-active-border-color",resultActiveBorderColorDark:"--sm-result-active-border-color-dark",resultActiveTextColor:"--sm-result-active-text-color",resultActiveTextColorDark:"--sm-result-active-text-color-dark",resultActiveDescColor:"--sm-result-active-desc-color",resultActiveDescColorDark:"--sm-result-active-desc-color-dark",resultActiveMutedColor:"--sm-result-active-muted-color",resultActiveMutedColorDark:"--sm-result-active-muted-color-dark",resultTextColor:"--sm-result-text-color",resultTextColorDark:"--sm-result-text-color-dark",resultDescColor:"--sm-result-desc-color",resultDescColorDark:"--sm-result-desc-color-dark",resultMutedColor:"--sm-result-muted-color",resultMutedColorDark:"--sm-result-muted-color-dark",resultGap:"--sm-result-gap",resultBorderWidth:"--sm-result-border-width",resultPaddingX:"--sm-result-px",resultPaddingY:"--sm-result-py",resultBorderRadius:"--sm-result-radius",triggerBg:"--sm-trigger-bg",triggerBgDark:"--sm-trigger-bg-dark",triggerTextColor:"--sm-trigger-text-color",triggerTextColorDark:"--sm-trigger-text-color-dark",triggerBorderRadius:"--sm-trigger-radius",triggerBorderWidth:"--sm-trigger-border-width",triggerBorderColor:"--sm-trigger-border-color",triggerBorderColorDark:"--sm-trigger-border-color-dark",triggerHoverBg:"--sm-trigger-hover-bg",triggerHoverBgDark:"--sm-trigger-hover-bg-dark",triggerHoverTextColor:"--sm-trigger-hover-text-color",triggerHoverTextColorDark:"--sm-trigger-hover-text-color-dark",triggerHoverBorderColor:"--sm-trigger-hover-border-color",triggerHoverBorderColorDark:"--sm-trigger-hover-border-color-dark",triggerPaddingX:"--sm-trigger-px",triggerPaddingY:"--sm-trigger-py",triggerFontSize:"--sm-trigger-font-size",kbdBg:"--sm-kbd-bg",kbdBgDark:"--sm-kbd-bg-dark",kbdTextColor:"--sm-kbd-text-color",kbdTextColorDark:"--sm-kbd-text-color-dark",kbdBorderRadius:"--sm-kbd-radius",iconColor:"--sm-icon-color",iconColorDark:"--sm-icon-color-dark",highlightBgLight:"--sm-highlight-bg",highlightColorLight:"--sm-highlight-color",highlightBgDark:"--sm-highlight-bg-dark",highlightColorDark:"--sm-highlight-color-dark",promotedBg:"--sm-promoted-bg",promotedBgDark:"--sm-promoted-bg-dark",promotedColor:"--sm-promoted-color",promotedColorDark:"--sm-promoted-color-dark",spinnerColor:"--sm-spinner-color-light",spinnerColorDark:"--sm-spinner-color-dark"},oe=["modalBorderRadius","modalBorderWidth","modalMaxWidth","modalPaddingX","modalPaddingY","headerBorderWidth","headerBorderRadius","headerPaddingX","headerPaddingY","inputFontSize","inputBorderRadius","inputBorderWidth","inputPaddingX","inputPaddingY","resultGap","resultBorderWidth","resultPaddingX","resultPaddingY","resultBorderRadius","triggerBorderRadius","triggerBorderWidth","triggerPaddingX","triggerPaddingY","triggerFontSize","kbdBorderRadius"],se=["modalMaxHeight"],Be=["modalBg","modalBgDark","modalBorderColor","modalBorderColorDark","headerBg","headerBgDark","headerBorderColor","headerBorderColorDark","inputBg","inputBgDark","inputTextColor","inputTextColorDark","inputPlaceholderColor","inputPlaceholderColorDark","inputBorderColor","inputBorderColorDark","resultBg","resultBgDark","resultBorderColor","resultBorderColorDark","resultActiveBg","resultActiveBgDark","resultActiveBorderColor","resultActiveBorderColorDark","resultTextColor","resultTextColorDark","resultActiveTextColor","resultActiveTextColorDark","resultActiveDescColor","resultActiveDescColorDark","resultActiveMutedColor","resultActiveMutedColorDark","resultDescColor","resultDescColorDark","resultMutedColor","resultMutedColorDark","triggerBg","triggerBgDark","triggerTextColor","triggerTextColorDark","triggerBorderColor","triggerBorderColorDark","triggerHoverBg","triggerHoverBgDark","triggerHoverTextColor","triggerHoverTextColorDark","triggerHoverBorderColor","triggerHoverBorderColorDark","kbdBg","kbdBgDark","kbdTextColor","kbdTextColorDark","iconColor","iconColorDark","highlightBgLight","highlightColorLight","highlightBgDark","highlightColorDark","promotedBg","promotedBgDark","promotedColor","promotedColorDark","spinnerColor","spinnerColorDark"],Jt={...De,highlightBgLight:"#fef08a",highlightColorLight:"#854d0e",highlightBgDark:"#854d0e",highlightColorDark:"#fef08a"};function mt(e){return typeof e=="string"&&/^(var|light-dark|calc|env|clamp|min|max|rgb|hsl)\s*\(/.test(e.trim())}function pt(e){return/^[0-9a-fA-F]{6}$/.test(e)}function bt(e,t){if(t==null||t==="")return null;let r=String(t);return mt(r)||(Be.includes(e)&&pt(r)&&(r="#"+r),oe.includes(e)&&(r=r+"px"),se.includes(e)&&(r=r+"vh")),r}function Re(e,t,r="light"){if(!t||typeof t!="object")return;let n=r==="dark",o=Object.entries(Ie),s=new Set([...oe,...se]);for(let[a,l]of o){let i=a.endsWith("Dark");if(n){if(!i&&!s.has(a))continue}else if(i)continue;if(t[a]!==void 0&&t[a]!==null&&t[a]!==""){let c=bt(a,t[a]);c&&e.style.setProperty(l,c)}}}var ft=new Set(["mark","em","strong","u","b","i","span"]),yt=/^[A-Za-z0-9_-]+$/;function h(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function $e(e){return e?e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"):""}function ae(e){if(!e)return[];let t=[],r=/"([^"]+)"/g,n;for(;(n=r.exec(e))!==null;)n[1].trim()&&t.push(n[1].trim());let o=e.replace(/"[^"]*"/g,""),s=new Set(["and","or","not","und","oder","nicht","et","ou","sauf","y","o","no"]);o.split(/\s+/).filter(l=>l.length>0).forEach(l=>{l=l.replace(/^[a-zA-Z]+:/,""),l=l.replace(/\*/g,""),l=l.replace(/\^\d+(\.\d+)?/,""),l=l.replace(/"/g,""),!(!l||s.has(l.toLowerCase()))&&t.push(l)});let a=[];return t.forEach(l=>{a.push(l);let i=l.split(/(?<=[a-z])(?=[A-Z])/);i.length>1&&i.forEach(c=>{c.length>=3&&a.push(c)})}),a}function z(e,t,r={}){let{enabled:n=!0,tag:o="mark",className:s="",terms:a=null}=r;if(!n)return h(e);let l=vt(o),c=["sm-highlight",...kt(s)],d=` class="${h(c.join(" "))}"`,u=xt(t,a);return u.length===0?h(e):wt(e,u,l,d)}function vt(e){let t=String(e||"mark").trim().toLowerCase();return ft.has(t)?t:"mark"}function kt(e){return String(e||"").trim().split(/\s+/).filter(t=>t&&yt.test(t))}function xt(e,t){return Array.isArray(t)&&t.length>0?Ee(t):e?Ee(ae(e)):[]}function Ee(e){let t=new Set;return e.filter(r=>typeof r=="string"&&r.length>0).sort((r,n)=>n.length-r.length).filter(r=>{let n=r.toLowerCase();return t.has(n)?!1:(t.add(n),!0)})}function wt(e,t,r,n){let o=e.toLowerCase(),s=[];if(t.forEach(d=>{let u=d.toLowerCase();if(!u)return;let m=0;for(;m<o.length;){let g=o.indexOf(u,m);if(g===-1)break;s.push({start:g,end:g+u.length}),m=g+u.length}}),s.length===0)return h(e);s.sort((d,u)=>d.start!==u.start?d.start-u.start:u.end-u.start-(d.end-d.start));let a=[],l=-1;s.forEach(d=>{d.start>=l&&(a.push(d),l=d.end)});let i="",c=0;return a.forEach(d=>{c<d.start&&(i+=h(e.slice(c,d.start))),i+=`<${r}${n}>${h(e.slice(d.start,d.end))}</${r}>`,c=d.end}),c<e.length&&(i+=h(e.slice(c))),i}function q(e,t,r="smq"){if(!e||e==="#")return e;if(Ct(e))return"#";let n=(t||"").trim();if(!n||!r||/^(mailto:|tel:)/i.test(e))return e;let[o,s]=e.split("#",2),[a,l]=o.split("?",2),i=new URLSearchParams(l||"");i.set(r,n);let c=i.toString(),d=s?`#${s}`:"";return`${a}${c?`?${c}`:""}${d}`}function Ct(e){let t=String(e).replace(/[\t\n\r]/g,"").replace(/^[\u0000-\u0020]+/,"");return/^(javascript|data|vbscript):/i.test(t)}var St=0;function ie(e="sm"){return`${e}-${++St}-${Date.now().toString(36)}`}function Le(e){let t=document.createElement("div");return t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-atomic","true"),t.className="sm-sr-only",e.appendChild(t),t}function G(e,t,r=100){e&&(e.textContent="",setTimeout(()=>{e.textContent=t},r))}function le(e,t){return e===0?`No results found for "${t}"`:e===1?`1 result found for "${t}"`:`${e} results found for "${t}"`}function Pe(){return"Searching..."}function He(e){return e===0?"No recent searches":e===1?"1 recent search available":`${e} recent searches available`}function Z(e,{expanded:t,activeDescendant:r,listboxId:n}){e.setAttribute("aria-expanded",String(t)),e.setAttribute("aria-controls",n),r?e.setAttribute("aria-activedescendant",r):e.removeAttribute("aria-activedescendant")}function O(e,t){return`${e}-option-${t}`}function Me(e,t){if(!e||!t)return;let r=e.getBoundingClientRect(),n=t.getBoundingClientRect();r.top<n.top?e.scrollIntoView({block:"nearest",behavior:"smooth"}):r.bottom>n.bottom&&e.scrollIntoView({block:"nearest",behavior:"smooth"})}function Tt(e,t,r={}){let{groupResults:n=!1,resultLayout:o="default",listboxId:s}=r;if(!e||e.length===0)return"";if(o==="hierarchical")return Ht(e,t,r);if(n){let a=Ce(e),l=0;return Object.entries(a).map(([i,c])=>`
            <div class="sm-section" role="group" aria-label="${h(i)}">
                <div class="sm-section-header">${h(i)}</div>
                ${c.map(d=>Ne(d,l++,t,r)).join("")}
            </div>
        `).join("")}return e.map((a,l)=>Ne(a,l,t,r)).join("")}function Ne(e,t,r,n={}){let{listboxId:o,enableHighlighting:s=!0,highlightTag:a="mark",highlightClass:l="",groupResults:i=!1,promotions:c={},debug:d=!1,persistQueryInUrl:u=!1,queryParamName:m="smq"}=n,g=ee(e),b=g?e.sectionTitle||e.title||e.name||"Untitled":e.title||e.name||"Untitled",x=e.snippet||"",f=g?e.sectionUrl||e.url||e.href||"#":e.url||e.href||"#",p=q(f,r,u?m:""),D=e.section||e.type||"",k=O(o,t),v=e.promoted===!0,I=e._index||e.index||"",B=he(e),w={enabled:s,tag:a,className:l},F=z(b,r,{...w,terms:N(e,"title")}),$=x?ce(e,x,r,{...w,terms:N(e,"snippet")}):"",L=At(e,c),T=v?" sm-promoted":"",P=D&&!i?`<span class="sm-result-type">${h(D)}</span>`:"",R=d?Ue(e):"";return d?`
            <a class="sm-result-item sm-debug-enabled${T}" id="${k}" role="option" aria-selected="false" href="${h(p)}" data-index="${t}" data-source-index="${h(I)}"${B} data-title="${h(b)}">
        ...
        `:`
        <a class="sm-result-item${T}" id="${k}" role="option" aria-selected="false" href="${h(p)}" data-index="${t}" data-source-index="${h(I)}"${B} data-title="${h(b)}">
            ${L}
            <div class="sm-result-content">
                <span class="sm-result-title">${F}</span>
                ${$?`<span class="sm-result-desc">${$}</span>`:""}
    ...
    `}function Ue(e){let t=[],r=e.backend?e.backend.toLowerCase():"";if((e._index||e.index)&&t.push(S("index",e._index||e.index,"index")),e.backend&&t.push(S("backend",r,"backend",r)),e.id&&t.push(S("id",e.id,"generic")),e.score!==void 0&&e.score!==null){let n=typeof e.score=="number"?e.score.toFixed(2):e.score;t.push(S("score",n,"score"))}if(e.site&&t.push(S("site",e.site,"generic")),e.language&&t.push(S("lang",e.language,"generic")),e.matchedIn&&Array.isArray(e.matchedIn)&&e.matchedIn.length>0){let n=e.matchedIn.join(", ");t.push(S("matched",n,"matched"))}return e.promoted&&t.push(S("promoted","yes","promoted")),e.boosted&&t.push(S("boosted","yes","boosted")),t.length===0?"":`<div class="sm-debug-info">${t.join("")}</div>`}function N(e,t){let r=Array.isArray(e.matchedPhrases)?e.matchedPhrases:[],n=e.matchedTerms,o=[];n&&(t==="title"&&Array.isArray(n.title)&&n.title.length>0?o=n.title:t==="snippet"&&Array.isArray(n.content)&&n.content.length>0?o=n.content:o=[...Array.isArray(n.title)?n.title:[],...Array.isArray(n.content)?n.content:[]]);let s=[...r,...o];return s.length>0?s:null}function ce(e,t,r,n){return z(t,r,n)}function S(e,t,r,n=""){let o=n?` data-backend="${h(n)}"`:"";return`<span class="sm-debug-item"><span class="sm-debug-label">${h(e)}</span><span class="sm-debug-value" data-type="${h(r)}"${o}>${h(String(t))}</span></span>`}function At(e,t={}){let{showBadge:r=!0,badgeText:n="Featured",badgePosition:o="top-right"}=t;return!e.promoted||!r?"":`<span class="sm-promoted-badge ${`sm-promoted-badge--${o}`}">${h(n)}</span>`}function ee(e){return!!(e&&typeof e=="object"&&e.sectionType)}function Dt(e){return Array.isArray(e)&&e.some(ee)}function It(e,t){let r=new Map,n=[];return e.forEach((o,s)=>{if(!ee(o)){n.push({type:"single",item:o,order:s,score:M(o)});return}let a=Et(o);if(!r.has(a)){let c={hits:[],order:s,score:M(o)};r.set(a,c),n.push({type:"section-group",key:a,order:s,score:c.score})}let l=r.get(a);l.hits.push(o),l.score=Math.max(l.score,M(o));let i=n.find(c=>c.type==="section-group"&&c.key===a);i&&(i.score=l.score)}),n.map(o=>{if(o.type==="section-group"){let s=r.get(o.key);return{...o,item:Bt(s.hits,t)}}return o}).sort((o,s)=>{let a=de(s.score,o.score);return a!==0?a:o.order-s.order}).map(o=>o.item)}function Bt(e,t){let r=[...e].sort((d,u)=>H(d)-H(u)),n=r.find(d=>d.sectionType==="intro")||null,o=[...e].sort((d,u)=>{let m=de(M(u),M(d));return m!==0?m:H(d)-H(u)})[0]||r[0]||{},s=n||o,a=W(s),l=s.siteId??"",i=Number.isFinite(t)&&t>0?t:3,c=r.filter(d=>d.sectionType==="heading").sort((d,u)=>{let m=de(M(u),M(d));return m!==0?m:H(d)-H(u)}).slice(0,i).sort((d,u)=>H(d)-H(u)).map(Rt);return{...s,id:a||s.id,elementId:a||s.elementId,backendId:n?.backendId||s.backendId||$t(a,l),title:s.title||s.sectionTitle||s.name||"Untitled",url:s.url||"#",snippet:n&&n.snippet||null,score:M(o),headings:c,__sectionHitGroup:!0,__useBackendDomId:!0}}function Rt(e){let t=Number.parseInt(e.sectionLevel,10),r=Number.isFinite(t)?t:2;return{title:e.sectionTitle||e.title||"",text:e.sectionTitle||e.title||"",id:e.sectionAnchor||e.sectionId||"",level:r,url:e.sectionUrl||e.url||null,snippet:e.snippet||null,backendId:e.backendId||"",elementId:W(e),sectionType:e.sectionType,_index:e._index,index:e.index,matchedTerms:e.matchedTerms,matchedPhrases:e.matchedPhrases,__useBackendDomId:!0}}function Et(e){return[W(e)||qe(e)||"",e.siteId??""].join(":")}function H(e){let t=Number.parseInt(e.sectionIndex,10);return Number.isFinite(t)?t:Number.MAX_SAFE_INTEGER}function M(e){let t=Number(e?.score);return Number.isFinite(t)?t:Number.NEGATIVE_INFINITY}function de(e,t){return e===t?0:e>t?1:-1}function $t(e,t){let r=e||"unknown";return t!=null&&String(t)!==""?`${r}_${t}`:String(r)}function qe(e,t=null){return e?.backendId||e?.objectID||t?.backendId||t?.objectID||e?.id||t?.id||""}function W(e,t=null){return e?.elementId||t?.elementId||Oe(e?.id)||Oe(t?.id)||""}function Oe(e){return e==null||e===""?"":/^\d+$/.test(String(e))?String(e):""}function he(e,t=null){if(!!!(e?.__useBackendDomId||t?.__sectionHitGroup||ee(e)))return` data-id="${h(e?.id||"")}"`;let n=qe(e,t),o=W(e,t);return` data-id="${h(n)}" data-element-id="${h(o)}"`}function _(){return`<svg class="sm-result-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
    ...
    </svg>`}function _e(){return`<svg class="sm-hierarchy-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
        <line x1="4" y1="9" x2="20" y2="9"/>
        <line x1="4" y1="15" x2="20" y2="15"/>
        <line x1="10" y1="3" x2="8" y2="21"/>
        <line x1="16" y1="3" x2="14" y2="21"/>
    </svg>`}function Ht(e,t,r={}){let{hierarchyGroupBy:n="section",hierarchyStyle:o="tree",hierarchyDisplay:s="individual",maxHeadingsPerResult:a=3,listboxId:l}=r,i=o==="tree",c=o!=="none",d=Dt(e)?It(e,a):e,m=Se(d,n||"section"),g=0;return Object.entries(m).map(([b,x])=>{let f=x.map(p=>{let D=g++,k=Mt(p,D,t,r),v="",I=p.headings||[],B=p.__sectionHitGroup?I:I.slice(0,a);if(B.length>0){let $=Math.min(...B.map(T=>T.level||2)),L=B.map(T=>i?(T.level||2)-$:0);v=B.map((T,P)=>{let R=L[P],K=!L.slice(P+1).some(U=>U===R),j=[];if(i){let U=L.slice(P+1);for(let A=0;A<R;A++)U.some(Y=>Y===A)&&j.push(A)}return Nt(p,T,g++,t,r,K,R,j)}).join("")}let w=!!v;return`
                <div class="sm-hierarchy-block${w?" sm-hierarchy-block--has-children":""}${s==="unified"?" sm-hierarchy-block--unified":""}">
                    ${w?k.replace("sm-result-item sm-hierarchy-parent","sm-result-item sm-hierarchy-parent sm-hierarchy-parent--has-children"):k}
                    ${w?`<div class="sm-hierarchy-children${c?"":" sm-hierarchy-children--no-connectors"}">${v}</div>`:""}
                </div>
            `}).join("");return`
        ...
        `}).join("")}function Mt(e,t,r,n={}){let{listboxId:o,enableHighlighting:s=!0,highlightTag:a="mark",highlightClass:l="",debug:i=!1,persistQueryInUrl:c=!1,queryParamName:d="smq"}=n,u=e.title||e.name||"Untitled",m=e.snippet||"",g=e.url||"#",b=q(g,r,c?d:""),x=O(o,t),f=e._index||e.index||"",p=he(e),D={enabled:s,tag:a,className:l},k=z(u,r,{...D,terms:N(e,"title")}),v=m?ce(e,m,r,{...D,terms:N(e,"snippet")}):"",I=i?Ue(e):"",w=e.headings&&e.headings.length>0?Lt():Pt();return i?`
            <a class="sm-result-item sm-hierarchy-parent sm-debug-enabled" id="${x}" role="option" aria-selected="false" href="${h(b)}" data-index="${t}" data-source-index="${h(f)}"${p} data-title="${h(u)}">
                <div class="sm-result-main">
                    ${w}
                    <div class="sm-result-content">
                        <span class="sm-result-title">${k}</span>
                        ${v?`<span class="sm-result-desc">${v}</span>`:""}
                    </div>
                    ${_()}
                </div>
                ${I}
        ...
        `:`
        <a class="sm-result-item sm-hierarchy-parent" id="${x}" role="option" aria-selected="false" href="${h(b)}" data-index="${t}" data-source-index="${h(f)}"${p} data-title="${h(u)}">
            ${w}
            <div class="sm-result-content">
                <span class="sm-result-title">${k}</span>
                ${v?`<span class="sm-result-desc">${v}</span>`:""}
    ...
    `}function Nt(e,t,r,n,o={},s=!1,a=0,l=[]){let{listboxId:i,enableHighlighting:c=!0,highlightTag:d="mark",highlightClass:u="",debug:m=!1,persistQueryInUrl:g=!1,queryParamName:b="smq"}=o,f=(t.title||t.text||"").replace(/^#+\s*/,""),p=t.snippet||"",D=Number.parseInt(t.level,10),k=Number.isFinite(D)?Math.min(Math.max(D,1),6):2,v=t.id||(f?Ot(f):""),I=e.url||"#",B=t.url||(v?`${I}#${v}`:I),w=q(B,n,g?b:""),F=O(i,r),$=t._index||t.index||e._index||e.index||"",L=he(t,e),T={enabled:c,tag:d,className:u},P=z(f,n,{...T,terms:N(t,"title")||N(e,"title")}),R=p?ce(e,p,n,{...T,terms:N(t,"snippet")||N(e,"snippet")}):"",K=s?" sm-hierarchy-child-row-last":"",j=l.map(A=>`<div class="sm-hierarchy-guide" style="--sm-guide-depth:${A}" aria-hidden="true"></div>`).join(""),U="";if(m){let A=[];A.push(S("h",k,"generic")),v&&A.push(S("anchor",v,"generic"));let Y=W(t,e);Y&&A.push(S("parent",Y,"generic")),U=`<div class="sm-debug-info">${A.join("")}</div>`}return m?`
            <div class="sm-hierarchy-child-row sm-hierarchy-level-${k} sm-hierarchy-depth-${a}${K}" style="--sm-hierarchy-depth:${a}">
                ${j}
                <a class="sm-result-item sm-hierarchy-child sm-hierarchy-level-${k} sm-debug-enabled" id="${F}" role="option" aria-selected="false" href="${h(w)}" data-index="${r}" data-source-index="${h($)}"${L} data-title="${h(f)}">
                    <div class="sm-result-main">
                        ${_e()}
                        <div class="sm-result-content">
        ...
        <div class="sm-hierarchy-child-row sm-hierarchy-level-${k} sm-hierarchy-depth-${a}${K}" style="--sm-hierarchy-depth:${a}">
            ${j}
            <a class="sm-result-item sm-hierarchy-child sm-hierarchy-level-${k}" id="${F}" role="option" aria-selected="false" href="${h(w)}" data-index="${r}" data-source-index="${h($)}"${L} data-title="${h(f)}">
                ${_e()}
                <div class="sm-result-content">
                    <span class="sm-result-title">${P}</span>
                    ${R?`<span class="sm-result-desc">${R}</span>`:""}
    ...
    `}function Ot(e){let t=e.normalize("NFKD").toLowerCase();try{return t.replace(/[^\p{L}\p{N}]+/gu,"-").replace(/^-+|-+$/g,"")}catch{return t.replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}}function _t(e,t){return!e||e.length===0?"":`
        <div class="sm-section">
            ...
            ${e.map((r,n)=>`
                <div class="sm-result-item sm-recent-item" id="${O(t,n)}" role="option" aria-selected="false" data-index="${n}" data-url="${h(r.url||"")}" data-query="${h(r.query)}">
    ...
    `}function je(e,t){let{query:r,results:n,recentSearches:o,loading:s,showRecent:a,error:l}=e,{showLoadingIndicator:i=!0}=t,c=r&&r.trim();return s&&i?{html:Ft(),hasResults:!1,showListbox:!1}:l?{html:Ut(l),hasResults:!1,showListbox:!1}:c?!n||n.length===0?{html:Fe(r),hasResults:!1,showListbox:!1}:{html:Tt(n,r,t),hasResults:!0,showListbox:!0}:a&&o&&o.length>0?{html:_t(o,t.listboxId),hasResults:!0,showListbox:!0}:{html:Fe(""),hasResults:!1,showListbox:!1}}function ue(e,t,r=!1){if(!e)return"";let n=[];if(n.push(E("results",t,"generic")),e.took!==void 0){let i=e.took<1?"<1ms":`${Math.round(e.took)}ms`;n.push(E("time",i,"time"))}if(e.cacheEnabled!==void 0&&(e.cacheEnabled?e.cached?n.push(E("cache","hit","cache-hit")):n.push(E("cache","miss","cache-miss")):n.push(E("cache","off","cache-off"))),e.cacheDriver&&n.push(E("storage",e.cacheDriver,"cache-driver",e.cacheDriver)),e.indices&&e.indices.length>0){let i=e.indices.length>2?`${e.indices.length} indices`:e.indices.join(", ");n.push(E("indices",i,"generic"))}if(e.synonymsExpanded){let i=e.expandedQueries?e.expandedQueries.length-1:0;n.push(E("synonyms",`+${i}`,"synonyms"))}let o=e.rulesMatched?.length||0;n.push(E("rules",o,o>0?"rules":"generic"));let s=e.promotionsMatched?.length||0;n.push(E("promoted",s,s>0?"promotions":"generic"));let l=`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">${r?'<path d="M6 9l6 6 6-6"/>':'<path d="M18 15l-6-6-6 6"/>'}</svg>`;return r?`<div class="sm-toolbar-collapsed-bar"><span class="sm-toolbar-collapsed-label">Debug</span>${l}</div>`:`<div class="sm-toolbar-content">${n.join("")}</div><button class="sm-toolbar-toggle" aria-label="Collapse debug panel" aria-expanded="true">${l}</button>`}function E(e,t,r,n=""){let o=n?` data-backend="${h(n)}"`:"";return`<span class="sm-toolbar-item"><span class="sm-toolbar-label">${h(e)}</span><span class="sm-toolbar-value" data-type="${h(r)}"${o}>${h(String(t))}</span></span>`}function ze(e,t){let{onSelect:r,onIndexChange:n,onEscape:o}=e,{listboxId:s}=t;return{handleKeydown(a,l,i){let c=i;switch(a.key){case"ArrowDown":return a.preventDefault(),c=Math.min(i+1,l-1),c!==i&&n&&n(c),c;case"ArrowUp":return a.preventDefault(),c=Math.max(i-1,-1),c!==i&&n&&n(c),c;case"Enter":return a.preventDefault(),i>=0&&r&&r(i),null;case"Escape":return a.preventDefault(),o&&o(),null;default:return null}},getListboxId(){return s}}}function Ge(e,t,r={}){let{scrollContainer:n,inputElement:o,listboxId:s,selectedClass:a="sm-selected"}=r,l=t>=0?O(s,t):null;o&&Z(o,{expanded:e.length>0,activeDescendant:l,listboxId:s}),e.forEach((i,c)=>{let d=c===t;i.classList.toggle(a,d),i.setAttribute("aria-selected",String(d)),d&&n&&Me(i,n)})}function We(e,t){e.forEach((r,n)=>{r.addEventListener("mouseenter",()=>{t&&t(n)})})}var Ke="sm-page-highlight-style",Ye="__smPageHighlightRegistry",ge=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.config=null,this.state=ve({...X},this.handleStateChange.bind(this)),this.searchSequence=0,this.debounceTimer=null,this.analyticsIdleTimer=null,this.lastTrackedQuery=null,this.lastSearchCacheState=null,this.listboxId=ie("sm-listbox"),this.inputId=ie("sm-input"),this.liveRegion=null,this.keyboardNavigator=null,this.elements={},this.handleInput=this.handleInput.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.handleResultClick=this.handleResultClick.bind(this)}get widgetType(){throw new Error("Subclass must implement widgetType getter")}render(){throw new Error("Subclass must implement render()")}getResultsContainer(){throw new Error("Subclass must implement getResultsContainer()")}getInputElement(){throw new Error("Subclass must implement getInputElement()")}getLoadingElement(){return this.elements.loading||null}getDebugToolbarElement(){return this.elements.debugToolbar||null}connectedCallback(){this.config=re(this,this.widgetType),this.state.set({recentSearches:J(V(this.config))}),this.keyboardNavigator=ze({onSelect:t=>this.selectResultAtIndex(t),onIndexChange:t=>this.state.set({selectedIndex:t}),onEscape:()=>this.handleEscape()},{listboxId:this.listboxId}),this.applyDestinationPageHighlight()}disconnectedCallback(){this.searchSequence++,this.debounceTimer&&(clearTimeout(this.debounceTimer),this.debounceTimer=null)}attributeChangedCallback(t,r,n){r!==n&&this.shadowRoot.children.length>0&&(this.config=re(this,this.widgetType),this.render(),this.applyCustomStyles())}handleStateChange(t,r){(r.includes("results")||r.includes("query")||r.includes("recentSearches")||r.includes("error"))&&this.renderResultsContent(),(r.includes("results")||r.includes("meta"))&&this.updateDebugToolbar(),r.includes("selectedIndex")&&this.updateSelectionVisual(),r.includes("loading")&&this.updateLoadingVisual()}handleInput(t){let r=t.target.value;if(this.state.set({query:r,selectedIndex:-1}),this.debounceTimer&&clearTimeout(this.debounceTimer),this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null),!r.trim()){this.state.set({results:[]});return}r.length<this.config.minChars||(this.debounceTimer=setTimeout(()=>{this.executeSearch(r)},this.config.debounce))}async executeSearch(t){let r=++this.searchSequence;this.state.set({loading:!0,error:null}),this.liveRegion&&G(this.liveRegion,Pe());try{let{results:n,meta:o}=await ke({query:t,endpoint:this.config.searchEndpoint,indices:this.config.indices,siteId:this.config.siteId,maxResults:this.config.maxResults,hideResultsWithoutUrl:this.config.hideResultsWithoutUrl,showCodeSnippets:this.config.showCodeSnippets,snippetMode:this.config.snippetMode,snippetLength:this.config.snippetLength,parseMarkdownSnippets:this.config.parseMarkdownSnippets,debug:this.config.debug,apiKey:this.config.apiKey});if(r!==this.searchSequence)return;this.state.set({results:n,meta:o,loading:!1,selectedIndex:n.length>0?0:-1}),o&&typeof o.cached=="boolean"?this.lastSearchCacheState={cached:o.cached,took:typeof o.took=="number"?o.took:null}:this.lastSearchCacheState=null,this.liveRegion&&G(this.liveRegion,le(n.length,t)),this.dispatchWidgetEvent("search",{query:t,results:n,meta:o}),this.startAnalyticsIdleTimer(t,n.length)}catch(n){if(r!==this.searchSequence||n.name==="AbortError")return;console.error("Search error:",n),this.state.set({results:[],loading:!1,error:n.message}),this.dispatchWidgetEvent("error",{query:t,error:n.message})}}renderResultsContent(){let t=this.getResultsContainer();if(!t)return;let r=this.state.getAll(),{showRecent:n,groupResults:o,enableHighlighting:s,highlightTag:a,highlightClass:l,showLoadingIndicator:i,debug:c}=this.config,{html:d,hasResults:u,showListbox:m}=je({query:r.query,results:r.results,recentSearches:r.recentSearches,loading:r.loading,error:r.error,showRecent:n},{listboxId:this.listboxId,groupResults:o,enableHighlighting:s,highlightTag:a,highlightClass:l,showLoadingIndicator:i,debug:c,persistQueryInUrl:this.config.highlightDestinationPage&&this.config.persistQueryInUrl,queryParamName:this.config.queryParamName,promotions:this.config.promotions,resultLayout:this.config.resultLayout,hierarchyGroupBy:this.config.hierarchyGroupBy,hierarchyStyle:this.config.hierarchyStyle,hierarchyDisplay:this.config.hierarchyDisplay,maxHeadingsPerResult:this.config.maxHeadingsPerResult});t.innerHTML=d,m?t.setAttribute("role","listbox"):t.removeAttribute("role");let g=this.getInputElement();g&&Z(g,{expanded:u,activeDescendant:null,listboxId:this.listboxId}),this.liveRegion&&!r.loading&&(r.query&&r.results.length===0?G(this.liveRegion,le(0,r.query)):!r.query&&r.recentSearches.length>0&&n&&G(this.liveRegion,He(r.recentSearches.length))),this.attachResultHandlers();let b=t.querySelector(".sm-clear-recent");b&&b.addEventListener("click",x=>{x.stopPropagation(),Ae(V(this.config)),this.state.set({recentSearches:[]})}),u&&r.results.length>0&&this.state.set({selectedIndex:0})}attachResultHandlers(){let t=this.getResultsContainer();if(!t)return;let r=t.querySelectorAll(".sm-result-item");r.forEach(n=>{n.addEventListener("click",o=>this.handleResultClick(o,n))}),We(r,n=>{this.state.set({selectedIndex:n})})}updateSelectionVisual(){let t=this.getResultsContainer(),r=this.getInputElement();if(!t)return;let n=t.querySelectorAll(".sm-result-item"),o=this.state.get("selectedIndex");Ge(n,o,{scrollContainer:t,inputElement:r,listboxId:this.listboxId})}handleKeydown(t){let r=this.getResultsContainer();if(!r)return;let n=r.querySelectorAll(".sm-result-item"),o=this.state.get("selectedIndex");if(t.key==="Enter"){let s=this.state.get("query"),a=this.state.get("results")||[];s&&a.length>0&&this.trackSearchAnalytics(s,a.length,"enter")}this.keyboardNavigator.handleKeydown(t,n.length,o)}selectResultAtIndex(t){let r=this.getResultsContainer();if(!r)return;let n=r.querySelectorAll(".sm-result-item");t>=0&&n[t]&&n[t].click()}handleEscape(){}handleResultClick(t,r){let n=r.getAttribute("href"),o=r.dataset.url,s=n||o,a=r.dataset.title||r.querySelector(".sm-result-title")?.textContent,l=r.dataset.id,i=r.dataset.elementId||l,c=r.dataset.query||this.state.get("query"),d=r.classList.contains("sm-recent-item"),u=q(s,c,this.config.highlightDestinationPage&&this.config.persistQueryInUrl?this.config.queryParamName:"");if(!d&&c){let g=Te(V(this.config),c,{title:a,url:s},this.config.maxRecentSearches);this.state.set({recentSearches:g})}let m=r.dataset.sourceIndex||fe(this.config);if(i&&m&&xe({endpoint:this.config.trackClickEndpoint,elementId:i,query:c,index:m,apiKey:this.config.apiKey}),!d&&c&&this.trackSearchAnalytics(c,this.state.get("results")?.length||0,"click"),this.dispatchWidgetEvent("result-click",{id:l,elementId:i,title:a,url:u,query:c,isRecent:d}),s&&s!=="#")d&&(t.preventDefault(),window.location.href=u),this.onResultSelected(u,a,l);else if(c){t.preventDefault();let g=this.getInputElement();g&&(g.value=c,this.state.set({query:c}),this.executeSearch(c))}}onResultSelected(t,r,n){}applyDestinationPageHighlight(){if(!this.config.highlightDestinationPage||typeof window>"u"||typeof document>"u")return;let t=this.config.queryParamName||"smq",r=this.config.destinationHighlightSelector||"main, article, [data-search-content]",n=new URLSearchParams(window.location.search).get(t);if(!n||!n.trim())return;let o=this.getPageHighlightRegistry(),s=`${t}::${r}`;if(o.has(s))return;o.add(s);let a=()=>{this.ensurePageHighlightStyles(),this.highlightDestinationNodes(n.trim(),r,s)};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",a,{once:!0}):window.requestAnimationFrame(a)}ensurePageHighlightStyles(){if(document.getElementById(Ke))return;let t=document.createElement("style");t.id=Ke,t.textContent=`
            .sm-page-highlight {
        ...
        `,document.head.appendChild(t)}highlightDestinationNodes(t,r,n){let o=Array.from(document.querySelectorAll(r));if(o.length===0)return;let s=[...new Set(ae(t).map(i=>i.trim()).filter(i=>i.length>=2))];if(s.length===0)return;let a=s.map(i=>$e(i)).filter(Boolean).sort((i,c)=>c.length-i.length).join("|");if(!a)return;let l=new RegExp(`(${a})`,"gi");o.forEach(i=>{i.getAttribute("data-sm-highlighted")!==n&&(this.highlightTextNodesInScope(i,l),i.setAttribute("data-sm-highlighted",n))})}highlightTextNodesInScope(t,r){let n=document.createTreeWalker(t,NodeFilter.SHOW_TEXT,{acceptNode:s=>{let a=s.nodeValue;if(!a||!a.trim())return NodeFilter.FILTER_REJECT;let l=s.parentElement;return!l||l.closest("script, style, noscript, textarea, mark, .sm-highlight, .sm-page-highlight, search-modal")?NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT}}),o=[];for(;n.nextNode();)o.push(n.currentNode);o.forEach(s=>{let a=s.nodeValue||"";if(r.lastIndex=0,!r.test(a))return;let l=document.createDocumentFragment(),i=0;r.lastIndex=0;let c=a.matchAll(r);for(let d of c){let u=d[0],m=d.index??-1;if(m<0)continue;m>i&&l.appendChild(document.createTextNode(a.slice(i,m)));let g=document.createElement("mark");g.className="sm-highlight sm-page-highlight",g.textContent=u,l.appendChild(g),i=m+u.length}i<a.length&&l.appendChild(document.createTextNode(a.slice(i))),s.parentNode?.replaceChild(l,s)})}getPageHighlightRegistry(){let t=window[Ye];if(t instanceof Set)return t;let r=new Set;return window[Ye]=r,r}updateLoadingVisual(){let t=this.getLoadingElement();if(t){let r=this.state.get("loading"),n=this.config?.showLoadingIndicator!==!1;t.hidden=!r||!n}}updateDebugToolbar(){let t=this.getDebugToolbarElement();if(!t)return;let{debug:r}=this.config,n=this.state.getAll();if(!r||!n.meta||n.results.length===0){t.hidden=!0;return}let o=t.classList.contains("sm-collapsed");t.innerHTML=ue(n.meta,n.results.length,o),t.hidden=!1,o&&t.classList.add("sm-collapsed"),this.attachDebugToolbarHandlers(t)}attachDebugToolbarHandlers(t){let r=t.querySelector(".sm-toolbar-toggle");r&&r.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),this.toggleDebugToolbar()});let n=t.querySelector(".sm-toolbar-collapsed-bar");n&&n.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),this.toggleDebugToolbar()})}toggleDebugToolbar(){let t=this.getDebugToolbarElement();if(!t)return;let r=t.classList.toggle("sm-collapsed"),n=this.state.getAll();t.innerHTML=ue(n.meta,n.results.length,r),r&&t.classList.add("sm-collapsed"),this.attachDebugToolbarHandlers(t)}applyCustomStyles(){if(!this.config)return;let t=this.shadowRoot.host,{theme:r,styles:n,resultTitleLines:o,resultDescLines:s}=this.config;Re(t,n,r),o&&t.style.setProperty("--sm-result-title-lines",String(o)),s&&t.style.setProperty("--sm-result-desc-lines",String(s))}initializeLiveRegion(){this.liveRegion=Le(this.shadowRoot)}startAnalyticsIdleTimer(t,r){this.analyticsIdleTimer&&clearTimeout(this.analyticsIdleTimer);let n=this.config.idleTimeout;!n||n<=0||(this.analyticsIdleTimer=setTimeout(()=>{this.trackSearchAnalytics(t,r,"idle")},n))}trackSearchAnalytics(t,r,n){!t||t===this.lastTrackedQuery||(this.lastTrackedQuery=t,this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null),we({endpoint:this.config.trackSearchEndpoint,query:t,indices:this.config.indices,resultsCount:r,trigger:n,source:this.config.source,siteId:this.config.siteId,cached:this.lastSearchCacheState?.cached,took:this.lastSearchCacheState?.took,apiKey:this.config.apiKey}))}resetAnalyticsTracking(){this.lastTrackedQuery=null,this.lastSearchCacheState=null,this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null)}dispatchWidgetEvent(t,r={}){this.dispatchEvent(new CustomEvent(`search-${t}`,{bubbles:!0,composed:!0,detail:r}))}},Ve=ge;var Xe=`/**
...
`;var qt=Xe+`
`+Qe+`
`+Je,me=class extends Ve{constructor(){super(),this.externalTrigger=null,this.open=this.open.bind(this),this.close=this.close.bind(this),this.toggle=this.toggle.bind(this),this.handleGlobalKeydown=this.handleGlobalKeydown.bind(this),this.handleBackdropClick=this.handleBackdropClick.bind(this)}get widgetType(){return"modal"}static get observedAttributes(){return ye("modal")}connectedCallback(){super.connectedCallback(),this.render(),this.attachEventListeners()}disconnectedCallback(){super.disconnectedCallback(),this.detachEventListeners()}render(){let{theme:t,placeholder:r,showTrigger:n}=this.config,o=h(this.getHotkeyDisplay()),s=h(r||"");this.shadowRoot.innerHTML=`
            <style>${qt}</style>
