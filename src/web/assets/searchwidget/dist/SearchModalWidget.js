"use strict";var SearchModalWidget=(()=>{var Y=Object.defineProperty;var _e=Object.getOwnPropertyDescriptor;var qe=Object.getOwnPropertyNames;var ze=Object.prototype.hasOwnProperty;var je=(e,r)=>{for(var t in r)Y(e,t,{get:r[t],enumerable:!0})},Ge=(e,r,t,n)=>{if(r&&typeof r=="object"||typeof r=="function")for(let o of qe(r))!ze.call(e,o)&&o!==t&&Y(e,o,{get:()=>r[o],enumerable:!(n=_e(r,o))||n.enumerable});return e};var We=e=>Ge(Y({},"__esModule",{value:!0}),e);var vt={};je(vt,{default:()=>ft});var Ke={indices:[],placeholder:"Search...",theme:"light",maxResults:20,debounce:200,minChars:2,showRecent:!0,maxRecentSearches:5,groupResults:!0,siteId:"",apiKey:"",searchEndpoint:"/actions/search-manager/api/search",trackClickEndpoint:"/actions/search-manager/search/track-click",trackSearchEndpoint:"/actions/search-manager/search/track-search",idleTimeout:1500,source:"",enableHighlighting:!0,highlightTag:"mark",highlightClass:"",hideResultsWithoutUrl:!1,showCodeSnippets:!1,snippetMode:"balanced",showLoadingIndicator:!0,debug:!1,resultTitleLines:1,resultDescLines:1,snippetLength:150,parseMarkdownSnippets:!1,persistQueryInUrl:!0,queryParamName:"smq",highlightDestinationPage:!0,destinationHighlightSelector:"main, article, [data-search-content]",resultLayout:"default",hierarchyGroupBy:"",hierarchyStyle:"tree",hierarchyDisplay:"individual",maxHeadingsPerResult:3,styles:{},promotions:{showBadge:!0,badgeText:"Featured",badgePosition:"top-right"}},Ye={hotkey:"k",showTrigger:!0,triggerSelector:"",backdropOpacity:50,enableBackdropBlur:!0,preventBodyScroll:!0},Ve={showFilters:!0,paginationType:"numbered",resultsPerPage:20,updateUrl:!0,sortOptions:["relevance","date-desc","date-asc","title"]},Xe={dropdownPosition:"below",dropdownMaxHeight:400,showOnFocus:!0};function Qe(e){return{...Ke,...{modal:Ye,page:Ve,inline:Xe}[e]||{}}}function v(e,r=!1){if(e==null)return r;if(typeof e=="boolean")return e;if(typeof e=="number")return e!==0;if(e==="")return!0;let t=String(e).trim().toLowerCase();return["1","true","on","yes"].includes(t)?!0:["0","false","off","no"].includes(t)?!1:r}function S(e,r=0){if(e==null)return r;let t=Number.parseInt(e,10);return Number.isNaN(t)?r:t}function se(e,r={}){if(!e)return r;try{return JSON.parse(e)}catch(t){return console.warn("SearchWidget: Invalid JSON attribute",t),r}}function ae(e){return e?e.split(",").map(r=>r.trim()).filter(Boolean):[]}function V(e,r="modal"){let t=Qe(r),n=e.getAttribute("indices")||"",o=ae(n),s={indices:o,index:o[0]||"",placeholder:e.getAttribute("placeholder")||t.placeholder,theme:e.getAttribute("theme")||t.theme,siteId:e.getAttribute("site-id")||t.siteId,apiKey:e.getAttribute("api-key")||t.apiKey,source:e.getAttribute("source")||t.source,highlightTag:e.getAttribute("highlight-tag")||t.highlightTag,highlightClass:e.getAttribute("highlight-class")||t.highlightClass,searchEndpoint:t.searchEndpoint,trackClickEndpoint:t.trackClickEndpoint,trackSearchEndpoint:t.trackSearchEndpoint,maxResults:S(e.getAttribute("max-results"),t.maxResults),debounce:S(e.getAttribute("debounce"),t.debounce),minChars:S(e.getAttribute("min-chars"),t.minChars),maxRecentSearches:S(e.getAttribute("max-recent-searches"),t.maxRecentSearches),idleTimeout:S(e.getAttribute("idle-timeout"),t.idleTimeout),showRecent:v(e.getAttribute("show-recent"),t.showRecent),groupResults:v(e.getAttribute("group-results"),t.groupResults),enableHighlighting:v(e.getAttribute("enable-highlighting"),t.enableHighlighting),showLoadingIndicator:v(e.getAttribute("show-loading-indicator"),t.showLoadingIndicator),hideResultsWithoutUrl:v(e.getAttribute("hide-results-without-url"),t.hideResultsWithoutUrl),showCodeSnippets:v(e.getAttribute("show-code-snippets"),t.showCodeSnippets),debug:v(e.getAttribute("debug"),t.debug),snippetMode:e.getAttribute("snippet-mode")||t.snippetMode,snippetLength:S(e.getAttribute("snippet-length"),t.snippetLength),parseMarkdownSnippets:v(e.getAttribute("parse-markdown-snippets"),t.parseMarkdownSnippets),persistQueryInUrl:v(e.getAttribute("persist-query-in-url"),t.persistQueryInUrl),highlightDestinationPage:v(e.getAttribute("highlight-destination-page"),t.highlightDestinationPage),resultTitleLines:S(e.getAttribute("result-title-lines"),t.resultTitleLines),resultDescLines:S(e.getAttribute("result-desc-lines"),t.resultDescLines),queryParamName:e.getAttribute("query-param-name")||t.queryParamName,destinationHighlightSelector:e.getAttribute("destination-highlight-selector")||t.destinationHighlightSelector,resultLayout:e.getAttribute("result-layout")||t.resultLayout,hierarchyGroupBy:e.getAttribute("hierarchy-group-by")||t.hierarchyGroupBy,hierarchyStyle:e.getAttribute("hierarchy-style")||t.hierarchyStyle,hierarchyDisplay:e.getAttribute("hierarchy-display")||t.hierarchyDisplay,maxHeadingsPerResult:S(e.getAttribute("max-headings-per-result"),t.maxHeadingsPerResult),styles:se(e.getAttribute("styles"),t.styles),promotions:se(e.getAttribute("promotions"),t.promotions)};return r==="modal"&&Object.assign(s,{hotkey:e.getAttribute("hotkey")||t.hotkey,triggerSelector:e.getAttribute("trigger-selector")||t.triggerSelector,backdropOpacity:S(e.getAttribute("backdrop-opacity"),t.backdropOpacity),showTrigger:v(e.getAttribute("show-trigger"),t.showTrigger),enableBackdropBlur:v(e.getAttribute("enable-backdrop-blur"),t.enableBackdropBlur),preventBodyScroll:v(e.getAttribute("prevent-body-scroll"),t.preventBodyScroll)}),r==="page"&&Object.assign(s,{resultsPerPage:S(e.getAttribute("results-per-page"),t.resultsPerPage),paginationType:e.getAttribute("pagination-type")||t.paginationType,showFilters:v(e.getAttribute("show-filters"),t.showFilters),updateUrl:v(e.getAttribute("update-url"),t.updateUrl),sortOptions:ae(e.getAttribute("sort-options"))||t.sortOptions}),r==="inline"&&Object.assign(s,{dropdownPosition:e.getAttribute("dropdown-position")||t.dropdownPosition,dropdownMaxHeight:S(e.getAttribute("dropdown-max-height"),t.dropdownMaxHeight),showOnFocus:v(e.getAttribute("show-on-focus"),t.showOnFocus)}),s}function ie(e="modal"){let r=["indices","placeholder","theme","max-results","debounce","min-chars","show-recent","max-recent-searches","group-results","site-id","idle-timeout","source","enable-highlighting","highlight-tag","highlight-class","hide-results-without-url","show-code-snippets","snippet-mode","show-loading-indicator","debug","styles","promotions","result-layout","hierarchy-group-by","hierarchy-style","hierarchy-display","max-headings-per-result","result-title-lines","result-desc-lines","snippet-length","parse-markdown-snippets","persist-query-in-url","query-param-name","highlight-destination-page","destination-highlight-selector"],s={modal:["hotkey","show-trigger","trigger-selector","backdrop-opacity","enable-backdrop-blur","prevent-body-scroll"],page:["show-filters","pagination-type","results-per-page","update-url","sort-options"],inline:["dropdown-position","dropdown-max-height","show-on-focus"]};return[...r,...s[e]||[]]}var z={isOpen:!1,query:"",results:[],recentSearches:[],selectedIndex:-1,loading:!1,error:null,meta:null};function le(e={},r=null){let t={...z,...e};return{get(n){return t[n]},getAll(){return{...t}},set(n){let o=[];return Object.keys(n).forEach(s=>{let a=t[s],l=n[s];j(a,l)||o.push(s)}),o.length>0&&(t={...t,...n},r&&r(t,o)),o},reset(n=e){let o={...z,...n},s=Object.keys(o).filter(a=>!j(t[a],o[a]));s.length>0&&(t=o,r&&r(t,s))},is(n,o){return t[n]===o},toggle(n){let o=!t[n];return this.set({[n]:o}),o}}}function j(e,r){if(e===r)return!0;if(e==null||r==null)return!1;if(Array.isArray(e)&&Array.isArray(r))return e.length!==r.length?!1:e.every((t,n)=>j(t,r[n]));if(typeof e=="object"&&typeof r=="object"){let t=Object.keys(e),n=Object.keys(r);return t.length!==n.length?!1:t.every(o=>j(e[o],r[o]))}return!1}async function de({query:e,endpoint:r,indices:t=[],siteId:n="",maxResults:o=10,hideResultsWithoutUrl:s=!1,showCodeSnippets:a=!1,snippetMode:l="balanced",snippetLength:i=150,parseMarkdownSnippets:d=!1,debug:c=!1,apiKey:u="",signal:m}){let g=new URLSearchParams({q:e,hitsPerPage:o.toString()});g.append("enrich","1"),t.length>0&&g.append("indices",t.join(",")),n&&g.append("siteId",n),s&&g.append("hideResultsWithoutUrl","1"),a&&g.append("showCodeSnippets","1"),l&&l!=="balanced"&&g.append("snippetMode",l),i&&i!==150&&g.append("snippetLength",String(i)),d&&g.append("parseMarkdownSnippets","1"),c&&g.append("debug","1"),g.append("skipAnalytics","1");let y=r.includes("?")?"&":"?",k={Accept:"application/json"};u&&(k["X-Search-Manager-Key"]=u);let p=await fetch(`${r}${y}${g}`,{signal:m,headers:k});if(!p.ok)throw new Error("Search failed");let b=await p.json();return b.error&&console.warn("Search warning:",b.error),{results:b.results||b.hits||[],total:b.total||0,meta:b.meta||null,error:b.error||null}}function ce({endpoint:e,elementId:r,query:t,index:n,apiKey:o=""}){if(!(!r||!e))try{let s=new FormData;s.append("elementId",r),s.append("query",t),s.append("index",n);let a={Accept:"application/json"};o&&(a["X-Search-Manager-Key"]=o),fetch(e,{method:"POST",body:s,headers:a}).catch(()=>{})}catch{}}function he({endpoint:e,query:r,indices:t=[],resultsCount:n=0,trigger:o="unknown",source:s="",siteId:a="",cached:l,took:i,apiKey:d=""}){if(!(!r||!e))try{let c=new FormData;c.append("q",r),c.append("indices",t.join(",")),c.append("resultsCount",n.toString()),c.append("trigger",o),c.append("source",s||"frontend-widget"),a&&c.append("siteId",a),typeof l=="boolean"&&c.append("cached",l?"1":"0"),typeof i=="number"&&Number.isFinite(i)&&i>=0&&c.append("took",i.toString());let u={Accept:"application/json"};d&&(u["X-Search-Manager-Key"]=d),fetch(e,{method:"POST",body:c,headers:u}).catch(()=>{})}catch{}}function ue(e){let r={};return e.forEach(t=>{let n=t.section||t.type||"Results";r[n]||(r[n]=[]),r[n].push(t)}),r}function ge(e,r){let t={};return e.forEach(n=>{let o=n[r]||n.section||n.type||"Results";t[o]||(t[o]=[]),t[o].push(n)}),t}var Je="sm-recent-";function X(e){return`${Je}${e||"default"}`}function G(e){try{let r=X(e),t=localStorage.getItem(r);return t?JSON.parse(t):[]}catch{return[]}}function me(e,r,t=null,n=5){if(!r||!r.trim())return G(e);let o=X(e),s={query:r.trim(),title:t?.title||r,url:t?.url||null,timestamp:Date.now()},a=G(e);a=a.filter(l=>l.query!==s.query),a.unshift(s),a=a.slice(0,n);try{localStorage.setItem(o,JSON.stringify(a))}catch{}return a}function pe(e){try{let r=X(e);localStorage.removeItem(r)}catch{}}var be={spinnerColor:"#3b82f6",spinnerColorDark:"#60a5fa",modalBg:"#ffffff",modalBgDark:"#1f2937",modalBorderRadius:"12",modalBorderWidth:"1",modalBorderColor:"#e5e7eb",modalBorderColorDark:"#374151",modalShadow:"0 25px 50px -12px rgba(0, 0, 0, 0.25)",modalShadowDark:"0 25px 50px -12px rgba(0, 0, 0, 0.5)",modalMaxWidth:"640",modalMaxHeight:"80",modalPaddingX:"16",modalPaddingY:"16",headerBg:"transparent",headerBgDark:"transparent",headerBorderColor:"#e5e7eb",headerBorderColorDark:"#374151",headerBorderWidth:"1",headerBorderRadius:"0",headerPaddingX:"16",headerPaddingY:"12",inputBg:"#ffffff",inputBgDark:"#1f2937",inputTextColor:"#111827",inputTextColorDark:"#f9fafb",inputPlaceholderColor:"#9ca3af",inputPlaceholderColorDark:"#9ca3af",inputBorderColor:"transparent",inputBorderColorDark:"transparent",inputFontSize:"16",inputBorderRadius:"0",inputBorderWidth:"0",inputPaddingX:"0",inputPaddingY:"0",resultBg:"transparent",resultBgDark:"transparent",resultBorderColor:"#e5e7eb",resultBorderColorDark:"#374151",resultActiveBg:"#e5e7eb",resultActiveBgDark:"#4b5563",resultActiveBorderColor:"#e5e7eb",resultActiveBorderColorDark:"#374151",resultActiveTextColor:"#111827",resultActiveTextColorDark:"#f9fafb",resultActiveDescColor:"#4b5563",resultActiveDescColorDark:"#d1d5db",resultActiveMutedColor:"#6b7280",resultActiveMutedColorDark:"#d1d5db",resultTextColor:"#111827",resultTextColorDark:"#f9fafb",resultDescColor:"#4b5563",resultDescColorDark:"#d1d5db",resultMutedColor:"#6b7280",resultMutedColorDark:"#d1d5db",resultGap:"8",resultBorderWidth:"0",resultPaddingX:"12",resultPaddingY:"12",resultBorderRadius:"8",triggerBg:"#ffffff",triggerBgDark:"#374151",triggerTextColor:"#374151",triggerTextColorDark:"#d1d5db",triggerBorderRadius:"8",triggerBorderWidth:"1",triggerBorderColor:"#d1d5db",triggerBorderColorDark:"#4b5563",triggerHoverBg:"#f9fafb",triggerHoverBgDark:"#4b5563",triggerHoverTextColor:"#111827",triggerHoverTextColorDark:"#f9fafb",triggerHoverBorderColor:"#3b82f6",triggerHoverBorderColorDark:"#60a5fa",triggerPaddingX:"12",triggerPaddingY:"8",triggerFontSize:"14",kbdBg:"#f3f4f6",kbdBgDark:"#4b5563",kbdTextColor:"#4b5563",kbdTextColorDark:"#e5e7eb",kbdBorderRadius:"4",backdropOpacity:"50",backdropBlur:"1",highlightEnabled:"1",highlightTag:"",highlightClass:"",highlightBgLight:"fef08a",highlightColorLight:"854d0e",highlightBgDark:"854d0e",highlightColorDark:"fef08a",iconColor:"#3b82f6",iconColorDark:"#60a5fa",promotedBg:"#2563eb",promotedBgDark:"#3b82f6",promotedColor:"#ffffff",promotedColorDark:"#ffffff"};var fe={modalBg:"--sm-modal-bg",modalBgDark:"--sm-modal-bg-dark",modalBorderRadius:"--sm-modal-radius",modalBorderWidth:"--sm-modal-border-width",modalBorderColor:"--sm-modal-border-color",modalBorderColorDark:"--sm-modal-border-color-dark",modalShadow:"--sm-modal-shadow",modalShadowDark:"--sm-modal-shadow-dark",modalMaxWidth:"--sm-modal-width",modalMaxHeight:"--sm-modal-max-height",modalPaddingX:"--sm-modal-px",modalPaddingY:"--sm-modal-py",headerBg:"--sm-header-bg",headerBgDark:"--sm-header-bg-dark",headerBorderColor:"--sm-header-border-color",headerBorderColorDark:"--sm-header-border-color-dark",headerBorderWidth:"--sm-header-border-width",headerBorderRadius:"--sm-header-radius",headerPaddingX:"--sm-header-px",headerPaddingY:"--sm-header-py",inputBg:"--sm-input-bg",inputBgDark:"--sm-input-bg-dark",inputTextColor:"--sm-input-color",inputTextColorDark:"--sm-input-color-dark",inputPlaceholderColor:"--sm-input-placeholder",inputPlaceholderColorDark:"--sm-input-placeholder-dark",inputBorderColor:"--sm-input-border-color",inputBorderColorDark:"--sm-input-border-color-dark",inputFontSize:"--sm-input-font-size",inputBorderRadius:"--sm-input-radius",inputBorderWidth:"--sm-input-border-width",inputPaddingX:"--sm-input-px",inputPaddingY:"--sm-input-py",resultBg:"--sm-result-bg",resultBgDark:"--sm-result-bg-dark",resultBorderColor:"--sm-result-border-color",resultBorderColorDark:"--sm-result-border-color-dark",resultActiveBg:"--sm-result-active-bg",resultActiveBgDark:"--sm-result-active-bg-dark",resultActiveBorderColor:"--sm-result-active-border-color",resultActiveBorderColorDark:"--sm-result-active-border-color-dark",resultActiveTextColor:"--sm-result-active-text-color",resultActiveTextColorDark:"--sm-result-active-text-color-dark",resultActiveDescColor:"--sm-result-active-desc-color",resultActiveDescColorDark:"--sm-result-active-desc-color-dark",resultActiveMutedColor:"--sm-result-active-muted-color",resultActiveMutedColorDark:"--sm-result-active-muted-color-dark",resultTextColor:"--sm-result-text-color",resultTextColorDark:"--sm-result-text-color-dark",resultDescColor:"--sm-result-desc-color",resultDescColorDark:"--sm-result-desc-color-dark",resultMutedColor:"--sm-result-muted-color",resultMutedColorDark:"--sm-result-muted-color-dark",resultGap:"--sm-result-gap",resultBorderWidth:"--sm-result-border-width",resultPaddingX:"--sm-result-px",resultPaddingY:"--sm-result-py",resultBorderRadius:"--sm-result-radius",triggerBg:"--sm-trigger-bg",triggerBgDark:"--sm-trigger-bg-dark",triggerTextColor:"--sm-trigger-text-color",triggerTextColorDark:"--sm-trigger-text-color-dark",triggerBorderRadius:"--sm-trigger-radius",triggerBorderWidth:"--sm-trigger-border-width",triggerBorderColor:"--sm-trigger-border-color",triggerBorderColorDark:"--sm-trigger-border-color-dark",triggerHoverBg:"--sm-trigger-hover-bg",triggerHoverBgDark:"--sm-trigger-hover-bg-dark",triggerHoverTextColor:"--sm-trigger-hover-text-color",triggerHoverTextColorDark:"--sm-trigger-hover-text-color-dark",triggerHoverBorderColor:"--sm-trigger-hover-border-color",triggerHoverBorderColorDark:"--sm-trigger-hover-border-color-dark",triggerPaddingX:"--sm-trigger-px",triggerPaddingY:"--sm-trigger-py",triggerFontSize:"--sm-trigger-font-size",kbdBg:"--sm-kbd-bg",kbdBgDark:"--sm-kbd-bg-dark",kbdTextColor:"--sm-kbd-text-color",kbdTextColorDark:"--sm-kbd-text-color-dark",kbdBorderRadius:"--sm-kbd-radius",iconColor:"--sm-icon-color",iconColorDark:"--sm-icon-color-dark",highlightBgLight:"--sm-highlight-bg",highlightColorLight:"--sm-highlight-color",highlightBgDark:"--sm-highlight-bg-dark",highlightColorDark:"--sm-highlight-color-dark",promotedBg:"--sm-promoted-bg",promotedBgDark:"--sm-promoted-bg-dark",promotedColor:"--sm-promoted-color",promotedColorDark:"--sm-promoted-color-dark",spinnerColor:"--sm-spinner-color-light",spinnerColorDark:"--sm-spinner-color-dark"},Q=["modalBorderRadius","modalBorderWidth","modalMaxWidth","modalPaddingX","modalPaddingY","headerBorderWidth","headerBorderRadius","headerPaddingX","headerPaddingY","inputFontSize","inputBorderRadius","inputBorderWidth","inputPaddingX","inputPaddingY","resultGap","resultBorderWidth","resultPaddingX","resultPaddingY","resultBorderRadius","triggerBorderRadius","triggerBorderWidth","triggerPaddingX","triggerPaddingY","triggerFontSize","kbdBorderRadius"],J=["modalMaxHeight"],ve=["modalBg","modalBgDark","modalBorderColor","modalBorderColorDark","headerBg","headerBgDark","headerBorderColor","headerBorderColorDark","inputBg","inputBgDark","inputTextColor","inputTextColorDark","inputPlaceholderColor","inputPlaceholderColorDark","inputBorderColor","inputBorderColorDark","resultBg","resultBgDark","resultBorderColor","resultBorderColorDark","resultActiveBg","resultActiveBgDark","resultActiveBorderColor","resultActiveBorderColorDark","resultTextColor","resultTextColorDark","resultActiveTextColor","resultActiveTextColorDark","resultActiveDescColor","resultActiveDescColorDark","resultActiveMutedColor","resultActiveMutedColorDark","resultDescColor","resultDescColorDark","resultMutedColor","resultMutedColorDark","triggerBg","triggerBgDark","triggerTextColor","triggerTextColorDark","triggerBorderColor","triggerBorderColorDark","triggerHoverBg","triggerHoverBgDark","triggerHoverTextColor","triggerHoverTextColorDark","triggerHoverBorderColor","triggerHoverBorderColorDark","kbdBg","kbdBgDark","kbdTextColor","kbdTextColorDark","iconColor","iconColorDark","highlightBgLight","highlightColorLight","highlightBgDark","highlightColorDark","promotedBg","promotedBgDark","promotedColor","promotedColorDark","spinnerColor","spinnerColorDark"],At={...be,highlightBgLight:"#fef08a",highlightColorLight:"#854d0e",highlightBgDark:"#854d0e",highlightColorDark:"#fef08a"};function et(e){return typeof e=="string"&&/^(var|light-dark|calc|env|clamp|min|max|rgb|hsl)\s*\(/.test(e.trim())}function tt(e){return/^[0-9a-fA-F]{6}$/.test(e)}function rt(e,r){if(r==null||r==="")return null;let t=String(r);return et(t)||(ve.includes(e)&&tt(t)&&(t="#"+t),Q.includes(e)&&(t=t+"px"),J.includes(e)&&(t=t+"vh")),t}function ye(e,r,t="light"){if(!r||typeof r!="object")return;let n=t==="dark",o=Object.entries(fe),s=new Set([...Q,...J]);for(let[a,l]of o){let i=a.endsWith("Dark");if(n){if(!i&&!s.has(a))continue}else if(i)continue;if(r[a]!==void 0&&r[a]!==null&&r[a]!==""){let d=rt(a,r[a]);d&&e.style.setProperty(l,d)}}}function h(e){if(!e)return"";let r=document.createElement("div");return r.textContent=e,r.innerHTML}function xe(e){return e?e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"):""}function Z(e){if(!e)return[];let r=[],t=/"([^"]+)"/g,n;for(;(n=t.exec(e))!==null;)n[1].trim()&&r.push(n[1].trim());let o=e.replace(/"[^"]*"/g,""),s=new Set(["and","or","not","und","oder","nicht","et","ou","sauf","y","o","no"]);o.split(/\s+/).filter(l=>l.length>0).forEach(l=>{l=l.replace(/^[a-zA-Z]+:/,""),l=l.replace(/\*/g,""),l=l.replace(/\^\d+(\.\d+)?/,""),l=l.replace(/"/g,""),!(!l||s.has(l.toLowerCase()))&&r.push(l)});let a=[];return r.forEach(l=>{a.push(l);let i=l.split(/(?<=[a-z])(?=[A-Z])/);i.length>1&&i.forEach(d=>{d.length>=3&&a.push(d)})}),a}function $(e,r,t={}){let{enabled:n=!0,tag:o="mark",className:s="",terms:a=null}=t;if(!n)return h(e);let l=["sm-highlight"];s&&l.push(s);let i=` class="${l.join(" ")}"`,d=nt(r,a);return d.length===0?h(e):ot(e,d,o,i)}function nt(e,r){return Array.isArray(r)&&r.length>0?ke(r):e?ke(Z(e)):[]}function ke(e){let r=new Set;return e.filter(t=>typeof t=="string"&&t.length>0).sort((t,n)=>n.length-t.length).filter(t=>{let n=t.toLowerCase();return r.has(n)?!1:(r.add(n),!0)})}function ot(e,r,t,n){let o=e.toLowerCase(),s=[];if(r.forEach(c=>{let u=c.toLowerCase();if(!u)return;let m=0;for(;m<o.length;){let g=o.indexOf(u,m);if(g===-1)break;s.push({start:g,end:g+u.length}),m=g+u.length}}),s.length===0)return h(e);s.sort((c,u)=>c.start!==u.start?c.start-u.start:u.end-u.start-(c.end-c.start));let a=[],l=-1;s.forEach(c=>{c.start>=l&&(a.push(c),l=c.end)});let i="",d=0;return a.forEach(c=>{d<c.start&&(i+=h(e.slice(d,c.start))),i+=`<${t}${n}>${h(e.slice(c.start,c.end))}</${t}>`,d=c.end}),d<e.length&&(i+=h(e.slice(d))),i}function N(e,r,t="smq"){if(!e||e==="#")return e;let n=(r||"").trim();if(!n||!t||/^(mailto:|tel:|javascript:)/i.test(e))return e;let[o,s]=e.split("#",2),[a,l]=o.split("?",2),i=new URLSearchParams(l||"");i.set(t,n);let d=i.toString(),c=s?`#${s}`:"";return`${a}${d?`?${d}`:""}${c}`}var st=0;function ee(e="sm"){return`${e}-${++st}-${Date.now().toString(36)}`}function we(e){let r=document.createElement("div");return r.setAttribute("role","status"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-atomic","true"),r.className="sm-sr-only",e.appendChild(r),r}function U(e,r,t=100){e&&(e.textContent="",setTimeout(()=>{e.textContent=r},t))}function te(e,r){return e===0?`No results found for "${r}"`:e===1?`1 result found for "${r}"`:`${e} results found for "${r}"`}function Ce(){return"Searching..."}function Se(e){return e===0?"No recent searches":e===1?"1 recent search available":`${e} recent searches available`}function W(e,{expanded:r,activeDescendant:t,listboxId:n}){e.setAttribute("aria-expanded",String(r)),e.setAttribute("aria-controls",n),t?e.setAttribute("aria-activedescendant",t):e.removeAttribute("aria-activedescendant")}function L(e,r){return`${e}-option-${r}`}function Te(e,r){if(!e||!r)return;let t=e.getBoundingClientRect(),n=r.getBoundingClientRect();t.top<n.top?e.scrollIntoView({block:"nearest",behavior:"smooth"}):t.bottom>n.bottom&&e.scrollIntoView({block:"nearest",behavior:"smooth"})}function at(e,r,t={}){let{groupResults:n=!1,resultLayout:o="default",listboxId:s}=t;if(!e||e.length===0)return"";if(o==="hierarchical")return ct(e,r,t);if(n){let a=ue(e),l=0;return Object.entries(a).map(([i,d])=>`
    ...
    `}function Re(e){let r=[],t=e.backend?e.backend.toLowerCase():"";if((e._index||e.index)&&r.push(T("index",e._index||e.index,"index")),e.backend&&r.push(T("backend",t,"backend",t)),e.id&&r.push(T("id",e.id,"generic")),e.score!==void 0&&e.score!==null){let n=typeof e.score=="number"?e.score.toFixed(2):e.score;r.push(T("score",n,"score"))}if(e.site&&r.push(T("site",e.site,"generic")),e.language&&r.push(T("lang",e.language,"generic")),e.matchedIn&&Array.isArray(e.matchedIn)&&e.matchedIn.length>0){let n=e.matchedIn.join(", ");r.push(T("matched",n,"matched"))}return e.promoted&&r.push(T("promoted","yes","promoted")),e.boosted&&r.push(T("boosted","yes","boosted")),r.length===0?"":`<div class="sm-debug-info">${r.join("")}</div>`}function F(e,r){let t=Array.isArray(e.matchedPhrases)?e.matchedPhrases:[],n=e.matchedTerms,o=[];n&&(r==="title"&&Array.isArray(n.title)&&n.title.length>0?o=n.title:r==="description"&&Array.isArray(n.content)&&n.content.length>0?o=n.content:o=[...Array.isArray(n.title)?n.title:[],...Array.isArray(n.content)?n.content:[]]);let s=[...t,...o];return s.length>0?s:null}function T(e,r,t,n=""){let o=n?` data-backend="${h(n)}"`:"";return`<span class="sm-debug-item"><span class="sm-debug-label">${h(e)}</span><span class="sm-debug-value" data-type="${h(t)}"${o}>${h(String(r))}</span></span>`}function it(e,r={}){let{showBadge:t=!0,badgeText:n="Featured",badgePosition:o="top-right"}=r;return!e.promoted||!t?"":`<span class="sm-promoted-badge ${`sm-promoted-badge--${o}`}">${h(n)}</span>`}function P(){return`<svg class="sm-result-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
    ...
    </svg>`}function ct(e,r,t={}){let{hierarchyGroupBy:n="section",hierarchyStyle:o="tree",hierarchyDisplay:s="individual",maxHeadingsPerResult:a=3,listboxId:l}=t,i=o==="tree",d=o!=="none",u=ge(e,n||"section"),m=0;return Object.entries(u).map(([g,y])=>{let k=y.map(p=>{let b=m++,f=ht(p,b,r,t),x="",w=(p._matchedHeadings||[]).slice(0,a);if(w.length>0){let I=Math.min(...w.map(C=>C.level||2)),B=w.map(C=>i?(C.level||2)-I:0);x=w.map((C,M)=>{let O=B[M],_=!B.slice(M+1).some(K=>K===O),R=[];if(i){let K=B.slice(M+1);for(let q=0;q<O;q++)K.some(Ue=>Ue===q)&&R.push(q)}return ut(p,C,m++,r,t,_,O,R)}).join("")}let A=!!x;return`
        ...
        `}).join("")}function ht(e,r,t,n={}){let{listboxId:o,enableHighlighting:s=!0,highlightTag:a="mark",highlightClass:l="",debug:i=!1,persistQueryInUrl:d=!1,queryParamName:c="smq"}=n,u=e.title||e.name||"Untitled",m=e.description||e.excerpt||"",g=e.url||"#",y=N(g,t,d?c:""),k=L(o,r),p={enabled:s,tag:a,className:l},b=$(u,t,{...p,terms:F(e,"title")}),f=m?$(m,t,{...p,terms:F(e,"description")}):"",x=i?Re(e):"",w=e._matchedHeadings&&e._matchedHeadings.length>0?lt():dt();return i?`
            <a class="sm-result-item sm-hierarchy-parent sm-debug-enabled" id="${k}" role="option" aria-selected="false" href="${h(y)}" data-index="${r}" data-id="${e.id||""}" data-title="${h(u)}">
                <div class="sm-result-main">
                    ${w}
                    <div class="sm-result-content">
        ...
        `:`
        <a class="sm-result-item sm-hierarchy-parent" id="${k}" role="option" aria-selected="false" href="${h(y)}" data-index="${r}" data-id="${e.id||""}" data-title="${h(u)}">
            ${w}
            <div class="sm-result-content">
                <span class="sm-result-title">${b}</span>
                ${f?`<span class="sm-result-desc">${f}</span>`:""}
    ...
    `}function ut(e,r,t,n,o={},s=!1,a=0,l=[]){let{listboxId:i,enableHighlighting:d=!0,highlightTag:c="mark",highlightClass:u="",debug:m=!1,persistQueryInUrl:g=!1,queryParamName:y="smq"}=o,p=(r.text||"").replace(/^#+\s*/,""),b=r.description||"",f=r.level||2,x=r.id||(p?gt(p):""),E=e.url||"#",w=x?`${E}#${x}`:E,A=N(w,n,g?y:""),H=L(i,t),I={enabled:d,tag:c,className:u},B=$(p,n,{...I,terms:F(e,"title")}),C=b?$(b,n,{...I,terms:F(e,"description")}):"",M=s?" sm-hierarchy-child-row-last":"",O=l.map(R=>`<div class="sm-hierarchy-guide" style="--sm-guide-depth:${R}" aria-hidden="true"></div>`).join(""),_="";if(m){let R=[];R.push(T("h",f,"generic")),x&&R.push(T("anchor",x,"generic")),e.id&&R.push(T("parent",e.id,"generic")),_=`<div class="sm-debug-info">${R.join("")}</div>`}return m?`
    ...
    `}function gt(e){let r=e.normalize("NFKD").toLowerCase();try{return r.replace(/[^\p{L}\p{N}]+/gu,"-").replace(/^-+|-+$/g,"")}catch{return r.replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}}function mt(e,r){return!e||e.length===0?"":`
