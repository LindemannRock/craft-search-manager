"use strict";var SearchModalWidget=(()=>{var oe=Object.defineProperty;var nt=Object.getOwnPropertyDescriptor;var st=Object.getOwnPropertyNames;var ot=Object.prototype.hasOwnProperty;var it=(e,t)=>{for(var r in t)oe(e,r,{get:t[r],enumerable:!0})},at=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of st(t))!ot.call(e,s)&&s!==r&&oe(e,s,{get:()=>t[s],enumerable:!(n=nt(t,s))||n.enumerable});return e};var lt=e=>at(oe({},"__esModule",{value:!0}),e);var Wt={};it(Wt,{default:()=>Kt});var dt={indexHandles:[],placeholder:"Search...",theme:"light",resultsLimit:20,searchDebounceMs:200,searchMinChars:2,recentlyViewedEnabled:!0,recentlyViewedLimit:5,resultsGroupingEnabled:!0,siteId:"",apiKey:"",searchEndpoint:"/actions/search-manager/api/search",trackClickEndpoint:"/actions/search-manager/search/track-click",trackSearchEndpoint:"/actions/search-manager/search/track-search",analyticsIdleTimeoutMs:1500,analyticsSource:"",highlightResultsEnabled:!0,highlightTag:"mark",highlightClass:"",resultsRequireUrl:!1,snippetIncludeCodeBlocks:!1,snippetMode:"balanced",loadingIndicatorEnabled:!0,debugEnabled:!1,resultsTitleLines:1,resultsDescriptionLines:1,snippetMaxLength:150,snippetCleanMarkdown:!1,highlightDestinationPersistQuery:!0,highlightDestinationQueryParam:"smq",highlightDestinationEnabled:!0,highlightDestinationContentSelector:"main, article, [data-search-content]",resultsLayout:"default",hierarchyGroupBy:"",hierarchyStyle:"tree",hierarchyDisplay:"individual",hierarchyMaxHeadings:3,styles:{},translations:{},promotionBadge:{showBadge:!0,badgeText:"Featured",badgePosition:"top-right"}},ct={triggerHotkey:"k",triggerEnabled:!0,triggerLabel:"Search",triggerSelector:"",modalBackdropOpacity:50,modalBackdropBlurEnabled:!0,modalPreventBodyScroll:!0};function ht(e){return{...dt,...{modal:ct}[e]||{}}}function w(e,t=!1){if(e==null)return t;if(typeof e=="boolean")return e;if(typeof e=="number")return e!==0;if(e==="")return!0;let r=String(e).trim().toLowerCase();return["1","true","on","yes"].includes(r)?!0:["0","false","off","no"].includes(r)?!1:t}function B(e,t=0){if(e==null)return t;let r=Number.parseInt(e,10);return Number.isNaN(r)?t:r}function Z(e,t={}){if(!e)return t;try{return JSON.parse(e)}catch(r){return console.warn("SearchWidget: Invalid JSON attribute",r),t}}function ut(e){return e?e.split(",").map(t=>t.trim()).filter(Boolean):[]}function ee(e){return e.indexHandles.length>0?e.indexHandles.join(","):"all"}function ke(e){return e.indexHandles.length===1?e.indexHandles[0]:""}function U(e,t="modal"){let r=Z(e.getAttribute("snippet-defaults"),{}),n={...ht(t),...Object.fromEntries(Object.entries(r).filter(([g])=>["snippetIncludeCodeBlocks","snippetMode","snippetMaxLength","snippetCleanMarkdown","minSnippetLength","maxSnippetLength","snippetModes"].includes(g)))},s=Array.isArray(n.snippetModes)?n.snippetModes:["early","balanced","deep"],o=Number.isFinite(Number(n.minSnippetLength))?Number(n.minSnippetLength):50,i=Number.isFinite(Number(n.maxSnippetLength))?Number(n.maxSnippetLength):1e3,l=Math.min(i,Math.max(o,B(e.getAttribute("snippet-max-length"),n.snippetMaxLength))),a=e.getAttribute("snippet-mode")||n.snippetMode,d=e.getAttribute("index-handles")||"",u={indexHandles:ut(d),placeholder:e.getAttribute("placeholder")||n.placeholder,theme:e.getAttribute("theme")||n.theme,siteId:e.getAttribute("site-id")||n.siteId,apiKey:e.getAttribute("api-key")||n.apiKey,analyticsSource:e.getAttribute("analytics-source")||n.analyticsSource,highlightTag:e.getAttribute("highlight-tag")||n.highlightTag,highlightClass:e.getAttribute("highlight-class")||n.highlightClass,searchEndpoint:n.searchEndpoint,trackClickEndpoint:n.trackClickEndpoint,trackSearchEndpoint:n.trackSearchEndpoint,resultsLimit:B(e.getAttribute("results-limit"),n.resultsLimit),searchDebounceMs:B(e.getAttribute("search-debounce-ms"),n.searchDebounceMs),searchMinChars:B(e.getAttribute("search-min-chars"),n.searchMinChars),recentlyViewedLimit:B(e.getAttribute("recently-viewed-limit"),n.recentlyViewedLimit),analyticsIdleTimeoutMs:B(e.getAttribute("analytics-idle-timeout-ms"),n.analyticsIdleTimeoutMs),recentlyViewedEnabled:w(e.getAttribute("recently-viewed-enabled"),n.recentlyViewedEnabled),resultsGroupingEnabled:w(e.getAttribute("results-grouping-enabled"),n.resultsGroupingEnabled),highlightResultsEnabled:w(e.getAttribute("highlight-results-enabled"),n.highlightResultsEnabled),loadingIndicatorEnabled:w(e.getAttribute("loading-indicator-enabled"),n.loadingIndicatorEnabled),resultsRequireUrl:w(e.getAttribute("results-require-url"),n.resultsRequireUrl),snippetIncludeCodeBlocks:w(e.getAttribute("snippet-include-code-blocks"),n.snippetIncludeCodeBlocks),debugEnabled:w(e.getAttribute("debug-enabled"),n.debugEnabled),snippetMode:s.includes(a)?a:n.snippetMode,snippetMaxLength:l,snippetCleanMarkdown:w(e.getAttribute("snippet-clean-markdown"),n.snippetCleanMarkdown),highlightDestinationPersistQuery:w(e.getAttribute("highlight-destination-persist-query"),n.highlightDestinationPersistQuery),highlightDestinationEnabled:w(e.getAttribute("highlight-destination-enabled"),n.highlightDestinationEnabled),resultsTitleLines:B(e.getAttribute("results-title-lines"),n.resultsTitleLines),resultsDescriptionLines:B(e.getAttribute("results-description-lines"),n.resultsDescriptionLines),highlightDestinationQueryParam:e.getAttribute("highlight-destination-query-param")||n.highlightDestinationQueryParam,highlightDestinationContentSelector:e.getAttribute("highlight-destination-content-selector")||n.highlightDestinationContentSelector,resultsLayout:e.getAttribute("results-layout")||n.resultsLayout,hierarchyGroupBy:e.getAttribute("hierarchy-group-by")||n.hierarchyGroupBy,hierarchyStyle:e.getAttribute("hierarchy-style")||n.hierarchyStyle,hierarchyDisplay:e.getAttribute("hierarchy-display")||n.hierarchyDisplay,hierarchyMaxHeadings:B(e.getAttribute("hierarchy-max-headings"),n.hierarchyMaxHeadings),styles:Z(e.getAttribute("styles"),n.styles),translations:Z(e.getAttribute("translations"),n.translations),promotionBadge:Z(e.getAttribute("promotion-badge"),n.promotionBadge)};return t==="modal"&&Object.assign(u,{triggerHotkey:e.getAttribute("trigger-hotkey")||n.triggerHotkey,triggerLabel:e.getAttribute("trigger-label")||n.triggerLabel,triggerSelector:e.getAttribute("trigger-selector")||n.triggerSelector,modalBackdropOpacity:B(e.getAttribute("modal-backdrop-opacity"),n.modalBackdropOpacity),triggerEnabled:w(e.getAttribute("trigger-enabled"),n.triggerEnabled),modalBackdropBlurEnabled:w(e.getAttribute("modal-backdrop-blur-enabled"),n.modalBackdropBlurEnabled),modalPreventBodyScroll:w(e.getAttribute("modal-prevent-body-scroll"),n.modalPreventBodyScroll)}),u}function we(e="modal"){let t=["index-handles","placeholder","theme","results-limit","search-debounce-ms","search-min-chars","recently-viewed-enabled","recently-viewed-limit","results-grouping-enabled","site-id","analytics-idle-timeout-ms","analytics-source","highlight-results-enabled","highlight-tag","highlight-class","results-require-url","snippet-include-code-blocks","snippet-mode","loading-indicator-enabled","debug-enabled","styles","translations","promotion-badge","results-layout","hierarchy-group-by","hierarchy-style","hierarchy-display","hierarchy-max-headings","results-title-lines","results-description-lines","snippet-max-length","snippet-clean-markdown","highlight-destination-persist-query","highlight-destination-query-param","highlight-destination-enabled","highlight-destination-content-selector"],n={modal:["trigger-hotkey","trigger-enabled","trigger-label","trigger-selector","modal-backdrop-opacity","modal-backdrop-blur-enabled","modal-prevent-body-scroll"]};return[...t,...n[e]||[]]}var te={isOpen:!1,query:"",results:[],recentlyViewed:[],selectedIndex:-1,loading:!1,error:null,meta:null};function Ce(e={},t=null){let r={...te,...e};return{get(n){return r[n]},getAll(){return{...r}},set(n){let s=[];return Object.keys(n).forEach(o=>{let i=r[o],l=n[o];re(i,l)||s.push(o)}),s.length>0&&(r={...r,...n},t&&t(r,s)),s},reset(n=e){let s={...te,...n},o=Object.keys(s).filter(i=>!re(r[i],s[i]));o.length>0&&(r=s,t&&t(r,o))},is(n,s){return r[n]===s},toggle(n){let s=!r[n];return this.set({[n]:s}),s}}}function re(e,t){if(e===t)return!0;if(e==null||t==null)return!1;if(Array.isArray(e)&&Array.isArray(t))return e.length!==t.length?!1:e.every((r,n)=>re(r,t[n]));if(typeof e=="object"&&typeof t=="object"){let r=Object.keys(e),n=Object.keys(t);return r.length!==n.length?!1:r.every(s=>re(e[s],t[s]))}return!1}function m(e,t,r={}){let n=e&&Object.prototype.hasOwnProperty.call(e,t)?e[t]:t;return String(n).replace(/\{([a-zA-Z0-9_]+)\}/g,(s,o)=>Object.prototype.hasOwnProperty.call(r,o)?String(r[o]):s)}async function Se({query:e,endpoint:t,indexHandles:r=[],siteId:n="",resultsLimit:s=10,resultsRequireUrl:o=!1,snippetIncludeCodeBlocks:i=!1,snippetMode:l="",snippetMaxLength:a=0,snippetCleanMarkdown:d=!1,debugEnabled:c=!1,apiKey:u="",signal:g,translations:p={}}){let b=new URLSearchParams({q:e,resultsLimit:s.toString()});r.length>0&&b.append("indexHandles",r.join(",")),n&&b.append("siteId",n),o&&b.append("resultsRequireUrl","1"),i&&b.append("snippetIncludeCodeBlocks","1"),l&&b.append("snippetMode",l),a&&b.append("snippetMaxLength",String(a)),d&&b.append("snippetCleanMarkdown","1"),c&&b.append("debugEnabled","1"),b.append("skipAnalytics","1");let y=t.includes("?")?"&":"?",D={Accept:"application/json"};u&&(D["X-Search-Manager-Key"]=u);let f=await fetch(`${t}${y}${b}`,{signal:g,headers:D});if(!f.ok)throw new Error(await mt(f,p));let v=await f.json();return v.error&&console.warn("Search warning:",v.error),{results:v.results||v.hits||[],total:v.total||0,meta:v.meta||null,error:v.error||null}}async function mt(e,t={}){let r=await gt(e);return e.status===401?r||m(t,"Search requires an API key."):e.status===403?r||m(t,"This API key cannot access this search."):e.status===429?r||m(t,"Search rate limit exceeded. Try again in a moment."):r||m(t,"Search failed.")}async function gt(e){try{if((e.headers.get("content-type")||"").includes("application/json")){let r=await e.json(),n=r.error||r.message||"";return typeof n=="string"?n.slice(0,240):""}}catch{return""}return""}function De({endpoint:e,elementId:t,query:r,index:n,apiKey:s=""}){if(!(!t||!e))try{let o=new FormData;o.append("elementId",t),o.append("query",r),o.append("index",n);let i={Accept:"application/json"};s&&(i["X-Search-Manager-Key"]=s),fetch(e,{method:"POST",body:o,headers:i}).catch(()=>{})}catch{}}function Te({endpoint:e,query:t,indexHandles:r=[],resultsCount:n=0,trigger:s="unknown",analyticsSource:o="",siteId:i="",cached:l,took:a,apiKey:d=""}){if(!(!t||!e))try{let c=new FormData;c.append("q",t),c.append("indexHandles",r.join(",")),c.append("resultsCount",n.toString()),c.append("trigger",s),c.append("analyticsSource",o||"frontend-widget"),i&&c.append("siteId",i),typeof l=="boolean"&&c.append("cached",l?"1":"0"),typeof a=="number"&&Number.isFinite(a)&&a>=0&&c.append("took",a.toString());let u={Accept:"application/json"};d&&(u["X-Search-Manager-Key"]=d),fetch(e,{method:"POST",body:c,headers:u}).catch(()=>{})}catch{}}function Ae(e){let t={};return e.forEach(r=>{let n=r.source||r.entrySection||r.type||"Results";t[n]||(t[n]=[]),t[n].push(r)}),t}function Ee(e,t){let r={};return e.forEach(n=>{let s=(t?n[t]:null)||n.source||n.entrySection||n.type||"Results";r[s]||(r[s]=[]),r[s].push(n)}),r}var pt="sm-recently-viewed-";function ie(e){return`${pt}${e||"default"}`}function ne(e){try{let t=ie(e),r=localStorage.getItem(t);return r?JSON.parse(r):[]}catch{return[]}}function Ie(e,t,r=null,n=5){if(!t||!t.trim())return ne(e);let s=ie(e),o={query:t.trim(),title:r?.title||t,url:r?.url||null,timestamp:Date.now()},i=ne(e);i=i.filter(l=>l.query!==o.query),i.unshift(o),i=i.slice(0,n);try{localStorage.setItem(s,JSON.stringify(i))}catch{}return i}function Be(e){try{let t=ie(e);localStorage.removeItem(t)}catch{}}var Le={spinnerColor:"#3b82f6",spinnerColorDark:"#60a5fa",modalBg:"#ffffff",modalBgDark:"#1f2937",modalBorderRadius:"12",modalBorderWidth:"1",modalBorderColor:"#e5e7eb",modalBorderColorDark:"#374151",modalShadow:"0 25px 50px -12px rgba(0, 0, 0, 0.25)",modalShadowDark:"0 25px 50px -12px rgba(0, 0, 0, 0.5)",modalMaxWidth:"640",modalMaxHeight:"80",modalPaddingX:"16",modalPaddingY:"16",headerBg:"transparent",headerBgDark:"transparent",headerBorderColor:"#e5e7eb",headerBorderColorDark:"#374151",headerBorderWidth:"1",headerBorderRadius:"0",headerPaddingX:"16",headerPaddingY:"12",inputBg:"#ffffff",inputBgDark:"#1f2937",inputTextColor:"#111827",inputTextColorDark:"#f9fafb",inputPlaceholderColor:"#9ca3af",inputPlaceholderColorDark:"#9ca3af",inputBorderColor:"transparent",inputBorderColorDark:"transparent",inputFontSize:"16",inputBorderRadius:"0",inputBorderWidth:"0",inputPaddingX:"0",inputPaddingY:"0",resultBg:"transparent",resultBgDark:"transparent",resultBorderColor:"#e5e7eb",resultBorderColorDark:"#374151",resultActiveBg:"#e5e7eb",resultActiveBgDark:"#4b5563",resultActiveBorderColor:"#e5e7eb",resultActiveBorderColorDark:"#374151",resultActiveTextColor:"#111827",resultActiveTextColorDark:"#f9fafb",resultActiveDescColor:"#4b5563",resultActiveDescColorDark:"#d1d5db",resultActiveMutedColor:"#6b7280",resultActiveMutedColorDark:"#d1d5db",resultTextColor:"#111827",resultTextColorDark:"#f9fafb",resultDescColor:"#4b5563",resultDescColorDark:"#d1d5db",resultMutedColor:"#6b7280",resultMutedColorDark:"#d1d5db",resultGap:"8",resultBorderWidth:"0",resultPaddingX:"12",resultPaddingY:"12",resultBorderRadius:"8",triggerBg:"#ffffff",triggerBgDark:"#374151",triggerTextColor:"#374151",triggerTextColorDark:"#d1d5db",triggerBorderRadius:"8",triggerBorderWidth:"1",triggerBorderColor:"#d1d5db",triggerBorderColorDark:"#4b5563",triggerHoverBg:"#f9fafb",triggerHoverBgDark:"#4b5563",triggerHoverTextColor:"#111827",triggerHoverTextColorDark:"#f9fafb",triggerHoverBorderColor:"#3b82f6",triggerHoverBorderColorDark:"#60a5fa",triggerPaddingX:"12",triggerPaddingY:"8",triggerFontSize:"14",kbdBg:"#f3f4f6",kbdBgDark:"#4b5563",kbdTextColor:"#4b5563",kbdTextColorDark:"#e5e7eb",kbdBorderRadius:"4",backdropOpacity:"50",backdropBlur:"1",highlightResultsEnabled:"1",highlightTag:"",highlightClass:"",highlightBgLight:"fef08a",highlightColorLight:"854d0e",highlightBgDark:"854d0e",highlightColorDark:"fef08a",highlightActiveBgLight:"",highlightActiveColorLight:"",highlightActiveBgDark:"",highlightActiveColorDark:"",iconColor:"#3b82f6",iconColorDark:"#60a5fa",hierarchyConnectorColor:"",hierarchyConnectorColorDark:"",searchIconColor:"",searchIconColorDark:"",clearIconColor:"",clearIconColorDark:"",resultIconColor:"",resultIconColorDark:"",arrowColor:"",arrowColorDark:"",iconActiveColor:"",iconActiveColorDark:"",resultIconActiveColor:"",resultIconActiveColorDark:"",hierarchyConnectorActiveColor:"",hierarchyConnectorActiveColorDark:"",promotedBg:"#2563eb",promotedBgDark:"#2563eb",promotedColor:"#ffffff",promotedColorDark:"#ffffff",scrollbarColor:"",scrollbarColorDark:"",footerBg:"",footerBgDark:"",footerTextColor:"",footerTextColorDark:"",footerPaddingX:"16",footerPaddingY:"16"};var Q={modalBg:"--sm-modal-bg",modalBgDark:"--sm-modal-bg-dark",modalBorderRadius:"--sm-modal-radius",modalBorderWidth:"--sm-modal-border-width",modalBorderColor:"--sm-modal-border-color",modalBorderColorDark:"--sm-modal-border-color-dark",modalShadow:"--sm-modal-shadow",modalShadowDark:"--sm-modal-shadow-dark",modalMaxWidth:"--sm-modal-width",modalMaxHeight:"--sm-modal-max-height",modalPaddingX:"--sm-modal-px",modalPaddingY:"--sm-modal-py",headerBg:"--sm-header-bg",headerBgDark:"--sm-header-bg-dark",headerBorderColor:"--sm-header-border-color",headerBorderColorDark:"--sm-header-border-color-dark",headerBorderWidth:"--sm-header-border-width",headerBorderRadius:"--sm-header-radius",headerPaddingX:"--sm-header-px",headerPaddingY:"--sm-header-py",inputBg:"--sm-input-bg",inputBgDark:"--sm-input-bg-dark",inputTextColor:"--sm-input-color",inputTextColorDark:"--sm-input-color-dark",inputPlaceholderColor:"--sm-input-placeholder",inputPlaceholderColorDark:"--sm-input-placeholder-dark",inputBorderColor:"--sm-input-border-color",inputBorderColorDark:"--sm-input-border-color-dark",inputFontSize:"--sm-input-font-size",inputBorderRadius:"--sm-input-radius",inputBorderWidth:"--sm-input-border-width",inputPaddingX:"--sm-input-px",inputPaddingY:"--sm-input-py",resultBg:"--sm-result-bg",resultBgDark:"--sm-result-bg-dark",resultBorderColor:"--sm-result-border-color",resultBorderColorDark:"--sm-result-border-color-dark",resultActiveBg:"--sm-result-active-bg",resultActiveBgDark:"--sm-result-active-bg-dark",resultActiveBorderColor:"--sm-result-active-border-color",resultActiveBorderColorDark:"--sm-result-active-border-color-dark",resultActiveTextColor:"--sm-result-active-text-color",resultActiveTextColorDark:"--sm-result-active-text-color-dark",resultActiveDescColor:"--sm-result-active-desc-color",resultActiveDescColorDark:"--sm-result-active-desc-color-dark",resultActiveMutedColor:"--sm-result-active-muted-color",resultActiveMutedColorDark:"--sm-result-active-muted-color-dark",resultTextColor:"--sm-result-text-color",resultTextColorDark:"--sm-result-text-color-dark",resultDescColor:"--sm-result-desc-color",resultDescColorDark:"--sm-result-desc-color-dark",resultMutedColor:"--sm-result-muted-color",resultMutedColorDark:"--sm-result-muted-color-dark",resultGap:"--sm-result-gap",resultBorderWidth:"--sm-result-border-width",resultPaddingX:"--sm-result-px",resultPaddingY:"--sm-result-py",resultBorderRadius:"--sm-result-radius",triggerBg:"--sm-trigger-bg",triggerBgDark:"--sm-trigger-bg-dark",triggerTextColor:"--sm-trigger-text-color",triggerTextColorDark:"--sm-trigger-text-color-dark",triggerBorderRadius:"--sm-trigger-radius",triggerBorderWidth:"--sm-trigger-border-width",triggerBorderColor:"--sm-trigger-border-color",triggerBorderColorDark:"--sm-trigger-border-color-dark",triggerHoverBg:"--sm-trigger-hover-bg",triggerHoverBgDark:"--sm-trigger-hover-bg-dark",triggerHoverTextColor:"--sm-trigger-hover-text-color",triggerHoverTextColorDark:"--sm-trigger-hover-text-color-dark",triggerHoverBorderColor:"--sm-trigger-hover-border-color",triggerHoverBorderColorDark:"--sm-trigger-hover-border-color-dark",triggerPaddingX:"--sm-trigger-px",triggerPaddingY:"--sm-trigger-py",triggerFontSize:"--sm-trigger-font-size",kbdBg:"--sm-kbd-bg",kbdBgDark:"--sm-kbd-bg-dark",kbdTextColor:"--sm-kbd-text-color",kbdTextColorDark:"--sm-kbd-text-color-dark",kbdBorderRadius:"--sm-kbd-radius",iconColor:"--sm-icon-color",iconColorDark:"--sm-icon-color-dark",searchIconColor:"--sm-search-icon-color",searchIconColorDark:"--sm-search-icon-color-dark",clearIconColor:"--sm-clear-icon-color",clearIconColorDark:"--sm-clear-icon-color-dark",resultIconColor:"--sm-result-icon-color",resultIconColorDark:"--sm-result-icon-color-dark",arrowColor:"--sm-arrow-color",arrowColorDark:"--sm-arrow-color-dark",iconActiveColor:"--sm-icon-active-color",iconActiveColorDark:"--sm-icon-active-color-dark",resultIconActiveColor:"--sm-result-icon-active-color",resultIconActiveColorDark:"--sm-result-icon-active-color-dark",hierarchyConnectorActiveColor:"--sm-hierarchy-connector-active-color",hierarchyConnectorActiveColorDark:"--sm-hierarchy-connector-active-color-dark",hierarchyConnectorColor:"--sm-hierarchy-connector-color",hierarchyConnectorColorDark:"--sm-hierarchy-connector-color-dark",highlightBgLight:"--sm-highlight-bg",highlightColorLight:"--sm-highlight-color",highlightBgDark:"--sm-highlight-bg-dark",highlightColorDark:"--sm-highlight-color-dark",highlightActiveBgLight:"--sm-highlight-active-bg",highlightActiveColorLight:"--sm-highlight-active-color",highlightActiveBgDark:"--sm-highlight-active-bg-dark",highlightActiveColorDark:"--sm-highlight-active-color-dark",promotedBg:"--sm-promoted-bg",promotedBgDark:"--sm-promoted-bg-dark",promotedColor:"--sm-promoted-color",promotedColorDark:"--sm-promoted-color-dark",spinnerColor:"--sm-spinner-color-light",spinnerColorDark:"--sm-spinner-color-dark",scrollbarColor:"--sm-scrollbar-color",scrollbarColorDark:"--sm-scrollbar-color-dark",footerBg:"--sm-footer-bg",footerBgDark:"--sm-footer-bg-dark",footerTextColor:"--sm-footer-text-color",footerTextColorDark:"--sm-footer-text-color-dark",footerPaddingX:"--sm-footer-px",footerPaddingY:"--sm-footer-py"},ae=["modalBorderRadius","modalBorderWidth","modalMaxWidth","modalPaddingX","modalPaddingY","headerBorderWidth","headerBorderRadius","headerPaddingX","headerPaddingY","inputFontSize","inputBorderRadius","inputBorderWidth","inputPaddingX","inputPaddingY","resultGap","resultBorderWidth","resultPaddingX","resultPaddingY","resultBorderRadius","triggerBorderRadius","triggerBorderWidth","triggerPaddingX","triggerPaddingY","triggerFontSize","kbdBorderRadius","footerPaddingX","footerPaddingY"],le=["modalMaxHeight"],Re=["modalBg","modalBgDark","modalBorderColor","modalBorderColorDark","headerBg","headerBgDark","headerBorderColor","headerBorderColorDark","inputBg","inputBgDark","inputTextColor","inputTextColorDark","inputPlaceholderColor","inputPlaceholderColorDark","inputBorderColor","inputBorderColorDark","resultBg","resultBgDark","resultBorderColor","resultBorderColorDark","resultActiveBg","resultActiveBgDark","resultActiveBorderColor","resultActiveBorderColorDark","resultTextColor","resultTextColorDark","resultActiveTextColor","resultActiveTextColorDark","resultActiveDescColor","resultActiveDescColorDark","resultActiveMutedColor","resultActiveMutedColorDark","resultDescColor","resultDescColorDark","resultMutedColor","resultMutedColorDark","triggerBg","triggerBgDark","triggerTextColor","triggerTextColorDark","triggerBorderColor","triggerBorderColorDark","triggerHoverBg","triggerHoverBgDark","triggerHoverTextColor","triggerHoverTextColorDark","triggerHoverBorderColor","triggerHoverBorderColorDark","kbdBg","kbdBgDark","kbdTextColor","kbdTextColorDark","iconColor","iconColorDark","searchIconColor","searchIconColorDark","clearIconColor","clearIconColorDark","resultIconColor","resultIconColorDark","arrowColor","arrowColorDark","iconActiveColor","iconActiveColorDark","resultIconActiveColor","resultIconActiveColorDark","hierarchyConnectorActiveColor","hierarchyConnectorActiveColorDark","hierarchyConnectorColor","hierarchyConnectorColorDark","highlightBgLight","highlightColorLight","highlightBgDark","highlightColorDark","highlightActiveBgLight","highlightActiveColorLight","highlightActiveBgDark","highlightActiveColorDark","promotedBg","promotedBgDark","promotedColor","promotedColorDark","spinnerColor","spinnerColorDark","scrollbarColor","scrollbarColorDark","footerBg","footerBgDark","footerTextColor","footerTextColorDark"],sr={...Le,highlightBgLight:"#fef08a",highlightColorLight:"#854d0e",highlightBgDark:"#854d0e",highlightColorDark:"#fef08a"};var de=new WeakMap;function ft(){let e=new Set,t=new Set;for(let r of Object.keys(Q)){if(r.endsWith("Dark")){t.add(r);continue}if(r.endsWith("Light")){let n=r.replace(/Light$/,"Dark");Q[n]&&e.add(r);continue}Q[`${r}Dark`]&&e.add(r)}return{lightKeys:e,darkKeys:t}}var $e=ft();function vt(e){return typeof e=="string"&&/^(var|light-dark|calc|env|clamp|min|max|rgb|hsl)\s*\(/.test(e.trim())}function yt(e){return/^[0-9a-fA-F]{6}$/.test(e)}function xt(e,t){if(t==null||t==="")return null;let r=String(t);return vt(r)||(Re.includes(e)&&yt(r)&&(r="#"+r),ae.includes(e)&&(r=r+"px"),le.includes(e)&&(r=r+"vh")),r}function _e(e,t,r="light"){if(!e)return;let n=de.get(e);if(n){for(let a of n)e.style.removeProperty(a);de.delete(e)}if(!t||typeof t!="object")return;let s=r==="dark",o=Object.entries(Q),i=new Set([...ae,...le]),l=new Set;for(let[a,d]of o){let c=$e.lightKeys.has(a),u=$e.darkKeys.has(a),g=c||u;if(s){if(c||!u&&!i.has(a))continue}else if(u)continue;if(t[a]!==void 0&&t[a]!==null&&t[a]!==""){let p=xt(a,t[a]);p&&(e.style.setProperty(d,p),g&&l.add(d))}}l.size>0&&de.set(e,l)}var kt=new Set(["mark","em","strong","u","b","i","span"]),wt=/^[A-Za-z0-9_-]+$/;function h(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function Pe(e){return e?e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"):""}function ce(e){if(!e)return[];let t=[],r=/"([^"]+)"/g,n;for(;(n=r.exec(e))!==null;)n[1].trim()&&t.push(n[1].trim());let s=e.replace(/"[^"]*"/g,""),o=new Set(["and","or","not","und","oder","nicht","et","ou","sauf","y","o","no"]);s.split(/\s+/).filter(l=>l.length>0).forEach(l=>{l=l.replace(/^[a-zA-Z]+:/,""),l=l.replace(/\*/g,""),l=l.replace(/\^\d+(\.\d+)?/,""),l=l.replace(/"/g,""),!(!l||o.has(l.toLowerCase()))&&t.push(l)});let i=[];return t.forEach(l=>{i.push(l);let a=l.split(/(?<=[a-z])(?=[A-Z])/);a.length>1&&a.forEach(d=>{d.length>=3&&i.push(d)})}),i}function X(e,t,r={}){let{enabled:n=!0,tag:s="mark",className:o="",terms:i=null}=r;if(!n)return h(e);let l=Ct(s),d=["sm-highlight",...St(o)],c=` class="${h(d.join(" "))}"`,u=Dt(t,i);return u.length===0?h(e):Tt(e,u,l,c)}function Ct(e){let t=String(e||"mark").trim().toLowerCase();return kt.has(t)?t:"mark"}function St(e){return String(e||"").trim().split(/\s+/).filter(t=>t&&wt.test(t))}function Dt(e,t){return Array.isArray(t)&&t.length>0?He(t):e?He(ce(e)):[]}function He(e){let t=new Set;return e.filter(r=>typeof r=="string"&&r.length>0).sort((r,n)=>n.length-r.length).filter(r=>{let n=r.toLowerCase();return t.has(n)?!1:(t.add(n),!0)})}function Tt(e,t,r,n){let s=e.toLowerCase(),o=[];if(t.forEach(c=>{let u=c.toLowerCase();if(!u)return;let g=0;for(;g<s.length;){let p=s.indexOf(u,g);if(p===-1)break;o.push({start:p,end:p+u.length}),g=p+u.length}}),o.length===0)return h(e);o.sort((c,u)=>c.start!==u.start?c.start-u.start:u.end-u.start-(c.end-c.start));let i=[],l=-1;o.forEach(c=>{c.start>=l&&(i.push(c),l=c.end)});let a="",d=0;return i.forEach(c=>{d<c.start&&(a+=h(e.slice(d,c.start))),a+=`<${r}${n}>${h(e.slice(c.start,c.end))}</${r}>`,d=c.end}),d<e.length&&(a+=h(e.slice(d))),a}function K(e,t,r="smq"){if(!e||e==="#")return e;if(At(e))return"#";let n=(t||"").trim();if(!n||!r||/^(mailto:|tel:)/i.test(e))return e;let[s,o]=e.split("#",2),[i,l]=s.split("?",2),a=new URLSearchParams(l||"");a.set(r,n);let d=a.toString(),c=o?`#${o}`:"";return`${i}${d?`?${d}`:""}${c}`}function At(e){let t=String(e).replace(/[\t\n\r]/g,"").replace(/^[\u0000-\u0020]+/,"");return/^(javascript|data|vbscript):/i.test(t)}var Et=0;function he(e="sm"){return`${e}-${++Et}-${Date.now().toString(36)}`}function Me(e){let t=document.createElement("div");return t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-atomic","true"),t.className="sm-sr-only",e.appendChild(t),t}function J(e,t,r=100){e&&(e.textContent="",setTimeout(()=>{e.textContent=t},r))}function ue(e,t,r={}){return e===0?m(r,'No results found for "{query}"',{query:t}):e===1?m(r,'1 result found for "{query}"',{query:t}):m(r,'{count} results found for "{query}"',{count:e,query:t})}function Oe(e={}){return m(e,"Searching...")}function Ne(e,t={}){return e===0?m(t,"No recently viewed items"):e===1?m(t,"1 recently viewed item available"):m(t,"{count} recently viewed items available",{count:e})}function se(e,{expanded:t,activeDescendant:r,listboxId:n}){e.setAttribute("aria-expanded",String(t)),e.setAttribute("aria-controls",n),r?e.setAttribute("aria-activedescendant",r):e.removeAttribute("aria-activedescendant")}function z(e,t){return`${e}-option-${t}`}function Fe(e,t){if(!e||!t)return;let r=e.getBoundingClientRect(),n=t.getBoundingClientRect();r.top<n.top?e.scrollIntoView({block:"nearest",behavior:"smooth"}):r.bottom>n.bottom&&e.scrollIntoView({block:"nearest",behavior:"smooth"})}function It(e,t,r={}){let{resultsGroupingEnabled:n=!1,resultsLayout:s="default",listboxId:o}=r;if(!e||e.length===0)return"";if(s==="hierarchical")return Nt(e,t,r);if(n){let i=Ae(e),l=0;return Object.entries(i).map(([a,d])=>`
        ...
        `:`
        <a class="sm-result-item${_}" id="${x}" role="option" aria-selected="false" href="${h(v)}" data-index="${t}" data-source-index="${h(S)}"${R} data-title="${h(y)}">
            ${E}
            <div class="sm-result-content">
                <span class="sm-result-title">${q}</span>
                ${A?`<span class="sm-result-desc">${A}</span>`:""}
    ...
    `}function je(e,t={}){let r=[],n=e.backend?e.backend.toLowerCase():"";if((e._index||e.index)&&r.push(C("index",e._index||e.index,"index","",t)),e.backend&&r.push(C("backend",n,"backend",n,t)),e.elementId&&r.push(C("element",e.elementId,"generic","",t)),e.backendId&&r.push(C("hit",e.backendId,"generic","",t)),e.score!==void 0&&e.score!==null){let s=typeof e.score=="number"?e.score.toFixed(2):e.score;r.push(C("score",s,"score","",t))}if(e.site&&r.push(C("site",e.site,"generic","",t)),e.language&&r.push(C("lang",e.language,"generic","",t)),e.matchedIn&&Array.isArray(e.matchedIn)&&e.matchedIn.length>0){let s=e.matchedIn.join(", ");r.push(C("matched",s,"matched","",t))}return e.promoted&&r.push(C("promoted",m(t,"yes"),"promoted","",t)),e.boosted&&r.push(C("boosted",m(t,"yes"),"boosted","",t)),r.length===0?"":`<div class="sm-debug-info">${r.join("")}</div>`}function F(e,t){let r=Array.isArray(e.matchedPhrases)?e.matchedPhrases:[],n=e.matchedTerms,s=[];n&&(t==="title"&&Array.isArray(n.title)&&n.title.length>0?s=n.title:t==="snippet"&&Array.isArray(n.content)&&n.content.length>0?s=n.content:s=[...Array.isArray(n.title)?n.title:[],...Array.isArray(n.content)?n.content:[]]);let o=[...r,...s];return o.length>0?o:null}function ge(e,t,r,n){return X(t,r,n)}function C(e,t,r,n="",s={}){let o=n?` data-backend="${h(n)}"`:"";return`<span class="sm-debug-item"><span class="sm-debug-label">${h(m(s,e))}</span><span class="sm-debug-value" data-type="${h(r)}"${o}>${h(String(t))}</span></span>`}function Bt(e,t={}){let{showBadge:r=!0,badgeText:n="Featured",badgePosition:s="top-right"}=t;return!e.promoted||!r?"":`<span class="sm-promoted-badge ${`sm-promoted-badge--${new Set(["top-right","top-left","inline"]).has(s)?s:"top-right"}`}">${h(n)}</span>`}function pe(e){return!!(e&&typeof e=="object"&&["heading","intro","promoted-page"].includes(String(e.sectionType||"")))}function Lt(e){return Array.isArray(e)&&e.some(pe)}function Rt(e,t){let r=new Map,n=[];return e.forEach((s,o)=>{if(!pe(s)){n.push({type:"single",item:s,order:o,score:N(s)});return}let i=Ht(s);if(!r.has(i)){let d={hits:[],order:o,score:N(s)};r.set(i,d),n.push({type:"section-group",key:i,order:o,score:d.score})}let l=r.get(i);l.hits.push(s),l.score=Math.max(l.score,N(s));let a=n.find(d=>d.type==="section-group"&&d.key===i);a&&(a.score=l.score)}),n.map(s=>{if(s.type==="section-group"){let o=r.get(s.key);return{...s,item:$t(o.hits,t)}}return s}).sort((s,o)=>{let i=me(o.score,s.score);return i!==0?i:s.order-o.order}).map(s=>s.item)}function $t(e,t){let r=[...e].sort((c,u)=>O(c)-O(u)),n=r.find(c=>c.sectionType==="intro")||null,s=[...e].sort((c,u)=>{let g=me(N(u),N(c));return g!==0?g:O(c)-O(u)})[0]||r[0]||{},o=n||s,i=W(o),l=o.siteId??"",a=Number.isFinite(t)&&t>0?t:3,d=r.filter(c=>c.sectionType==="heading").sort((c,u)=>{let g=me(N(u),N(c));return g!==0?g:O(c)-O(u)}).slice(0,a).sort((c,u)=>O(c)-O(u)).map(_t);return{...o,elementId:i||o.elementId,backendId:n?.backendId||o.backendId||Pt(i,l),title:o.title||o.sectionTitle||o.name||"",url:o.url||"#",snippet:n&&n.snippet||null,score:N(s),headings:d,__sectionHitGroup:!0,__useBackendDomId:!0}}function _t(e){let t=Number.parseInt(e.sectionLevel,10),r=Number.isFinite(t)?t:2;return{title:e.sectionTitle||e.title||"",text:e.sectionTitle||e.title||"",id:e.sectionAnchor||e.sectionId||"",level:r,url:e.sectionUrl||e.url||null,snippet:e.snippet||null,backendId:e.backendId||"",elementId:W(e),sectionType:e.sectionType,_index:e._index,index:e.index,matchedTerms:e.matchedTerms,matchedPhrases:e.matchedPhrases,__useBackendDomId:!0}}function Ht(e){return[W(e)||Ge(e)||"",e.siteId??""].join(":")}function O(e){let t=Number.parseInt(e.sectionIndex,10);return Number.isFinite(t)?t:Number.MAX_SAFE_INTEGER}function N(e){let t=Number(e?.score);return Number.isFinite(t)?t:Number.NEGATIVE_INFINITY}function me(e,t){return e===t?0:e>t?1:-1}function Pt(e,t){let r=e||"unknown";return t!=null&&String(t)!==""?`${r}_${t}`:String(r)}function Ge(e,t=null){return e?.backendId||t?.backendId||""}function W(e,t=null){return e?.elementId||t?.elementId||""}function be(e,t=null){let r=Ge(e,t)||W(e,t),n=W(e,t);return` data-id="${h(r)}" data-element-id="${h(n)}"`}function j(){return`<svg class="sm-result-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
    ...
    </svg>`}function Ve(){return`<svg class="sm-hierarchy-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
        <line x1="4" y1="9" x2="20" y2="9"/>
        <line x1="4" y1="15" x2="20" y2="15"/>
        <line x1="10" y1="3" x2="8" y2="21"/>
        <line x1="16" y1="3" x2="14" y2="21"/>
    </svg>`}function Nt(e,t,r={}){let{hierarchyGroupBy:n="",hierarchyStyle:s="tree",hierarchyDisplay:o="individual",hierarchyMaxHeadings:i=3,listboxId:l}=r,a=s==="tree",d=s!=="none",c=Lt(e)?Rt(e,i):e,g=Ee(c,n||""),p=0;return Object.entries(g).map(([b,y])=>{let D=y.map(f=>{let v=p++,T=Ft(f,v,t,r),x="",k=f.headings||[],S=f.__sectionHitGroup?k:k.slice(0,i);if(S.length>0){let q=Math.min(...S.map(E=>E.level||2)),A=S.map(E=>a?(E.level||2)-q:0);x=S.map((E,_)=>{let H=A[_],P=!A.slice(_+1).some(G=>G===H),Y=[];if(a){let G=A.slice(_+1);for(let V=0;V<H;V++)G.some(M=>M===V)&&Y.push(V)}return qt(f,E,p++,t,r,P,H,Y)}).join("")}let R=!!x;return`
                <div class="sm-hierarchy-block${R?" sm-hierarchy-block--has-children":""}${o==="unified"?" sm-hierarchy-block--unified":""}">
                    ...
                    ${R?`<div class="sm-hierarchy-children${d?"":" sm-hierarchy-children--no-connectors"}">${x}</div>`:""}
                </div>
            `}).join("");return`
        ...
        `}).join("")}function Ft(e,t,r,n={}){let{listboxId:s,highlightResultsEnabled:o=!0,highlightTag:i="mark",highlightClass:l="",debugEnabled:a=!1,highlightDestinationPersistQuery:d=!1,highlightDestinationQueryParam:c="smq",translations:u={}}=n,g=e.title||e.name||m(u,"Untitled"),p=e.snippet||"",b=e.url||"#",y=K(b,r,d?c:""),D=z(s,t),f=e._index||e.index||"",v=be(e),T={enabled:o,tag:i,className:l},x=X(g,r,{...T,terms:F(e,"title")}),k=p?ge(e,p,r,{...T,terms:F(e,"snippet")}):"",S=a?je(e,u):"",$=e.headings&&e.headings.length>0?Mt():Ot();return a?`
            <a class="sm-result-item sm-hierarchy-parent sm-debug-enabled" id="${D}" role="option" aria-selected="false" href="${h(y)}" data-index="${t}" data-source-index="${h(f)}"${v} data-title="${h(g)}">
                <div class="sm-result-main">
                    ${$}
                    <div class="sm-result-content">
        ...
        `:`
        <a class="sm-result-item sm-hierarchy-parent" id="${D}" role="option" aria-selected="false" href="${h(y)}" data-index="${t}" data-source-index="${h(f)}"${v} data-title="${h(g)}">
            ${$}
            <div class="sm-result-content">
                <span class="sm-result-title">${x}</span>
                ${k?`<span class="sm-result-desc">${k}</span>`:""}
    ...
    `}function qt(e,t,r,n,s={},o=!1,i=0,l=[]){let{listboxId:a,highlightResultsEnabled:d=!0,highlightTag:c="mark",highlightClass:u="",debugEnabled:g=!1,highlightDestinationPersistQuery:p=!1,highlightDestinationQueryParam:b="smq",translations:y={}}=s,f=(t.title||t.text||"").replace(/^#+\s*/,""),v=t.snippet||"",T=Number.parseInt(t.level,10),x=Number.isFinite(T)?Math.min(Math.max(T,1),6):2,k=t.id||(f?Vt(f):""),S=e.url||"#",R=t.url||(k?`${S}#${k}`:S),$=K(R,n,p?b:""),q=z(a,r),A=t._index||t.index||e._index||e.index||"",E=be(t,e),_={enabled:d,tag:c,className:u},H=X(f,n,{..._,terms:F(t,"title")||F(e,"title")}),P=v?ge(e,v,n,{..._,terms:F(t,"snippet")||F(e,"snippet")}):"",Y=o?" sm-hierarchy-child-row-last":"",G=l.map(M=>`<div class="sm-hierarchy-guide" style="--sm-guide-depth:${M}" aria-hidden="true"></div>`).join(""),V="";if(g){let M=[];M.push(C("h",x,"generic","",y)),k&&M.push(C("anchor",k,"generic","",y));let xe=W(t,e);xe&&M.push(C("parent",xe,"generic","",y)),V=`<div class="sm-debug-info">${M.join("")}</div>`}return g?`
            <div class="sm-hierarchy-child-row sm-hierarchy-level-${x} sm-hierarchy-depth-${i}${Y}" style="--sm-hierarchy-depth:${i}">
                ${G}
                <a class="sm-result-item sm-hierarchy-child sm-hierarchy-level-${x} sm-debug-enabled" id="${q}" role="option" aria-selected="false" href="${h($)}" data-index="${r}" data-source-index="${h(A)}"${E} data-title="${h(f)}">
                    <div class="sm-result-main">
                        ${Ve()}
                        <div class="sm-result-content">
                            <span class="sm-result-title">${H}</span>
        ...
        <div class="sm-hierarchy-child-row sm-hierarchy-level-${x} sm-hierarchy-depth-${i}${Y}" style="--sm-hierarchy-depth:${i}">
            ${G}
            <a class="sm-result-item sm-hierarchy-child sm-hierarchy-level-${x}" id="${q}" role="option" aria-selected="false" href="${h($)}" data-index="${r}" data-source-index="${h(A)}"${E} data-title="${h(f)}">
                ${Ve()}
                <div class="sm-result-content">
                    <span class="sm-result-title">${H}</span>
                    ${P?`<span class="sm-result-desc">${P}</span>`:""}
    ...
    `}function Vt(e){let t=e.normalize("NFKD").toLowerCase();try{return t.replace(/[^\p{L}\p{N}]+/gu,"-").replace(/^-+|-+$/g,"")}catch{return t.replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}}function zt(e,t,r={}){return!e||e.length===0?"":`
        <div class="sm-section">
            <div class="sm-section-header">
                <span id="${t}-recently-viewed-label">${h(m(r,"Recently viewed"))}</span>
                <button class="sm-recently-viewed-clear" part="recently-viewed-clear">${h(m(r,"Clear"))}</button>
            </div>
            ${e.map((n,s)=>`
                <div class="sm-result-item sm-recently-viewed-item" id="${z(t,s)}" role="option" aria-selected="false" data-index="${s}" data-url="${h(n.url||"")}" data-query="${h(n.query)}">
    ...
    `}function ze(e,t={}){return!e||!e.trim()?`
            <div class="sm-empty" part="empty">
                ...
                <p>${h(m(t,"Start typing to search"))}</p>
            </div>
        `:`
        <div class="sm-empty" part="empty">
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
            ...
            <p>${h(m(t,'No results for "{query}"',{query:e}))}</p>
        </div>
    ...
    `}function Gt(e,t={}){return`
        <div class="sm-empty sm-error" part="error">
            ...
            <p>${h(e||m(t,"Search failed."))}</p>
        </div>
    `}function Ue(e,t){let{query:r,results:n,recentlyViewed:s,loading:o,recentlyViewedEnabled:i,error:l}=e,{loadingIndicatorEnabled:a=!0,translations:d={}}=t,c=r&&r.trim();return o&&a?{html:jt(d),hasResults:!1,showListbox:!1}:l?{html:Gt(l,d),hasResults:!1,showListbox:!1}:c?!n||n.length===0?{html:ze(r,d),hasResults:!1,showListbox:!1}:{html:It(n,r,t),hasResults:!0,showListbox:!0}:i&&s&&s.length>0?{html:zt(s,t.listboxId,d),hasResults:!0,showListbox:!0}:{html:ze("",d),hasResults:!1,showListbox:!1}}function fe(e,t,r=!1,n={}){if(!e)return"";let s=[];if(s.push(L("results",t,"generic","",n)),e.took!==void 0){let d=e.took<1?"<1ms":`${Math.round(e.took)}ms`;s.push(L("time",d,"time","",n))}if(e.cacheEnabled!==void 0&&(e.cacheEnabled?e.cached?s.push(L("cache",m(n,"hit"),"cache-hit","",n)):s.push(L("cache",m(n,"miss"),"cache-miss","",n)):s.push(L("cache",m(n,"off"),"cache-off","",n))),e.cacheDriver&&s.push(L("storage",e.cacheDriver,"cache-driver",e.cacheDriver,n)),e.indices&&e.indices.length>0){let d=e.indices.length>2?m(n,"{count} indices",{count:e.indices.length}):e.indices.join(", ");s.push(L("indices",d,"generic","",n))}if(e.synonymsExpanded){let d=e.expandedQueries?e.expandedQueries.length-1:0;s.push(L("synonyms",`+${d}`,"synonyms","",n))}let o=e.rulesMatched?.length||0;s.push(L("rules",o,o>0?"rules":"generic","",n));let i=e.promotionsMatched?.length||0;s.push(L("promoted",i,i>0?"promotions":"generic","",n));let a=`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">${r?'<path d="M6 9l6 6 6-6"/>':'<path d="M18 15l-6-6-6 6"/>'}</svg>`;return r?`<div class="sm-toolbar-collapsed-bar"><span class="sm-toolbar-collapsed-label">${h(m(n,"Debug"))}</span>${a}</div>`:`<div class="sm-toolbar-content">${s.join("")}</div><button class="sm-toolbar-toggle" aria-label="${h(m(n,"Collapse debug panel"))}" aria-expanded="true">${a}</button>`}function L(e,t,r,n="",s={}){let o=n?` data-backend="${h(n)}"`:"";return`<span class="sm-toolbar-item"><span class="sm-toolbar-label">${h(m(s,e))}</span><span class="sm-toolbar-value" data-type="${h(r)}"${o}>${h(String(t))}</span></span>`}function Ke(e,t){let{onSelect:r,onIndexChange:n,onEscape:s}=e,{listboxId:o}=t;return{handleKeydown(i,l,a){let d=a;switch(i.key){case"ArrowDown":return i.preventDefault(),d=Math.min(a+1,l-1),d!==a&&n&&n(d),d;case"ArrowUp":return i.preventDefault(),d=Math.max(a-1,-1),d!==a&&n&&n(d),d;case"Enter":return i.preventDefault(),a>=0&&r&&r(a),null;case"Escape":return i.preventDefault(),s&&s(),null;default:return null}},getListboxId(){return o}}}function We(e,t,r={}){let{scrollContainer:n,inputElement:s,listboxId:o,selectedClass:i="sm-selected"}=r,l=t>=0?z(o,t):null;s&&se(s,{expanded:e.length>0,activeDescendant:l,listboxId:o}),e.forEach((a,d)=>{let c=d===t;a.classList.toggle(i,c),a.setAttribute("aria-selected",String(c)),c&&n&&Fe(a,n)})}function Ye(e,t){e.forEach((r,n)=>{r.addEventListener("mouseenter",()=>{t&&t(n)})})}var Qe="sm-page-highlight-style",Xe="__smPageHighlightRegistry",Je="__searchManagerHotkeyHandled",I=null,ve=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.config=null,this.state=Ce({...te},this.handleStateChange.bind(this)),this.searchSequence=0,this.debounceTimer=null,this.analyticsIdleTimer=null,this.lastTrackedQuery=null,this.lastSearchCacheState=null,this.listboxId=he("sm-listbox"),this.inputId=he("sm-input"),this.liveRegion=null,this.keyboardNavigator=null,this.elements={},this.handleInput=this.handleInput.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.handleResultClick=this.handleResultClick.bind(this)}get widgetType(){throw new Error("Subclass must implement widgetType getter")}render(){throw new Error("Subclass must implement render()")}getResultsContainer(){throw new Error("Subclass must implement getResultsContainer()")}getInputElement(){throw new Error("Subclass must implement getInputElement()")}getLoadingElement(){return this.elements.loading||null}getDebugToolbarElement(){return this.elements.debugToolbar||null}connectedCallback(){this.config=U(this,this.widgetType),this.state.set({recentlyViewed:ne(ee(this.config))}),this.keyboardNavigator=Ke({onSelect:t=>this.selectResultAtIndex(t),onIndexChange:t=>this.state.set({selectedIndex:t}),onEscape:()=>this.handleEscape()},{listboxId:this.listboxId}),this.applyDestinationPageHighlight()}disconnectedCallback(){this.unregisterOpenWidget(),this.searchSequence++,this.debounceTimer&&(clearTimeout(this.debounceTimer),this.debounceTimer=null)}registerOpenWidget(){I&&I!==this&&typeof I.close=="function"&&I.close({reason:"replace",replacedBy:this,source:"replace"}),I=this}unregisterOpenWidget(){I===this&&(I=null)}claimHotkeyEvent(t,r){return t[Je]||I&&I!==this&&I.state?.get("isOpen")&&I.config?.triggerHotkey?.toLowerCase()===r?!1:(t[Je]=!0,!0)}attributeChangedCallback(t,r,n){r!==n&&this.shadowRoot.children.length>0&&(this.config=U(this,this.widgetType),this.render(),this.applyCustomStyles())}handleStateChange(t,r){(r.includes("results")||r.includes("query")||r.includes("recentlyViewed")||r.includes("error"))&&this.renderResultsContent(),(r.includes("results")||r.includes("meta"))&&this.updateDebugToolbar(),r.includes("selectedIndex")&&this.updateSelectionVisual(),r.includes("loading")&&this.updateLoadingVisual()}handleInput(t){let r=t.target.value;if(this.elements&&this.elements.clear&&(this.elements.clear.hidden=!r),this.state.set({query:r,selectedIndex:-1}),this.debounceTimer&&clearTimeout(this.debounceTimer),this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null),!r.trim()){this.state.set({results:[]});return}r.length<this.config.searchMinChars||(this.debounceTimer=setTimeout(()=>{this.executeSearch(r)},this.config.searchDebounceMs))}async executeSearch(t){let r=++this.searchSequence;this.state.set({loading:!0,error:null}),this.liveRegion&&J(this.liveRegion,Oe(this.config.translations));try{let{results:n,meta:s}=await Se({query:t,endpoint:this.config.searchEndpoint,indexHandles:this.config.indexHandles,siteId:this.config.siteId,resultsLimit:this.config.resultsLimit,resultsRequireUrl:this.config.resultsRequireUrl,snippetIncludeCodeBlocks:this.config.snippetIncludeCodeBlocks,snippetMode:this.config.snippetMode,snippetMaxLength:this.config.snippetMaxLength,snippetCleanMarkdown:this.config.snippetCleanMarkdown,debugEnabled:this.config.debugEnabled,apiKey:this.config.apiKey,translations:this.config.translations});if(r!==this.searchSequence)return;this.state.set({results:n,meta:s,loading:!1,selectedIndex:n.length>0?0:-1}),s&&typeof s.cached=="boolean"?this.lastSearchCacheState={cached:s.cached,took:typeof s.took=="number"?s.took:null}:this.lastSearchCacheState=null,this.liveRegion&&J(this.liveRegion,ue(n.length,t,this.config.translations)),this.dispatchWidgetEvent("search",{query:t,results:n,meta:s}),this.startAnalyticsIdleTimer(t,n.length)}catch(n){if(r!==this.searchSequence||n.name==="AbortError")return;console.error("Search error:",n),this.state.set({results:[],loading:!1,error:n.message}),this.dispatchWidgetEvent("error",{query:t,error:n.message})}}renderResultsContent(){let t=this.getResultsContainer();if(!t)return;let r=this.state.getAll(),{recentlyViewedEnabled:n,resultsGroupingEnabled:s,highlightResultsEnabled:o,highlightTag:i,highlightClass:l,loadingIndicatorEnabled:a,debugEnabled:d}=this.config,{html:c,hasResults:u,showListbox:g}=Ue({query:r.query,results:r.results,recentlyViewed:r.recentlyViewed,loading:r.loading,error:r.error,recentlyViewedEnabled:n},{listboxId:this.listboxId,resultsGroupingEnabled:s,highlightResultsEnabled:o,highlightTag:i,highlightClass:l,loadingIndicatorEnabled:a,debugEnabled:d,translations:this.config.translations,highlightDestinationPersistQuery:this.config.highlightDestinationEnabled&&this.config.highlightDestinationPersistQuery,highlightDestinationQueryParam:this.config.highlightDestinationQueryParam,promotionBadge:this.config.promotionBadge,resultsLayout:this.config.resultsLayout,hierarchyGroupBy:this.config.hierarchyGroupBy,hierarchyStyle:this.config.hierarchyStyle,hierarchyDisplay:this.config.hierarchyDisplay,hierarchyMaxHeadings:this.config.hierarchyMaxHeadings});t.innerHTML=c,g?t.setAttribute("role","listbox"):t.removeAttribute("role");let p=this.getInputElement();p&&se(p,{expanded:u,activeDescendant:null,listboxId:this.listboxId}),this.liveRegion&&!r.loading&&(r.query&&r.results.length===0?J(this.liveRegion,ue(0,r.query,this.config.translations)):!r.query&&r.recentlyViewed.length>0&&n&&J(this.liveRegion,Ne(r.recentlyViewed.length,this.config.translations))),this.attachResultHandlers();let b=t.querySelector(".sm-recently-viewed-clear");b&&b.addEventListener("click",y=>{y.stopPropagation(),Be(ee(this.config)),this.state.set({recentlyViewed:[]})}),u&&r.results.length>0&&this.state.set({selectedIndex:0})}attachResultHandlers(){let t=this.getResultsContainer();if(!t)return;let r=t.querySelectorAll(".sm-result-item");r.forEach(n=>{n.addEventListener("click",s=>this.handleResultClick(s,n))}),Ye(r,n=>{this.state.set({selectedIndex:n})})}updateSelectionVisual(){let t=this.getResultsContainer(),r=this.getInputElement();if(!t)return;let n=t.querySelectorAll(".sm-result-item"),s=this.state.get("selectedIndex");We(n,s,{scrollContainer:t,inputElement:r,listboxId:this.listboxId})}handleKeydown(t){let r=this.getResultsContainer();if(!r)return;let n=r.querySelectorAll(".sm-result-item"),s=this.state.get("selectedIndex");if(t.key==="Enter"){let o=this.state.get("query"),i=this.state.get("results")||[];o&&i.length>0&&this.trackSearchAnalytics(o,i.length,"enter")}this.keyboardNavigator.handleKeydown(t,n.length,s)}selectResultAtIndex(t){let r=this.getResultsContainer();if(!r)return;let n=r.querySelectorAll(".sm-result-item");t>=0&&n[t]&&n[t].click()}handleEscape(){}handleResultClick(t,r){let n=r.getAttribute("href"),s=r.dataset.url,o=n||s,i=r.dataset.title||r.querySelector(".sm-result-title")?.textContent,l=r.dataset.id,a=r.dataset.elementId||l,d=r.dataset.query||this.state.get("query"),c=r.classList.contains("sm-recently-viewed-item"),u=K(o,d,this.config.highlightDestinationEnabled&&this.config.highlightDestinationPersistQuery?this.config.highlightDestinationQueryParam:"");if(!c&&d){let p=Ie(ee(this.config),d,{title:i,url:o},this.config.recentlyViewedLimit);this.state.set({recentlyViewed:p})}let g=r.dataset.sourceIndex||ke(this.config);if(a&&g&&De({endpoint:this.config.trackClickEndpoint,elementId:a,query:d,index:g,apiKey:this.config.apiKey}),!c&&d&&this.trackSearchAnalytics(d,this.state.get("results")?.length||0,"click"),this.dispatchWidgetEvent("result-click",{id:l,elementId:a,title:i,url:u,query:d,isRecentlyViewed:c}),o&&o!=="#")c&&(t.preventDefault(),window.location.href=u),this.onResultSelected(u,i,l);else if(d){t.preventDefault();let p=this.getInputElement();p&&(p.value=d,this.state.set({query:d}),this.executeSearch(d))}}onResultSelected(t,r,n){}applyDestinationPageHighlight(){if(!this.config.highlightDestinationEnabled||typeof window>"u"||typeof document>"u")return;let t=this.config.highlightDestinationQueryParam||"smq",r=this.config.highlightDestinationContentSelector||"main, article, [data-search-content]",n=new URLSearchParams(window.location.search).get(t);if(!n||!n.trim())return;let s=this.getPageHighlightRegistry(),o=`${t}::${r}`;if(s.has(o))return;s.add(o);let i=()=>{this.ensurePageHighlightStyles(),this.highlightDestinationNodes(n.trim(),r,o)};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",i,{once:!0}):window.requestAnimationFrame(i)}ensurePageHighlightStyles(){if(document.getElementById(Qe))return;let t=document.createElement("style");t.id=Qe,t.textContent=`
            .sm-page-highlight {
        ...
        `,document.head.appendChild(t)}highlightDestinationNodes(t,r,n){let s=Array.from(document.querySelectorAll(r));if(s.length===0)return;let o=[...new Set(ce(t).map(a=>a.trim()).filter(a=>a.length>=2))];if(o.length===0)return;let i=o.map(a=>Pe(a)).filter(Boolean).sort((a,d)=>d.length-a.length).join("|");if(!i)return;let l=new RegExp(`(${i})`,"gi");s.forEach(a=>{a.getAttribute("data-sm-highlighted")!==n&&(this.highlightTextNodesInScope(a,l),a.setAttribute("data-sm-highlighted",n))})}highlightTextNodesInScope(t,r){let n=document.createTreeWalker(t,NodeFilter.SHOW_TEXT,{acceptNode:o=>{let i=o.nodeValue;if(!i||!i.trim())return NodeFilter.FILTER_REJECT;let l=o.parentElement;return!l||l.closest("script, style, noscript, textarea, mark, .sm-highlight, .sm-page-highlight, search-modal")?NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT}}),s=[];for(;n.nextNode();)s.push(n.currentNode);s.forEach(o=>{let i=o.nodeValue||"";if(r.lastIndex=0,!r.test(i))return;let l=document.createDocumentFragment(),a=0;r.lastIndex=0;let d=i.matchAll(r);for(let c of d){let u=c[0],g=c.index??-1;if(g<0)continue;g>a&&l.appendChild(document.createTextNode(i.slice(a,g)));let p=document.createElement("mark");p.className="sm-highlight sm-page-highlight",p.textContent=u,l.appendChild(p),a=g+u.length}a<i.length&&l.appendChild(document.createTextNode(i.slice(a))),o.parentNode?.replaceChild(l,o)})}getPageHighlightRegistry(){let t=window[Xe];if(t instanceof Set)return t;let r=new Set;return window[Xe]=r,r}updateLoadingVisual(){let t=this.getLoadingElement();if(t){let r=this.state.get("loading"),n=this.config?.loadingIndicatorEnabled!==!1;t.hidden=!r||!n}}updateDebugToolbar(){let t=this.getDebugToolbarElement();if(!t)return;let{debugEnabled:r}=this.config,n=this.state.getAll();if(!r||!n.meta||n.results.length===0){t.hidden=!0;return}let s=t.classList.contains("sm-collapsed");t.innerHTML=fe(n.meta,n.results.length,s,this.config.translations),t.hidden=!1,s&&t.classList.add("sm-collapsed"),this.attachDebugToolbarHandlers(t)}attachDebugToolbarHandlers(t){let r=t.querySelector(".sm-toolbar-toggle");r&&r.addEventListener("click",s=>{s.preventDefault(),s.stopPropagation(),this.toggleDebugToolbar()});let n=t.querySelector(".sm-toolbar-collapsed-bar");n&&n.addEventListener("click",s=>{s.preventDefault(),s.stopPropagation(),this.toggleDebugToolbar()})}toggleDebugToolbar(){let t=this.getDebugToolbarElement();if(!t)return;let r=t.classList.toggle("sm-collapsed"),n=this.state.getAll();t.innerHTML=fe(n.meta,n.results.length,r,this.config.translations),r&&t.classList.add("sm-collapsed"),this.attachDebugToolbarHandlers(t)}applyCustomStyles(){if(!this.config)return;let t=this.shadowRoot.host,{theme:r,styles:n,resultsTitleLines:s,resultsDescriptionLines:o}=this.config;_e(t,n,r),s&&t.style.setProperty("--sm-result-title-lines",String(s)),o&&t.style.setProperty("--sm-result-desc-lines",String(o))}initializeLiveRegion(){this.liveRegion=Me(this.shadowRoot)}startAnalyticsIdleTimer(t,r){this.analyticsIdleTimer&&clearTimeout(this.analyticsIdleTimer);let n=this.config.analyticsIdleTimeoutMs;!n||n<=0||(this.analyticsIdleTimer=setTimeout(()=>{this.trackSearchAnalytics(t,r,"idle")},n))}trackSearchAnalytics(t,r,n){!t||t===this.lastTrackedQuery||(this.lastTrackedQuery=t,this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null),Te({endpoint:this.config.trackSearchEndpoint,query:t,indexHandles:this.config.indexHandles,resultsCount:r,trigger:n,analyticsSource:this.config.analyticsSource,siteId:this.config.siteId,cached:this.lastSearchCacheState?.cached,took:this.lastSearchCacheState?.took,apiKey:this.config.apiKey}))}resetAnalyticsTracking(){this.lastTrackedQuery=null,this.lastSearchCacheState=null,this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null)}dispatchWidgetEvent(t,r={}){this.dispatchEvent(new CustomEvent(`search-${t}`,{bubbles:!0,composed:!0,detail:r}))}},Ze=ve;var et=`/**
