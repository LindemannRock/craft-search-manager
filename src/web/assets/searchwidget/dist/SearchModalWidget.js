"use strict";var SearchModalWidget=(()=>{var re=Object.defineProperty;var et=Object.getOwnPropertyDescriptor;var tt=Object.getOwnPropertyNames;var rt=Object.prototype.hasOwnProperty;var nt=(e,t)=>{for(var n in t)re(e,n,{get:t[n],enumerable:!0})},st=(e,t,n,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of tt(t))!rt.call(e,s)&&s!==n&&re(e,s,{get:()=>t[s],enumerable:!(r=et(t,s))||r.enumerable});return e};var ot=e=>st(re({},"__esModule",{value:!0}),e);var Gt={};nt(Gt,{default:()=>zt});var at={indices:[],placeholder:"Search...",theme:"light",maxResults:20,debounce:200,minChars:2,showRecent:!0,maxRecentSearches:5,groupResults:!0,siteId:"",apiKey:"",searchEndpoint:"/actions/search-manager/api/search",trackClickEndpoint:"/actions/search-manager/search/track-click",trackSearchEndpoint:"/actions/search-manager/search/track-search",idleTimeout:1500,source:"",enableHighlighting:!0,highlightTag:"mark",highlightClass:"",hideResultsWithoutUrl:!1,showCodeSnippets:!1,snippetMode:"balanced",showLoadingIndicator:!0,debug:!1,resultTitleLines:1,resultDescLines:1,snippetLength:150,parseMarkdownSnippets:!1,persistQueryInUrl:!0,queryParamName:"smq",highlightDestinationPage:!0,destinationHighlightSelector:"main, article, [data-search-content]",resultLayout:"default",hierarchyGroupBy:"",hierarchyStyle:"tree",hierarchyDisplay:"individual",maxHeadingsPerResult:3,styles:{},promotions:{showBadge:!0,badgeText:"Featured",badgePosition:"top-right"}},it={hotkey:"k",showTrigger:!0,triggerSelector:"",backdropOpacity:50,enableBackdropBlur:!0,preventBodyScroll:!0},lt={showFilters:!0,paginationType:"numbered",resultsPerPage:20,updateUrl:!0,sortOptions:["relevance","date-desc","date-asc","title"]},dt={dropdownPosition:"below",dropdownMaxHeight:400,showOnFocus:!0};function ct(e){return{...at,...{modal:it,page:lt,inline:dt}[e]||{}}}function y(e,t=!1){if(e==null)return t;if(typeof e=="boolean")return e;if(typeof e=="number")return e!==0;if(e==="")return!0;let n=String(e).trim().toLowerCase();return["1","true","on","yes"].includes(n)?!0:["0","false","off","no"].includes(n)?!1:t}function S(e,t=0){if(e==null)return t;let n=Number.parseInt(e,10);return Number.isNaN(n)?t:n}function ne(e,t={}){if(!e)return t;try{return JSON.parse(e)}catch(n){return console.warn("SearchWidget: Invalid JSON attribute",n),t}}function fe(e){return e?e.split(",").map(t=>t.trim()).filter(Boolean):[]}function Q(e){return e.indices.length>0?e.indices.join(","):"all"}function ye(e){return e.indices.length===1?e.indices[0]:""}function j(e,t="modal"){let n=ne(e.getAttribute("snippet-defaults"),{}),r={...ct(t),...Object.fromEntries(Object.entries(n).filter(([m])=>["showCodeSnippets","snippetMode","snippetLength","parseMarkdownSnippets","minSnippetLength","maxSnippetLength","snippetModes"].includes(m)))},s=Array.isArray(r.snippetModes)?r.snippetModes:["early","balanced","deep"],o=Number.isFinite(Number(r.minSnippetLength))?Number(r.minSnippetLength):50,a=Number.isFinite(Number(r.maxSnippetLength))?Number(r.maxSnippetLength):1e3,l=Math.min(a,Math.max(o,S(e.getAttribute("snippet-length"),r.snippetLength))),i=e.getAttribute("snippet-mode")||r.snippetMode,c=e.getAttribute("indices")||"",h={indices:fe(c),placeholder:e.getAttribute("placeholder")||r.placeholder,theme:e.getAttribute("theme")||r.theme,siteId:e.getAttribute("site-id")||r.siteId,apiKey:e.getAttribute("api-key")||r.apiKey,source:e.getAttribute("source")||r.source,highlightTag:e.getAttribute("highlight-tag")||r.highlightTag,highlightClass:e.getAttribute("highlight-class")||r.highlightClass,searchEndpoint:r.searchEndpoint,trackClickEndpoint:r.trackClickEndpoint,trackSearchEndpoint:r.trackSearchEndpoint,maxResults:S(e.getAttribute("max-results"),r.maxResults),debounce:S(e.getAttribute("debounce"),r.debounce),minChars:S(e.getAttribute("min-chars"),r.minChars),maxRecentSearches:S(e.getAttribute("max-recent-searches"),r.maxRecentSearches),idleTimeout:S(e.getAttribute("idle-timeout"),r.idleTimeout),showRecent:y(e.getAttribute("show-recent"),r.showRecent),groupResults:y(e.getAttribute("group-results"),r.groupResults),enableHighlighting:y(e.getAttribute("enable-highlighting"),r.enableHighlighting),showLoadingIndicator:y(e.getAttribute("show-loading-indicator"),r.showLoadingIndicator),hideResultsWithoutUrl:y(e.getAttribute("hide-results-without-url"),r.hideResultsWithoutUrl),showCodeSnippets:y(e.getAttribute("show-code-snippets"),r.showCodeSnippets),debug:y(e.getAttribute("debug"),r.debug),snippetMode:s.includes(i)?i:r.snippetMode,snippetLength:l,parseMarkdownSnippets:y(e.getAttribute("parse-markdown-snippets"),r.parseMarkdownSnippets),persistQueryInUrl:y(e.getAttribute("persist-query-in-url"),r.persistQueryInUrl),highlightDestinationPage:y(e.getAttribute("highlight-destination-page"),r.highlightDestinationPage),resultTitleLines:S(e.getAttribute("result-title-lines"),r.resultTitleLines),resultDescLines:S(e.getAttribute("result-desc-lines"),r.resultDescLines),queryParamName:e.getAttribute("query-param-name")||r.queryParamName,destinationHighlightSelector:e.getAttribute("destination-highlight-selector")||r.destinationHighlightSelector,resultLayout:e.getAttribute("result-layout")||r.resultLayout,hierarchyGroupBy:e.getAttribute("hierarchy-group-by")||r.hierarchyGroupBy,hierarchyStyle:e.getAttribute("hierarchy-style")||r.hierarchyStyle,hierarchyDisplay:e.getAttribute("hierarchy-display")||r.hierarchyDisplay,maxHeadingsPerResult:S(e.getAttribute("max-headings-per-result"),r.maxHeadingsPerResult),styles:ne(e.getAttribute("styles"),r.styles),promotions:ne(e.getAttribute("promotions"),r.promotions)};return t==="modal"&&Object.assign(h,{hotkey:e.getAttribute("hotkey")||r.hotkey,triggerSelector:e.getAttribute("trigger-selector")||r.triggerSelector,backdropOpacity:S(e.getAttribute("backdrop-opacity"),r.backdropOpacity),showTrigger:y(e.getAttribute("show-trigger"),r.showTrigger),enableBackdropBlur:y(e.getAttribute("enable-backdrop-blur"),r.enableBackdropBlur),preventBodyScroll:y(e.getAttribute("prevent-body-scroll"),r.preventBodyScroll)}),t==="page"&&Object.assign(h,{resultsPerPage:S(e.getAttribute("results-per-page"),r.resultsPerPage),paginationType:e.getAttribute("pagination-type")||r.paginationType,showFilters:y(e.getAttribute("show-filters"),r.showFilters),updateUrl:y(e.getAttribute("update-url"),r.updateUrl),sortOptions:fe(e.getAttribute("sort-options"))||r.sortOptions}),t==="inline"&&Object.assign(h,{dropdownPosition:e.getAttribute("dropdown-position")||r.dropdownPosition,dropdownMaxHeight:S(e.getAttribute("dropdown-max-height"),r.dropdownMaxHeight),showOnFocus:y(e.getAttribute("show-on-focus"),r.showOnFocus)}),h}function ke(e="modal"){let t=["indices","placeholder","theme","max-results","debounce","min-chars","show-recent","max-recent-searches","group-results","site-id","idle-timeout","source","enable-highlighting","highlight-tag","highlight-class","hide-results-without-url","show-code-snippets","snippet-mode","show-loading-indicator","debug","styles","promotions","result-layout","hierarchy-group-by","hierarchy-style","hierarchy-display","max-headings-per-result","result-title-lines","result-desc-lines","snippet-length","parse-markdown-snippets","persist-query-in-url","query-param-name","highlight-destination-page","destination-highlight-selector"],o={modal:["hotkey","show-trigger","trigger-selector","backdrop-opacity","enable-backdrop-blur","prevent-body-scroll"],page:["show-filters","pagination-type","results-per-page","update-url","sort-options"],inline:["dropdown-position","dropdown-max-height","show-on-focus"]};return[...t,...o[e]||[]]}var J={isOpen:!1,query:"",results:[],recentSearches:[],selectedIndex:-1,loading:!1,error:null,meta:null};function ve(e={},t=null){let n={...J,...e};return{get(r){return n[r]},getAll(){return{...n}},set(r){let s=[];return Object.keys(r).forEach(o=>{let a=n[o],l=r[o];Z(a,l)||s.push(o)}),s.length>0&&(n={...n,...r},t&&t(n,s)),s},reset(r=e){let s={...J,...r},o=Object.keys(s).filter(a=>!Z(n[a],s[a]));o.length>0&&(n=s,t&&t(n,o))},is(r,s){return n[r]===s},toggle(r){let s=!n[r];return this.set({[r]:s}),s}}}function Z(e,t){if(e===t)return!0;if(e==null||t==null)return!1;if(Array.isArray(e)&&Array.isArray(t))return e.length!==t.length?!1:e.every((n,r)=>Z(n,t[r]));if(typeof e=="object"&&typeof t=="object"){let n=Object.keys(e),r=Object.keys(t);return n.length!==r.length?!1:n.every(s=>Z(e[s],t[s]))}return!1}async function xe({query:e,endpoint:t,indices:n=[],siteId:r="",maxResults:s=10,hideResultsWithoutUrl:o=!1,showCodeSnippets:a=!1,snippetMode:l="",snippetLength:i=0,parseMarkdownSnippets:c=!1,debug:d=!1,apiKey:h="",signal:m}){let g=new URLSearchParams({q:e,hitsPerPage:s.toString()});n.length>0&&g.append("indices",n.join(",")),r&&g.append("siteId",r),o&&g.append("hideResultsWithoutUrl","1"),a&&g.append("showCodeSnippets","1"),l&&g.append("snippetMode",l),i&&g.append("snippetLength",String(i)),c&&g.append("parseMarkdownSnippets","1"),d&&g.append("debug","1"),g.append("skipAnalytics","1");let b=t.includes("?")?"&":"?",x={Accept:"application/json"};h&&(x["X-Search-Manager-Key"]=h);let f=await fetch(`${t}${b}${g}`,{signal:m,headers:x});if(!f.ok)throw new Error(await ht(f));let p=await f.json();return p.error&&console.warn("Search warning:",p.error),{results:p.results||p.hits||[],total:p.total||0,meta:p.meta||null,error:p.error||null}}async function ht(e){let t=await ut(e);return e.status===401?t||"Search requires an API key.":e.status===403?t||"This API key cannot access this search.":e.status===429?t||"Search rate limit exceeded. Try again in a moment.":t||"Search failed."}async function ut(e){try{if((e.headers.get("content-type")||"").includes("application/json")){let n=await e.json(),r=n.error||n.message||"";return typeof r=="string"?r.slice(0,240):""}}catch{return""}return""}function we({endpoint:e,elementId:t,query:n,index:r,apiKey:s=""}){if(!(!t||!e))try{let o=new FormData;o.append("elementId",t),o.append("query",n),o.append("index",r);let a={Accept:"application/json"};s&&(a["X-Search-Manager-Key"]=s),fetch(e,{method:"POST",body:o,headers:a}).catch(()=>{})}catch{}}function Ce({endpoint:e,query:t,indices:n=[],resultsCount:r=0,trigger:s="unknown",source:o="",siteId:a="",cached:l,took:i,apiKey:c=""}){if(!(!t||!e))try{let d=new FormData;d.append("q",t),d.append("indices",n.join(",")),d.append("resultsCount",r.toString()),d.append("trigger",s),d.append("source",o||"frontend-widget"),a&&d.append("siteId",a),typeof l=="boolean"&&d.append("cached",l?"1":"0"),typeof i=="number"&&Number.isFinite(i)&&i>=0&&d.append("took",i.toString());let h={Accept:"application/json"};c&&(h["X-Search-Manager-Key"]=c),fetch(e,{method:"POST",body:d,headers:h}).catch(()=>{})}catch{}}function Se(e){let t={};return e.forEach(n=>{let r=n.source||n.entrySection||n.type||"Results";t[r]||(t[r]=[]),t[r].push(n)}),t}function Te(e,t){let n={};return e.forEach(r=>{let s=(t?r[t]:null)||r.source||r.entrySection||r.type||"Results";n[s]||(n[s]=[]),n[s].push(r)}),n}var gt="sm-recent-";function se(e){return`${gt}${e||"default"}`}function ee(e){try{let t=se(e),n=localStorage.getItem(t);return n?JSON.parse(n):[]}catch{return[]}}function Ae(e,t,n=null,r=5){if(!t||!t.trim())return ee(e);let s=se(e),o={query:t.trim(),title:n?.title||t,url:n?.url||null,timestamp:Date.now()},a=ee(e);a=a.filter(l=>l.query!==o.query),a.unshift(o),a=a.slice(0,r);try{localStorage.setItem(s,JSON.stringify(a))}catch{}return a}function De(e){try{let t=se(e);localStorage.removeItem(t)}catch{}}var Ie={spinnerColor:"#3b82f6",spinnerColorDark:"#60a5fa",modalBg:"#ffffff",modalBgDark:"#1f2937",modalBorderRadius:"12",modalBorderWidth:"1",modalBorderColor:"#e5e7eb",modalBorderColorDark:"#374151",modalShadow:"0 25px 50px -12px rgba(0, 0, 0, 0.25)",modalShadowDark:"0 25px 50px -12px rgba(0, 0, 0, 0.5)",modalMaxWidth:"640",modalMaxHeight:"80",modalPaddingX:"16",modalPaddingY:"16",headerBg:"transparent",headerBgDark:"transparent",headerBorderColor:"#e5e7eb",headerBorderColorDark:"#374151",headerBorderWidth:"1",headerBorderRadius:"0",headerPaddingX:"16",headerPaddingY:"12",inputBg:"#ffffff",inputBgDark:"#1f2937",inputTextColor:"#111827",inputTextColorDark:"#f9fafb",inputPlaceholderColor:"#9ca3af",inputPlaceholderColorDark:"#9ca3af",inputBorderColor:"transparent",inputBorderColorDark:"transparent",inputFontSize:"16",inputBorderRadius:"0",inputBorderWidth:"0",inputPaddingX:"0",inputPaddingY:"0",resultBg:"transparent",resultBgDark:"transparent",resultBorderColor:"#e5e7eb",resultBorderColorDark:"#374151",resultActiveBg:"#e5e7eb",resultActiveBgDark:"#4b5563",resultActiveBorderColor:"#e5e7eb",resultActiveBorderColorDark:"#374151",resultActiveTextColor:"#111827",resultActiveTextColorDark:"#f9fafb",resultActiveDescColor:"#4b5563",resultActiveDescColorDark:"#d1d5db",resultActiveMutedColor:"#6b7280",resultActiveMutedColorDark:"#d1d5db",resultTextColor:"#111827",resultTextColorDark:"#f9fafb",resultDescColor:"#4b5563",resultDescColorDark:"#d1d5db",resultMutedColor:"#6b7280",resultMutedColorDark:"#d1d5db",resultGap:"8",resultBorderWidth:"0",resultPaddingX:"12",resultPaddingY:"12",resultBorderRadius:"8",triggerBg:"#ffffff",triggerBgDark:"#374151",triggerTextColor:"#374151",triggerTextColorDark:"#d1d5db",triggerBorderRadius:"8",triggerBorderWidth:"1",triggerBorderColor:"#d1d5db",triggerBorderColorDark:"#4b5563",triggerHoverBg:"#f9fafb",triggerHoverBgDark:"#4b5563",triggerHoverTextColor:"#111827",triggerHoverTextColorDark:"#f9fafb",triggerHoverBorderColor:"#3b82f6",triggerHoverBorderColorDark:"#60a5fa",triggerPaddingX:"12",triggerPaddingY:"8",triggerFontSize:"14",kbdBg:"#f3f4f6",kbdBgDark:"#4b5563",kbdTextColor:"#4b5563",kbdTextColorDark:"#e5e7eb",kbdBorderRadius:"4",backdropOpacity:"50",backdropBlur:"1",highlightEnabled:"1",highlightTag:"",highlightClass:"",highlightBgLight:"fef08a",highlightColorLight:"854d0e",highlightBgDark:"854d0e",highlightColorDark:"fef08a",iconColor:"#3b82f6",iconColorDark:"#60a5fa",promotedBg:"#2563eb",promotedBgDark:"#2563eb",promotedColor:"#ffffff",promotedColorDark:"#ffffff"};var Ee={modalBg:"--sm-modal-bg",modalBgDark:"--sm-modal-bg-dark",modalBorderRadius:"--sm-modal-radius",modalBorderWidth:"--sm-modal-border-width",modalBorderColor:"--sm-modal-border-color",modalBorderColorDark:"--sm-modal-border-color-dark",modalShadow:"--sm-modal-shadow",modalShadowDark:"--sm-modal-shadow-dark",modalMaxWidth:"--sm-modal-width",modalMaxHeight:"--sm-modal-max-height",modalPaddingX:"--sm-modal-px",modalPaddingY:"--sm-modal-py",headerBg:"--sm-header-bg",headerBgDark:"--sm-header-bg-dark",headerBorderColor:"--sm-header-border-color",headerBorderColorDark:"--sm-header-border-color-dark",headerBorderWidth:"--sm-header-border-width",headerBorderRadius:"--sm-header-radius",headerPaddingX:"--sm-header-px",headerPaddingY:"--sm-header-py",inputBg:"--sm-input-bg",inputBgDark:"--sm-input-bg-dark",inputTextColor:"--sm-input-color",inputTextColorDark:"--sm-input-color-dark",inputPlaceholderColor:"--sm-input-placeholder",inputPlaceholderColorDark:"--sm-input-placeholder-dark",inputBorderColor:"--sm-input-border-color",inputBorderColorDark:"--sm-input-border-color-dark",inputFontSize:"--sm-input-font-size",inputBorderRadius:"--sm-input-radius",inputBorderWidth:"--sm-input-border-width",inputPaddingX:"--sm-input-px",inputPaddingY:"--sm-input-py",resultBg:"--sm-result-bg",resultBgDark:"--sm-result-bg-dark",resultBorderColor:"--sm-result-border-color",resultBorderColorDark:"--sm-result-border-color-dark",resultActiveBg:"--sm-result-active-bg",resultActiveBgDark:"--sm-result-active-bg-dark",resultActiveBorderColor:"--sm-result-active-border-color",resultActiveBorderColorDark:"--sm-result-active-border-color-dark",resultActiveTextColor:"--sm-result-active-text-color",resultActiveTextColorDark:"--sm-result-active-text-color-dark",resultActiveDescColor:"--sm-result-active-desc-color",resultActiveDescColorDark:"--sm-result-active-desc-color-dark",resultActiveMutedColor:"--sm-result-active-muted-color",resultActiveMutedColorDark:"--sm-result-active-muted-color-dark",resultTextColor:"--sm-result-text-color",resultTextColorDark:"--sm-result-text-color-dark",resultDescColor:"--sm-result-desc-color",resultDescColorDark:"--sm-result-desc-color-dark",resultMutedColor:"--sm-result-muted-color",resultMutedColorDark:"--sm-result-muted-color-dark",resultGap:"--sm-result-gap",resultBorderWidth:"--sm-result-border-width",resultPaddingX:"--sm-result-px",resultPaddingY:"--sm-result-py",resultBorderRadius:"--sm-result-radius",triggerBg:"--sm-trigger-bg",triggerBgDark:"--sm-trigger-bg-dark",triggerTextColor:"--sm-trigger-text-color",triggerTextColorDark:"--sm-trigger-text-color-dark",triggerBorderRadius:"--sm-trigger-radius",triggerBorderWidth:"--sm-trigger-border-width",triggerBorderColor:"--sm-trigger-border-color",triggerBorderColorDark:"--sm-trigger-border-color-dark",triggerHoverBg:"--sm-trigger-hover-bg",triggerHoverBgDark:"--sm-trigger-hover-bg-dark",triggerHoverTextColor:"--sm-trigger-hover-text-color",triggerHoverTextColorDark:"--sm-trigger-hover-text-color-dark",triggerHoverBorderColor:"--sm-trigger-hover-border-color",triggerHoverBorderColorDark:"--sm-trigger-hover-border-color-dark",triggerPaddingX:"--sm-trigger-px",triggerPaddingY:"--sm-trigger-py",triggerFontSize:"--sm-trigger-font-size",kbdBg:"--sm-kbd-bg",kbdBgDark:"--sm-kbd-bg-dark",kbdTextColor:"--sm-kbd-text-color",kbdTextColorDark:"--sm-kbd-text-color-dark",kbdBorderRadius:"--sm-kbd-radius",iconColor:"--sm-icon-color",iconColorDark:"--sm-icon-color-dark",highlightBgLight:"--sm-highlight-bg",highlightColorLight:"--sm-highlight-color",highlightBgDark:"--sm-highlight-bg-dark",highlightColorDark:"--sm-highlight-color-dark",promotedBg:"--sm-promoted-bg",promotedBgDark:"--sm-promoted-bg-dark",promotedColor:"--sm-promoted-color",promotedColorDark:"--sm-promoted-color-dark",spinnerColor:"--sm-spinner-color-light",spinnerColorDark:"--sm-spinner-color-dark"},oe=["modalBorderRadius","modalBorderWidth","modalMaxWidth","modalPaddingX","modalPaddingY","headerBorderWidth","headerBorderRadius","headerPaddingX","headerPaddingY","inputFontSize","inputBorderRadius","inputBorderWidth","inputPaddingX","inputPaddingY","resultGap","resultBorderWidth","resultPaddingX","resultPaddingY","resultBorderRadius","triggerBorderRadius","triggerBorderWidth","triggerPaddingX","triggerPaddingY","triggerFontSize","kbdBorderRadius"],ae=["modalMaxHeight"],Be=["modalBg","modalBgDark","modalBorderColor","modalBorderColorDark","headerBg","headerBgDark","headerBorderColor","headerBorderColorDark","inputBg","inputBgDark","inputTextColor","inputTextColorDark","inputPlaceholderColor","inputPlaceholderColorDark","inputBorderColor","inputBorderColorDark","resultBg","resultBgDark","resultBorderColor","resultBorderColorDark","resultActiveBg","resultActiveBgDark","resultActiveBorderColor","resultActiveBorderColorDark","resultTextColor","resultTextColorDark","resultActiveTextColor","resultActiveTextColorDark","resultActiveDescColor","resultActiveDescColorDark","resultActiveMutedColor","resultActiveMutedColorDark","resultDescColor","resultDescColorDark","resultMutedColor","resultMutedColorDark","triggerBg","triggerBgDark","triggerTextColor","triggerTextColorDark","triggerBorderColor","triggerBorderColorDark","triggerHoverBg","triggerHoverBgDark","triggerHoverTextColor","triggerHoverTextColorDark","triggerHoverBorderColor","triggerHoverBorderColorDark","kbdBg","kbdBgDark","kbdTextColor","kbdTextColorDark","iconColor","iconColorDark","highlightBgLight","highlightColorLight","highlightBgDark","highlightColorDark","promotedBg","promotedBgDark","promotedColor","promotedColorDark","spinnerColor","spinnerColorDark"],Zt={...Ie,highlightBgLight:"#fef08a",highlightColorLight:"#854d0e",highlightBgDark:"#854d0e",highlightColorDark:"#fef08a"};function pt(e){return typeof e=="string"&&/^(var|light-dark|calc|env|clamp|min|max|rgb|hsl)\s*\(/.test(e.trim())}function bt(e){return/^[0-9a-fA-F]{6}$/.test(e)}function ft(e,t){if(t==null||t==="")return null;let n=String(t);return pt(n)||(Be.includes(e)&&bt(n)&&(n="#"+n),oe.includes(e)&&(n=n+"px"),ae.includes(e)&&(n=n+"vh")),n}function Re(e,t,n="light"){if(!t||typeof t!="object")return;let r=n==="dark",s=Object.entries(Ee),o=new Set([...oe,...ae]);for(let[a,l]of s){let i=a.endsWith("Dark");if(r){if(!i&&!o.has(a))continue}else if(i)continue;if(t[a]!==void 0&&t[a]!==null&&t[a]!==""){let c=ft(a,t[a]);c&&e.style.setProperty(l,c)}}}var yt=new Set(["mark","em","strong","u","b","i","span"]),kt=/^[A-Za-z0-9_-]+$/;function u(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function $e(e){return e?e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"):""}function ie(e){if(!e)return[];let t=[],n=/"([^"]+)"/g,r;for(;(r=n.exec(e))!==null;)r[1].trim()&&t.push(r[1].trim());let s=e.replace(/"[^"]*"/g,""),o=new Set(["and","or","not","und","oder","nicht","et","ou","sauf","y","o","no"]);s.split(/\s+/).filter(l=>l.length>0).forEach(l=>{l=l.replace(/^[a-zA-Z]+:/,""),l=l.replace(/\*/g,""),l=l.replace(/\^\d+(\.\d+)?/,""),l=l.replace(/"/g,""),!(!l||o.has(l.toLowerCase()))&&t.push(l)});let a=[];return t.forEach(l=>{a.push(l);let i=l.split(/(?<=[a-z])(?=[A-Z])/);i.length>1&&i.forEach(c=>{c.length>=3&&a.push(c)})}),a}function K(e,t,n={}){let{enabled:r=!0,tag:s="mark",className:o="",terms:a=null}=n;if(!r)return u(e);let l=vt(s),c=["sm-highlight",...xt(o)],d=` class="${u(c.join(" "))}"`,h=wt(t,a);return h.length===0?u(e):Ct(e,h,l,d)}function vt(e){let t=String(e||"mark").trim().toLowerCase();return yt.has(t)?t:"mark"}function xt(e){return String(e||"").trim().split(/\s+/).filter(t=>t&&kt.test(t))}function wt(e,t){return Array.isArray(t)&&t.length>0?Le(t):e?Le(ie(e)):[]}function Le(e){let t=new Set;return e.filter(n=>typeof n=="string"&&n.length>0).sort((n,r)=>r.length-n.length).filter(n=>{let r=n.toLowerCase();return t.has(r)?!1:(t.add(r),!0)})}function Ct(e,t,n,r){let s=e.toLowerCase(),o=[];if(t.forEach(d=>{let h=d.toLowerCase();if(!h)return;let m=0;for(;m<s.length;){let g=s.indexOf(h,m);if(g===-1)break;o.push({start:g,end:g+h.length}),m=g+h.length}}),o.length===0)return u(e);o.sort((d,h)=>d.start!==h.start?d.start-h.start:h.end-h.start-(d.end-d.start));let a=[],l=-1;o.forEach(d=>{d.start>=l&&(a.push(d),l=d.end)});let i="",c=0;return a.forEach(d=>{c<d.start&&(i+=u(e.slice(c,d.start))),i+=`<${n}${r}>${u(e.slice(d.start,d.end))}</${n}>`,c=d.end}),c<e.length&&(i+=u(e.slice(c))),i}function z(e,t,n="smq"){if(!e||e==="#")return e;if(St(e))return"#";let r=(t||"").trim();if(!r||!n||/^(mailto:|tel:)/i.test(e))return e;let[s,o]=e.split("#",2),[a,l]=s.split("?",2),i=new URLSearchParams(l||"");i.set(n,r);let c=i.toString(),d=o?`#${o}`:"";return`${a}${c?`?${c}`:""}${d}`}function St(e){let t=String(e).replace(/[\t\n\r]/g,"").replace(/^[\u0000-\u0020]+/,"");return/^(javascript|data|vbscript):/i.test(t)}var Tt=0;function le(e="sm"){return`${e}-${++Tt}-${Date.now().toString(36)}`}function He(e){let t=document.createElement("div");return t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-atomic","true"),t.className="sm-sr-only",e.appendChild(t),t}function Y(e,t,n=100){e&&(e.textContent="",setTimeout(()=>{e.textContent=t},n))}function de(e,t){return e===0?`No results found for "${t}"`:e===1?`1 result found for "${t}"`:`${e} results found for "${t}"`}function Pe(){return"Searching..."}function Me(e){return e===0?"No recent searches":e===1?"1 recent search available":`${e} recent searches available`}function te(e,{expanded:t,activeDescendant:n,listboxId:r}){e.setAttribute("aria-expanded",String(t)),e.setAttribute("aria-controls",r),n?e.setAttribute("aria-activedescendant",n):e.removeAttribute("aria-activedescendant")}function F(e,t){return`${e}-option-${t}`}function Ne(e,t){if(!e||!t)return;let n=e.getBoundingClientRect(),r=t.getBoundingClientRect();n.top<r.top?e.scrollIntoView({block:"nearest",behavior:"smooth"}):n.bottom>r.bottom&&e.scrollIntoView({block:"nearest",behavior:"smooth"})}function At(e,t,n={}){let{groupResults:r=!1,resultLayout:s="default",listboxId:o}=n;if(!e||e.length===0)return"";if(s==="hierarchical")return Mt(e,t,n);if(r){let a=Se(e),l=0;return Object.entries(a).map(([i,c])=>`
        ...
        `:`
        <a class="sm-result-item${T}" id="${v}" role="option" aria-selected="false" href="${u(p)}" data-index="${t}" data-source-index="${u(E)}"${B} data-title="${u(b)}">
            ${H}
            <div class="sm-result-content">
                <span class="sm-result-title">${U}</span>
                ${$?`<span class="sm-result-desc">${$}</span>`:""}
    ...
    `}function Ue(e){let t=[],n=e.backend?e.backend.toLowerCase():"";if((e._index||e.index)&&t.push(w("index",e._index||e.index,"index")),e.backend&&t.push(w("backend",n,"backend",n)),e.elementId&&t.push(w("element",e.elementId,"generic")),e.backendId&&t.push(w("hit",e.backendId,"generic")),e.score!==void 0&&e.score!==null){let r=typeof e.score=="number"?e.score.toFixed(2):e.score;t.push(w("score",r,"score"))}if(e.site&&t.push(w("site",e.site,"generic")),e.language&&t.push(w("lang",e.language,"generic")),e.matchedIn&&Array.isArray(e.matchedIn)&&e.matchedIn.length>0){let r=e.matchedIn.join(", ");t.push(w("matched",r,"matched"))}return e.promoted&&t.push(w("promoted","yes","promoted")),e.boosted&&t.push(w("boosted","yes","boosted")),t.length===0?"":`<div class="sm-debug-info">${t.join("")}</div>`}function O(e,t){let n=Array.isArray(e.matchedPhrases)?e.matchedPhrases:[],r=e.matchedTerms,s=[];r&&(t==="title"&&Array.isArray(r.title)&&r.title.length>0?s=r.title:t==="snippet"&&Array.isArray(r.content)&&r.content.length>0?s=r.content:s=[...Array.isArray(r.title)?r.title:[],...Array.isArray(r.content)?r.content:[]]);let o=[...n,...s];return o.length>0?o:null}function he(e,t,n,r){return K(t,n,r)}function w(e,t,n,r=""){let s=r?` data-backend="${u(r)}"`:"";return`<span class="sm-debug-item"><span class="sm-debug-label">${u(e)}</span><span class="sm-debug-value" data-type="${u(n)}"${s}>${u(String(t))}</span></span>`}function Dt(e,t={}){let{showBadge:n=!0,badgeText:r="Featured",badgePosition:s="top-right"}=t;return!e.promoted||!n?"":`<span class="sm-promoted-badge ${`sm-promoted-badge--${s}`}">${u(r)}</span>`}function ue(e){return!!(e&&typeof e=="object"&&["heading","intro","promoted-page"].includes(String(e.sectionType||"")))}function It(e){return Array.isArray(e)&&e.some(ue)}function Et(e,t){let n=new Map,r=[];return e.forEach((s,o)=>{if(!ue(s)){r.push({type:"single",item:s,order:o,score:N(s)});return}let a=Lt(s);if(!n.has(a)){let c={hits:[],order:o,score:N(s)};n.set(a,c),r.push({type:"section-group",key:a,order:o,score:c.score})}let l=n.get(a);l.hits.push(s),l.score=Math.max(l.score,N(s));let i=r.find(c=>c.type==="section-group"&&c.key===a);i&&(i.score=l.score)}),r.map(s=>{if(s.type==="section-group"){let o=n.get(s.key);return{...s,item:Bt(o.hits,t)}}return s}).sort((s,o)=>{let a=ce(o.score,s.score);return a!==0?a:s.order-o.order}).map(s=>s.item)}function Bt(e,t){let n=[...e].sort((d,h)=>M(d)-M(h)),r=n.find(d=>d.sectionType==="intro")||null,s=[...e].sort((d,h)=>{let m=ce(N(h),N(d));return m!==0?m:M(d)-M(h)})[0]||n[0]||{},o=r||s,a=G(o),l=o.siteId??"",i=Number.isFinite(t)&&t>0?t:3,c=n.filter(d=>d.sectionType==="heading").sort((d,h)=>{let m=ce(N(h),N(d));return m!==0?m:M(d)-M(h)}).slice(0,i).sort((d,h)=>M(d)-M(h)).map(Rt);return{...o,elementId:a||o.elementId,backendId:r?.backendId||o.backendId||$t(a,l),title:o.title||o.sectionTitle||o.name||"Untitled",url:o.url||"#",snippet:r&&r.snippet||null,score:N(s),headings:c,__sectionHitGroup:!0,__useBackendDomId:!0}}function Rt(e){let t=Number.parseInt(e.sectionLevel,10),n=Number.isFinite(t)?t:2;return{title:e.sectionTitle||e.title||"",text:e.sectionTitle||e.title||"",id:e.sectionAnchor||e.sectionId||"",level:n,url:e.sectionUrl||e.url||null,snippet:e.snippet||null,backendId:e.backendId||"",elementId:G(e),sectionType:e.sectionType,_index:e._index,index:e.index,matchedTerms:e.matchedTerms,matchedPhrases:e.matchedPhrases,__useBackendDomId:!0}}function Lt(e){return[G(e)||qe(e)||"",e.siteId??""].join(":")}function M(e){let t=Number.parseInt(e.sectionIndex,10);return Number.isFinite(t)?t:Number.MAX_SAFE_INTEGER}function N(e){let t=Number(e?.score);return Number.isFinite(t)?t:Number.NEGATIVE_INFINITY}function ce(e,t){return e===t?0:e>t?1:-1}function $t(e,t){let n=e||"unknown";return t!=null&&String(t)!==""?`${n}_${t}`:String(n)}function qe(e,t=null){return e?.backendId||t?.backendId||""}function G(e,t=null){return e?.elementId||t?.elementId||""}function ge(e,t=null){let n=qe(e,t)||G(e,t),r=G(e,t);return` data-id="${u(n)}" data-element-id="${u(r)}"`}function _(){return`<svg class="sm-result-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
    ...
    </svg>`}function Mt(e,t,n={}){let{hierarchyGroupBy:r="",hierarchyStyle:s="tree",hierarchyDisplay:o="individual",maxHeadingsPerResult:a=3,listboxId:l}=n,i=s==="tree",c=s!=="none",d=It(e)?Et(e,a):e,m=Te(d,r||""),g=0;return Object.entries(m).map(([b,x])=>{let f=x.map(p=>{let I=g++,v=Nt(p,I,t,n),k="",E=p.headings||[],B=p.__sectionHitGroup?E:E.slice(0,a);if(B.length>0){let $=Math.min(...B.map(T=>T.level||2)),H=B.map(T=>i?(T.level||2)-$:0);k=B.map((T,P)=>{let R=H[P],V=!H.slice(P+1).some(q=>q===R),W=[];if(i){let q=H.slice(P+1);for(let A=0;A<R;A++)q.some(X=>X===A)&&W.push(A)}return Ot(p,T,g++,t,n,V,R,W)}).join("")}let C=!!k;return`
        ...
        `}).join("")}function Nt(e,t,n,r={}){let{listboxId:s,enableHighlighting:o=!0,highlightTag:a="mark",highlightClass:l="",debug:i=!1,persistQueryInUrl:c=!1,queryParamName:d="smq"}=r,h=e.title||e.name||"Untitled",m=e.snippet||"",g=e.url||"#",b=z(g,n,c?d:""),x=F(s,t),f=e._index||e.index||"",p=ge(e),I={enabled:o,tag:a,className:l},v=K(h,n,{...I,terms:O(e,"title")}),k=m?he(e,m,n,{...I,terms:O(e,"snippet")}):"",E=i?Ue(e):"",C=e.headings&&e.headings.length>0?Ht():Pt();return i?`
    ...
    `}function Ot(e,t,n,r,s={},o=!1,a=0,l=[]){let{listboxId:i,enableHighlighting:c=!0,highlightTag:d="mark",highlightClass:h="",debug:m=!1,persistQueryInUrl:g=!1,queryParamName:b="smq"}=s,f=(t.title||t.text||"").replace(/^#+\s*/,""),p=t.snippet||"",I=Number.parseInt(t.level,10),v=Number.isFinite(I)?Math.min(Math.max(I,1),6):2,k=t.id||(f?Ft(f):""),E=e.url||"#",B=t.url||(k?`${E}#${k}`:E),C=z(B,r,g?b:""),U=F(i,n),$=t._index||t.index||e._index||e.index||"",H=ge(t,e),T={enabled:c,tag:d,className:h},P=K(f,r,{...T,terms:O(t,"title")||O(e,"title")}),R=p?he(e,p,r,{...T,terms:O(t,"snippet")||O(e,"snippet")}):"",V=o?" sm-hierarchy-child-row-last":"",W=l.map(A=>`<div class="sm-hierarchy-guide" style="--sm-guide-depth:${A}" aria-hidden="true"></div>`).join(""),q="";if(m){let A=[];A.push(w("h",v,"generic")),k&&A.push(w("anchor",k,"generic"));let X=G(t,e);X&&A.push(w("parent",X,"generic")),q=`<div class="sm-debug-info">${A.join("")}</div>`}return m?`
            <div class="sm-hierarchy-child-row sm-hierarchy-level-${v} sm-hierarchy-depth-${a}${V}" style="--sm-hierarchy-depth:${a}">
                ${W}
                <a class="sm-result-item sm-hierarchy-child sm-hierarchy-level-${v} sm-debug-enabled" id="${U}" role="option" aria-selected="false" href="${u(C)}" data-index="${n}" data-source-index="${u($)}"${H} data-title="${u(f)}">
                    <div class="sm-result-main">
                        ${Fe()}
                        <div class="sm-result-content">
        ...
        <div class="sm-hierarchy-child-row sm-hierarchy-level-${v} sm-hierarchy-depth-${a}${V}" style="--sm-hierarchy-depth:${a}">
            ${W}
            <a class="sm-result-item sm-hierarchy-child sm-hierarchy-level-${v}" id="${U}" role="option" aria-selected="false" href="${u(C)}" data-index="${n}" data-source-index="${u($)}"${H} data-title="${u(f)}">
                ${Fe()}
                <div class="sm-result-content">
                    <span class="sm-result-title">${P}</span>
                    ${R?`<span class="sm-result-desc">${R}</span>`:""}
    ...
    `}function je(e,t){let{query:n,results:r,recentSearches:s,loading:o,showRecent:a,error:l}=e,{showLoadingIndicator:i=!0}=t,c=n&&n.trim();return o&&i?{html:Ut(),hasResults:!1,showListbox:!1}:l?{html:qt(l),hasResults:!1,showListbox:!1}:c?!r||r.length===0?{html:_e(n),hasResults:!1,showListbox:!1}:{html:At(r,n,t),hasResults:!0,showListbox:!0}:a&&s&&s.length>0?{html:_t(s,t.listboxId),hasResults:!0,showListbox:!0}:{html:_e(""),hasResults:!1,showListbox:!1}}function me(e,t,n=!1){if(!e)return"";let r=[];if(r.push(L("results",t,"generic")),e.took!==void 0){let i=e.took<1?"<1ms":`${Math.round(e.took)}ms`;r.push(L("time",i,"time"))}if(e.cacheEnabled!==void 0&&(e.cacheEnabled?e.cached?r.push(L("cache","hit","cache-hit")):r.push(L("cache","miss","cache-miss")):r.push(L("cache","off","cache-off"))),e.cacheDriver&&r.push(L("storage",e.cacheDriver,"cache-driver",e.cacheDriver)),e.indices&&e.indices.length>0){let i=e.indices.length>2?`${e.indices.length} indices`:e.indices.join(", ");r.push(L("indices",i,"generic"))}if(e.synonymsExpanded){let i=e.expandedQueries?e.expandedQueries.length-1:0;r.push(L("synonyms",`+${i}`,"synonyms"))}let s=e.rulesMatched?.length||0;r.push(L("rules",s,s>0?"rules":"generic"));let o=e.promotionsMatched?.length||0;r.push(L("promoted",o,o>0?"promotions":"generic"));let l=`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">${n?'<path d="M6 9l6 6 6-6"/>':'<path d="M18 15l-6-6-6 6"/>'}</svg>`;return n?`<div class="sm-toolbar-collapsed-bar"><span class="sm-toolbar-collapsed-label">Debug</span>${l}</div>`:`<div class="sm-toolbar-content">${r.join("")}</div><button class="sm-toolbar-toggle" aria-label="Collapse debug panel" aria-expanded="true">${l}</button>`}function L(e,t,n,r=""){let s=r?` data-backend="${u(r)}"`:"";return`<span class="sm-toolbar-item"><span class="sm-toolbar-label">${u(e)}</span><span class="sm-toolbar-value" data-type="${u(n)}"${s}>${u(String(t))}</span></span>`}function ze(e,t){let{onSelect:n,onIndexChange:r,onEscape:s}=e,{listboxId:o}=t;return{handleKeydown(a,l,i){let c=i;switch(a.key){case"ArrowDown":return a.preventDefault(),c=Math.min(i+1,l-1),c!==i&&r&&r(c),c;case"ArrowUp":return a.preventDefault(),c=Math.max(i-1,-1),c!==i&&r&&r(c),c;case"Enter":return a.preventDefault(),i>=0&&n&&n(i),null;case"Escape":return a.preventDefault(),s&&s(),null;default:return null}},getListboxId(){return o}}}function Ge(e,t,n={}){let{scrollContainer:r,inputElement:s,listboxId:o,selectedClass:a="sm-selected"}=n,l=t>=0?F(o,t):null;s&&te(s,{expanded:e.length>0,activeDescendant:l,listboxId:o}),e.forEach((i,c)=>{let d=c===t;i.classList.toggle(a,d),i.setAttribute("aria-selected",String(d)),d&&r&&Ne(i,r)})}function We(e,t){e.forEach((n,r)=>{n.addEventListener("mouseenter",()=>{t&&t(r)})})}var Ke="sm-page-highlight-style",Ye="__smPageHighlightRegistry",Ve="__searchManagerHotkeyHandled",D=null,pe=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.config=null,this.state=ve({...J},this.handleStateChange.bind(this)),this.searchSequence=0,this.debounceTimer=null,this.analyticsIdleTimer=null,this.lastTrackedQuery=null,this.lastSearchCacheState=null,this.listboxId=le("sm-listbox"),this.inputId=le("sm-input"),this.liveRegion=null,this.keyboardNavigator=null,this.elements={},this.handleInput=this.handleInput.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.handleResultClick=this.handleResultClick.bind(this)}get widgetType(){throw new Error("Subclass must implement widgetType getter")}render(){throw new Error("Subclass must implement render()")}getResultsContainer(){throw new Error("Subclass must implement getResultsContainer()")}getInputElement(){throw new Error("Subclass must implement getInputElement()")}getLoadingElement(){return this.elements.loading||null}getDebugToolbarElement(){return this.elements.debugToolbar||null}connectedCallback(){this.config=j(this,this.widgetType),this.state.set({recentSearches:ee(Q(this.config))}),this.keyboardNavigator=ze({onSelect:t=>this.selectResultAtIndex(t),onIndexChange:t=>this.state.set({selectedIndex:t}),onEscape:()=>this.handleEscape()},{listboxId:this.listboxId}),this.applyDestinationPageHighlight()}disconnectedCallback(){this.unregisterOpenWidget(),this.searchSequence++,this.debounceTimer&&(clearTimeout(this.debounceTimer),this.debounceTimer=null)}registerOpenWidget(){D&&D!==this&&typeof D.close=="function"&&D.close({reason:"replace",replacedBy:this,source:"replace"}),D=this}unregisterOpenWidget(){D===this&&(D=null)}claimHotkeyEvent(t,n){return t[Ve]||D&&D!==this&&D.state?.get("isOpen")&&D.config?.hotkey?.toLowerCase()===n?!1:(t[Ve]=!0,!0)}attributeChangedCallback(t,n,r){n!==r&&this.shadowRoot.children.length>0&&(this.config=j(this,this.widgetType),this.render(),this.applyCustomStyles())}handleStateChange(t,n){(n.includes("results")||n.includes("query")||n.includes("recentSearches")||n.includes("error"))&&this.renderResultsContent(),(n.includes("results")||n.includes("meta"))&&this.updateDebugToolbar(),n.includes("selectedIndex")&&this.updateSelectionVisual(),n.includes("loading")&&this.updateLoadingVisual()}handleInput(t){let n=t.target.value;if(this.state.set({query:n,selectedIndex:-1}),this.debounceTimer&&clearTimeout(this.debounceTimer),this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null),!n.trim()){this.state.set({results:[]});return}n.length<this.config.minChars||(this.debounceTimer=setTimeout(()=>{this.executeSearch(n)},this.config.debounce))}async executeSearch(t){let n=++this.searchSequence;this.state.set({loading:!0,error:null}),this.liveRegion&&Y(this.liveRegion,Pe());try{let{results:r,meta:s}=await xe({query:t,endpoint:this.config.searchEndpoint,indices:this.config.indices,siteId:this.config.siteId,maxResults:this.config.maxResults,hideResultsWithoutUrl:this.config.hideResultsWithoutUrl,showCodeSnippets:this.config.showCodeSnippets,snippetMode:this.config.snippetMode,snippetLength:this.config.snippetLength,parseMarkdownSnippets:this.config.parseMarkdownSnippets,debug:this.config.debug,apiKey:this.config.apiKey});if(n!==this.searchSequence)return;this.state.set({results:r,meta:s,loading:!1,selectedIndex:r.length>0?0:-1}),s&&typeof s.cached=="boolean"?this.lastSearchCacheState={cached:s.cached,took:typeof s.took=="number"?s.took:null}:this.lastSearchCacheState=null,this.liveRegion&&Y(this.liveRegion,de(r.length,t)),this.dispatchWidgetEvent("search",{query:t,results:r,meta:s}),this.startAnalyticsIdleTimer(t,r.length)}catch(r){if(n!==this.searchSequence||r.name==="AbortError")return;console.error("Search error:",r),this.state.set({results:[],loading:!1,error:r.message}),this.dispatchWidgetEvent("error",{query:t,error:r.message})}}renderResultsContent(){let t=this.getResultsContainer();if(!t)return;let n=this.state.getAll(),{showRecent:r,groupResults:s,enableHighlighting:o,highlightTag:a,highlightClass:l,showLoadingIndicator:i,debug:c}=this.config,{html:d,hasResults:h,showListbox:m}=je({query:n.query,results:n.results,recentSearches:n.recentSearches,loading:n.loading,error:n.error,showRecent:r},{listboxId:this.listboxId,groupResults:s,enableHighlighting:o,highlightTag:a,highlightClass:l,showLoadingIndicator:i,debug:c,persistQueryInUrl:this.config.highlightDestinationPage&&this.config.persistQueryInUrl,queryParamName:this.config.queryParamName,promotions:this.config.promotions,resultLayout:this.config.resultLayout,hierarchyGroupBy:this.config.hierarchyGroupBy,hierarchyStyle:this.config.hierarchyStyle,hierarchyDisplay:this.config.hierarchyDisplay,maxHeadingsPerResult:this.config.maxHeadingsPerResult});t.innerHTML=d,m?t.setAttribute("role","listbox"):t.removeAttribute("role");let g=this.getInputElement();g&&te(g,{expanded:h,activeDescendant:null,listboxId:this.listboxId}),this.liveRegion&&!n.loading&&(n.query&&n.results.length===0?Y(this.liveRegion,de(0,n.query)):!n.query&&n.recentSearches.length>0&&r&&Y(this.liveRegion,Me(n.recentSearches.length))),this.attachResultHandlers();let b=t.querySelector(".sm-clear-recent");b&&b.addEventListener("click",x=>{x.stopPropagation(),De(Q(this.config)),this.state.set({recentSearches:[]})}),h&&n.results.length>0&&this.state.set({selectedIndex:0})}attachResultHandlers(){let t=this.getResultsContainer();if(!t)return;let n=t.querySelectorAll(".sm-result-item");n.forEach(r=>{r.addEventListener("click",s=>this.handleResultClick(s,r))}),We(n,r=>{this.state.set({selectedIndex:r})})}updateSelectionVisual(){let t=this.getResultsContainer(),n=this.getInputElement();if(!t)return;let r=t.querySelectorAll(".sm-result-item"),s=this.state.get("selectedIndex");Ge(r,s,{scrollContainer:t,inputElement:n,listboxId:this.listboxId})}handleKeydown(t){let n=this.getResultsContainer();if(!n)return;let r=n.querySelectorAll(".sm-result-item"),s=this.state.get("selectedIndex");if(t.key==="Enter"){let o=this.state.get("query"),a=this.state.get("results")||[];o&&a.length>0&&this.trackSearchAnalytics(o,a.length,"enter")}this.keyboardNavigator.handleKeydown(t,r.length,s)}selectResultAtIndex(t){let n=this.getResultsContainer();if(!n)return;let r=n.querySelectorAll(".sm-result-item");t>=0&&r[t]&&r[t].click()}handleEscape(){}handleResultClick(t,n){let r=n.getAttribute("href"),s=n.dataset.url,o=r||s,a=n.dataset.title||n.querySelector(".sm-result-title")?.textContent,l=n.dataset.id,i=n.dataset.elementId||l,c=n.dataset.query||this.state.get("query"),d=n.classList.contains("sm-recent-item"),h=z(o,c,this.config.highlightDestinationPage&&this.config.persistQueryInUrl?this.config.queryParamName:"");if(!d&&c){let g=Ae(Q(this.config),c,{title:a,url:o},this.config.maxRecentSearches);this.state.set({recentSearches:g})}let m=n.dataset.sourceIndex||ye(this.config);if(i&&m&&we({endpoint:this.config.trackClickEndpoint,elementId:i,query:c,index:m,apiKey:this.config.apiKey}),!d&&c&&this.trackSearchAnalytics(c,this.state.get("results")?.length||0,"click"),this.dispatchWidgetEvent("result-click",{id:l,elementId:i,title:a,url:h,query:c,isRecent:d}),o&&o!=="#")d&&(t.preventDefault(),window.location.href=h),this.onResultSelected(h,a,l);else if(c){t.preventDefault();let g=this.getInputElement();g&&(g.value=c,this.state.set({query:c}),this.executeSearch(c))}}onResultSelected(t,n,r){}applyDestinationPageHighlight(){if(!this.config.highlightDestinationPage||typeof window>"u"||typeof document>"u")return;let t=this.config.queryParamName||"smq",n=this.config.destinationHighlightSelector||"main, article, [data-search-content]",r=new URLSearchParams(window.location.search).get(t);if(!r||!r.trim())return;let s=this.getPageHighlightRegistry(),o=`${t}::${n}`;if(s.has(o))return;s.add(o);let a=()=>{this.ensurePageHighlightStyles(),this.highlightDestinationNodes(r.trim(),n,o)};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",a,{once:!0}):window.requestAnimationFrame(a)}ensurePageHighlightStyles(){if(document.getElementById(Ke))return;let t=document.createElement("style");t.id=Ke,t.textContent=`
            .sm-page-highlight {
        ...
        `,document.head.appendChild(t)}highlightDestinationNodes(t,n,r){let s=Array.from(document.querySelectorAll(n));if(s.length===0)return;let o=[...new Set(ie(t).map(i=>i.trim()).filter(i=>i.length>=2))];if(o.length===0)return;let a=o.map(i=>$e(i)).filter(Boolean).sort((i,c)=>c.length-i.length).join("|");if(!a)return;let l=new RegExp(`(${a})`,"gi");s.forEach(i=>{i.getAttribute("data-sm-highlighted")!==r&&(this.highlightTextNodesInScope(i,l),i.setAttribute("data-sm-highlighted",r))})}highlightTextNodesInScope(t,n){let r=document.createTreeWalker(t,NodeFilter.SHOW_TEXT,{acceptNode:o=>{let a=o.nodeValue;if(!a||!a.trim())return NodeFilter.FILTER_REJECT;let l=o.parentElement;return!l||l.closest("script, style, noscript, textarea, mark, .sm-highlight, .sm-page-highlight, search-modal")?NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT}}),s=[];for(;r.nextNode();)s.push(r.currentNode);s.forEach(o=>{let a=o.nodeValue||"";if(n.lastIndex=0,!n.test(a))return;let l=document.createDocumentFragment(),i=0;n.lastIndex=0;let c=a.matchAll(n);for(let d of c){let h=d[0],m=d.index??-1;if(m<0)continue;m>i&&l.appendChild(document.createTextNode(a.slice(i,m)));let g=document.createElement("mark");g.className="sm-highlight sm-page-highlight",g.textContent=h,l.appendChild(g),i=m+h.length}i<a.length&&l.appendChild(document.createTextNode(a.slice(i))),o.parentNode?.replaceChild(l,o)})}getPageHighlightRegistry(){let t=window[Ye];if(t instanceof Set)return t;let n=new Set;return window[Ye]=n,n}updateLoadingVisual(){let t=this.getLoadingElement();if(t){let n=this.state.get("loading"),r=this.config?.showLoadingIndicator!==!1;t.hidden=!n||!r}}updateDebugToolbar(){let t=this.getDebugToolbarElement();if(!t)return;let{debug:n}=this.config,r=this.state.getAll();if(!n||!r.meta||r.results.length===0){t.hidden=!0;return}let s=t.classList.contains("sm-collapsed");t.innerHTML=me(r.meta,r.results.length,s),t.hidden=!1,s&&t.classList.add("sm-collapsed"),this.attachDebugToolbarHandlers(t)}attachDebugToolbarHandlers(t){let n=t.querySelector(".sm-toolbar-toggle");n&&n.addEventListener("click",s=>{s.preventDefault(),s.stopPropagation(),this.toggleDebugToolbar()});let r=t.querySelector(".sm-toolbar-collapsed-bar");r&&r.addEventListener("click",s=>{s.preventDefault(),s.stopPropagation(),this.toggleDebugToolbar()})}toggleDebugToolbar(){let t=this.getDebugToolbarElement();if(!t)return;let n=t.classList.toggle("sm-collapsed"),r=this.state.getAll();t.innerHTML=me(r.meta,r.results.length,n),n&&t.classList.add("sm-collapsed"),this.attachDebugToolbarHandlers(t)}applyCustomStyles(){if(!this.config)return;let t=this.shadowRoot.host,{theme:n,styles:r,resultTitleLines:s,resultDescLines:o}=this.config;Re(t,r,n),s&&t.style.setProperty("--sm-result-title-lines",String(s)),o&&t.style.setProperty("--sm-result-desc-lines",String(o))}initializeLiveRegion(){this.liveRegion=He(this.shadowRoot)}startAnalyticsIdleTimer(t,n){this.analyticsIdleTimer&&clearTimeout(this.analyticsIdleTimer);let r=this.config.idleTimeout;!r||r<=0||(this.analyticsIdleTimer=setTimeout(()=>{this.trackSearchAnalytics(t,n,"idle")},r))}trackSearchAnalytics(t,n,r){!t||t===this.lastTrackedQuery||(this.lastTrackedQuery=t,this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null),Ce({endpoint:this.config.trackSearchEndpoint,query:t,indices:this.config.indices,resultsCount:n,trigger:r,source:this.config.source,siteId:this.config.siteId,cached:this.lastSearchCacheState?.cached,took:this.lastSearchCacheState?.took,apiKey:this.config.apiKey}))}resetAnalyticsTracking(){this.lastTrackedQuery=null,this.lastSearchCacheState=null,this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null)}dispatchWidgetEvent(t,n={}){this.dispatchEvent(new CustomEvent(`search-${t}`,{bubbles:!0,composed:!0,detail:n}))}},Xe=pe;var Qe=`/**
...
`+Ze,be=class extends Xe{constructor(){super(),this.externalTrigger=null,this.previouslyFocused=null,this.open=this.open.bind(this),this.close=this.close.bind(this),this.toggle=this.toggle.bind(this),this.handleGlobalKeydown=this.handleGlobalKeydown.bind(this),this.handleBackdropClick=this.handleBackdropClick.bind(this),this.handleTriggerClick=this.handleTriggerClick.bind(this),this.handleExternalTriggerClick=this.handleExternalTriggerClick.bind(this),this.handleCloseClick=this.handleCloseClick.bind(this)}get widgetType(){return"modal"}static get observedAttributes(){return ke("modal")}connectedCallback(){super.connectedCallback(),this.render(),this.attachEventListeners()}disconnectedCallback(){this.state.get("isOpen")&&this.close({reason:"disconnect",source:"disconnect",restoreFocus:!1}),super.disconnectedCallback(),this.detachEventListeners()}attributeChangedCallback(t,n,r){if(n===r||this.shadowRoot.children.length===0)return;if(t==="theme"){this.config=j(this,this.widgetType),this.shadowRoot.host.setAttribute("data-theme",this.config.theme),this.applyCustomStyles();return}let s=this.state.get("isOpen"),o=this.state.get("query")||"";this.detachEventListeners(),this.config=j(this,this.widgetType),this.render(),this.attachEventListeners(),s&&(this.registerOpenWidget(),this.elements.backdrop.hidden=!1,this.elements.trigger.setAttribute("aria-expanded","true"),this.elements.input.value=o,this.renderResultsContent(),this.updateLoadingVisual(),this.updateDebugToolbar(),this.updateSelectionVisual(),document.body.style.overflow=this.config.preventBodyScroll?"hidden":"",requestAnimationFrame(()=>{this.isConnected&&this.elements.input.focus()}))}render(){let{theme:t,placeholder:n,showTrigger:r}=this.config,s=u(this.getHotkeyDisplay()),o=u(n||"");this.shadowRoot.innerHTML=`
            ...
            <button class="sm-trigger" part="trigger" aria-label="Open search" aria-haspopup="dialog" aria-expanded="false" ${r?"":'style="display: none;"'}>
                ...
                <kbd class="sm-trigger-kbd" aria-hidden="true">${s}</kbd>
            </button>
