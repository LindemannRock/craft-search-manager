"use strict";var SearchModalWidget=(()=>{var le=Object.defineProperty;var dt=Object.getOwnPropertyDescriptor;var ct=Object.getOwnPropertyNames;var ht=Object.prototype.hasOwnProperty;var mt=(e,t)=>{for(var r in t)le(e,r,{get:t[r],enumerable:!0})},ut=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of ct(t))!ht.call(e,o)&&o!==r&&le(e,o,{get:()=>t[o],enumerable:!(n=dt(t,o))||n.enumerable});return e};var gt=e=>ut(le({},"__esModule",{value:!0}),e);var tr={};mt(tr,{default:()=>er});var pt={indexHandles:[],placeholder:"Search...",theme:"light",resultsLimit:20,searchDebounceMs:200,searchMinChars:2,recentlyViewedEnabled:!0,recentlyViewedLimit:5,resultsGroupingEnabled:!0,siteId:"",apiKey:"",searchEndpoint:"/actions/search-manager/api/search",trackClickEndpoint:"/actions/search-manager/search/track-click",trackSearchEndpoint:"/actions/search-manager/search/track-search",analyticsIdleTimeoutMs:1500,analyticsSource:"",highlightResultsEnabled:!0,highlightTag:"mark",highlightClass:"",resultsRequireUrl:!1,snippetIncludeCodeBlocks:!1,snippetMode:"balanced",loadingIndicatorEnabled:!0,debugEnabled:!1,snippetMaxLength:150,snippetCleanMarkdown:!1,highlightDestinationPersistQuery:!0,highlightDestinationQueryParam:"smq",highlightDestinationEnabled:!0,highlightDestinationContentSelector:"main, article, [data-search-content]",resultsLayout:"default",hierarchyGroupBy:"",hierarchyStyle:"tree",hierarchyDisplay:"individual",hierarchyMaxHeadings:3,styles:{},translations:{},promotionDisplay:"none",promotionBadgeText:"Featured",promotionBadgePosition:"inline"},bt={triggerHotkey:"k",triggerEnabled:!0,triggerLabel:"Search",triggerSelector:"",modalBackdropOpacity:50,modalBackdropBlurEnabled:!0,modalPreventBodyScroll:!0};function ft(e){return{...pt,...{modal:bt}[e]||{}}}function D(e,t=!1){if(e==null)return t;if(typeof e=="boolean")return e;if(typeof e=="number")return e!==0;if(e==="")return!0;let r=String(e).trim().toLowerCase();return["1","true","on","yes"].includes(r)?!0:["0","false","off","no"].includes(r)?!1:t}function P(e,t=0){if(e==null)return t;let r=Number.parseInt(e,10);return Number.isNaN(r)?t:r}function Te(e,t,r){return t.includes(e)?e:r}function de(e,t={}){if(!e)return t;try{return JSON.parse(e)}catch(r){return console.warn("SearchWidget: Invalid JSON attribute",r),t}}function vt(e){return e?e.split(",").map(t=>t.trim()).filter(Boolean):[]}function te(e){return e.indexHandles.length>0?e.indexHandles.join(","):"all"}function Ae(e){return e.indexHandles.length===1?e.indexHandles[0]:""}function K(e,t="modal"){let r=de(e.getAttribute("snippet-defaults"),{}),n={...ft(t),...Object.fromEntries(Object.entries(r).filter(([p])=>["snippetIncludeCodeBlocks","snippetMode","snippetMaxLength","snippetCleanMarkdown","minSnippetLength","maxSnippetLength","snippetModes"].includes(p)))},o=Array.isArray(n.snippetModes)?n.snippetModes:["early","balanced","deep"],s=Number.isFinite(Number(n.minSnippetLength))?Number(n.minSnippetLength):50,i=Number.isFinite(Number(n.maxSnippetLength))?Number(n.maxSnippetLength):1e3,d=Math.min(i,Math.max(s,P(e.getAttribute("snippet-max-length"),n.snippetMaxLength))),a=e.getAttribute("snippet-mode")||n.snippetMode,l=e.getAttribute("index-handles")||"",u={indexHandles:vt(l),placeholder:e.getAttribute("placeholder")||n.placeholder,theme:e.getAttribute("theme")||n.theme,siteId:e.getAttribute("site-id")||n.siteId,apiKey:e.getAttribute("api-key")||n.apiKey,analyticsSource:e.getAttribute("analytics-source")||n.analyticsSource,highlightTag:e.getAttribute("highlight-tag")||n.highlightTag,highlightClass:e.getAttribute("highlight-class")||n.highlightClass,searchEndpoint:n.searchEndpoint,trackClickEndpoint:n.trackClickEndpoint,trackSearchEndpoint:n.trackSearchEndpoint,resultsLimit:P(e.getAttribute("results-limit"),n.resultsLimit),searchDebounceMs:P(e.getAttribute("search-debounce-ms"),n.searchDebounceMs),searchMinChars:P(e.getAttribute("search-min-chars"),n.searchMinChars),recentlyViewedLimit:P(e.getAttribute("recently-viewed-limit"),n.recentlyViewedLimit),analyticsIdleTimeoutMs:P(e.getAttribute("analytics-idle-timeout-ms"),n.analyticsIdleTimeoutMs),recentlyViewedEnabled:D(e.getAttribute("recently-viewed-enabled"),n.recentlyViewedEnabled),resultsGroupingEnabled:D(e.getAttribute("results-grouping-enabled"),n.resultsGroupingEnabled),highlightResultsEnabled:D(e.getAttribute("highlight-results-enabled"),n.highlightResultsEnabled),loadingIndicatorEnabled:D(e.getAttribute("loading-indicator-enabled"),n.loadingIndicatorEnabled),resultsRequireUrl:D(e.getAttribute("results-require-url"),n.resultsRequireUrl),snippetIncludeCodeBlocks:D(e.getAttribute("snippet-include-code-blocks"),n.snippetIncludeCodeBlocks),debugEnabled:D(e.getAttribute("debug-enabled"),n.debugEnabled),snippetMode:o.includes(a)?a:n.snippetMode,snippetMaxLength:d,snippetCleanMarkdown:D(e.getAttribute("snippet-clean-markdown"),n.snippetCleanMarkdown),highlightDestinationPersistQuery:D(e.getAttribute("highlight-destination-persist-query"),n.highlightDestinationPersistQuery),highlightDestinationEnabled:D(e.getAttribute("highlight-destination-enabled"),n.highlightDestinationEnabled),highlightDestinationQueryParam:e.getAttribute("highlight-destination-query-param")||n.highlightDestinationQueryParam,highlightDestinationContentSelector:e.getAttribute("highlight-destination-content-selector")||n.highlightDestinationContentSelector,resultsLayout:e.getAttribute("results-layout")||n.resultsLayout,hierarchyGroupBy:e.getAttribute("hierarchy-group-by")||n.hierarchyGroupBy,hierarchyStyle:e.getAttribute("hierarchy-style")||n.hierarchyStyle,hierarchyDisplay:e.getAttribute("hierarchy-display")||n.hierarchyDisplay,hierarchyMaxHeadings:P(e.getAttribute("hierarchy-max-headings"),n.hierarchyMaxHeadings),styles:de(e.getAttribute("styles"),n.styles),translations:de(e.getAttribute("translations"),n.translations),promotionDisplay:Te(e.getAttribute("promotion-display"),["badge","tint","none"],n.promotionDisplay),promotionBadgeText:e.getAttribute("promotion-badge-text")||n.promotionBadgeText,promotionBadgePosition:Te(e.getAttribute("promotion-badge-position"),["inline","above","below"],n.promotionBadgePosition)};return t==="modal"&&Object.assign(u,{triggerHotkey:e.getAttribute("trigger-hotkey")||n.triggerHotkey,triggerLabel:e.getAttribute("trigger-label")||n.triggerLabel,triggerSelector:e.getAttribute("trigger-selector")||n.triggerSelector,modalBackdropOpacity:P(e.getAttribute("modal-backdrop-opacity"),n.modalBackdropOpacity),triggerEnabled:D(e.getAttribute("trigger-enabled"),n.triggerEnabled),modalBackdropBlurEnabled:D(e.getAttribute("modal-backdrop-blur-enabled"),n.modalBackdropBlurEnabled),modalPreventBodyScroll:D(e.getAttribute("modal-prevent-body-scroll"),n.modalPreventBodyScroll)}),u}function Be(e="modal"){let t=["index-handles","placeholder","theme","results-limit","search-debounce-ms","search-min-chars","recently-viewed-enabled","recently-viewed-limit","results-grouping-enabled","site-id","analytics-idle-timeout-ms","analytics-source","highlight-results-enabled","highlight-tag","highlight-class","results-require-url","snippet-include-code-blocks","snippet-mode","loading-indicator-enabled","debug-enabled","styles","translations","promotion-display","promotion-badge-text","promotion-badge-position","results-layout","hierarchy-group-by","hierarchy-style","hierarchy-display","hierarchy-max-headings","snippet-max-length","snippet-clean-markdown","highlight-destination-persist-query","highlight-destination-query-param","highlight-destination-enabled","highlight-destination-content-selector"],n={modal:["trigger-hotkey","trigger-enabled","trigger-label","trigger-selector","modal-backdrop-opacity","modal-backdrop-blur-enabled","modal-prevent-body-scroll"]};return[...t,...n[e]||[]]}var re={isOpen:!1,query:"",results:[],recentlyViewed:[],selectedIndex:-1,loading:!1,error:null,meta:null};function Ee(e={},t=null){let r={...re,...e};return{get(n){return r[n]},getAll(){return{...r}},set(n){let o=[];return Object.keys(n).forEach(s=>{let i=r[s],d=n[s];ne(i,d)||o.push(s)}),o.length>0&&(r={...r,...n},t&&t(r,o)),o},reset(n=e){let o={...re,...n},s=Object.keys(o).filter(i=>!ne(r[i],o[i]));s.length>0&&(r=o,t&&t(r,s))},is(n,o){return r[n]===o},toggle(n){let o=!r[n];return this.set({[n]:o}),o}}}function ne(e,t){if(e===t)return!0;if(e==null||t==null)return!1;if(Array.isArray(e)&&Array.isArray(t))return e.length!==t.length?!1:e.every((r,n)=>ne(r,t[n]));if(typeof e=="object"&&typeof t=="object"){let r=Object.keys(e),n=Object.keys(t);return r.length!==n.length?!1:r.every(o=>ne(e[o],t[o]))}return!1}function g(e,t,r={}){let n=e&&Object.prototype.hasOwnProperty.call(e,t)?e[t]:t;return String(n).replace(/\{([a-zA-Z0-9_]+)\}/g,(o,s)=>Object.prototype.hasOwnProperty.call(r,s)?String(r[s]):o)}async function Ie({query:e,endpoint:t,indexHandles:r=[],siteId:n="",resultsLimit:o=10,resultsRequireUrl:s=!1,snippetIncludeCodeBlocks:i=!1,snippetMode:d="",snippetMaxLength:a=0,snippetCleanMarkdown:l=!1,debugEnabled:c=!1,apiKey:u="",signal:p,translations:b={}}){let f=new URLSearchParams({q:e,resultsLimit:o.toString()});r.length>0&&f.append("indexHandles",r.join(",")),n&&f.append("siteId",n),s&&f.append("resultsRequireUrl","1"),i&&f.append("snippetIncludeCodeBlocks","1"),d&&f.append("snippetMode",d),a&&f.append("snippetMaxLength",String(a)),l&&f.append("snippetCleanMarkdown","1"),c&&f.append("debugEnabled","1"),f.append("skipAnalytics","1");let m=t.includes("?")?"&":"?",y={Accept:"application/json"};u&&(y["X-Search-Manager-Key"]=u);let v=await fetch(`${t}${m}${f}`,{signal:p,headers:y});if(!v.ok)throw new Error(await yt(v,b));let k=await v.json();return k.error&&console.warn("Search warning:",k.error),{results:k.results||k.hits||[],total:k.total||0,meta:k.meta||null,error:k.error||null}}async function yt(e,t={}){let r=await xt(e);return e.status===401?r||g(t,"Search requires an API key."):e.status===403?r||g(t,"This API key cannot access this search."):e.status===429?r||g(t,"Search rate limit exceeded. Try again in a moment."):r||g(t,"Search failed.")}async function xt(e){try{if((e.headers.get("content-type")||"").includes("application/json")){let r=await e.json(),n=r.error||r.message||"";return typeof n=="string"?n.slice(0,240):""}}catch{return""}return""}function $e({endpoint:e,elementId:t,query:r,index:n,apiKey:o=""}){if(!(!t||!e))try{let s=new FormData;s.append("elementId",t),s.append("query",r),s.append("index",n);let i={Accept:"application/json"};o&&(i["X-Search-Manager-Key"]=o),fetch(e,{method:"POST",body:s,headers:i}).catch(()=>{})}catch{}}function Le({endpoint:e,query:t,indexHandles:r=[],resultsCount:n=0,trigger:o="unknown",analyticsSource:s="",siteId:i="",cached:d,took:a,apiKey:l=""}){if(!(!t||!e))try{let c=new FormData;c.append("q",t),c.append("indexHandles",r.join(",")),c.append("resultsCount",n.toString()),c.append("trigger",o),c.append("analyticsSource",s||"frontend-widget"),i&&c.append("siteId",i),typeof d=="boolean"&&c.append("cached",d?"1":"0"),typeof a=="number"&&Number.isFinite(a)&&a>=0&&c.append("took",a.toString());let u={Accept:"application/json"};l&&(u["X-Search-Manager-Key"]=l),fetch(e,{method:"POST",body:c,headers:u}).catch(()=>{})}catch{}}function Re(e){let t={};return e.forEach(r=>{let n=r.source||r.entrySection||r.type||"Results";t[n]||(t[n]=[]),t[n].push(r)}),t}function _e(e,t){let r={};return e.forEach(n=>{let o=(t?n[t]:null)||n.source||n.entrySection||n.type||"Results";r[o]||(r[o]=[]),r[o].push(n)}),r}var kt="sm-recently-viewed-";function ce(e){return`${kt}${e||"default"}`}function oe(e){try{let t=ce(e),r=localStorage.getItem(t);return r?JSON.parse(r):[]}catch{return[]}}function Me(e,t,r=null,n=5){if(!t||!t.trim())return oe(e);let o=ce(e),s={query:t.trim(),title:r?.title||t,url:r?.url||null,timestamp:Date.now()},i=oe(e);i=i.filter(d=>d.query!==s.query),i.unshift(s),i=i.slice(0,n);try{localStorage.setItem(o,JSON.stringify(i))}catch{}return i}function Pe(e){try{let t=ce(e);localStorage.removeItem(t)}catch{}}var He={spinnerColor:"#3b82f6",spinnerColorDark:"#60a5fa",modalBg:"#ffffff",modalBgDark:"#1f2937",modalBorderRadius:"12",modalBorderWidth:"1",modalBorderColor:"#e5e7eb",modalBorderColorDark:"#374151",modalShadow:"0 25px 50px -12px rgba(0, 0, 0, 0.25)",modalShadowDark:"0 25px 50px -12px rgba(0, 0, 0, 0.5)",modalMaxWidth:"640",modalMaxHeight:"80",modalPaddingX:"16",modalPaddingY:"16",headerBg:"transparent",headerBgDark:"transparent",headerBorderColor:"#e5e7eb",headerBorderColorDark:"#374151",headerBorderWidth:"1",headerBorderRadius:"0",headerPaddingX:"16",headerPaddingY:"12",inputBg:"#ffffff",inputBgDark:"#1f2937",inputTextColor:"#111827",inputTextColorDark:"#f9fafb",inputPlaceholderColor:"#9ca3af",inputPlaceholderColorDark:"#9ca3af",inputBorderColor:"transparent",inputBorderColorDark:"transparent",inputFontSize:"16",inputBorderRadius:"0",inputBorderWidth:"0",inputPaddingX:"0",inputPaddingY:"0",resultBg:"transparent",resultBgDark:"transparent",resultBorderColor:"#e5e7eb",resultBorderColorDark:"#374151",resultActiveBg:"#e5e7eb",resultActiveBgDark:"#4b5563",resultActiveBorderColor:"#e5e7eb",resultActiveBorderColorDark:"#374151",resultActiveTextColor:"#111827",resultActiveTextColorDark:"#f9fafb",resultActiveDescColor:"#4b5563",resultActiveDescColorDark:"#d1d5db",resultActiveMutedColor:"#6b7280",resultActiveMutedColorDark:"#d1d5db",resultTextColor:"#111827",resultTextColorDark:"#f9fafb",resultDescColor:"#4b5563",resultDescColorDark:"#d1d5db",resultMutedColor:"#6b7280",resultMutedColorDark:"#d1d5db",resultGap:"8",resultBorderWidth:"0",resultPaddingX:"12",resultPaddingY:"12",resultBorderRadius:"8",triggerBg:"#ffffff",triggerBgDark:"#374151",triggerTextColor:"#374151",triggerTextColorDark:"#d1d5db",triggerBorderRadius:"8",triggerBorderWidth:"1",triggerBorderColor:"#d1d5db",triggerBorderColorDark:"#4b5563",triggerHoverBg:"#f9fafb",triggerHoverBgDark:"#4b5563",triggerHoverTextColor:"#111827",triggerHoverTextColorDark:"#f9fafb",triggerHoverBorderColor:"#3b82f6",triggerHoverBorderColorDark:"#60a5fa",triggerPaddingX:"12",triggerPaddingY:"8",triggerFontSize:"14",kbdBg:"#f3f4f6",kbdBgDark:"#4b5563",kbdTextColor:"#4b5563",kbdTextColorDark:"#e5e7eb",kbdBorderRadius:"4",backdropOpacity:"50",backdropBlur:"1",highlightResultsEnabled:"1",highlightTag:"",highlightClass:"",highlightBgLight:"fef08a",highlightColorLight:"854d0e",highlightBgDark:"854d0e",highlightColorDark:"fef08a",highlightActiveBgLight:"",highlightActiveColorLight:"",highlightActiveBgDark:"",highlightActiveColorDark:"",iconColor:"#3b82f6",iconColorDark:"#60a5fa",hierarchyConnectorColor:"",hierarchyConnectorColorDark:"",searchIconColor:"",searchIconColorDark:"",clearIconColor:"",clearIconColorDark:"",resultIconColor:"",resultIconColorDark:"",arrowColor:"",arrowColorDark:"",iconActiveColor:"",iconActiveColorDark:"",resultIconActiveColor:"",resultIconActiveColorDark:"",hierarchyConnectorActiveColor:"",hierarchyConnectorActiveColorDark:"",promotedBg:"#2563eb",promotedBgDark:"#2563eb",promotedColor:"#ffffff",promotedColorDark:"#ffffff",promotedActiveBg:"",promotedActiveBgDark:"",promotedActiveColor:"",promotedActiveColorDark:"",promotedBorderColor:"",promotedBorderColorDark:"",promotedPaddingX:"6",promotedPaddingY:"2",promotedBorderRadius:"4",promotedBorderWidth:"0",promotedTintBg:"#eff6ff",promotedTintBgDark:"#1e3a8a",promotedTintTextColor:"",promotedTintTextColorDark:"",promotedTintActiveBg:"",promotedTintActiveBgDark:"",scrollbarColor:"",scrollbarColorDark:"",footerBg:"",footerBgDark:"",footerTextColor:"",footerTextColorDark:"",footerPaddingX:"16",footerPaddingY:"16"};var X={modalBg:"--sm-modal-bg",modalBgDark:"--sm-modal-bg-dark",modalBorderRadius:"--sm-modal-radius",modalBorderWidth:"--sm-modal-border-width",modalBorderColor:"--sm-modal-border-color",modalBorderColorDark:"--sm-modal-border-color-dark",modalShadow:"--sm-modal-shadow",modalShadowDark:"--sm-modal-shadow-dark",modalMaxWidth:"--sm-modal-width",modalMaxHeight:"--sm-modal-max-height",modalPaddingX:"--sm-modal-px",modalPaddingY:"--sm-modal-py",headerBg:"--sm-header-bg",headerBgDark:"--sm-header-bg-dark",headerBorderColor:"--sm-header-border-color",headerBorderColorDark:"--sm-header-border-color-dark",headerBorderWidth:"--sm-header-border-width",headerBorderRadius:"--sm-header-radius",headerPaddingX:"--sm-header-px",headerPaddingY:"--sm-header-py",inputBg:"--sm-input-bg",inputBgDark:"--sm-input-bg-dark",inputTextColor:"--sm-input-color",inputTextColorDark:"--sm-input-color-dark",inputPlaceholderColor:"--sm-input-placeholder",inputPlaceholderColorDark:"--sm-input-placeholder-dark",inputBorderColor:"--sm-input-border-color",inputBorderColorDark:"--sm-input-border-color-dark",inputFontSize:"--sm-input-font-size",inputBorderRadius:"--sm-input-radius",inputBorderWidth:"--sm-input-border-width",inputPaddingX:"--sm-input-px",inputPaddingY:"--sm-input-py",resultBg:"--sm-result-bg",resultBgDark:"--sm-result-bg-dark",resultBorderColor:"--sm-result-border-color",resultBorderColorDark:"--sm-result-border-color-dark",resultActiveBg:"--sm-result-active-bg",resultActiveBgDark:"--sm-result-active-bg-dark",resultActiveBorderColor:"--sm-result-active-border-color",resultActiveBorderColorDark:"--sm-result-active-border-color-dark",resultActiveTextColor:"--sm-result-active-text-color",resultActiveTextColorDark:"--sm-result-active-text-color-dark",resultActiveDescColor:"--sm-result-active-desc-color",resultActiveDescColorDark:"--sm-result-active-desc-color-dark",resultActiveMutedColor:"--sm-result-active-muted-color",resultActiveMutedColorDark:"--sm-result-active-muted-color-dark",resultTextColor:"--sm-result-text-color",resultTextColorDark:"--sm-result-text-color-dark",resultDescColor:"--sm-result-desc-color",resultDescColorDark:"--sm-result-desc-color-dark",resultMutedColor:"--sm-result-muted-color",resultMutedColorDark:"--sm-result-muted-color-dark",resultGap:"--sm-result-gap",resultBorderWidth:"--sm-result-border-width",resultPaddingX:"--sm-result-px",resultPaddingY:"--sm-result-py",resultBorderRadius:"--sm-result-radius",triggerBg:"--sm-trigger-bg",triggerBgDark:"--sm-trigger-bg-dark",triggerTextColor:"--sm-trigger-text-color",triggerTextColorDark:"--sm-trigger-text-color-dark",triggerBorderRadius:"--sm-trigger-radius",triggerBorderWidth:"--sm-trigger-border-width",triggerBorderColor:"--sm-trigger-border-color",triggerBorderColorDark:"--sm-trigger-border-color-dark",triggerHoverBg:"--sm-trigger-hover-bg",triggerHoverBgDark:"--sm-trigger-hover-bg-dark",triggerHoverTextColor:"--sm-trigger-hover-text-color",triggerHoverTextColorDark:"--sm-trigger-hover-text-color-dark",triggerHoverBorderColor:"--sm-trigger-hover-border-color",triggerHoverBorderColorDark:"--sm-trigger-hover-border-color-dark",triggerPaddingX:"--sm-trigger-px",triggerPaddingY:"--sm-trigger-py",triggerFontSize:"--sm-trigger-font-size",kbdBg:"--sm-kbd-bg",kbdBgDark:"--sm-kbd-bg-dark",kbdTextColor:"--sm-kbd-text-color",kbdTextColorDark:"--sm-kbd-text-color-dark",kbdBorderRadius:"--sm-kbd-radius",iconColor:"--sm-icon-color",iconColorDark:"--sm-icon-color-dark",searchIconColor:"--sm-search-icon-color",searchIconColorDark:"--sm-search-icon-color-dark",clearIconColor:"--sm-clear-icon-color",clearIconColorDark:"--sm-clear-icon-color-dark",resultIconColor:"--sm-result-icon-color",resultIconColorDark:"--sm-result-icon-color-dark",arrowColor:"--sm-arrow-color",arrowColorDark:"--sm-arrow-color-dark",iconActiveColor:"--sm-icon-active-color",iconActiveColorDark:"--sm-icon-active-color-dark",resultIconActiveColor:"--sm-result-icon-active-color",resultIconActiveColorDark:"--sm-result-icon-active-color-dark",hierarchyConnectorActiveColor:"--sm-hierarchy-connector-active-color",hierarchyConnectorActiveColorDark:"--sm-hierarchy-connector-active-color-dark",hierarchyConnectorColor:"--sm-hierarchy-connector-color",hierarchyConnectorColorDark:"--sm-hierarchy-connector-color-dark",highlightBgLight:"--sm-highlight-bg",highlightColorLight:"--sm-highlight-color",highlightBgDark:"--sm-highlight-bg-dark",highlightColorDark:"--sm-highlight-color-dark",highlightActiveBgLight:"--sm-highlight-active-bg",highlightActiveColorLight:"--sm-highlight-active-color",highlightActiveBgDark:"--sm-highlight-active-bg-dark",highlightActiveColorDark:"--sm-highlight-active-color-dark",promotedBg:"--sm-promoted-bg",promotedBgDark:"--sm-promoted-bg-dark",promotedColor:"--sm-promoted-color",promotedColorDark:"--sm-promoted-color-dark",promotedActiveBg:"--sm-promoted-active-bg",promotedActiveBgDark:"--sm-promoted-active-bg-dark",promotedActiveColor:"--sm-promoted-active-color",promotedActiveColorDark:"--sm-promoted-active-color-dark",promotedBorderColor:"--sm-promoted-border-color",promotedBorderColorDark:"--sm-promoted-border-color-dark",promotedPaddingX:"--sm-promoted-px",promotedPaddingY:"--sm-promoted-py",promotedBorderRadius:"--sm-promoted-radius",promotedBorderWidth:"--sm-promoted-border-width",promotedTintBg:"--sm-promoted-tint-bg",promotedTintBgDark:"--sm-promoted-tint-bg-dark",promotedTintTextColor:"--sm-promoted-tint-text",promotedTintTextColorDark:"--sm-promoted-tint-text-dark",promotedTintActiveBg:"--sm-promoted-tint-active-bg",promotedTintActiveBgDark:"--sm-promoted-tint-active-bg-dark",spinnerColor:"--sm-spinner-color-light",spinnerColorDark:"--sm-spinner-color-dark",scrollbarColor:"--sm-scrollbar-color",scrollbarColorDark:"--sm-scrollbar-color-dark",footerBg:"--sm-footer-bg",footerBgDark:"--sm-footer-bg-dark",footerTextColor:"--sm-footer-text-color",footerTextColorDark:"--sm-footer-text-color-dark",footerPaddingX:"--sm-footer-px",footerPaddingY:"--sm-footer-py"},he=["modalBorderRadius","modalBorderWidth","modalMaxWidth","modalPaddingX","modalPaddingY","headerBorderWidth","headerBorderRadius","headerPaddingX","headerPaddingY","inputFontSize","inputBorderRadius","inputBorderWidth","inputPaddingX","inputPaddingY","resultGap","resultBorderWidth","resultPaddingX","resultPaddingY","resultBorderRadius","triggerBorderRadius","triggerBorderWidth","triggerPaddingX","triggerPaddingY","triggerFontSize","kbdBorderRadius","footerPaddingX","footerPaddingY","promotedPaddingX","promotedPaddingY","promotedBorderRadius","promotedBorderWidth"],me=["modalMaxHeight"],Oe=["modalBg","modalBgDark","modalBorderColor","modalBorderColorDark","headerBg","headerBgDark","headerBorderColor","headerBorderColorDark","inputBg","inputBgDark","inputTextColor","inputTextColorDark","inputPlaceholderColor","inputPlaceholderColorDark","inputBorderColor","inputBorderColorDark","resultBg","resultBgDark","resultBorderColor","resultBorderColorDark","resultActiveBg","resultActiveBgDark","resultActiveBorderColor","resultActiveBorderColorDark","resultTextColor","resultTextColorDark","resultActiveTextColor","resultActiveTextColorDark","resultActiveDescColor","resultActiveDescColorDark","resultActiveMutedColor","resultActiveMutedColorDark","resultDescColor","resultDescColorDark","resultMutedColor","resultMutedColorDark","triggerBg","triggerBgDark","triggerTextColor","triggerTextColorDark","triggerBorderColor","triggerBorderColorDark","triggerHoverBg","triggerHoverBgDark","triggerHoverTextColor","triggerHoverTextColorDark","triggerHoverBorderColor","triggerHoverBorderColorDark","kbdBg","kbdBgDark","kbdTextColor","kbdTextColorDark","iconColor","iconColorDark","searchIconColor","searchIconColorDark","clearIconColor","clearIconColorDark","resultIconColor","resultIconColorDark","arrowColor","arrowColorDark","iconActiveColor","iconActiveColorDark","resultIconActiveColor","resultIconActiveColorDark","hierarchyConnectorActiveColor","hierarchyConnectorActiveColorDark","hierarchyConnectorColor","hierarchyConnectorColorDark","highlightBgLight","highlightColorLight","highlightBgDark","highlightColorDark","highlightActiveBgLight","highlightActiveColorLight","highlightActiveBgDark","highlightActiveColorDark","promotedBg","promotedBgDark","promotedColor","promotedColorDark","promotedActiveBg","promotedActiveBgDark","promotedActiveColor","promotedActiveColorDark","promotedBorderColor","promotedBorderColorDark","promotedTintBg","promotedTintBgDark","promotedTintTextColor","promotedTintTextColorDark","promotedTintActiveBg","promotedTintActiveBgDark","spinnerColor","spinnerColorDark","scrollbarColor","scrollbarColorDark","footerBg","footerBgDark","footerTextColor","footerTextColorDark"],hr={...He,highlightBgLight:"#fef08a",highlightColorLight:"#854d0e",highlightBgDark:"#854d0e",highlightColorDark:"#fef08a"};var ue=new WeakMap;function Ct(){let e=new Set,t=new Set;for(let r of Object.keys(X)){if(r.endsWith("Dark")){t.add(r);continue}if(r.endsWith("Light")){let n=r.replace(/Light$/,"Dark");X[n]&&e.add(r);continue}X[`${r}Dark`]&&e.add(r)}return{lightKeys:e,darkKeys:t}}var Ne=Ct();function St(e){return typeof e=="string"&&/^(var|light-dark|calc|env|clamp|min|max|rgb|hsl)\s*\(/.test(e.trim())}function Dt(e){return/^[0-9a-fA-F]{6}$/.test(e)}function Tt(e,t){if(t==null||t==="")return null;let r=String(t);return St(r)||(Oe.includes(e)&&Dt(r)&&(r="#"+r),he.includes(e)&&(r=r+"px"),me.includes(e)&&(r=r+"vh")),r}function Fe(e,t,r="light"){if(!e)return;let n=ue.get(e);if(n){for(let a of n)e.style.removeProperty(a);ue.delete(e)}if(!t||typeof t!="object")return;let o=r==="dark",s=Object.entries(X),i=new Set([...he,...me]),d=new Set;for(let[a,l]of s){let c=Ne.lightKeys.has(a),u=Ne.darkKeys.has(a),p=c||u;if(o){if(c||!u&&!i.has(a))continue}else if(u)continue;if(t[a]!==void 0&&t[a]!==null&&t[a]!==""){let b=Tt(a,t[a]);b&&(e.style.setProperty(l,b),p&&d.add(l))}}d.size>0&&ue.set(e,d)}var At=new Set(["mark","em","strong","u","b","i","span"]),Bt=/^[A-Za-z0-9_-]+$/;function h(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function F(e,t="#"){if(typeof e!="string"||e==="")return e||"";let r=e.replace(/[\u0000-\u0020]+/g,"").toLowerCase();for(let n of["javascript","vbscript","data","file"])if(r.startsWith(n+":"))return t;return e}function ze(e){return e?e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"):""}function J(e,t=null){if(!e)return[];let r=[],n=/"([^"]+)"/g,o;for(;(o=n.exec(e))!==null;)o[1].trim()&&r.push(o[1].trim());let s=e.replace(/"[^"]*"/g,""),i=new Set(["and","or","not","und","oder","nicht","et","ou","sauf","y","o","no"]);s.split(/\s+/).filter(a=>a.length>0).forEach(a=>{let l=null,c=a.match(/^(title|content):(.*)$/i);c?(l=c[1].toLowerCase(),a=c[2]):a=a.replace(/^[a-zA-Z]+:/,""),a=a.replace(/\*/g,""),a=a.replace(/\^\d+(\.\d+)?/,""),a=a.replace(/"/g,""),!(!a||i.has(a.toLowerCase())||t&&l&&l!==t)&&r.push(a)});let d=[];return r.forEach(a=>{d.push(a);let l=a.split(/(?<=[a-z])(?=[A-Z])/);l.length>1&&l.forEach(c=>{c.length>=3&&d.push(c)})}),d}function z(e,t,r){let n=t==="snippet"?"content":"title",o=J(r,n);if(r&&o.length===0)return[];let s=e&&e.matchedTerms,i=s&&Array.isArray(s[n])?s[n]:[],d=e&&Array.isArray(e.matchedPhrases)?e.matchedPhrases:[],a=i.length>0?i:o;return[...d,...a]}function Z(e,t,r={}){let{enabled:n=!0,tag:o="mark",className:s="",terms:i=null}=r;if(!n)return h(e);let d=Et(o),l=["sm-highlight",...It(s)],c=` class="${h(l.join(" "))}"`,{termList:u,queryTerms:p}=$t(t,i);return u.length===0?h(e):Lt(e,u,d,c,p)}function Et(e){let t=String(e||"mark").trim().toLowerCase();return At.has(t)?t:"mark"}function It(e){return String(e||"").trim().split(/\s+/).filter(t=>t&&Bt.test(t))}function $t(e,t){let r=Array.isArray(t)?ge(t):ge(J(e)),n=r.map(s=>se(s)).filter(s=>s.length===1).map(s=>s[0]),o=ge(J(e)).filter(s=>{let i=se(s);return i.length!==1?!1:n.some(d=>i[0]===d||pe(i[0],d))});return{termList:r,queryTerms:o}}function ge(e){let t=new Set;return e.filter(r=>typeof r=="string"&&r.length>0).sort((r,n)=>n.length-r.length).filter(r=>{let n=ie(r);return t.has(n)?!1:(t.add(n),!0)})}function Lt(e,t,r,n,o){let s=Rt(e),i=[],d=t.map(m=>se(m)).filter(m=>m.length>0),a=o.map(m=>se(m)).filter(m=>m.length===1).map(m=>m[0]),l=new Set(a),c=new Set;if(d.forEach(m=>{m.length!==1||l.has(m[0])||a.some(y=>pe(y,m[0]))&&c.add(m[0])}),d.forEach(m=>{if(m.length===1&&c.has(m[0]))return;let y=s.length-m.length;for(let v=0;v<=y;v+=1)m.every((S,w)=>s[v+w].normalized===S)&&i.push({start:s[v].start,end:s[v+m.length-1].end,type:"whole"})}),a.forEach(m=>{s.forEach(y=>{pe(m,y.normalized)&&i.push({start:y.start,end:y.start+_t(y.text,m),type:"prefix"})})}),i.length===0)return h(e);i.sort((m,y)=>{if(m.start!==y.start)return m.start-y.start;let v=y.end-y.start-(m.end-m.start);return v!==0?v:m.type==="whole"?-1:1});let u=[],p=-1;i.forEach(m=>{m.start>=p&&(u.push(m),p=m.end)});let b="",f=0;return u.forEach(m=>{f<m.start&&(b+=h(e.slice(f,m.start))),b+=`<${r}${n}>${h(e.slice(m.start,m.end))}</${r}>`,f=m.end}),f<e.length&&(b+=h(e.slice(f))),b}function ie(e){return String(e||"").normalize("NFKC").replace(/\u0640/gu,"").toLowerCase().normalize("NFKD").replace(/\p{M}/gu,t=>t==="\u3099"||t==="\u309A"?t:"").normalize("NFC")}function se(e){return ie(e).match(/[\p{L}\p{N}\p{M}_]+/gu)||[]}function Rt(e){let t=[],r=/[\p{L}\p{N}\p{M}_]+/gu,n;for(;(n=r.exec(e))!==null;)t.push({text:n[0],normalized:ie(n[0]),start:n.index,end:n.index+n[0].length});return t}function pe(e,t){return t.length>e.length&&t.startsWith(e)}function _t(e,t){let r="",n="",o=!1;for(let s of Array.from(e)){let i=ie(s);if(o&&i!=="")break;n+=s,r+=i,o=Array.from(r).length>=Array.from(t).length}return n.length}function W(e,t,r="smq"){if(!e||e==="#")return e;if(Mt(e))return"#";let n=(t||"").trim();if(!n||!r||/^(mailto:|tel:)/i.test(e))return e;let[o,s]=e.split("#",2),[i,d]=o.split("?",2),a=new URLSearchParams(d||"");a.set(r,n);let l=a.toString(),c=s?`#${s}`:"";return`${i}${l?`?${l}`:""}${c}`}function Mt(e){let t=String(e).replace(/[\t\n\r]/g,"").replace(/^[\u0000-\u0020]+/,"");return/^(javascript|data|vbscript):/i.test(t)}var Pt=0;function be(e="sm"){return`${e}-${++Pt}-${Date.now().toString(36)}`}function qe(e){let t=document.createElement("div");return t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-atomic","true"),t.className="sm-sr-only",e.appendChild(t),t}function ee(e,t,r=100){e&&(e.textContent="",setTimeout(()=>{e.textContent=t},r))}function fe(e,t,r={}){return e===0?g(r,'No results found for "{query}"',{query:t}):e===1?g(r,'1 result found for "{query}"',{query:t}):g(r,'{count} results found for "{query}"',{count:e,query:t})}function Ve(e={}){return g(e,"Searching...")}function Ue(e,t={}){return e===0?g(t,"No recently viewed items"):e===1?g(t,"1 recently viewed item available"):g(t,"{count} recently viewed items available",{count:e})}function ae(e,{expanded:t,activeDescendant:r,listboxId:n}){e.setAttribute("aria-expanded",String(t)),e.setAttribute("aria-controls",n),r?e.setAttribute("aria-activedescendant",r):e.removeAttribute("aria-activedescendant")}function q(e,t){return`${e}-option-${t}`}function je(e,t){if(!e||!t)return;let r=e.getBoundingClientRect(),n=t.getBoundingClientRect();r.top<n.top?e.scrollIntoView({block:"nearest",behavior:"smooth"}):r.bottom>n.bottom&&e.scrollIntoView({block:"nearest",behavior:"smooth"})}function Ht(e,t,r={}){let{resultsGroupingEnabled:n=!1,resultsLayout:o="default",listboxId:s}=r;if(!e||e.length===0)return"";if(o==="hierarchical")return Gt(e,t,r);if(n){let i=Re(e),d=0;return Object.entries(i).map(([a,l])=>`
            <div class="sm-section" role="group" aria-label="${h(a)}">
                <div class="sm-section-header">${h(a)}</div>
                ${l.map(c=>Ge(c,d++,t,r)).join("")}
            </div>
        `).join("")}return e.map((i,d)=>Ge(i,d,t,r)).join("")}function Ge(e,t,r,n={}){let{listboxId:o,highlightResultsEnabled:s=!0,highlightTag:i="mark",highlightClass:d="",resultsGroupingEnabled:a=!1,debugEnabled:l=!1,highlightDestinationPersistQuery:c=!1,highlightDestinationQueryParam:u="smq",translations:p={}}=n,b=xe(e),f=b?e.sectionTitle||e.title||e.name||g(p,"Untitled"):e.title||e.name||g(p,"Untitled"),m=e.snippet||"",y=F(b?e.sectionUrl||e.url||e.href||"#":e.url||e.href||"#"),v=W(y,r,c?u:""),k=e.source||e.entrySection||e.type||"",S=q(o,t),w=e._index||e.index||"",C=ke(e),A={enabled:s,tag:i,className:d},R=Z(f,r,{...A,terms:z(e,"title",r)}),E=m?ye(e,m,r,{...A,terms:z(e,"snippet",r)}):"",x=Qe(e,n),B=x.rowClass,I=k&&!a?`<span class="sm-result-type">${h(k)}</span>`:"",_=l?Ye(e,p):"";return l?`
            <a class="sm-result-item sm-debug-enabled${B}" id="${S}" role="option" aria-selected="false" href="${h(v)}" data-index="${t}" data-source-index="${h(w)}"${C} data-title="${h(f)}">
                <div class="sm-result-main">
                    <div class="sm-result-content">
                        ${x.aboveMarkup}
                        <span class="sm-result-title">${x.titlePrefix}${R}${x.titleSuffix}</span>
                        ${x.blockMarkup}
                        ${E?`<span class="sm-result-desc">${E}</span>`:""}
                    </div>
                    ${I}
                    ${V()}
                </div>
        ...
        `:`
        <a class="sm-result-item${B}" id="${S}" role="option" aria-selected="false" href="${h(v)}" data-index="${t}" data-source-index="${h(w)}"${C} data-title="${h(f)}">
            <div class="sm-result-content">
                ${x.aboveMarkup}
                <span class="sm-result-title">${x.titlePrefix}${R}${x.titleSuffix}</span>
                ${x.blockMarkup}
    ...
    `}function Ye(e,t={}){let r=[],n=e.backend?e.backend.toLowerCase():"";if((e._index||e.index)&&r.push(T("index",e._index||e.index,"index","",t)),e.backend&&r.push(T("backend",n,"backend",n,t)),e.elementId&&r.push(T("element",e.elementId,"generic","",t)),e.backendId&&r.push(T("hit",e.backendId,"generic","",t)),e.score!==void 0&&e.score!==null){let o=typeof e.score=="number"?e.score.toFixed(2):e.score;r.push(T("score",o,"score","",t))}if(e.site&&r.push(T("site",e.site,"generic","",t)),e.language&&r.push(T("lang",e.language,"generic","",t)),e.matchedIn&&Array.isArray(e.matchedIn)&&e.matchedIn.length>0){let o=e.matchedIn.join(", ");r.push(T("matched",o,"matched","",t))}return e.promoted&&r.push(T("promoted",g(t,"yes"),"promoted","",t)),e.boosted&&r.push(T("boosted",g(t,"yes"),"boosted","",t)),r.length===0?"":`<div class="sm-debug-info">${r.join("")}</div>`}function ye(e,t,r,n){return Z(t,r,n)}function T(e,t,r,n="",o={}){let s=n?` data-backend="${h(n)}"`:"";return`<span class="sm-debug-item"><span class="sm-debug-label">${h(g(o,e))}</span><span class="sm-debug-value" data-type="${h(r)}"${s}>${h(String(t))}</span></span>`}function Qe(e,t={}){let{promotionDisplay:r="none",promotionBadgeText:n="Featured",promotionBadgePosition:o="inline"}=t;if(e.promoted!==!0||r==="none")return{rowClass:"",titlePrefix:"",titleSuffix:"",aboveMarkup:"",blockMarkup:""};if(r==="tint")return{rowClass:" sm-promoted sm-promoted--tint",titlePrefix:"",titleSuffix:`<span class="sm-sr-only"> ${h(n)}</span>`,aboveMarkup:"",blockMarkup:""};let s=`<span class="sm-promoted-badge">${h(n)}</span>`;return o==="above"?{rowClass:" sm-promoted",titlePrefix:"",titleSuffix:"",aboveMarkup:`<span class="sm-promoted-badge-row sm-promoted-badge-row--above">${s}</span>`,blockMarkup:""}:o==="below"?{rowClass:" sm-promoted",titlePrefix:"",titleSuffix:"",aboveMarkup:"",blockMarkup:`<span class="sm-promoted-badge-row">${s}</span>`}:{rowClass:" sm-promoted",titlePrefix:s,titleSuffix:"",aboveMarkup:"",blockMarkup:""}}function xe(e){return!!(e&&typeof e=="object"&&["heading","intro","promoted-page"].includes(String(e.sectionType||"")))}function Ot(e){return Array.isArray(e)&&e.some(xe)}function Nt(e,t){let r=new Map,n=[];return e.forEach((o,s)=>{if(!xe(o)){n.push({type:"single",item:o,order:s,score:O(o)});return}let i=qt(o);if(!r.has(i)){let l={hits:[],order:s,score:O(o)};r.set(i,l),n.push({type:"section-group",key:i,order:s,score:l.score})}let d=r.get(i);d.hits.push(o),d.score=Math.max(d.score,O(o));let a=n.find(l=>l.type==="section-group"&&l.key===i);a&&(a.score=d.score)}),n.map(o=>{if(o.type==="section-group"){let s=r.get(o.key);return{...o,item:Ft(s.hits,t)}}return o}).sort((o,s)=>{let i=ve(s.score,o.score);return i!==0?i:o.order-s.order}).map(o=>o.item)}function Ft(e,t){let r=[...e].sort((c,u)=>H(c)-H(u)),n=r.find(c=>c.sectionType==="intro")||null,o=[...e].sort((c,u)=>{let p=ve(O(u),O(c));return p!==0?p:H(c)-H(u)})[0]||r[0]||{},s=n||o,i=Y(s),d=s.siteId??"",a=Number.isFinite(t)&&t>0?t:3,l=r.filter(c=>c.sectionType==="heading").sort((c,u)=>{let p=ve(O(u),O(c));return p!==0?p:H(c)-H(u)}).slice(0,a).sort((c,u)=>H(c)-H(u)).map(zt);return{...s,elementId:i||s.elementId,backendId:n?.backendId||s.backendId||Vt(i,d),title:s.title||s.sectionTitle||s.name||"",url:s.url||"#",snippet:n&&n.snippet||null,score:O(o),promoted:r.some(c=>c.promoted===!0),headings:l,__sectionHitGroup:!0,__useBackendDomId:!0}}function zt(e){let t=Number.parseInt(e.sectionLevel,10),r=Number.isFinite(t)?t:2;return{title:e.sectionTitle||e.title||"",text:e.sectionTitle||e.title||"",id:e.sectionAnchor||e.sectionId||"",level:r,url:e.sectionUrl||e.url||null,snippet:e.snippet||null,backendId:e.backendId||"",elementId:Y(e),sectionType:e.sectionType,_index:e._index,index:e.index,matchedTerms:e.matchedTerms,matchedPhrases:e.matchedPhrases,__useBackendDomId:!0}}function qt(e){return[Y(e)||Xe(e)||"",e.siteId??""].join(":")}function H(e){let t=Number.parseInt(e.sectionIndex,10);return Number.isFinite(t)?t:Number.MAX_SAFE_INTEGER}function O(e){let t=Number(e?.score);return Number.isFinite(t)?t:Number.NEGATIVE_INFINITY}function ve(e,t){return e===t?0:e>t?1:-1}function Vt(e,t){let r=e||"unknown";return t!=null&&String(t)!==""?`${r}_${t}`:String(r)}function Xe(e,t=null){return e?.backendId||t?.backendId||""}function Y(e,t=null){return e?.elementId||t?.elementId||""}function ke(e,t=null){let r=Xe(e,t)||Y(e,t),n=Y(e,t);return` data-id="${h(r)}" data-element-id="${h(n)}"`}function V(){return`<svg class="sm-result-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
    ...
    </svg>`}function jt(){return`<svg class="sm-hierarchy-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
        <line x1="4" y1="7" x2="20" y2="7"/>
        <line x1="4" y1="12" x2="20" y2="12"/>
        <line x1="4" y1="17" x2="14" y2="17"/>
    </svg>`}function Ke(){return`<svg class="sm-hierarchy-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
        <line x1="4" y1="9" x2="20" y2="9"/>
        <line x1="4" y1="15" x2="20" y2="15"/>
        <line x1="10" y1="3" x2="8" y2="21"/>
        <line x1="16" y1="3" x2="14" y2="21"/>
    </svg>`}function Gt(e,t,r={}){let{hierarchyGroupBy:n="",hierarchyStyle:o="tree",hierarchyDisplay:s="individual",hierarchyMaxHeadings:i=3,listboxId:d}=r,a=o==="tree",l=o!=="none",c=Ot(e)?Nt(e,i):e,p=_e(c,n||""),b=0;return Object.entries(p).map(([f,m])=>{let y=m.map(v=>{let k=b++,S=Kt(v,k,t,r),w="",C=v.headings||[],A=v.__sectionHitGroup?C:C.slice(0,i);if(A.length>0){let x=Math.min(...A.map(I=>I.level||2)),B=A.map(I=>a?(I.level||2)-x:0);w=A.map((I,_)=>{let U=B[_],j=!B.slice(_+1).some(G=>G===U),Q=[];if(a){let G=B.slice(_+1);for(let N=0;N<U;N++)G.some(M=>M===N)&&Q.push(N)}return Wt(v,I,b++,t,r,j,U,Q)}).join("")}let R=!!w;return`
                <div class="sm-hierarchy-block${R?" sm-hierarchy-block--has-children":""}${s==="unified"?" sm-hierarchy-block--unified":""}">
                    ${R?S.replace("sm-result-item sm-hierarchy-parent","sm-result-item sm-hierarchy-parent sm-hierarchy-parent--has-children"):S}
                    ${R?`<div class="sm-hierarchy-children${l?"":" sm-hierarchy-children--no-connectors"}">${w}</div>`:""}
                </div>
            `}).join("");return`
            <div class="sm-hierarchy-group" role="group" aria-label="${h(f)}">
                <div class="sm-hierarchy-group-header">${h(f)}</div>
                ${y}
            </div>
        `}).join("")}function Kt(e,t,r,n={}){let{listboxId:o,highlightResultsEnabled:s=!0,highlightTag:i="mark",highlightClass:d="",debugEnabled:a=!1,highlightDestinationPersistQuery:l=!1,highlightDestinationQueryParam:c="smq",translations:u={}}=n,p=e.title||e.name||g(u,"Untitled"),b=e.snippet||"",f=F(e.url||"#"),m=W(f,r,l?c:""),y=q(o,t),v=e._index||e.index||"",k=ke(e),S={enabled:s,tag:i,className:d},w=Z(p,r,{...S,terms:z(e,"title",r)}),C=b?ye(e,b,r,{...S,terms:z(e,"snippet",r)}):"",A=a?Ye(e,u):"",E=e.headings&&e.headings.length>0?Ut():jt(),x=Qe(e,n),B=x.rowClass;return a?`
            <a class="sm-result-item sm-hierarchy-parent sm-debug-enabled${B}" id="${y}" role="option" aria-selected="false" href="${h(m)}" data-index="${t}" data-source-index="${h(v)}"${k} data-title="${h(p)}">
                <div class="sm-result-main">
                    ${E}
                    <div class="sm-result-content">
                        ${x.aboveMarkup}
        ...
        `:`
        <a class="sm-result-item sm-hierarchy-parent${B}" id="${y}" role="option" aria-selected="false" href="${h(m)}" data-index="${t}" data-source-index="${h(v)}"${k} data-title="${h(p)}">
            ${E}
            <div class="sm-result-content">
                ${x.aboveMarkup}
                <span class="sm-result-title">${x.titlePrefix}${w}${x.titleSuffix}</span>
    ...
    `}function Wt(e,t,r,n,o={},s=!1,i=0,d=[]){let{listboxId:a,highlightResultsEnabled:l=!0,highlightTag:c="mark",highlightClass:u="",debugEnabled:p=!1,highlightDestinationPersistQuery:b=!1,highlightDestinationQueryParam:f="smq",translations:m={}}=o,v=(t.title||t.text||"").replace(/^#+\s*/,""),k=t.snippet||"",S=Number.parseInt(t.level,10),w=Number.isFinite(S)?Math.min(Math.max(S,1),6):2,C=t.id||(v?Yt(v):""),A=e.url||"#",R=F(t.url||(C?`${A}#${C}`:A)),E=W(R,n,b?f:""),x=q(a,r),B=t._index||t.index||e._index||e.index||"",I=ke(t,e),_={enabled:l,tag:c,className:u},U=Z(v,n,{..._,terms:z(t,"title",n)}),j=k?ye(e,k,n,{..._,terms:z(t,"snippet",n)}):"",Q=s?" sm-hierarchy-child-row-last":"",G=d.map(M=>`<div class="sm-hierarchy-guide" style="--sm-guide-depth:${M}" aria-hidden="true"></div>`).join(""),N="";if(p){let M=[];M.push(T("h",w,"generic","",m)),C&&M.push(T("anchor",C,"generic","",m));let De=Y(t,e);De&&M.push(T("parent",De,"generic","",m)),N=`<div class="sm-debug-info">${M.join("")}</div>`}return p?`
            <div class="sm-hierarchy-child-row sm-hierarchy-level-${w} sm-hierarchy-depth-${i}${Q}" style="--sm-hierarchy-depth:${i}">
                ${G}
                <a class="sm-result-item sm-hierarchy-child sm-hierarchy-level-${w} sm-debug-enabled" id="${x}" role="option" aria-selected="false" href="${h(E)}" data-index="${r}" data-source-index="${h(B)}"${I} data-title="${h(v)}">
                    <div class="sm-result-main">
                        ${Ke()}
                        <div class="sm-result-content">
        ...
        <div class="sm-hierarchy-child-row sm-hierarchy-level-${w} sm-hierarchy-depth-${i}${Q}" style="--sm-hierarchy-depth:${i}">
            ${G}
            <a class="sm-result-item sm-hierarchy-child sm-hierarchy-level-${w}" id="${x}" role="option" aria-selected="false" href="${h(E)}" data-index="${r}" data-source-index="${h(B)}"${I} data-title="${h(v)}">
                ${Ke()}
                <div class="sm-result-content">
                    <span class="sm-result-title">${U}</span>
                    ${j?`<span class="sm-result-desc">${j}</span>`:""}
    ...
    `}function Yt(e){let t=e.normalize("NFKD").toLowerCase();try{return t.replace(/[^\p{L}\p{N}]+/gu,"-").replace(/^-+|-+$/g,"")}catch{return t.replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}}function Qt(e,t,r={}){return!e||e.length===0?"":`
        <div class="sm-section">
            <div class="sm-section-header">
                <span id="${t}-recently-viewed-label">${h(g(r,"Recently viewed"))}</span>
                <button class="sm-recently-viewed-clear" part="recently-viewed-clear">${h(g(r,"Clear"))}</button>
            </div>
            ${e.map((n,o)=>`
                <div class="sm-result-item sm-recently-viewed-item" id="${q(t,o)}" role="option" aria-selected="false" data-index="${o}" data-url="${h(F(n.url||""))}" data-query="${h(n.query)}">
    ...
    `}function We(e,t={}){return!e||!e.trim()?`
    ...
    `}function Je(e,t){let{query:r,results:n,recentlyViewed:o,loading:s,recentlyViewedEnabled:i,error:d}=e,{loadingIndicatorEnabled:a=!0,translations:l={}}=t,c=r&&r.trim();return s&&a?{html:Xt(l),hasResults:!1,showListbox:!1}:d?{html:Jt(d,l),hasResults:!1,showListbox:!1}:c?!n||n.length===0?{html:We(r,l),hasResults:!1,showListbox:!1}:{html:Ht(n,r,t),hasResults:!0,showListbox:!0}:i&&o&&o.length>0?{html:Qt(o,t.listboxId,l),hasResults:!0,showListbox:!0}:{html:We("",l),hasResults:!1,showListbox:!1}}function we(e,t,r=!1,n={}){if(!e)return"";let o=[];if(o.push(L("results",t,"generic","",n)),e.took!==void 0){let l=e.took<1?"<1ms":`${Math.round(e.took)}ms`;o.push(L("time",l,"time","",n))}if(e.cacheEnabled!==void 0&&(e.cacheEnabled?e.cached?o.push(L("cache",g(n,"hit"),"cache-hit","",n)):o.push(L("cache",g(n,"miss"),"cache-miss","",n)):o.push(L("cache",g(n,"off"),"cache-off","",n))),e.cacheDriver&&o.push(L("storage",e.cacheDriver,"cache-driver",e.cacheDriver,n)),e.indices&&e.indices.length>0){let l=e.indices.length>2?g(n,"{count} indices",{count:e.indices.length}):e.indices.join(", ");o.push(L("indices",l,"generic","",n))}if(e.synonymsExpanded){let l=e.expandedQueries?e.expandedQueries.length-1:0;o.push(L("synonyms",`+${l}`,"synonyms","",n))}let s=e.rulesMatched?.length||0;o.push(L("rules",s,s>0?"rules":"generic","",n));let i=e.promotionsMatched?.length||0;o.push(L("promoted",i,i>0?"promotions":"generic","",n));let a=`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">${r?'<path d="M6 9l6 6 6-6"/>':'<path d="M18 15l-6-6-6 6"/>'}</svg>`;return r?`<div class="sm-toolbar-collapsed-bar"><span class="sm-toolbar-collapsed-label">${h(g(n,"Debug"))}</span>${a}</div>`:`<div class="sm-toolbar-content">${o.join("")}</div><button class="sm-toolbar-toggle" aria-label="${h(g(n,"Collapse debug panel"))}" aria-expanded="true">${a}</button>`}function L(e,t,r,n="",o={}){let s=n?` data-backend="${h(n)}"`:"";return`<span class="sm-toolbar-item"><span class="sm-toolbar-label">${h(g(o,e))}</span><span class="sm-toolbar-value" data-type="${h(r)}"${s}>${h(String(t))}</span></span>`}function Ze(e,t){let{onSelect:r,onIndexChange:n,onEscape:o}=e,{listboxId:s}=t;return{handleKeydown(i,d,a){let l=a;switch(i.key){case"ArrowDown":return i.preventDefault(),l=Math.min(a+1,d-1),l!==a&&n&&n(l),l;case"ArrowUp":return i.preventDefault(),l=Math.max(a-1,-1),l!==a&&n&&n(l),l;case"Enter":return i.preventDefault(),a>=0&&r&&r(a),null;case"Escape":return i.preventDefault(),o&&o(),null;default:return null}},getListboxId(){return s}}}function et(e,t,r={}){let{scrollContainer:n,inputElement:o,listboxId:s,selectedClass:i="sm-selected"}=r,d=t>=0?q(s,t):null;o&&ae(o,{expanded:e.length>0,activeDescendant:d,listboxId:s}),e.forEach((a,l)=>{let c=l===t;a.classList.toggle(i,c),a.setAttribute("aria-selected",String(c)),c&&n&&je(a,n)})}function tt(e,t){e.forEach((r,n)=>{r.addEventListener("mousemove",()=>{t&&!r.classList.contains("sm-selected")&&t(n)})})}var rt="sm-page-highlight-style",nt="__smPageHighlightRegistry",ot="__searchManagerHotkeyHandled",$=null,Ce=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.config=null,this.state=Ee({...re},this.handleStateChange.bind(this)),this.searchSequence=0,this.debounceTimer=null,this.analyticsIdleTimer=null,this.lastTrackedQuery=null,this.lastSearchCacheState=null,this.listboxId=be("sm-listbox"),this.inputId=be("sm-input"),this.liveRegion=null,this.keyboardNavigator=null,this.elements={},this.handleInput=this.handleInput.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.handleResultClick=this.handleResultClick.bind(this)}get widgetType(){throw new Error("Subclass must implement widgetType getter")}render(){throw new Error("Subclass must implement render()")}getResultsContainer(){throw new Error("Subclass must implement getResultsContainer()")}getInputElement(){throw new Error("Subclass must implement getInputElement()")}getLoadingElement(){return this.elements.loading||null}getDebugToolbarElement(){return this.elements.debugToolbar||null}connectedCallback(){this.config=K(this,this.widgetType),this.state.set({recentlyViewed:oe(te(this.config))}),this.keyboardNavigator=Ze({onSelect:t=>this.selectResultAtIndex(t),onIndexChange:t=>this.state.set({selectedIndex:t}),onEscape:()=>this.handleEscape()},{listboxId:this.listboxId}),this.applyDestinationPageHighlight()}disconnectedCallback(){this.unregisterOpenWidget(),this.searchSequence++,this.debounceTimer&&(clearTimeout(this.debounceTimer),this.debounceTimer=null)}registerOpenWidget(){$&&$!==this&&typeof $.close=="function"&&$.close({reason:"replace",replacedBy:this,source:"replace"}),$=this}unregisterOpenWidget(){$===this&&($=null)}claimHotkeyEvent(t,r){return t[ot]||$&&$!==this&&$.state?.get("isOpen")&&$.config?.triggerHotkey?.toLowerCase()===r?!1:(t[ot]=!0,!0)}attributeChangedCallback(t,r,n){r!==n&&this.shadowRoot.children.length>0&&(this.config=K(this,this.widgetType),this.render(),this.applyCustomStyles())}handleStateChange(t,r){(r.includes("results")||r.includes("query")||r.includes("recentlyViewed")||r.includes("error"))&&this.renderResultsContent(),(r.includes("results")||r.includes("meta"))&&this.updateDebugToolbar(),r.includes("selectedIndex")&&this.updateSelectionVisual(),r.includes("loading")&&this.updateLoadingVisual()}handleInput(t){let r=t.target.value;if(this.elements&&this.elements.clear&&(this.elements.clear.hidden=!r),this.state.set({query:r,selectedIndex:-1}),this.debounceTimer&&clearTimeout(this.debounceTimer),this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null),!r.trim()){this.state.set({results:[]});return}r.length<this.config.searchMinChars||(this.debounceTimer=setTimeout(()=>{this.executeSearch(r)},this.config.searchDebounceMs))}async executeSearch(t){let r=++this.searchSequence;this.state.set({loading:!0,error:null}),this.liveRegion&&ee(this.liveRegion,Ve(this.config.translations));try{let{results:n,meta:o}=await Ie({query:t,endpoint:this.config.searchEndpoint,indexHandles:this.config.indexHandles,siteId:this.config.siteId,resultsLimit:this.config.resultsLimit,resultsRequireUrl:this.config.resultsRequireUrl,snippetIncludeCodeBlocks:this.config.snippetIncludeCodeBlocks,snippetMode:this.config.snippetMode,snippetMaxLength:this.config.snippetMaxLength,snippetCleanMarkdown:this.config.snippetCleanMarkdown,debugEnabled:this.config.debugEnabled,apiKey:this.config.apiKey,translations:this.config.translations});if(r!==this.searchSequence)return;this.state.set({results:n,meta:o,loading:!1,selectedIndex:n.length>0?0:-1}),o&&typeof o.cached=="boolean"?this.lastSearchCacheState={cached:o.cached,took:typeof o.took=="number"?o.took:null}:this.lastSearchCacheState=null,this.liveRegion&&ee(this.liveRegion,fe(n.length,t,this.config.translations)),this.dispatchWidgetEvent("search",{query:t,results:n,meta:o}),this.startAnalyticsIdleTimer(t,n.length)}catch(n){if(r!==this.searchSequence||n.name==="AbortError")return;console.error("Search error:",n),this.state.set({results:[],loading:!1,error:n.message}),this.dispatchWidgetEvent("error",{query:t,error:n.message})}}renderResultsContent(){let t=this.getResultsContainer();if(!t)return;let r=this.state.getAll(),{recentlyViewedEnabled:n,resultsGroupingEnabled:o,highlightResultsEnabled:s,highlightTag:i,highlightClass:d,loadingIndicatorEnabled:a,debugEnabled:l}=this.config,{html:c,hasResults:u,showListbox:p}=Je({query:r.query,results:r.results,recentlyViewed:r.recentlyViewed,loading:r.loading,error:r.error,recentlyViewedEnabled:n},{listboxId:this.listboxId,resultsGroupingEnabled:o,highlightResultsEnabled:s,highlightTag:i,highlightClass:d,loadingIndicatorEnabled:a,debugEnabled:l,translations:this.config.translations,highlightDestinationPersistQuery:this.config.highlightDestinationEnabled&&this.config.highlightDestinationPersistQuery,highlightDestinationQueryParam:this.config.highlightDestinationQueryParam,promotionDisplay:this.config.promotionDisplay,promotionBadgeText:this.config.promotionBadgeText,promotionBadgePosition:this.config.promotionBadgePosition,resultsLayout:this.config.resultsLayout,hierarchyGroupBy:this.config.hierarchyGroupBy,hierarchyStyle:this.config.hierarchyStyle,hierarchyDisplay:this.config.hierarchyDisplay,hierarchyMaxHeadings:this.config.hierarchyMaxHeadings});t.innerHTML=c,p?t.setAttribute("role","listbox"):t.removeAttribute("role");let b=this.getInputElement();b&&ae(b,{expanded:u,activeDescendant:null,listboxId:this.listboxId}),this.liveRegion&&!r.loading&&(r.query&&r.results.length===0?ee(this.liveRegion,fe(0,r.query,this.config.translations)):!r.query&&r.recentlyViewed.length>0&&n&&ee(this.liveRegion,Ue(r.recentlyViewed.length,this.config.translations))),this.attachResultHandlers();let f=t.querySelector(".sm-recently-viewed-clear");f&&f.addEventListener("click",m=>{m.stopPropagation(),Pe(te(this.config)),this.state.set({recentlyViewed:[]})}),u&&r.results.length>0&&this.state.set({selectedIndex:0})}attachResultHandlers(){let t=this.getResultsContainer();if(!t)return;let r=t.querySelectorAll(".sm-result-item");r.forEach(n=>{n.addEventListener("click",o=>this.handleResultClick(o,n))}),tt(r,n=>{this.state.set({selectedIndex:n})})}updateSelectionVisual(){let t=this.getResultsContainer(),r=this.getInputElement();if(!t)return;let n=t.querySelectorAll(".sm-result-item"),o=this.state.get("selectedIndex");et(n,o,{scrollContainer:t,inputElement:r,listboxId:this.listboxId})}handleKeydown(t){let r=this.getResultsContainer();if(!r)return;let n=r.querySelectorAll(".sm-result-item"),o=this.state.get("selectedIndex");if(t.key==="Enter"){let s=this.state.get("query"),i=this.state.get("results")||[];s&&i.length>0&&this.trackSearchAnalytics(s,i.length,"enter")}this.keyboardNavigator.handleKeydown(t,n.length,o)}selectResultAtIndex(t){let r=this.getResultsContainer();if(!r)return;let n=r.querySelectorAll(".sm-result-item");t>=0&&n[t]&&n[t].click()}handleEscape(){}handleResultClick(t,r){let n=r.getAttribute("href"),o=r.dataset.url,s=n||o,i=r.dataset.title||r.querySelector(".sm-result-title")?.textContent,d=r.dataset.id,a=r.dataset.elementId||d,l=r.dataset.query||this.state.get("query"),c=r.classList.contains("sm-recently-viewed-item"),u=W(s,l,this.config.highlightDestinationEnabled&&this.config.highlightDestinationPersistQuery?this.config.highlightDestinationQueryParam:"");if(!c&&l){let b=Me(te(this.config),l,{title:i,url:s},this.config.recentlyViewedLimit);this.state.set({recentlyViewed:b})}let p=r.dataset.sourceIndex||Ae(this.config);if(a&&p&&$e({endpoint:this.config.trackClickEndpoint,elementId:a,query:l,index:p,apiKey:this.config.apiKey}),!c&&l&&this.trackSearchAnalytics(l,this.state.get("results")?.length||0,"click"),this.dispatchWidgetEvent("result-click",{id:d,elementId:a,title:i,url:u,query:l,isRecentlyViewed:c}),s&&s!=="#")c&&(t.preventDefault(),window.location.href=F(u,"/")),this.onResultSelected(u,i,d);else if(l){t.preventDefault();let b=this.getInputElement();b&&(b.value=l,this.state.set({query:l}),this.executeSearch(l))}}onResultSelected(t,r,n){}applyDestinationPageHighlight(){if(!this.config.highlightDestinationEnabled||typeof window>"u"||typeof document>"u")return;let t=this.config.highlightDestinationQueryParam||"smq",r=this.config.highlightDestinationContentSelector||"main, article, [data-search-content]",n=new URLSearchParams(window.location.search).get(t);if(!n||!n.trim())return;let o=this.getPageHighlightRegistry(),s=`${t}::${r}`;if(o.has(s))return;o.add(s);let i=()=>{this.ensurePageHighlightStyles(),this.highlightDestinationNodes(n.trim(),r,s)};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",i,{once:!0}):window.requestAnimationFrame(i)}ensurePageHighlightStyles(){if(document.getElementById(rt))return;let t=document.createElement("style");t.id=rt,t.textContent=`
            .sm-page-highlight {
        ...
        `,document.head.appendChild(t)}highlightDestinationNodes(t,r,n){let o=Array.from(document.querySelectorAll(r));if(o.length===0)return;let s=[...new Set(J(t).map(a=>a.trim()).filter(a=>a.length>=2))];if(s.length===0)return;let i=s.map(a=>ze(a)).filter(Boolean).sort((a,l)=>l.length-a.length).join("|");if(!i)return;let d=new RegExp(`(${i})`,"gi");o.forEach(a=>{a.getAttribute("data-sm-highlighted")!==n&&(this.highlightTextNodesInScope(a,d),a.setAttribute("data-sm-highlighted",n))})}highlightTextNodesInScope(t,r){let n=document.createTreeWalker(t,NodeFilter.SHOW_TEXT,{acceptNode:s=>{let i=s.nodeValue;if(!i||!i.trim())return NodeFilter.FILTER_REJECT;let d=s.parentElement;return!d||d.closest("script, style, noscript, textarea, mark, .sm-highlight, .sm-page-highlight, search-modal")?NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT}}),o=[];for(;n.nextNode();)o.push(n.currentNode);o.forEach(s=>{let i=s.nodeValue||"";if(r.lastIndex=0,!r.test(i))return;let d=document.createDocumentFragment(),a=0;r.lastIndex=0;let l=i.matchAll(r);for(let c of l){let u=c[0],p=c.index??-1;if(p<0)continue;p>a&&d.appendChild(document.createTextNode(i.slice(a,p)));let b=document.createElement("mark");b.className="sm-highlight sm-page-highlight",b.textContent=u,d.appendChild(b),a=p+u.length}a<i.length&&d.appendChild(document.createTextNode(i.slice(a))),s.parentNode?.replaceChild(d,s)})}getPageHighlightRegistry(){let t=window[nt];if(t instanceof Set)return t;let r=new Set;return window[nt]=r,r}updateLoadingVisual(){let t=this.getLoadingElement();if(t){let r=this.state.get("loading"),n=this.config?.loadingIndicatorEnabled!==!1;t.hidden=!r||!n}}updateDebugToolbar(){let t=this.getDebugToolbarElement();if(!t)return;let{debugEnabled:r}=this.config,n=this.state.getAll();if(!r||!n.meta||n.results.length===0){t.hidden=!0;return}let o=t.classList.contains("sm-collapsed");t.innerHTML=we(n.meta,n.results.length,o,this.config.translations),t.hidden=!1,o&&t.classList.add("sm-collapsed"),this.attachDebugToolbarHandlers(t)}attachDebugToolbarHandlers(t){let r=t.querySelector(".sm-toolbar-toggle");r&&r.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),this.toggleDebugToolbar()});let n=t.querySelector(".sm-toolbar-collapsed-bar");n&&n.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),this.toggleDebugToolbar()})}toggleDebugToolbar(){let t=this.getDebugToolbarElement();if(!t)return;let r=t.classList.toggle("sm-collapsed"),n=this.state.getAll();t.innerHTML=we(n.meta,n.results.length,r,this.config.translations),r&&t.classList.add("sm-collapsed"),this.attachDebugToolbarHandlers(t)}applyCustomStyles(){if(!this.config)return;let t=this.shadowRoot.host,{theme:r,styles:n}=this.config;Fe(t,n,r)}initializeLiveRegion(){this.liveRegion=qe(this.shadowRoot)}startAnalyticsIdleTimer(t,r){this.analyticsIdleTimer&&clearTimeout(this.analyticsIdleTimer);let n=this.config.analyticsIdleTimeoutMs;!n||n<=0||(this.analyticsIdleTimer=setTimeout(()=>{this.trackSearchAnalytics(t,r,"idle")},n))}trackSearchAnalytics(t,r,n){!t||t===this.lastTrackedQuery||(this.lastTrackedQuery=t,this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null),Le({endpoint:this.config.trackSearchEndpoint,query:t,indexHandles:this.config.indexHandles,resultsCount:r,trigger:n,analyticsSource:this.config.analyticsSource,siteId:this.config.siteId,cached:this.lastSearchCacheState?.cached,took:this.lastSearchCacheState?.took,apiKey:this.config.apiKey}))}resetAnalyticsTracking(){this.lastTrackedQuery=null,this.lastSearchCacheState=null,this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null)}dispatchWidgetEvent(t,r={}){this.dispatchEvent(new CustomEvent(`search-${t}`,{bubbles:!0,composed:!0,detail:r}))}},st=Ce;var it=`/**
...
`+lt,Se=class extends st{constructor(){super(),this.externalTrigger=null,this.previouslyFocused=null,this.open=this.open.bind(this),this.close=this.close.bind(this),this.toggle=this.toggle.bind(this),this.handleGlobalKeydown=this.handleGlobalKeydown.bind(this),this.handleClearClick=this.handleClearClick.bind(this),this.handleBackdropClick=this.handleBackdropClick.bind(this),this.handleTriggerClick=this.handleTriggerClick.bind(this),this.handleExternalTriggerClick=this.handleExternalTriggerClick.bind(this),this.handleCloseClick=this.handleCloseClick.bind(this)}get widgetType(){return"modal"}static get observedAttributes(){return Be("modal")}connectedCallback(){super.connectedCallback(),this.render(),this.attachEventListeners()}disconnectedCallback(){this.state.get("isOpen")&&this.close({reason:"disconnect",source:"disconnect",restoreFocus:!1}),super.disconnectedCallback(),this.detachEventListeners()}attributeChangedCallback(t,r,n){if(r===n||this.shadowRoot.children.length===0)return;if(t==="theme"){this.config=K(this,this.widgetType),this.shadowRoot.host.setAttribute("data-theme",this.config.theme),this.applyCustomStyles();return}let o=this.state.get("isOpen"),s=this.state.get("query")||"";this.detachEventListeners(),this.config=K(this,this.widgetType),this.render(),this.attachEventListeners(),o&&(this.registerOpenWidget(),this.elements.backdrop.hidden=!1,this.elements.trigger.setAttribute("aria-expanded","true"),this.elements.input.value=s,this.elements.clear.hidden=!s,this.renderResultsContent(),this.updateLoadingVisual(),this.updateDebugToolbar(),this.updateSelectionVisual(),document.body.style.overflow=this.config.modalPreventBodyScroll?"hidden":"",requestAnimationFrame(()=>{this.isConnected&&this.elements.input.focus()}))}render(){let{theme:t,placeholder:r,triggerEnabled:n,triggerLabel:o,translations:s}=this.config,i=h(this.getHotkeyDisplay()),d=h(r||""),a=h(o||g(s,"Search")),l=h(g(s,"Search")),c=h(g(s,"Close search")),u=h(g(s,"Clear search")),p=h(g(s,"Search results"));this.shadowRoot.innerHTML=`
            ...
            <div class="sm-backdrop" part="backdrop" hidden>
                <div class="sm-modal" part="modal" role="dialog" aria-modal="true" aria-label="${l}">
                    ...
                    <!-- Results -->
                    <div class="sm-results" part="results" id="${this.listboxId}" role="listbox" aria-label="${p}"></div>
