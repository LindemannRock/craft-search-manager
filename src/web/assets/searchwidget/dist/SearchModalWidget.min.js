var SearchModalWidget=(()=>{var T=Object.defineProperty;var xe=Object.getOwnPropertyDescriptor;var ve=Object.getOwnPropertyNames;var ye=Object.prototype.hasOwnProperty;var we=(e,t)=>{for(var n in t)T(e,n,{get:t[n],enumerable:!0})},Ce=(e,t,n,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of ve(t))!ye.call(e,o)&&o!==n&&T(e,o,{get:()=>t[o],enumerable:!(r=xe(t,o))||r.enumerable});return e};var Se=e=>Ce(T({},"__esModule",{value:!0}),e);var je={};we(je,{default:()=>ze});var Re={indices:[],placeholder:"Search...",endpoint:"/actions/search-manager/search/query",theme:"light",maxResults:10,debounce:200,minChars:2,showRecent:!0,maxRecentSearches:5,groupResults:!0,siteId:"",analyticsEndpoint:"/actions/search-manager/search/track-click",enableHighlighting:!0,highlightTag:"mark",highlightClass:"",hideResultsWithoutUrl:!1,showLoadingIndicator:!0,debug:!1,styles:{},promotions:{showBadge:!0,badgeText:"Featured",badgePosition:"top-right"}},Ae={hotkey:"k",showTrigger:!0,triggerSelector:"",backdropOpacity:50,enableBackdropBlur:!0,preventBodyScroll:!0},De={showFilters:!0,paginationType:"numbered",resultsPerPage:20,updateUrl:!0,sortOptions:["relevance","date-desc","date-asc","title"]},Te={dropdownPosition:"below",dropdownMaxHeight:400,showOnFocus:!0};function Ee(e){return{...Re,...{modal:Ae,page:De,inline:Te}[e]||{}}}function h(e,t=!1){return e==null?t:e===""?!0:e!=="false"&&e!=="0"}function b(e,t=0){if(e==null)return t;let n=Number.parseInt(e,10);return Number.isNaN(n)?t:n}function z(e,t={}){if(!e)return t;try{return JSON.parse(e)}catch(n){return console.warn("SearchWidget: Invalid JSON attribute",n),t}}function j(e){return e?e.split(",").map(t=>t.trim()).filter(Boolean):[]}function E(e,t="modal"){let n=Ee(t),r=e.getAttribute("indices")||"",o=j(r),a={indices:o,index:o[0]||"",placeholder:e.getAttribute("placeholder")||n.placeholder,endpoint:e.getAttribute("endpoint")||n.endpoint,theme:e.getAttribute("theme")||n.theme,siteId:e.getAttribute("site-id")||n.siteId,analyticsEndpoint:e.getAttribute("analytics-endpoint")||n.analyticsEndpoint,highlightTag:e.getAttribute("highlight-tag")||n.highlightTag,highlightClass:e.getAttribute("highlight-class")||n.highlightClass,maxResults:b(e.getAttribute("max-results"),n.maxResults),debounce:b(e.getAttribute("debounce"),n.debounce),minChars:b(e.getAttribute("min-chars"),n.minChars),maxRecentSearches:b(e.getAttribute("max-recent-searches"),n.maxRecentSearches),showRecent:h(e.getAttribute("show-recent"),n.showRecent),groupResults:h(e.getAttribute("group-results"),n.groupResults),enableHighlighting:h(e.getAttribute("enable-highlighting"),n.enableHighlighting),showLoadingIndicator:h(e.getAttribute("show-loading-indicator"),n.showLoadingIndicator),hideResultsWithoutUrl:h(e.getAttribute("hide-results-without-url"),n.hideResultsWithoutUrl),debug:h(e.getAttribute("debug"),n.debug),styles:z(e.getAttribute("styles"),n.styles),promotions:z(e.getAttribute("promotions"),n.promotions)};return t==="modal"&&Object.assign(a,{hotkey:e.getAttribute("hotkey")||n.hotkey,triggerSelector:e.getAttribute("trigger-selector")||n.triggerSelector,backdropOpacity:b(e.getAttribute("backdrop-opacity"),n.backdropOpacity),showTrigger:h(e.getAttribute("show-trigger"),n.showTrigger),enableBackdropBlur:h(e.getAttribute("enable-backdrop-blur"),n.enableBackdropBlur),preventBodyScroll:h(e.getAttribute("prevent-body-scroll"),n.preventBodyScroll)}),t==="page"&&Object.assign(a,{resultsPerPage:b(e.getAttribute("results-per-page"),n.resultsPerPage),paginationType:e.getAttribute("pagination-type")||n.paginationType,showFilters:h(e.getAttribute("show-filters"),n.showFilters),updateUrl:h(e.getAttribute("update-url"),n.updateUrl),sortOptions:j(e.getAttribute("sort-options"))||n.sortOptions}),t==="inline"&&Object.assign(a,{dropdownPosition:e.getAttribute("dropdown-position")||n.dropdownPosition,dropdownMaxHeight:b(e.getAttribute("dropdown-max-height"),n.dropdownMaxHeight),showOnFocus:h(e.getAttribute("show-on-focus"),n.showOnFocus)}),a}function W(e="modal"){let t=["indices","placeholder","endpoint","theme","max-results","debounce","min-chars","show-recent","max-recent-searches","group-results","site-id","analytics-endpoint","enable-highlighting","highlight-tag","highlight-class","hide-results-without-url","show-loading-indicator","debug","styles","promotions"],a={modal:["hotkey","show-trigger","trigger-selector","backdrop-opacity","enable-backdrop-blur","prevent-body-scroll"],page:["show-filters","pagination-type","results-per-page","update-url","sort-options"],inline:["dropdown-position","dropdown-max-height","show-on-focus"]};return[...t,...a[e]||[]]}var S={isOpen:!1,query:"",results:[],recentSearches:[],selectedIndex:-1,loading:!1,error:null,meta:null};function _(e={},t=null){let n={...S,...e};return{get(r){return n[r]},getAll(){return{...n}},set(r){let o=[];return Object.keys(r).forEach(a=>{let s=n[a],l=r[a];R(s,l)||o.push(a)}),o.length>0&&(n={...n,...r},t&&t(n,o)),o},reset(r=e){let o={...S,...r},a=Object.keys(o).filter(s=>!R(n[s],o[s]));a.length>0&&(n=o,t&&t(n,a))},is(r,o){return n[r]===o},toggle(r){let o=!n[r];return this.set({[r]:o}),o}}}function R(e,t){if(e===t)return!0;if(e==null||t==null)return!1;if(Array.isArray(e)&&Array.isArray(t))return e.length!==t.length?!1:e.every((n,r)=>R(n,t[r]));if(typeof e=="object"&&typeof t=="object"){let n=Object.keys(e),r=Object.keys(t);return n.length!==r.length?!1:n.every(o=>R(e[o],t[o]))}return!1}async function G({query:e,endpoint:t,indices:n=[],siteId:r="",maxResults:o=10,hideResultsWithoutUrl:a=!1,debug:s=!1,signal:l}){let i=new URLSearchParams({q:e,limit:o.toString()});n.length>0&&i.append("indices",n.join(",")),r&&i.append("siteId",r),a&&i.append("hideResultsWithoutUrl","1"),s&&i.append("debug","1");let d=t.includes("?")?"&":"?",g=await fetch(`${t}${d}${i}`,{signal:l,headers:{Accept:"application/json"}});if(!g.ok)throw new Error("Search failed");let u=await g.json();return{results:u.results||u.hits||[],total:u.total||0,meta:u.meta||null}}function K({endpoint:e,elementId:t,query:n,index:r}){if(!(!t||!e))try{let o=new FormData;o.append("elementId",t),o.append("query",n),o.append("index",r),fetch(e,{method:"POST",body:o}).catch(()=>{})}catch{}}function V(e){let t={};return e.forEach(n=>{let r=n.section||n.type||"Results";t[r]||(t[r]=[]),t[r].push(n)}),t}var Be="sm-recent-";function B(e){return`${Be}${e||"default"}`}function A(e){try{let t=B(e),n=localStorage.getItem(t);return n?JSON.parse(n):[]}catch{return[]}}function Y(e,t,n=null,r=5){if(!t||!t.trim())return A(e);let o=B(e),a={query:t.trim(),title:n?.title||t,url:n?.url||null,timestamp:Date.now()},s=A(e);s=s.filter(l=>l.query!==a.query),s.unshift(a),s=s.slice(0,r);try{localStorage.setItem(o,JSON.stringify(s))}catch{}return s}function X(e){try{let t=B(e);localStorage.removeItem(t)}catch{}}var J={spinnerColor:"#3b82f6",spinnerColorDark:"#60a5fa",modalBg:"#ffffff",modalBgDark:"#1f2937",modalBorderRadius:"12",modalBorderWidth:"1",modalBorderColor:"#e5e7eb",modalBorderColorDark:"#374151",modalShadow:"0 25px 50px -12px rgba(0, 0, 0, 0.25)",modalShadowDark:"0 25px 50px -12px rgba(0, 0, 0, 0.5)",modalMaxWidth:"640",modalMaxHeight:"80",inputBg:"#ffffff",inputBgDark:"#1f2937",inputTextColor:"#111827",inputTextColorDark:"#f9fafb",inputPlaceholderColor:"#9ca3af",inputPlaceholderColorDark:"#9ca3af",inputBorderColor:"#e5e7eb",inputBorderColorDark:"#374151",inputFontSize:"16",resultBg:"transparent",resultBgDark:"transparent",resultHoverBg:"#f3f4f6",resultHoverBgDark:"#374151",resultActiveBg:"#e5e7eb",resultActiveBgDark:"#4b5563",resultTextColor:"#111827",resultTextColorDark:"#f9fafb",resultDescColor:"#4b5563",resultDescColorDark:"#d1d5db",resultMutedColor:"#6b7280",resultMutedColorDark:"#d1d5db",resultBorderRadius:"8",triggerBg:"#ffffff",triggerBgDark:"#374151",triggerTextColor:"#374151",triggerTextColorDark:"#d1d5db",triggerBorderRadius:"8",triggerBorderWidth:"1",triggerBorderColor:"#d1d5db",triggerBorderColorDark:"#4b5563",triggerPaddingX:"12",triggerPaddingY:"8",triggerFontSize:"14",kbdBg:"#f3f4f6",kbdBgDark:"#4b5563",kbdTextColor:"#4b5563",kbdTextColorDark:"#e5e7eb",kbdBorderRadius:"4"};var Q={modalBg:"--sm-modal-bg",modalBgDark:"--sm-modal-bg-dark",modalBorderRadius:"--sm-modal-radius",modalBorderWidth:"--sm-modal-border-width",modalBorderColor:"--sm-modal-border-color",modalBorderColorDark:"--sm-modal-border-color-dark",modalShadow:"--sm-modal-shadow",modalShadowDark:"--sm-modal-shadow-dark",modalMaxWidth:"--sm-modal-width",modalMaxHeight:"--sm-modal-max-height",inputBg:"--sm-input-bg",inputBgDark:"--sm-input-bg-dark",inputTextColor:"--sm-input-color",inputTextColorDark:"--sm-input-color-dark",inputPlaceholderColor:"--sm-input-placeholder",inputPlaceholderColorDark:"--sm-input-placeholder-dark",inputBorderColor:"--sm-input-border-color",inputBorderColorDark:"--sm-input-border-color-dark",inputFontSize:"--sm-input-font-size",resultBg:"--sm-result-bg",resultBgDark:"--sm-result-bg-dark",resultHoverBg:"--sm-result-hover-bg",resultHoverBgDark:"--sm-result-hover-bg-dark",resultActiveBg:"--sm-result-active-bg",resultActiveBgDark:"--sm-result-active-bg-dark",resultTextColor:"--sm-result-text-color",resultTextColorDark:"--sm-result-text-color-dark",resultDescColor:"--sm-result-desc-color",resultDescColorDark:"--sm-result-desc-color-dark",resultMutedColor:"--sm-result-muted-color",resultMutedColorDark:"--sm-result-muted-color-dark",resultBorderRadius:"--sm-result-radius",triggerBg:"--sm-trigger-bg",triggerBgDark:"--sm-trigger-bg-dark",triggerTextColor:"--sm-trigger-text-color",triggerTextColorDark:"--sm-trigger-text-color-dark",triggerBorderRadius:"--sm-trigger-radius",triggerBorderWidth:"--sm-trigger-border-width",triggerBorderColor:"--sm-trigger-border-color",triggerBorderColorDark:"--sm-trigger-border-color-dark",triggerPaddingX:"--sm-trigger-px",triggerPaddingY:"--sm-trigger-py",triggerFontSize:"--sm-trigger-font-size",kbdBg:"--sm-kbd-bg",kbdBgDark:"--sm-kbd-bg-dark",kbdTextColor:"--sm-kbd-text-color",kbdTextColorDark:"--sm-kbd-text-color-dark",kbdBorderRadius:"--sm-kbd-radius",highlightBgLight:"--sm-highlight-bg",highlightColorLight:"--sm-highlight-color",highlightBgDark:"--sm-highlight-bg-dark",highlightColorDark:"--sm-highlight-color-dark",spinnerColor:"--sm-spinner-color-light",spinnerColorDark:"--sm-spinner-color-dark"},Z=["modalBorderRadius","modalBorderWidth","modalMaxWidth","inputFontSize","resultBorderRadius","triggerBorderRadius","triggerBorderWidth","triggerPaddingX","triggerPaddingY","triggerFontSize","kbdBorderRadius"],ee=["modalMaxHeight"],te=["modalBg","modalBgDark","modalBorderColor","modalBorderColorDark","inputBg","inputBgDark","inputTextColor","inputTextColorDark","inputPlaceholderColor","inputPlaceholderColorDark","inputBorderColor","inputBorderColorDark","resultBg","resultBgDark","resultHoverBg","resultHoverBgDark","resultActiveBg","resultActiveBgDark","resultTextColor","resultTextColorDark","resultDescColor","resultDescColorDark","resultMutedColor","resultMutedColorDark","triggerBg","triggerBgDark","triggerTextColor","triggerTextColorDark","triggerBorderColor","triggerBorderColorDark","kbdBg","kbdBgDark","kbdTextColor","kbdTextColorDark","highlightBgLight","highlightColorLight","highlightBgDark","highlightColorDark","spinnerColor","spinnerColorDark"],Je={...J,highlightBgLight:"#fef08a",highlightColorLight:"#854d0e",highlightBgDark:"#854d0e",highlightColorDark:"#fef08a"};function Le(e){return/^[0-9a-fA-F]{6}$/.test(e)}function $e(e,t){if(t==null||t==="")return null;let n=String(t);return te.includes(e)&&Le(n)&&(n="#"+n),Z.includes(e)&&(n=n+"px"),ee.includes(e)&&(n=n+"vh"),n}function ne(e,t,n="light"){if(!t||typeof t!="object")return;let r=n==="dark";for(let[o,a]of Object.entries(Q)){let s=o.endsWith("Dark");if(!(r&&!s)&&!(!r&&s)&&t[o]!==void 0&&t[o]!==null&&t[o]!==""){let l=$e(o,t[o]);l&&e.style.setProperty(a,l)}}}function c(e){if(!e)return"";let t=document.createElement("div");return t.textContent=e,t.innerHTML}function Me(e){return e?e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"):""}function I(e,t,n={}){let{enabled:r=!0,tag:o="mark",className:a=""}=n,s=c(e);if(!r||!t)return s;let l=t.toLowerCase().split(/\s+/).filter(u=>u.length>0);if(l.length===0)return s;let i=["sm-highlight"];a&&i.push(a);let d=` class="${i.join(" ")}"`,g=s;return l.forEach(u=>{let f=new RegExp(`\\b(${Me(u)})\\b`,"gi");g=g.replace(f,`<${o}${d}>$1</${o}>`)}),g}var Oe=0;function L(e="sm"){return`${e}-${++Oe}-${Date.now().toString(36)}`}function re(e){let t=document.createElement("div");return t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-atomic","true"),t.className="sm-sr-only",e.appendChild(t),t}function v(e,t,n=100){e&&(e.textContent="",setTimeout(()=>{e.textContent=t},n))}function $(e,t){return e===0?`No results found for "${t}"`:e===1?`1 result found for "${t}"`:`${e} results found for "${t}"`}function oe(){return"Searching..."}function ae(e){return e===0?"No recent searches":e===1?"1 recent search available":`${e} recent searches available`}function D(e,{expanded:t,activeDescendant:n,listboxId:r}){e.setAttribute("aria-expanded",String(t)),e.setAttribute("aria-controls",r),n?e.setAttribute("aria-activedescendant",n):e.removeAttribute("aria-activedescendant")}function y(e,t){return`${e}-option-${t}`}function se(e,t){if(!e||!t)return;let n=e.getBoundingClientRect(),r=t.getBoundingClientRect();n.top<r.top?e.scrollIntoView({block:"nearest",behavior:"smooth"}):n.bottom>r.bottom&&e.scrollIntoView({block:"nearest",behavior:"smooth"})}function Pe(e,t,n={}){let{groupResults:r=!1,listboxId:o}=n;if(!e||e.length===0)return"";if(r){let a=V(e),s=0;return Object.entries(a).map(([l,i])=>`
            <div class="sm-section" role="group" aria-label="${c(l)}">
                <div class="sm-section-header">${c(l)}</div>
                ${i.map(d=>ie(d,s++,t,n)).join("")}
            </div>
        `).join("")}return e.map((a,s)=>ie(a,s,t,n)).join("")}function ie(e,t,n,r={}){let{listboxId:o,enableHighlighting:a=!0,highlightTag:s="mark",highlightClass:l="",groupResults:i=!1,promotions:d={},debug:g=!1}=r,u=e.title||e.name||"Untitled",f=e.description||e.excerpt||e.snippet||"",k=e.url||e.href||"#",x=e.section||e.type||"",w=y(o,t),fe=e.promoted===!0,H={enabled:a,tag:s,className:l},F=I(u,n,H),C=f?I(f,n,H):"",N=Fe(e,d),U=fe?" sm-promoted":"",q=x&&!i?`<span class="sm-result-type">${c(x)}</span>`:"",ke=g?He(e):"";return g?`
            <a class="sm-result-item sm-debug-enabled${U}" id="${w}" role="option" aria-selected="false" href="${c(k)}" data-index="${t}" data-id="${e.id||""}" data-title="${c(u)}">
        ...
        `:`
        <a class="sm-result-item${U}" id="${w}" role="option" aria-selected="false" href="${c(k)}" data-index="${t}" data-id="${e.id||""}" data-title="${c(u)}">
            ${N}
            <div class="sm-result-content">
                <span class="sm-result-title">${F}</span>
                ${C?`<span class="sm-result-desc">${C}</span>`:""}
    ...
    `}function He(e){let t=[],n=e.backend?e.backend.toLowerCase():"";if((e._index||e.index)&&t.push(m("index",e._index||e.index,"index")),e.backend&&t.push(m("backend",n,"backend",n)),e.id&&t.push(m("id",e.id,"generic")),e.score!==void 0&&e.score!==null){let r=typeof e.score=="number"?e.score.toFixed(2):e.score;t.push(m("score",r,"score"))}if(e.site&&t.push(m("site",e.site,"generic")),e.language&&t.push(m("lang",e.language,"generic")),e.matchedIn&&Array.isArray(e.matchedIn)&&e.matchedIn.length>0){let r=e.matchedIn.join(", ");t.push(m("matched",r,"matched"))}return e.promoted&&t.push(m("promoted","yes","promoted")),e.boosted&&t.push(m("boosted","yes","boosted")),t.length===0?"":`<div class="sm-debug-info">${t.join("")}</div>`}function m(e,t,n,r=""){let o=r?` data-backend="${c(r)}"`:"";return`<span class="sm-debug-item"><span class="sm-debug-label">${c(e)}</span><span class="sm-debug-value" data-type="${c(n)}"${o}>${c(String(t))}</span></span>`}function Fe(e,t={}){let{showBadge:n=!0,badgeText:r="Featured",badgePosition:o="top-right"}=t;return!e.promoted||!n?"":`<span class="sm-promoted-badge ${`sm-promoted-badge--${o}`}">${c(r)}</span>`}function Ne(e,t){return!e||e.length===0?"":`
        <div class="sm-section">
            ...
            ${e.map((n,r)=>`
                <div class="sm-result-item sm-recent-item" id="${y(t,r)}" role="option" aria-selected="false" data-index="${r}" data-url="${n.url||""}" data-query="${c(n.query)}">
    ...
    `}function le(e){return!e||!e.trim()?`
        ...
        <div class="sm-empty" part="empty">
            ...
            <p>No results for "<strong>${c(e)}</strong>"</p>
        </div>
    `}function Ue(){return`
    ...
    `}function de(e,t){let{query:n,results:r,recentSearches:o,loading:a,showRecent:s}=e,{showLoadingIndicator:l=!0}=t,i=n&&n.trim();return a&&l?{html:Ue(),hasResults:!1,showListbox:!1}:i?!r||r.length===0?{html:le(n),hasResults:!1,showListbox:!1}:{html:Pe(r,n,t),hasResults:!0,showListbox:!0}:s&&o&&o.length>0?{html:Ne(o,t.listboxId),hasResults:!0,showListbox:!0}:{html:le(""),hasResults:!1,showListbox:!1}}function M(e,t,n=!1){if(!e)return"";let r=[];if(r.push(p("results",t,"generic")),e.took!==void 0){let i=e.took<1?"<1ms":`${Math.round(e.took)}ms`;r.push(p("time",i,"time"))}if(e.cacheEnabled!==void 0&&(e.cacheEnabled?e.cached?r.push(p("cache","hit","cache-hit")):r.push(p("cache","miss","cache-miss")):r.push(p("cache","off","cache-off"))),e.cacheDriver&&r.push(p("storage",e.cacheDriver,"cache-driver",e.cacheDriver)),e.indices&&e.indices.length>0){let i=e.indices.length>2?`${e.indices.length} indices`:e.indices.join(", ");r.push(p("indices",i,"generic"))}if(e.synonymsExpanded){let i=e.expandedQueries?e.expandedQueries.length-1:0;r.push(p("synonyms",`+${i}`,"synonyms"))}let o=e.rulesMatched?.length||0;r.push(p("rules",o,o>0?"rules":"generic"));let a=e.promotionsMatched?.length||0;r.push(p("promoted",a,a>0?"promotions":"generic"));let l=`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">${n?'<path d="M6 9l6 6 6-6"/>':'<path d="M18 15l-6-6-6 6"/>'}</svg>`;return n?`<div class="sm-toolbar-collapsed-bar"><span class="sm-toolbar-collapsed-label">Debug</span>${l}</div>`:`<div class="sm-toolbar-content">${r.join("")}</div><button class="sm-toolbar-toggle" aria-label="Collapse debug panel" aria-expanded="true">${l}</button>`}function p(e,t,n,r=""){let o=r?` data-backend="${c(r)}"`:"";return`<span class="sm-toolbar-item"><span class="sm-toolbar-label">${c(e)}</span><span class="sm-toolbar-value" data-type="${c(n)}"${o}>${c(String(t))}</span></span>`}function ce(e,t){let{onSelect:n,onIndexChange:r,onEscape:o}=e,{listboxId:a}=t;return{handleKeydown(s,l,i){let d=i;switch(s.key){case"ArrowDown":return s.preventDefault(),d=Math.min(i+1,l-1),d!==i&&r&&r(d),d;case"ArrowUp":return s.preventDefault(),d=Math.max(i-1,-1),d!==i&&r&&r(d),d;case"Enter":return s.preventDefault(),i>=0&&n&&n(i),null;case"Escape":return s.preventDefault(),o&&o(),null;default:return null}},getListboxId(){return a}}}function ge(e,t,n={}){let{scrollContainer:r,inputElement:o,listboxId:a,selectedClass:s="sm-selected"}=n,l=t>=0?y(a,t):null;o&&D(o,{expanded:e.length>0,activeDescendant:l,listboxId:a}),e.forEach((i,d)=>{let g=d===t;i.classList.toggle(s,g),i.setAttribute("aria-selected",String(g)),g&&r&&se(i,r)})}function ue(e,t){e.forEach((n,r)=>{n.addEventListener("mouseenter",()=>{t&&t(r)})})}var O=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.config=null,this.state=_({...S},this.handleStateChange.bind(this)),this.abortController=null,this.debounceTimer=null,this.listboxId=L("sm-listbox"),this.inputId=L("sm-input"),this.liveRegion=null,this.keyboardNavigator=null,this.elements={},this.handleInput=this.handleInput.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.handleResultClick=this.handleResultClick.bind(this)}get widgetType(){throw new Error("Subclass must implement widgetType getter")}render(){throw new Error("Subclass must implement render()")}getResultsContainer(){throw new Error("Subclass must implement getResultsContainer()")}getInputElement(){throw new Error("Subclass must implement getInputElement()")}getLoadingElement(){return this.elements.loading||null}getDebugToolbarElement(){return this.elements.debugToolbar||null}connectedCallback(){this.config=E(this,this.widgetType),this.state.set({recentSearches:A(this.config.index)}),this.keyboardNavigator=ce({onSelect:t=>this.selectResultAtIndex(t),onIndexChange:t=>this.state.set({selectedIndex:t}),onEscape:()=>this.handleEscape()},{listboxId:this.listboxId})}disconnectedCallback(){this.abortController&&(this.abortController.abort(),this.abortController=null),this.debounceTimer&&(clearTimeout(this.debounceTimer),this.debounceTimer=null)}attributeChangedCallback(t,n,r){n!==r&&this.shadowRoot.children.length>0&&(this.config=E(this,this.widgetType),this.render(),this.applyCustomStyles())}handleStateChange(t,n){(n.includes("results")||n.includes("query")||n.includes("recentSearches"))&&this.renderResultsContent(),(n.includes("results")||n.includes("meta"))&&this.updateDebugToolbar(),n.includes("selectedIndex")&&this.updateSelectionVisual(),n.includes("loading")&&this.updateLoadingVisual()}handleInput(t){let n=t.target.value;if(this.state.set({query:n,selectedIndex:-1}),this.debounceTimer&&clearTimeout(this.debounceTimer),!n.trim()){this.state.set({results:[]});return}n.length<this.config.minChars||(this.debounceTimer=setTimeout(()=>{this.executeSearch(n)},this.config.debounce))}async executeSearch(t){this.abortController&&this.abortController.abort(),this.abortController=new AbortController,this.state.set({loading:!0,error:null}),this.liveRegion&&v(this.liveRegion,oe());try{let{results:n,meta:r}=await G({query:t,endpoint:this.config.endpoint,indices:this.config.indices,siteId:this.config.siteId,maxResults:this.config.maxResults,hideResultsWithoutUrl:this.config.hideResultsWithoutUrl,debug:this.config.debug,signal:this.abortController.signal});this.state.set({results:n,meta:r,loading:!1,selectedIndex:n.length>0?0:-1}),this.liveRegion&&v(this.liveRegion,$(n.length,t)),this.dispatchWidgetEvent("search",{query:t,results:n,meta:r})}catch(n){if(n.name==="AbortError")return;console.error("Search error:",n),this.state.set({results:[],loading:!1,error:n.message}),this.dispatchWidgetEvent("error",{query:t,error:n.message})}}renderResultsContent(){let t=this.getResultsContainer();if(!t)return;let n=this.state.getAll(),{showRecent:r,groupResults:o,enableHighlighting:a,highlightTag:s,highlightClass:l,showLoadingIndicator:i,debug:d}=this.config,{html:g,hasResults:u,showListbox:f}=de({query:n.query,results:n.results,recentSearches:n.recentSearches,loading:n.loading,showRecent:r},{listboxId:this.listboxId,groupResults:o,enableHighlighting:a,highlightTag:s,highlightClass:l,showLoadingIndicator:i,debug:d,promotions:this.config.promotions});t.innerHTML=g,f?t.setAttribute("role","listbox"):t.removeAttribute("role");let k=this.getInputElement();k&&D(k,{expanded:u,activeDescendant:null,listboxId:this.listboxId}),this.liveRegion&&!n.loading&&(n.query&&n.results.length===0?v(this.liveRegion,$(0,n.query)):!n.query&&n.recentSearches.length>0&&r&&v(this.liveRegion,ae(n.recentSearches.length))),this.attachResultHandlers();let x=t.querySelector(".sm-clear-recent");x&&x.addEventListener("click",w=>{w.stopPropagation(),X(this.config.index),this.state.set({recentSearches:[]})}),u&&n.results.length>0&&this.state.set({selectedIndex:0})}attachResultHandlers(){let t=this.getResultsContainer();if(!t)return;let n=t.querySelectorAll(".sm-result-item");n.forEach(r=>{r.addEventListener("click",o=>this.handleResultClick(o,r))}),ue(n,r=>{this.state.set({selectedIndex:r})})}updateSelectionVisual(){let t=this.getResultsContainer(),n=this.getInputElement();if(!t)return;let r=t.querySelectorAll(".sm-result-item"),o=this.state.get("selectedIndex");ge(r,o,{scrollContainer:t,inputElement:n,listboxId:this.listboxId})}handleKeydown(t){let n=this.getResultsContainer();if(!n)return;let r=n.querySelectorAll(".sm-result-item"),o=this.state.get("selectedIndex");this.keyboardNavigator.handleKeydown(t,r.length,o)}selectResultAtIndex(t){let n=this.getResultsContainer();if(!n)return;let r=n.querySelectorAll(".sm-result-item");t>=0&&r[t]&&r[t].click()}handleEscape(){}handleResultClick(t,n){let r=n.getAttribute("href"),o=n.dataset.url,a=r||o,s=n.dataset.title||n.querySelector(".sm-result-title")?.textContent,l=n.dataset.id,i=n.dataset.query||this.state.get("query"),d=n.classList.contains("sm-recent-item");if(!d&&i){let g=Y(this.config.index,i,{title:s,url:a},this.config.maxRecentSearches);this.state.set({recentSearches:g})}if(l&&this.config.index&&K({endpoint:this.config.analyticsEndpoint,elementId:l,query:i,index:this.config.index}),this.dispatchWidgetEvent("result-click",{id:l,title:s,url:a,query:i,isRecent:d}),a&&a!=="#")d&&(t.preventDefault(),window.location.href=a),this.onResultSelected(a,s,l);else if(i){t.preventDefault();let g=this.getInputElement();g&&(g.value=i,this.state.set({query:i}),this.executeSearch(i))}}onResultSelected(t,n,r){}updateLoadingVisual(){let t=this.getLoadingElement();if(t){let n=this.state.get("loading"),r=this.config?.showLoadingIndicator!==!1;t.hidden=!n||!r}}updateDebugToolbar(){let t=this.getDebugToolbarElement();if(!t)return;let{debug:n}=this.config,r=this.state.getAll();if(!n||!r.meta||r.results.length===0){t.hidden=!0;return}let o=t.classList.contains("sm-collapsed");t.innerHTML=M(r.meta,r.results.length,o),t.hidden=!1,o&&t.classList.add("sm-collapsed"),this.attachDebugToolbarHandlers(t)}attachDebugToolbarHandlers(t){let n=t.querySelector(".sm-toolbar-toggle");n&&n.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),this.toggleDebugToolbar()});let r=t.querySelector(".sm-toolbar-collapsed-bar");r&&r.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),this.toggleDebugToolbar()})}toggleDebugToolbar(){let t=this.getDebugToolbarElement();if(!t)return;let n=t.classList.toggle("sm-collapsed"),r=this.state.getAll();t.innerHTML=M(r.meta,r.results.length,n),n&&t.classList.add("sm-collapsed"),this.attachDebugToolbarHandlers(t)}applyCustomStyles(){if(!this.config)return;let t=this.shadowRoot.host,{theme:n,styles:r}=this.config;ne(t,r,n)}initializeLiveRegion(){this.liveRegion=re(this.shadowRoot)}dispatchWidgetEvent(t,n={}){this.dispatchEvent(new CustomEvent(`search-${t}`,{bubbles:!0,composed:!0,detail:n}))}},he=O;var pe=`/**
