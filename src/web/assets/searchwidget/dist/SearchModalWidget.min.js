var SearchModalWidget=(()=>{var q=Object.defineProperty;var He=Object.getOwnPropertyDescriptor;var Oe=Object.getOwnPropertyNames;var Fe=Object.prototype.hasOwnProperty;var Ne=(e,t)=>{for(var r in t)q(e,r,{get:t[r],enumerable:!0})},ze=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of Oe(t))!Fe.call(e,o)&&o!==r&&q(e,o,{get:()=>t[o],enumerable:!(n=He(t,o))||n.enumerable});return e};var Ue=e=>ze(q({},"__esModule",{value:!0}),e);var gt={};Ne(gt,{default:()=>ut});var je={indices:[],placeholder:"Search...",theme:"light",maxResults:20,debounce:200,minChars:2,showRecent:!0,maxRecentSearches:5,groupResults:!0,siteId:"",searchEndpoint:"/actions/search-manager/api/search",trackClickEndpoint:"/actions/search-manager/search/track-click",trackSearchEndpoint:"/actions/search-manager/search/track-search",idleTimeout:1500,source:"",enableHighlighting:!0,highlightTag:"mark",highlightClass:"",hideResultsWithoutUrl:!1,showCodeSnippets:!1,snippetMode:"balanced",showLoadingIndicator:!0,debug:!1,resultTitleLines:1,resultDescLines:1,snippetLength:150,parseMarkdownSnippets:!1,resultLayout:"default",hierarchyGroupBy:"",hierarchyStyle:"tree",hierarchyDisplay:"individual",maxHeadingsPerResult:3,styles:{},promotions:{showBadge:!0,badgeText:"Featured",badgePosition:"top-right"}},_e={hotkey:"k",showTrigger:!0,triggerSelector:"",backdropOpacity:50,enableBackdropBlur:!0,preventBodyScroll:!0},Ge={showFilters:!0,paginationType:"numbered",resultsPerPage:20,updateUrl:!0,sortOptions:["relevance","date-desc","date-asc","title"]},qe={dropdownPosition:"below",dropdownMaxHeight:400,showOnFocus:!0};function We(e){return{...je,...{modal:_e,page:Ge,inline:qe}[e]||{}}}function f(e,t=!1){return e==null?t:e===""?!0:e!=="false"&&e!=="0"}function k(e,t=0){if(e==null)return t;let r=Number.parseInt(e,10);return Number.isNaN(r)?t:r}function re(e,t={}){if(!e)return t;try{return JSON.parse(e)}catch(r){return console.warn("SearchWidget: Invalid JSON attribute",r),t}}function ne(e){return e?e.split(",").map(t=>t.trim()).filter(Boolean):[]}function W(e,t="modal"){let r=We(t),n=e.getAttribute("indices")||"",o=ne(n),s={indices:o,index:o[0]||"",placeholder:e.getAttribute("placeholder")||r.placeholder,theme:e.getAttribute("theme")||r.theme,siteId:e.getAttribute("site-id")||r.siteId,source:e.getAttribute("source")||r.source,highlightTag:e.getAttribute("highlight-tag")||r.highlightTag,highlightClass:e.getAttribute("highlight-class")||r.highlightClass,searchEndpoint:r.searchEndpoint,trackClickEndpoint:r.trackClickEndpoint,trackSearchEndpoint:r.trackSearchEndpoint,maxResults:k(e.getAttribute("max-results"),r.maxResults),debounce:k(e.getAttribute("debounce"),r.debounce),minChars:k(e.getAttribute("min-chars"),r.minChars),maxRecentSearches:k(e.getAttribute("max-recent-searches"),r.maxRecentSearches),idleTimeout:k(e.getAttribute("idle-timeout"),r.idleTimeout),showRecent:f(e.getAttribute("show-recent"),r.showRecent),groupResults:f(e.getAttribute("group-results"),r.groupResults),enableHighlighting:f(e.getAttribute("enable-highlighting"),r.enableHighlighting),showLoadingIndicator:f(e.getAttribute("show-loading-indicator"),r.showLoadingIndicator),hideResultsWithoutUrl:f(e.getAttribute("hide-results-without-url"),r.hideResultsWithoutUrl),showCodeSnippets:f(e.getAttribute("show-code-snippets"),r.showCodeSnippets),debug:f(e.getAttribute("debug"),r.debug),snippetMode:e.getAttribute("snippet-mode")||r.snippetMode,snippetLength:k(e.getAttribute("snippet-length"),r.snippetLength),parseMarkdownSnippets:f(e.getAttribute("parse-markdown-snippets"),r.parseMarkdownSnippets),resultTitleLines:k(e.getAttribute("result-title-lines"),r.resultTitleLines),resultDescLines:k(e.getAttribute("result-desc-lines"),r.resultDescLines),resultLayout:e.getAttribute("result-layout")||r.resultLayout,hierarchyGroupBy:e.getAttribute("hierarchy-group-by")||r.hierarchyGroupBy,hierarchyStyle:e.getAttribute("hierarchy-style")||r.hierarchyStyle,hierarchyDisplay:e.getAttribute("hierarchy-display")||r.hierarchyDisplay,maxHeadingsPerResult:k(e.getAttribute("max-headings-per-result"),r.maxHeadingsPerResult),styles:re(e.getAttribute("styles"),r.styles),promotions:re(e.getAttribute("promotions"),r.promotions)};return t==="modal"&&Object.assign(s,{hotkey:e.getAttribute("hotkey")||r.hotkey,triggerSelector:e.getAttribute("trigger-selector")||r.triggerSelector,backdropOpacity:k(e.getAttribute("backdrop-opacity"),r.backdropOpacity),showTrigger:f(e.getAttribute("show-trigger"),r.showTrigger),enableBackdropBlur:f(e.getAttribute("enable-backdrop-blur"),r.enableBackdropBlur),preventBodyScroll:f(e.getAttribute("prevent-body-scroll"),r.preventBodyScroll)}),t==="page"&&Object.assign(s,{resultsPerPage:k(e.getAttribute("results-per-page"),r.resultsPerPage),paginationType:e.getAttribute("pagination-type")||r.paginationType,showFilters:f(e.getAttribute("show-filters"),r.showFilters),updateUrl:f(e.getAttribute("update-url"),r.updateUrl),sortOptions:ne(e.getAttribute("sort-options"))||r.sortOptions}),t==="inline"&&Object.assign(s,{dropdownPosition:e.getAttribute("dropdown-position")||r.dropdownPosition,dropdownMaxHeight:k(e.getAttribute("dropdown-max-height"),r.dropdownMaxHeight),showOnFocus:f(e.getAttribute("show-on-focus"),r.showOnFocus)}),s}function oe(e="modal"){let t=["indices","placeholder","theme","max-results","debounce","min-chars","show-recent","max-recent-searches","group-results","site-id","idle-timeout","source","enable-highlighting","highlight-tag","highlight-class","hide-results-without-url","show-code-snippets","snippet-mode","show-loading-indicator","debug","styles","promotions","result-layout","hierarchy-group-by","hierarchy-style","hierarchy-display","max-headings-per-result","result-title-lines","result-desc-lines","snippet-length","parse-markdown-snippets"],s={modal:["hotkey","show-trigger","trigger-selector","backdrop-opacity","enable-backdrop-blur","prevent-body-scroll"],page:["show-filters","pagination-type","results-per-page","update-url","sort-options"],inline:["dropdown-position","dropdown-max-height","show-on-focus"]};return[...t,...s[e]||[]]}var N={isOpen:!1,query:"",results:[],recentSearches:[],selectedIndex:-1,loading:!1,error:null,meta:null};function se(e={},t=null){let r={...N,...e};return{get(n){return r[n]},getAll(){return{...r}},set(n){let o=[];return Object.keys(n).forEach(s=>{let a=r[s],i=n[s];z(a,i)||o.push(s)}),o.length>0&&(r={...r,...n},t&&t(r,o)),o},reset(n=e){let o={...N,...n},s=Object.keys(o).filter(a=>!z(r[a],o[a]));s.length>0&&(r=o,t&&t(r,s))},is(n,o){return r[n]===o},toggle(n){let o=!r[n];return this.set({[n]:o}),o}}}function z(e,t){if(e===t)return!0;if(e==null||t==null)return!1;if(Array.isArray(e)&&Array.isArray(t))return e.length!==t.length?!1:e.every((r,n)=>z(r,t[n]));if(typeof e=="object"&&typeof t=="object"){let r=Object.keys(e),n=Object.keys(t);return r.length!==n.length?!1:r.every(o=>z(e[o],t[o]))}return!1}async function ae({query:e,endpoint:t,indices:r=[],siteId:n="",maxResults:o=10,hideResultsWithoutUrl:s=!1,showCodeSnippets:a=!1,snippetMode:i="balanced",snippetLength:l=150,parseMarkdownSnippets:d=!1,debug:c=!1,signal:g}){let u=new URLSearchParams({q:e,hitsPerPage:o.toString()});u.append("enrich","1"),r.length>0&&u.append("indices",r.join(",")),n&&u.append("siteId",n),s&&u.append("hideResultsWithoutUrl","1"),a&&u.append("showCodeSnippets","1"),i&&i!=="balanced"&&u.append("snippetMode",i),l&&l!==150&&u.append("snippetLength",String(l)),d&&u.append("parseMarkdownSnippets","1"),c&&u.append("debug","1"),u.append("skipAnalytics","1");let p=t.includes("?")?"&":"?",b=await fetch(`${t}${p}${u}`,{signal:g,headers:{Accept:"application/json"}});if(!b.ok)throw new Error("Search failed");let m=await b.json();return m.error&&console.warn("Search warning:",m.error),{results:m.results||m.hits||[],total:m.total||0,meta:m.meta||null,error:m.error||null}}function ie({endpoint:e,elementId:t,query:r,index:n}){if(!(!t||!e))try{let o=new FormData;o.append("elementId",t),o.append("query",r),o.append("index",n),fetch(e,{method:"POST",body:o,headers:{Accept:"application/json"}}).catch(()=>{})}catch{}}function le({endpoint:e,query:t,indices:r=[],resultsCount:n=0,trigger:o="unknown",source:s="",siteId:a=""}){if(!(!t||!e))try{let i=new FormData;i.append("q",t),i.append("indices",r.join(",")),i.append("resultsCount",n.toString()),i.append("trigger",o),i.append("source",s||"frontend-widget"),a&&i.append("siteId",a),fetch(e,{method:"POST",body:i,headers:{Accept:"application/json"}}).catch(()=>{})}catch{}}function de(e){let t={};return e.forEach(r=>{let n=r.section||r.type||"Results";t[n]||(t[n]=[]),t[n].push(r)}),t}function ce(e,t){let r={};return e.forEach(n=>{let o=n[t]||n.section||n.type||"Results";r[o]||(r[o]=[]),r[o].push(n)}),r}var Ke="sm-recent-";function K(e){return`${Ke}${e||"default"}`}function U(e){try{let t=K(e),r=localStorage.getItem(t);return r?JSON.parse(r):[]}catch{return[]}}function he(e,t,r=null,n=5){if(!t||!t.trim())return U(e);let o=K(e),s={query:t.trim(),title:r?.title||t,url:r?.url||null,timestamp:Date.now()},a=U(e);a=a.filter(i=>i.query!==s.query),a.unshift(s),a=a.slice(0,n);try{localStorage.setItem(o,JSON.stringify(a))}catch{}return a}function ue(e){try{let t=K(e);localStorage.removeItem(t)}catch{}}var ge={spinnerColor:"#3b82f6",spinnerColorDark:"#60a5fa",modalBg:"#ffffff",modalBgDark:"#1f2937",modalBorderRadius:"12",modalBorderWidth:"1",modalBorderColor:"#e5e7eb",modalBorderColorDark:"#374151",modalShadow:"0 25px 50px -12px rgba(0, 0, 0, 0.25)",modalShadowDark:"0 25px 50px -12px rgba(0, 0, 0, 0.5)",modalMaxWidth:"640",modalMaxHeight:"80",modalPaddingX:"16",modalPaddingY:"16",inputBg:"#ffffff",inputBgDark:"#1f2937",inputTextColor:"#111827",inputTextColorDark:"#f9fafb",inputPlaceholderColor:"#9ca3af",inputPlaceholderColorDark:"#9ca3af",inputBorderColor:"#e5e7eb",inputBorderColorDark:"#374151",inputFontSize:"16",resultBg:"transparent",resultBgDark:"transparent",resultBorderColor:"#e5e7eb",resultBorderColorDark:"#374151",resultActiveBg:"#e5e7eb",resultActiveBgDark:"#4b5563",resultActiveBorderColor:"#e5e7eb",resultActiveBorderColorDark:"#374151",resultActiveTextColor:"#111827",resultActiveTextColorDark:"#f9fafb",resultActiveDescColor:"#4b5563",resultActiveDescColorDark:"#d1d5db",resultActiveMutedColor:"#6b7280",resultActiveMutedColorDark:"#d1d5db",resultTextColor:"#111827",resultTextColorDark:"#f9fafb",resultDescColor:"#4b5563",resultDescColorDark:"#d1d5db",resultMutedColor:"#6b7280",resultMutedColorDark:"#d1d5db",resultGap:"8",resultBorderWidth:"0",resultPaddingX:"12",resultPaddingY:"12",resultBorderRadius:"8",triggerBg:"#ffffff",triggerBgDark:"#374151",triggerTextColor:"#374151",triggerTextColorDark:"#d1d5db",triggerBorderRadius:"8",triggerBorderWidth:"1",triggerBorderColor:"#d1d5db",triggerBorderColorDark:"#4b5563",triggerPaddingX:"12",triggerPaddingY:"8",triggerFontSize:"14",kbdBg:"#f3f4f6",kbdBgDark:"#4b5563",kbdTextColor:"#4b5563",kbdTextColorDark:"#e5e7eb",kbdBorderRadius:"4",backdropOpacity:"50",backdropBlur:"1",highlightEnabled:"1",highlightTag:"",highlightClass:"",highlightBgLight:"fef08a",highlightColorLight:"854d0e",highlightBgDark:"854d0e",highlightColorDark:"fef08a",promotedBg:"#2563eb",promotedBgDark:"#3b82f6",promotedColor:"#ffffff",promotedColorDark:"#ffffff"};var me={modalBg:"--sm-modal-bg",modalBgDark:"--sm-modal-bg-dark",modalBorderRadius:"--sm-modal-radius",modalBorderWidth:"--sm-modal-border-width",modalBorderColor:"--sm-modal-border-color",modalBorderColorDark:"--sm-modal-border-color-dark",modalShadow:"--sm-modal-shadow",modalShadowDark:"--sm-modal-shadow-dark",modalMaxWidth:"--sm-modal-width",modalMaxHeight:"--sm-modal-max-height",modalPaddingX:"--sm-modal-px",modalPaddingY:"--sm-modal-py",inputBg:"--sm-input-bg",inputBgDark:"--sm-input-bg-dark",inputTextColor:"--sm-input-color",inputTextColorDark:"--sm-input-color-dark",inputPlaceholderColor:"--sm-input-placeholder",inputPlaceholderColorDark:"--sm-input-placeholder-dark",inputBorderColor:"--sm-input-border-color",inputBorderColorDark:"--sm-input-border-color-dark",inputFontSize:"--sm-input-font-size",resultBg:"--sm-result-bg",resultBgDark:"--sm-result-bg-dark",resultBorderColor:"--sm-result-border-color",resultBorderColorDark:"--sm-result-border-color-dark",resultActiveBg:"--sm-result-active-bg",resultActiveBgDark:"--sm-result-active-bg-dark",resultActiveBorderColor:"--sm-result-active-border-color",resultActiveBorderColorDark:"--sm-result-active-border-color-dark",resultActiveTextColor:"--sm-result-active-text-color",resultActiveTextColorDark:"--sm-result-active-text-color-dark",resultActiveDescColor:"--sm-result-active-desc-color",resultActiveDescColorDark:"--sm-result-active-desc-color-dark",resultActiveMutedColor:"--sm-result-active-muted-color",resultActiveMutedColorDark:"--sm-result-active-muted-color-dark",resultTextColor:"--sm-result-text-color",resultTextColorDark:"--sm-result-text-color-dark",resultDescColor:"--sm-result-desc-color",resultDescColorDark:"--sm-result-desc-color-dark",resultMutedColor:"--sm-result-muted-color",resultMutedColorDark:"--sm-result-muted-color-dark",resultGap:"--sm-result-gap",resultBorderWidth:"--sm-result-border-width",resultPaddingX:"--sm-result-px",resultPaddingY:"--sm-result-py",resultBorderRadius:"--sm-result-radius",triggerBg:"--sm-trigger-bg",triggerBgDark:"--sm-trigger-bg-dark",triggerTextColor:"--sm-trigger-text-color",triggerTextColorDark:"--sm-trigger-text-color-dark",triggerBorderRadius:"--sm-trigger-radius",triggerBorderWidth:"--sm-trigger-border-width",triggerBorderColor:"--sm-trigger-border-color",triggerBorderColorDark:"--sm-trigger-border-color-dark",triggerPaddingX:"--sm-trigger-px",triggerPaddingY:"--sm-trigger-py",triggerFontSize:"--sm-trigger-font-size",kbdBg:"--sm-kbd-bg",kbdBgDark:"--sm-kbd-bg-dark",kbdTextColor:"--sm-kbd-text-color",kbdTextColorDark:"--sm-kbd-text-color-dark",kbdBorderRadius:"--sm-kbd-radius",highlightBgLight:"--sm-highlight-bg",highlightColorLight:"--sm-highlight-color",highlightBgDark:"--sm-highlight-bg-dark",highlightColorDark:"--sm-highlight-color-dark",promotedBg:"--sm-promoted-bg",promotedBgDark:"--sm-promoted-bg-dark",promotedColor:"--sm-promoted-color",promotedColorDark:"--sm-promoted-color-dark",spinnerColor:"--sm-spinner-color-light",spinnerColorDark:"--sm-spinner-color-dark"},Y=["modalBorderRadius","modalBorderWidth","modalMaxWidth","modalPaddingX","modalPaddingY","inputFontSize","resultGap","resultBorderWidth","resultPaddingX","resultPaddingY","resultBorderRadius","triggerBorderRadius","triggerBorderWidth","triggerPaddingX","triggerPaddingY","triggerFontSize","kbdBorderRadius"],V=["modalMaxHeight"],pe=["modalBg","modalBgDark","modalBorderColor","modalBorderColorDark","inputBg","inputBgDark","inputTextColor","inputTextColorDark","inputPlaceholderColor","inputPlaceholderColorDark","inputBorderColor","inputBorderColorDark","resultBg","resultBgDark","resultBorderColor","resultBorderColorDark","resultActiveBg","resultActiveBgDark","resultActiveBorderColor","resultActiveBorderColorDark","resultTextColor","resultTextColorDark","resultActiveTextColor","resultActiveTextColorDark","resultActiveDescColor","resultActiveDescColorDark","resultActiveMutedColor","resultActiveMutedColorDark","resultDescColor","resultDescColorDark","resultMutedColor","resultMutedColorDark","triggerBg","triggerBgDark","triggerTextColor","triggerTextColorDark","triggerBorderColor","triggerBorderColorDark","kbdBg","kbdBgDark","kbdTextColor","kbdTextColorDark","highlightBgLight","highlightColorLight","highlightBgDark","highlightColorDark","promotedBg","promotedBgDark","promotedColor","promotedColorDark","spinnerColor","spinnerColorDark"],xt={...ge,highlightBgLight:"#fef08a",highlightColorLight:"#854d0e",highlightBgDark:"#854d0e",highlightColorDark:"#fef08a"};function Ve(e){return/^[0-9a-fA-F]{6}$/.test(e)}function Xe(e,t){if(t==null||t==="")return null;let r=String(t);return pe.includes(e)&&Ve(r)&&(r="#"+r),Y.includes(e)&&(r=r+"px"),V.includes(e)&&(r=r+"vh"),r}function be(e,t,r="light"){if(!t||typeof t!="object")return;let n=r==="dark",o=Object.entries(me),s=new Set([...Y,...V]);for(let[a,i]of o){let l=a.endsWith("Dark");if(n){if(!l&&!s.has(a))continue}else if(l)continue;if(t[a]!==void 0&&t[a]!==null&&t[a]!==""){let d=Xe(a,t[a]);d&&e.style.setProperty(i,d)}}}function h(e){if(!e)return"";let t=document.createElement("div");return t.textContent=e,t.innerHTML}function Qe(e){if(!e)return[];let t=[],r=/"([^"]+)"/g,n;for(;(n=r.exec(e))!==null;)n[1].trim()&&t.push(n[1].trim());let o=e.replace(/"[^"]*"/g,""),s=new Set(["and","or","not","und","oder","nicht","et","ou","sauf","y","o","no"]);o.split(/\s+/).filter(i=>i.length>0).forEach(i=>{i=i.replace(/^[a-zA-Z]+:/,""),i=i.replace(/\*/g,""),i=i.replace(/\^\d+(\.\d+)?/,""),i=i.replace(/"/g,""),!(!i||s.has(i.toLowerCase()))&&t.push(i)});let a=[];return t.forEach(i=>{a.push(i);let l=i.split(/(?<=[a-z])(?=[A-Z])/);l.length>1&&l.forEach(d=>{d.length>=3&&a.push(d)})}),a}function E(e,t,r={}){let{enabled:n=!0,tag:o="mark",className:s="",terms:a=null}=r;if(!n)return h(e);let i=["sm-highlight"];s&&i.push(s);let l=` class="${i.join(" ")}"`,d=Je(t,a);return d.length===0?h(e):Ze(e,d,o,l)}function Je(e,t){return Array.isArray(t)&&t.length>0?fe(t):e?fe(Qe(e)):[]}function fe(e){let t=new Set;return e.filter(r=>typeof r=="string"&&r.length>0).sort((r,n)=>n.length-r.length).filter(r=>{let n=r.toLowerCase();return t.has(n)?!1:(t.add(n),!0)})}function Ze(e,t,r,n){let o=e.toLowerCase(),s=[];if(t.forEach(c=>{let g=c.toLowerCase();if(!g)return;let u=0;for(;u<o.length;){let p=o.indexOf(g,u);if(p===-1)break;s.push({start:p,end:p+g.length}),u=p+g.length}}),s.length===0)return h(e);s.sort((c,g)=>c.start!==g.start?c.start-g.start:g.end-g.start-(c.end-c.start));let a=[],i=-1;s.forEach(c=>{c.start>=i&&(a.push(c),i=c.end)});let l="",d=0;return a.forEach(c=>{d<c.start&&(l+=h(e.slice(d,c.start))),l+=`<${r}${n}>${h(e.slice(c.start,c.end))}</${r}>`,d=c.end}),d<e.length&&(l+=h(e.slice(d))),l}var et=0;function X(e="sm"){return`${e}-${++et}-${Date.now().toString(36)}`}function ve(e){let t=document.createElement("div");return t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-atomic","true"),t.className="sm-sr-only",e.appendChild(t),t}function H(e,t,r=100){e&&(e.textContent="",setTimeout(()=>{e.textContent=t},r))}function Q(e,t){return e===0?`No results found for "${t}"`:e===1?`1 result found for "${t}"`:`${e} results found for "${t}"`}function ke(){return"Searching..."}function ye(e){return e===0?"No recent searches":e===1?"1 recent search available":`${e} recent searches available`}function j(e,{expanded:t,activeDescendant:r,listboxId:n}){e.setAttribute("aria-expanded",String(t)),e.setAttribute("aria-controls",n),r?e.setAttribute("aria-activedescendant",r):e.removeAttribute("aria-activedescendant")}function $(e,t){return`${e}-option-${t}`}function xe(e,t){if(!e||!t)return;let r=e.getBoundingClientRect(),n=t.getBoundingClientRect();r.top<n.top?e.scrollIntoView({block:"nearest",behavior:"smooth"}):r.bottom>n.bottom&&e.scrollIntoView({block:"nearest",behavior:"smooth"})}function tt(e,t,r={}){let{groupResults:n=!1,resultLayout:o="default",listboxId:s}=r;if(!e||e.length===0)return"";if(o==="hierarchical")return st(e,t,r);if(n){let a=de(e),i=0;return Object.entries(a).map(([l,d])=>`
            <div class="sm-section" role="group" aria-label="${h(l)}">
                <div class="sm-section-header">${h(l)}</div>
                ${d.map(c=>we(c,i++,t,r)).join("")}
            </div>
        `).join("")}return e.map((a,i)=>we(a,i,t,r)).join("")}function we(e,t,r,n={}){let{listboxId:o,enableHighlighting:s=!0,highlightTag:a="mark",highlightClass:i="",groupResults:l=!1,promotions:d={},debug:c=!1}=n,g=e.title||e.name||"Untitled",u=e.description||e.excerpt||e.snippet||"",p=e.url||e.href||"#",b=e.section||e.type||"",m=$(o,t),v=e.promoted===!0,C={enabled:s,tag:a,className:i},x=E(g,r,{...C,terms:P(e,"title")}),w=u?E(u,r,{...C,terms:P(e,"description")}):"",L=rt(e,d),S=v?" sm-promoted":"",D=b&&!l?`<span class="sm-result-type">${h(b)}</span>`:"",B=c?Ae(e):"";return c?`
            <a class="sm-result-item sm-debug-enabled${S}" id="${m}" role="option" aria-selected="false" href="${h(p)}" data-index="${t}" data-id="${e.id||""}" data-title="${h(g)}">
        ...
        `:`
        <a class="sm-result-item${S}" id="${m}" role="option" aria-selected="false" href="${h(p)}" data-index="${t}" data-id="${e.id||""}" data-title="${h(g)}">
            ${L}
            <div class="sm-result-content">
                <span class="sm-result-title">${x}</span>
                ${w?`<span class="sm-result-desc">${w}</span>`:""}
    ...
    `}function Ae(e){let t=[],r=e.backend?e.backend.toLowerCase():"";if((e._index||e.index)&&t.push(y("index",e._index||e.index,"index")),e.backend&&t.push(y("backend",r,"backend",r)),e.id&&t.push(y("id",e.id,"generic")),e.score!==void 0&&e.score!==null){let n=typeof e.score=="number"?e.score.toFixed(2):e.score;t.push(y("score",n,"score"))}if(e.site&&t.push(y("site",e.site,"generic")),e.language&&t.push(y("lang",e.language,"generic")),e.matchedIn&&Array.isArray(e.matchedIn)&&e.matchedIn.length>0){let n=e.matchedIn.join(", ");t.push(y("matched",n,"matched"))}return e.promoted&&t.push(y("promoted","yes","promoted")),e.boosted&&t.push(y("boosted","yes","boosted")),t.length===0?"":`<div class="sm-debug-info">${t.join("")}</div>`}function P(e,t){let r=Array.isArray(e.matchedPhrases)?e.matchedPhrases:[],n=e.matchedTerms,o=[];n&&(t==="title"&&Array.isArray(n.title)&&n.title.length>0?o=n.title:t==="description"&&Array.isArray(n.content)&&n.content.length>0?o=n.content:o=[...Array.isArray(n.title)?n.title:[],...Array.isArray(n.content)?n.content:[]]);let s=[...r,...o];return s.length>0?s:null}function y(e,t,r,n=""){let o=n?` data-backend="${h(n)}"`:"";return`<span class="sm-debug-item"><span class="sm-debug-label">${h(e)}</span><span class="sm-debug-value" data-type="${h(r)}"${o}>${h(String(t))}</span></span>`}function rt(e,t={}){let{showBadge:r=!0,badgeText:n="Featured",badgePosition:o="top-right"}=t;return!e.promoted||!r?"":`<span class="sm-promoted-badge ${`sm-promoted-badge--${o}`}">${h(n)}</span>`}function I(){return`<svg class="sm-result-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
    ...
    </svg>`}function Ce(){return`<svg class="sm-hierarchy-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
        <line x1="4" y1="9" x2="20" y2="9"/>
        <line x1="4" y1="15" x2="20" y2="15"/>
        <line x1="10" y1="3" x2="8" y2="21"/>
        <line x1="16" y1="3" x2="14" y2="21"/>
    </svg>`}function st(e,t,r={}){let{hierarchyGroupBy:n="section",hierarchyStyle:o="tree",hierarchyDisplay:s="individual",maxHeadingsPerResult:a=3,listboxId:i}=r,l=o==="tree",d=o!=="none",g=ce(e,n||"section"),u=0;return Object.entries(g).map(([p,b])=>{let m=b.map(v=>{let C=u++,x=at(v,C,t,r),w="",S=(v._matchedHeadings||[]).slice(0,a);if(S.length>0){let O=Math.min(...S.map(R=>R.level||2)),M=S.map(R=>l?(R.level||2)-O:0);w=S.map((R,A)=>{let _=M[A],Me=!M.slice(A+1).some(G=>G===_),te=[];if(l){let G=M.slice(A+1);for(let F=0;F<_;F++)G.some(Pe=>Pe===F)&&te.push(F)}return it(v,R,u++,t,r,Me,_,te)}).join("")}let D=!!w;return`
                <div class="sm-hierarchy-block${D?" sm-hierarchy-block--has-children":""}${s==="unified"?" sm-hierarchy-block--unified":""}">
                    ${D?x.replace("sm-result-item sm-hierarchy-parent","sm-result-item sm-hierarchy-parent sm-hierarchy-parent--has-children"):x}
                    ${D?`<div class="sm-hierarchy-children${d?"":" sm-hierarchy-children--no-connectors"}">${w}</div>`:""}
                </div>
            `}).join("");return`
            <div class="sm-hierarchy-group" role="group" aria-label="${h(p)}">
                <div class="sm-hierarchy-group-header">${h(p)}</div>
                ${m}
            </div>
        `}).join("")}function at(e,t,r,n={}){let{listboxId:o,enableHighlighting:s=!0,highlightTag:a="mark",highlightClass:i="",debug:l=!1}=n,d=e.title||e.name||"Untitled",c=e.description||e.excerpt||"",g=e.url||"#",u=$(o,t),p={enabled:s,tag:a,className:i},b=E(d,r,{...p,terms:P(e,"title")}),m=c?E(c,r,{...p,terms:P(e,"description")}):"",v=l?Ae(e):"",x=e._matchedHeadings&&e._matchedHeadings.length>0?nt():ot();return l?`
            <a class="sm-result-item sm-hierarchy-parent sm-debug-enabled" id="${u}" role="option" aria-selected="false" href="${h(g)}" data-index="${t}" data-id="${e.id||""}" data-title="${h(d)}">
                <div class="sm-result-main">
                    ${x}
                    <div class="sm-result-content">
        ...
        `:`
        <a class="sm-result-item sm-hierarchy-parent" id="${u}" role="option" aria-selected="false" href="${h(g)}" data-index="${t}" data-id="${e.id||""}" data-title="${h(d)}">
            ${x}
            <div class="sm-result-content">
                <span class="sm-result-title">${b}</span>
                ${m?`<span class="sm-result-desc">${m}</span>`:""}
    ...
    `}function it(e,t,r,n,o={},s=!1,a=0,i=[]){let{listboxId:l,enableHighlighting:d=!0,highlightTag:c="mark",highlightClass:g="",debug:u=!1}=o,b=(t.text||"").replace(/^#+\s*/,""),m=t.description||"",v=t.level||2,C=t.id||(b?lt(b):""),x=e.url||"#",w=C?`${x}#${C}`:x,L=$(l,r),S={enabled:d,tag:c,className:g},D=E(b,n,{...S,terms:P(e,"title")}),B=m?E(m,n,{...S,terms:P(e,"description")}):"",O=s?" sm-hierarchy-child-row-last":"",M=i.map(A=>`<div class="sm-hierarchy-guide" style="--sm-guide-depth:${A}" aria-hidden="true"></div>`).join(""),R="";if(u){let A=[];A.push(y("h",v,"generic")),C&&A.push(y("anchor",C,"generic")),e.id&&A.push(y("parent",e.id,"generic")),R=`<div class="sm-debug-info">${A.join("")}</div>`}return u?`
            <div class="sm-hierarchy-child-row sm-hierarchy-level-${v} sm-hierarchy-depth-${a}${O}" style="--sm-hierarchy-depth:${a}">
                ${M}
                <a class="sm-result-item sm-hierarchy-child sm-hierarchy-level-${v} sm-debug-enabled" id="${L}" role="option" aria-selected="false" href="${h(w)}" data-index="${r}" data-id="${e.id||""}" data-title="${h(b)}">
                    <div class="sm-result-main">
                        ${Ce()}
                        <div class="sm-result-content">
                            <span class="sm-result-title">${D}</span>
        ...
        <div class="sm-hierarchy-child-row sm-hierarchy-level-${v} sm-hierarchy-depth-${a}${O}" style="--sm-hierarchy-depth:${a}">
            ${M}
            <a class="sm-result-item sm-hierarchy-child sm-hierarchy-level-${v}" id="${L}" role="option" aria-selected="false" href="${h(w)}" data-index="${r}" data-id="${e.id||""}" data-title="${h(b)}">
                ${Ce()}
                <div class="sm-result-content">
                    <span class="sm-result-title">${D}</span>
                    ${B?`<span class="sm-result-desc">${B}</span>`:""}
    ...
    `}function lt(e){let t=e.normalize("NFKD").toLowerCase();try{return t.replace(/[^\p{L}\p{N}]+/gu,"-").replace(/^-+|-+$/g,"")}catch{return t.replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}}function dt(e,t){return!e||e.length===0?"":`
        <div class="sm-section">
            ...
            ${e.map((r,n)=>`
                <div class="sm-result-item sm-recent-item" id="${$(t,n)}" role="option" aria-selected="false" data-index="${n}" data-url="${r.url||""}" data-query="${h(r.query)}">
    ...
    `}function Te(e,t){let{query:r,results:n,recentSearches:o,loading:s,showRecent:a}=e,{showLoadingIndicator:i=!0}=t,l=r&&r.trim();return s&&i?{html:ct(),hasResults:!1,showListbox:!1}:l?!n||n.length===0?{html:Se(r),hasResults:!1,showListbox:!1}:{html:tt(n,r,t),hasResults:!0,showListbox:!0}:a&&o&&o.length>0?{html:dt(o,t.listboxId),hasResults:!0,showListbox:!0}:{html:Se(""),hasResults:!1,showListbox:!1}}function J(e,t,r=!1){if(!e)return"";let n=[];if(n.push(T("results",t,"generic")),e.took!==void 0){let l=e.took<1?"<1ms":`${Math.round(e.took)}ms`;n.push(T("time",l,"time"))}if(e.cacheEnabled!==void 0&&(e.cacheEnabled?e.cached?n.push(T("cache","hit","cache-hit")):n.push(T("cache","miss","cache-miss")):n.push(T("cache","off","cache-off"))),e.cacheDriver&&n.push(T("storage",e.cacheDriver,"cache-driver",e.cacheDriver)),e.indices&&e.indices.length>0){let l=e.indices.length>2?`${e.indices.length} indices`:e.indices.join(", ");n.push(T("indices",l,"generic"))}if(e.synonymsExpanded){let l=e.expandedQueries?e.expandedQueries.length-1:0;n.push(T("synonyms",`+${l}`,"synonyms"))}let o=e.rulesMatched?.length||0;n.push(T("rules",o,o>0?"rules":"generic"));let s=e.promotionsMatched?.length||0;n.push(T("promoted",s,s>0?"promotions":"generic"));let i=`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">${r?'<path d="M6 9l6 6 6-6"/>':'<path d="M18 15l-6-6-6 6"/>'}</svg>`;return r?`<div class="sm-toolbar-collapsed-bar"><span class="sm-toolbar-collapsed-label">Debug</span>${i}</div>`:`<div class="sm-toolbar-content">${n.join("")}</div><button class="sm-toolbar-toggle" aria-label="Collapse debug panel" aria-expanded="true">${i}</button>`}function T(e,t,r,n=""){let o=n?` data-backend="${h(n)}"`:"";return`<span class="sm-toolbar-item"><span class="sm-toolbar-label">${h(e)}</span><span class="sm-toolbar-value" data-type="${h(r)}"${o}>${h(String(t))}</span></span>`}function De(e,t){let{onSelect:r,onIndexChange:n,onEscape:o}=e,{listboxId:s}=t;return{handleKeydown(a,i,l){let d=l;switch(a.key){case"ArrowDown":return a.preventDefault(),d=Math.min(l+1,i-1),d!==l&&n&&n(d),d;case"ArrowUp":return a.preventDefault(),d=Math.max(l-1,-1),d!==l&&n&&n(d),d;case"Enter":return a.preventDefault(),l>=0&&r&&r(l),null;case"Escape":return a.preventDefault(),o&&o(),null;default:return null}},getListboxId(){return s}}}function Re(e,t,r={}){let{scrollContainer:n,inputElement:o,listboxId:s,selectedClass:a="sm-selected"}=r,i=t>=0?$(s,t):null;o&&j(o,{expanded:e.length>0,activeDescendant:i,listboxId:s}),e.forEach((l,d)=>{let c=d===t;l.classList.toggle(a,c),l.setAttribute("aria-selected",String(c)),c&&n&&xe(l,n)})}function Be(e,t){e.forEach((r,n)=>{r.addEventListener("mouseenter",()=>{t&&t(n)})})}var Z=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.config=null,this.state=se({...N},this.handleStateChange.bind(this)),this.abortController=null,this.debounceTimer=null,this.analyticsIdleTimer=null,this.lastTrackedQuery=null,this.listboxId=X("sm-listbox"),this.inputId=X("sm-input"),this.liveRegion=null,this.keyboardNavigator=null,this.elements={},this.handleInput=this.handleInput.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.handleResultClick=this.handleResultClick.bind(this)}get widgetType(){throw new Error("Subclass must implement widgetType getter")}render(){throw new Error("Subclass must implement render()")}getResultsContainer(){throw new Error("Subclass must implement getResultsContainer()")}getInputElement(){throw new Error("Subclass must implement getInputElement()")}getLoadingElement(){return this.elements.loading||null}getDebugToolbarElement(){return this.elements.debugToolbar||null}connectedCallback(){this.config=W(this,this.widgetType),this.state.set({recentSearches:U(this.config.index)}),this.keyboardNavigator=De({onSelect:t=>this.selectResultAtIndex(t),onIndexChange:t=>this.state.set({selectedIndex:t}),onEscape:()=>this.handleEscape()},{listboxId:this.listboxId})}disconnectedCallback(){this.abortController&&(this.abortController.abort(),this.abortController=null),this.debounceTimer&&(clearTimeout(this.debounceTimer),this.debounceTimer=null)}attributeChangedCallback(t,r,n){r!==n&&this.shadowRoot.children.length>0&&(this.config=W(this,this.widgetType),this.render(),this.applyCustomStyles())}handleStateChange(t,r){(r.includes("results")||r.includes("query")||r.includes("recentSearches"))&&this.renderResultsContent(),(r.includes("results")||r.includes("meta"))&&this.updateDebugToolbar(),r.includes("selectedIndex")&&this.updateSelectionVisual(),r.includes("loading")&&this.updateLoadingVisual()}handleInput(t){let r=t.target.value;if(this.state.set({query:r,selectedIndex:-1}),this.debounceTimer&&clearTimeout(this.debounceTimer),this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null),!r.trim()){this.state.set({results:[]});return}r.length<this.config.minChars||(this.debounceTimer=setTimeout(()=>{this.executeSearch(r)},this.config.debounce))}async executeSearch(t){this.abortController&&this.abortController.abort(),this.abortController=new AbortController,this.state.set({loading:!0,error:null}),this.liveRegion&&H(this.liveRegion,ke());try{let{results:r,meta:n}=await ae({query:t,endpoint:this.config.searchEndpoint,indices:this.config.indices,siteId:this.config.siteId,maxResults:this.config.maxResults,hideResultsWithoutUrl:this.config.hideResultsWithoutUrl,showCodeSnippets:this.config.showCodeSnippets,snippetMode:this.config.snippetMode,snippetLength:this.config.snippetLength,parseMarkdownSnippets:this.config.parseMarkdownSnippets,debug:this.config.debug,signal:this.abortController.signal});this.state.set({results:r,meta:n,loading:!1,selectedIndex:r.length>0?0:-1}),this.liveRegion&&H(this.liveRegion,Q(r.length,t)),this.dispatchWidgetEvent("search",{query:t,results:r,meta:n}),this.startAnalyticsIdleTimer(t,r.length)}catch(r){if(r.name==="AbortError")return;console.error("Search error:",r),this.state.set({results:[],loading:!1,error:r.message}),this.dispatchWidgetEvent("error",{query:t,error:r.message})}}renderResultsContent(){let t=this.getResultsContainer();if(!t)return;let r=this.state.getAll(),{showRecent:n,groupResults:o,enableHighlighting:s,highlightTag:a,highlightClass:i,showLoadingIndicator:l,debug:d}=this.config,{html:c,hasResults:g,showListbox:u}=Te({query:r.query,results:r.results,recentSearches:r.recentSearches,loading:r.loading,showRecent:n},{listboxId:this.listboxId,groupResults:o,enableHighlighting:s,highlightTag:a,highlightClass:i,showLoadingIndicator:l,debug:d,promotions:this.config.promotions,resultLayout:this.config.resultLayout,hierarchyGroupBy:this.config.hierarchyGroupBy,hierarchyStyle:this.config.hierarchyStyle,hierarchyDisplay:this.config.hierarchyDisplay,maxHeadingsPerResult:this.config.maxHeadingsPerResult});t.innerHTML=c,u?t.setAttribute("role","listbox"):t.removeAttribute("role");let p=this.getInputElement();p&&j(p,{expanded:g,activeDescendant:null,listboxId:this.listboxId}),this.liveRegion&&!r.loading&&(r.query&&r.results.length===0?H(this.liveRegion,Q(0,r.query)):!r.query&&r.recentSearches.length>0&&n&&H(this.liveRegion,ye(r.recentSearches.length))),this.attachResultHandlers();let b=t.querySelector(".sm-clear-recent");b&&b.addEventListener("click",m=>{m.stopPropagation(),ue(this.config.index),this.state.set({recentSearches:[]})}),g&&r.results.length>0&&this.state.set({selectedIndex:0})}attachResultHandlers(){let t=this.getResultsContainer();if(!t)return;let r=t.querySelectorAll(".sm-result-item");r.forEach(n=>{n.addEventListener("click",o=>this.handleResultClick(o,n))}),Be(r,n=>{this.state.set({selectedIndex:n})})}updateSelectionVisual(){let t=this.getResultsContainer(),r=this.getInputElement();if(!t)return;let n=t.querySelectorAll(".sm-result-item"),o=this.state.get("selectedIndex");Re(n,o,{scrollContainer:t,inputElement:r,listboxId:this.listboxId})}handleKeydown(t){let r=this.getResultsContainer();if(!r)return;let n=r.querySelectorAll(".sm-result-item"),o=this.state.get("selectedIndex");if(t.key==="Enter"){let s=this.state.get("query"),a=this.state.get("results")||[];s&&a.length>0&&this.trackSearchAnalytics(s,a.length,"enter")}this.keyboardNavigator.handleKeydown(t,n.length,o)}selectResultAtIndex(t){let r=this.getResultsContainer();if(!r)return;let n=r.querySelectorAll(".sm-result-item");t>=0&&n[t]&&n[t].click()}handleEscape(){}handleResultClick(t,r){let n=r.getAttribute("href"),o=r.dataset.url,s=n||o,a=r.dataset.title||r.querySelector(".sm-result-title")?.textContent,i=r.dataset.id,l=r.dataset.query||this.state.get("query"),d=r.classList.contains("sm-recent-item");if(!d&&l){let c=he(this.config.index,l,{title:a,url:s},this.config.maxRecentSearches);this.state.set({recentSearches:c})}if(i&&this.config.index&&ie({endpoint:this.config.trackClickEndpoint,elementId:i,query:l,index:this.config.index}),!d&&l&&this.trackSearchAnalytics(l,this.state.get("results")?.length||0,"click"),this.dispatchWidgetEvent("result-click",{id:i,title:a,url:s,query:l,isRecent:d}),s&&s!=="#")d&&(t.preventDefault(),window.location.href=s),this.onResultSelected(s,a,i);else if(l){t.preventDefault();let c=this.getInputElement();c&&(c.value=l,this.state.set({query:l}),this.executeSearch(l))}}onResultSelected(t,r,n){}updateLoadingVisual(){let t=this.getLoadingElement();if(t){let r=this.state.get("loading"),n=this.config?.showLoadingIndicator!==!1;t.hidden=!r||!n}}updateDebugToolbar(){let t=this.getDebugToolbarElement();if(!t)return;let{debug:r}=this.config,n=this.state.getAll();if(!r||!n.meta||n.results.length===0){t.hidden=!0;return}let o=t.classList.contains("sm-collapsed");t.innerHTML=J(n.meta,n.results.length,o),t.hidden=!1,o&&t.classList.add("sm-collapsed"),this.attachDebugToolbarHandlers(t)}attachDebugToolbarHandlers(t){let r=t.querySelector(".sm-toolbar-toggle");r&&r.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),this.toggleDebugToolbar()});let n=t.querySelector(".sm-toolbar-collapsed-bar");n&&n.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),this.toggleDebugToolbar()})}toggleDebugToolbar(){let t=this.getDebugToolbarElement();if(!t)return;let r=t.classList.toggle("sm-collapsed"),n=this.state.getAll();t.innerHTML=J(n.meta,n.results.length,r),r&&t.classList.add("sm-collapsed"),this.attachDebugToolbarHandlers(t)}applyCustomStyles(){if(!this.config)return;let t=this.shadowRoot.host,{theme:r,styles:n,resultTitleLines:o,resultDescLines:s}=this.config;be(t,n,r),o&&t.style.setProperty("--sm-result-title-lines",String(o)),s&&t.style.setProperty("--sm-result-desc-lines",String(s))}initializeLiveRegion(){this.liveRegion=ve(this.shadowRoot)}startAnalyticsIdleTimer(t,r){this.analyticsIdleTimer&&clearTimeout(this.analyticsIdleTimer);let n=this.config.idleTimeout;!n||n<=0||(this.analyticsIdleTimer=setTimeout(()=>{this.trackSearchAnalytics(t,r,"idle")},n))}trackSearchAnalytics(t,r,n){!t||t===this.lastTrackedQuery||(this.lastTrackedQuery=t,this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null),le({endpoint:this.config.trackSearchEndpoint,query:t,indices:this.config.indices,resultsCount:r,trigger:n,source:this.config.source,siteId:this.config.siteId}))}resetAnalyticsTracking(){this.lastTrackedQuery=null,this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null)}dispatchWidgetEvent(t,r={}){this.dispatchEvent(new CustomEvent(`search-${t}`,{bubbles:!0,composed:!0,detail:r}))}},Ee=Z;var $e=`/**
...
`;var ht=$e+`
`+Ie+`
`+Le,ee=class extends Ee{constructor(){super(),this.externalTrigger=null,this.open=this.open.bind(this),this.close=this.close.bind(this),this.toggle=this.toggle.bind(this),this.handleGlobalKeydown=this.handleGlobalKeydown.bind(this),this.handleBackdropClick=this.handleBackdropClick.bind(this)}get widgetType(){return"modal"}static get observedAttributes(){return oe("modal")}connectedCallback(){super.connectedCallback(),this.render(),this.attachEventListeners()}disconnectedCallback(){super.disconnectedCallback(),this.detachEventListeners()}render(){let{theme:t,placeholder:r,showTrigger:n}=this.config;this.shadowRoot.innerHTML=`
            <style>${ht}</style>
