var SearchModalWidget=(()=>{var K=Object.defineProperty;var _e=Object.getOwnPropertyDescriptor;var qe=Object.getOwnPropertyNames;var ze=Object.prototype.hasOwnProperty;var je=(e,r)=>{for(var t in r)K(e,t,{get:r[t],enumerable:!0})},Ge=(e,r,t,n)=>{if(r&&typeof r=="object"||typeof r=="function")for(let s of qe(r))!ze.call(e,s)&&s!==t&&K(e,s,{get:()=>r[s],enumerable:!(n=_e(r,s))||n.enumerable});return e};var We=e=>Ge(K({},"__esModule",{value:!0}),e);var ft={};je(ft,{default:()=>bt});var Ye={indices:[],placeholder:"Search...",theme:"light",maxResults:20,debounce:200,minChars:2,showRecent:!0,maxRecentSearches:5,groupResults:!0,siteId:"",searchEndpoint:"/actions/search-manager/api/search",trackClickEndpoint:"/actions/search-manager/search/track-click",trackSearchEndpoint:"/actions/search-manager/search/track-search",idleTimeout:1500,source:"",enableHighlighting:!0,highlightTag:"mark",highlightClass:"",hideResultsWithoutUrl:!1,showCodeSnippets:!1,snippetMode:"balanced",showLoadingIndicator:!0,debug:!1,resultTitleLines:1,resultDescLines:1,snippetLength:150,parseMarkdownSnippets:!1,persistQueryInUrl:!0,queryParamName:"smq",highlightDestinationPage:!0,destinationHighlightSelector:"main, article, [data-search-content]",resultLayout:"default",hierarchyGroupBy:"",hierarchyStyle:"tree",hierarchyDisplay:"individual",maxHeadingsPerResult:3,styles:{},promotions:{showBadge:!0,badgeText:"Featured",badgePosition:"top-right"}},Ke={hotkey:"k",showTrigger:!0,triggerSelector:"",backdropOpacity:50,enableBackdropBlur:!0,preventBodyScroll:!0},Ve={showFilters:!0,paginationType:"numbered",resultsPerPage:20,updateUrl:!0,sortOptions:["relevance","date-desc","date-asc","title"]},Qe={dropdownPosition:"below",dropdownMaxHeight:400,showOnFocus:!0};function Xe(e){return{...Ye,...{modal:Ke,page:Ve,inline:Qe}[e]||{}}}function f(e,r=!1){return e==null?r:e===""?!0:e!=="false"&&e!=="0"}function C(e,r=0){if(e==null)return r;let t=Number.parseInt(e,10);return Number.isNaN(t)?r:t}function oe(e,r={}){if(!e)return r;try{return JSON.parse(e)}catch(t){return console.warn("SearchWidget: Invalid JSON attribute",t),r}}function ae(e){return e?e.split(",").map(r=>r.trim()).filter(Boolean):[]}function V(e,r="modal"){let t=Xe(r),n=e.getAttribute("indices")||"",s=ae(n),a={indices:s,index:s[0]||"",placeholder:e.getAttribute("placeholder")||t.placeholder,theme:e.getAttribute("theme")||t.theme,siteId:e.getAttribute("site-id")||t.siteId,source:e.getAttribute("source")||t.source,highlightTag:e.getAttribute("highlight-tag")||t.highlightTag,highlightClass:e.getAttribute("highlight-class")||t.highlightClass,searchEndpoint:t.searchEndpoint,trackClickEndpoint:t.trackClickEndpoint,trackSearchEndpoint:t.trackSearchEndpoint,maxResults:C(e.getAttribute("max-results"),t.maxResults),debounce:C(e.getAttribute("debounce"),t.debounce),minChars:C(e.getAttribute("min-chars"),t.minChars),maxRecentSearches:C(e.getAttribute("max-recent-searches"),t.maxRecentSearches),idleTimeout:C(e.getAttribute("idle-timeout"),t.idleTimeout),showRecent:f(e.getAttribute("show-recent"),t.showRecent),groupResults:f(e.getAttribute("group-results"),t.groupResults),enableHighlighting:f(e.getAttribute("enable-highlighting"),t.enableHighlighting),showLoadingIndicator:f(e.getAttribute("show-loading-indicator"),t.showLoadingIndicator),hideResultsWithoutUrl:f(e.getAttribute("hide-results-without-url"),t.hideResultsWithoutUrl),showCodeSnippets:f(e.getAttribute("show-code-snippets"),t.showCodeSnippets),debug:f(e.getAttribute("debug"),t.debug),snippetMode:e.getAttribute("snippet-mode")||t.snippetMode,snippetLength:C(e.getAttribute("snippet-length"),t.snippetLength),parseMarkdownSnippets:f(e.getAttribute("parse-markdown-snippets"),t.parseMarkdownSnippets),persistQueryInUrl:f(e.getAttribute("persist-query-in-url"),t.persistQueryInUrl),highlightDestinationPage:f(e.getAttribute("highlight-destination-page"),t.highlightDestinationPage),resultTitleLines:C(e.getAttribute("result-title-lines"),t.resultTitleLines),resultDescLines:C(e.getAttribute("result-desc-lines"),t.resultDescLines),queryParamName:e.getAttribute("query-param-name")||t.queryParamName,destinationHighlightSelector:e.getAttribute("destination-highlight-selector")||t.destinationHighlightSelector,resultLayout:e.getAttribute("result-layout")||t.resultLayout,hierarchyGroupBy:e.getAttribute("hierarchy-group-by")||t.hierarchyGroupBy,hierarchyStyle:e.getAttribute("hierarchy-style")||t.hierarchyStyle,hierarchyDisplay:e.getAttribute("hierarchy-display")||t.hierarchyDisplay,maxHeadingsPerResult:C(e.getAttribute("max-headings-per-result"),t.maxHeadingsPerResult),styles:oe(e.getAttribute("styles"),t.styles),promotions:oe(e.getAttribute("promotions"),t.promotions)};return r==="modal"&&Object.assign(a,{hotkey:e.getAttribute("hotkey")||t.hotkey,triggerSelector:e.getAttribute("trigger-selector")||t.triggerSelector,backdropOpacity:C(e.getAttribute("backdrop-opacity"),t.backdropOpacity),showTrigger:f(e.getAttribute("show-trigger"),t.showTrigger),enableBackdropBlur:f(e.getAttribute("enable-backdrop-blur"),t.enableBackdropBlur),preventBodyScroll:f(e.getAttribute("prevent-body-scroll"),t.preventBodyScroll)}),r==="page"&&Object.assign(a,{resultsPerPage:C(e.getAttribute("results-per-page"),t.resultsPerPage),paginationType:e.getAttribute("pagination-type")||t.paginationType,showFilters:f(e.getAttribute("show-filters"),t.showFilters),updateUrl:f(e.getAttribute("update-url"),t.updateUrl),sortOptions:ae(e.getAttribute("sort-options"))||t.sortOptions}),r==="inline"&&Object.assign(a,{dropdownPosition:e.getAttribute("dropdown-position")||t.dropdownPosition,dropdownMaxHeight:C(e.getAttribute("dropdown-max-height"),t.dropdownMaxHeight),showOnFocus:f(e.getAttribute("show-on-focus"),t.showOnFocus)}),a}function ie(e="modal"){let r=["indices","placeholder","theme","max-results","debounce","min-chars","show-recent","max-recent-searches","group-results","site-id","idle-timeout","source","enable-highlighting","highlight-tag","highlight-class","hide-results-without-url","show-code-snippets","snippet-mode","show-loading-indicator","debug","styles","promotions","result-layout","hierarchy-group-by","hierarchy-style","hierarchy-display","max-headings-per-result","result-title-lines","result-desc-lines","snippet-length","parse-markdown-snippets","persist-query-in-url","query-param-name","highlight-destination-page","destination-highlight-selector"],a={modal:["hotkey","show-trigger","trigger-selector","backdrop-opacity","enable-backdrop-blur","prevent-body-scroll"],page:["show-filters","pagination-type","results-per-page","update-url","sort-options"],inline:["dropdown-position","dropdown-max-height","show-on-focus"]};return[...r,...a[e]||[]]}var z={isOpen:!1,query:"",results:[],recentSearches:[],selectedIndex:-1,loading:!1,error:null,meta:null};function le(e={},r=null){let t={...z,...e};return{get(n){return t[n]},getAll(){return{...t}},set(n){let s=[];return Object.keys(n).forEach(a=>{let o=t[a],l=n[a];j(o,l)||s.push(a)}),s.length>0&&(t={...t,...n},r&&r(t,s)),s},reset(n=e){let s={...z,...n},a=Object.keys(s).filter(o=>!j(t[o],s[o]));a.length>0&&(t=s,r&&r(t,a))},is(n,s){return t[n]===s},toggle(n){let s=!t[n];return this.set({[n]:s}),s}}}function j(e,r){if(e===r)return!0;if(e==null||r==null)return!1;if(Array.isArray(e)&&Array.isArray(r))return e.length!==r.length?!1:e.every((t,n)=>j(t,r[n]));if(typeof e=="object"&&typeof r=="object"){let t=Object.keys(e),n=Object.keys(r);return t.length!==n.length?!1:t.every(s=>j(e[s],r[s]))}return!1}async function de({query:e,endpoint:r,indices:t=[],siteId:n="",maxResults:s=10,hideResultsWithoutUrl:a=!1,showCodeSnippets:o=!1,snippetMode:l="balanced",snippetLength:i=150,parseMarkdownSnippets:d=!1,debug:c=!1,signal:g}){let u=new URLSearchParams({q:e,hitsPerPage:s.toString()});u.append("enrich","1"),t.length>0&&u.append("indices",t.join(",")),n&&u.append("siteId",n),a&&u.append("hideResultsWithoutUrl","1"),o&&u.append("showCodeSnippets","1"),l&&l!=="balanced"&&u.append("snippetMode",l),i&&i!==150&&u.append("snippetLength",String(i)),d&&u.append("parseMarkdownSnippets","1"),c&&u.append("debug","1"),u.append("skipAnalytics","1");let m=r.includes("?")?"&":"?",y=await fetch(`${r}${m}${u}`,{signal:g,headers:{Accept:"application/json"}});if(!y.ok)throw new Error("Search failed");let p=await y.json();return p.error&&console.warn("Search warning:",p.error),{results:p.results||p.hits||[],total:p.total||0,meta:p.meta||null,error:p.error||null}}function ce({endpoint:e,elementId:r,query:t,index:n}){if(!(!r||!e))try{let s=new FormData;s.append("elementId",r),s.append("query",t),s.append("index",n),fetch(e,{method:"POST",body:s,headers:{Accept:"application/json"}}).catch(()=>{})}catch{}}function he({endpoint:e,query:r,indices:t=[],resultsCount:n=0,trigger:s="unknown",source:a="",siteId:o=""}){if(!(!r||!e))try{let l=new FormData;l.append("q",r),l.append("indices",t.join(",")),l.append("resultsCount",n.toString()),l.append("trigger",s),l.append("source",a||"frontend-widget"),o&&l.append("siteId",o),fetch(e,{method:"POST",body:l,headers:{Accept:"application/json"}}).catch(()=>{})}catch{}}function ue(e){let r={};return e.forEach(t=>{let n=t.section||t.type||"Results";r[n]||(r[n]=[]),r[n].push(t)}),r}function ge(e,r){let t={};return e.forEach(n=>{let s=n[r]||n.section||n.type||"Results";t[s]||(t[s]=[]),t[s].push(n)}),t}var Je="sm-recent-";function Q(e){return`${Je}${e||"default"}`}function G(e){try{let r=Q(e),t=localStorage.getItem(r);return t?JSON.parse(t):[]}catch{return[]}}function me(e,r,t=null,n=5){if(!r||!r.trim())return G(e);let s=Q(e),a={query:r.trim(),title:t?.title||r,url:t?.url||null,timestamp:Date.now()},o=G(e);o=o.filter(l=>l.query!==a.query),o.unshift(a),o=o.slice(0,n);try{localStorage.setItem(s,JSON.stringify(o))}catch{}return o}function pe(e){try{let r=Q(e);localStorage.removeItem(r)}catch{}}var be={spinnerColor:"#3b82f6",spinnerColorDark:"#60a5fa",modalBg:"#ffffff",modalBgDark:"#1f2937",modalBorderRadius:"12",modalBorderWidth:"1",modalBorderColor:"#e5e7eb",modalBorderColorDark:"#374151",modalShadow:"0 25px 50px -12px rgba(0, 0, 0, 0.25)",modalShadowDark:"0 25px 50px -12px rgba(0, 0, 0, 0.5)",modalMaxWidth:"640",modalMaxHeight:"80",modalPaddingX:"16",modalPaddingY:"16",inputBg:"#ffffff",inputBgDark:"#1f2937",inputTextColor:"#111827",inputTextColorDark:"#f9fafb",inputPlaceholderColor:"#9ca3af",inputPlaceholderColorDark:"#9ca3af",inputBorderColor:"#e5e7eb",inputBorderColorDark:"#374151",inputFontSize:"16",resultBg:"transparent",resultBgDark:"transparent",resultBorderColor:"#e5e7eb",resultBorderColorDark:"#374151",resultActiveBg:"#e5e7eb",resultActiveBgDark:"#4b5563",resultActiveBorderColor:"#e5e7eb",resultActiveBorderColorDark:"#374151",resultActiveTextColor:"#111827",resultActiveTextColorDark:"#f9fafb",resultActiveDescColor:"#4b5563",resultActiveDescColorDark:"#d1d5db",resultActiveMutedColor:"#6b7280",resultActiveMutedColorDark:"#d1d5db",resultTextColor:"#111827",resultTextColorDark:"#f9fafb",resultDescColor:"#4b5563",resultDescColorDark:"#d1d5db",resultMutedColor:"#6b7280",resultMutedColorDark:"#d1d5db",resultGap:"8",resultBorderWidth:"0",resultPaddingX:"12",resultPaddingY:"12",resultBorderRadius:"8",triggerBg:"#ffffff",triggerBgDark:"#374151",triggerTextColor:"#374151",triggerTextColorDark:"#d1d5db",triggerBorderRadius:"8",triggerBorderWidth:"1",triggerBorderColor:"#d1d5db",triggerBorderColorDark:"#4b5563",triggerPaddingX:"12",triggerPaddingY:"8",triggerFontSize:"14",kbdBg:"#f3f4f6",kbdBgDark:"#4b5563",kbdTextColor:"#4b5563",kbdTextColorDark:"#e5e7eb",kbdBorderRadius:"4",backdropOpacity:"50",backdropBlur:"1",highlightEnabled:"1",highlightTag:"",highlightClass:"",highlightBgLight:"fef08a",highlightColorLight:"854d0e",highlightBgDark:"854d0e",highlightColorDark:"fef08a",promotedBg:"#2563eb",promotedBgDark:"#3b82f6",promotedColor:"#ffffff",promotedColorDark:"#ffffff"};var fe={modalBg:"--sm-modal-bg",modalBgDark:"--sm-modal-bg-dark",modalBorderRadius:"--sm-modal-radius",modalBorderWidth:"--sm-modal-border-width",modalBorderColor:"--sm-modal-border-color",modalBorderColorDark:"--sm-modal-border-color-dark",modalShadow:"--sm-modal-shadow",modalShadowDark:"--sm-modal-shadow-dark",modalMaxWidth:"--sm-modal-width",modalMaxHeight:"--sm-modal-max-height",modalPaddingX:"--sm-modal-px",modalPaddingY:"--sm-modal-py",inputBg:"--sm-input-bg",inputBgDark:"--sm-input-bg-dark",inputTextColor:"--sm-input-color",inputTextColorDark:"--sm-input-color-dark",inputPlaceholderColor:"--sm-input-placeholder",inputPlaceholderColorDark:"--sm-input-placeholder-dark",inputBorderColor:"--sm-input-border-color",inputBorderColorDark:"--sm-input-border-color-dark",inputFontSize:"--sm-input-font-size",resultBg:"--sm-result-bg",resultBgDark:"--sm-result-bg-dark",resultBorderColor:"--sm-result-border-color",resultBorderColorDark:"--sm-result-border-color-dark",resultActiveBg:"--sm-result-active-bg",resultActiveBgDark:"--sm-result-active-bg-dark",resultActiveBorderColor:"--sm-result-active-border-color",resultActiveBorderColorDark:"--sm-result-active-border-color-dark",resultActiveTextColor:"--sm-result-active-text-color",resultActiveTextColorDark:"--sm-result-active-text-color-dark",resultActiveDescColor:"--sm-result-active-desc-color",resultActiveDescColorDark:"--sm-result-active-desc-color-dark",resultActiveMutedColor:"--sm-result-active-muted-color",resultActiveMutedColorDark:"--sm-result-active-muted-color-dark",resultTextColor:"--sm-result-text-color",resultTextColorDark:"--sm-result-text-color-dark",resultDescColor:"--sm-result-desc-color",resultDescColorDark:"--sm-result-desc-color-dark",resultMutedColor:"--sm-result-muted-color",resultMutedColorDark:"--sm-result-muted-color-dark",resultGap:"--sm-result-gap",resultBorderWidth:"--sm-result-border-width",resultPaddingX:"--sm-result-px",resultPaddingY:"--sm-result-py",resultBorderRadius:"--sm-result-radius",triggerBg:"--sm-trigger-bg",triggerBgDark:"--sm-trigger-bg-dark",triggerTextColor:"--sm-trigger-text-color",triggerTextColorDark:"--sm-trigger-text-color-dark",triggerBorderRadius:"--sm-trigger-radius",triggerBorderWidth:"--sm-trigger-border-width",triggerBorderColor:"--sm-trigger-border-color",triggerBorderColorDark:"--sm-trigger-border-color-dark",triggerPaddingX:"--sm-trigger-px",triggerPaddingY:"--sm-trigger-py",triggerFontSize:"--sm-trigger-font-size",kbdBg:"--sm-kbd-bg",kbdBgDark:"--sm-kbd-bg-dark",kbdTextColor:"--sm-kbd-text-color",kbdTextColorDark:"--sm-kbd-text-color-dark",kbdBorderRadius:"--sm-kbd-radius",highlightBgLight:"--sm-highlight-bg",highlightColorLight:"--sm-highlight-color",highlightBgDark:"--sm-highlight-bg-dark",highlightColorDark:"--sm-highlight-color-dark",promotedBg:"--sm-promoted-bg",promotedBgDark:"--sm-promoted-bg-dark",promotedColor:"--sm-promoted-color",promotedColorDark:"--sm-promoted-color-dark",spinnerColor:"--sm-spinner-color-light",spinnerColorDark:"--sm-spinner-color-dark"},X=["modalBorderRadius","modalBorderWidth","modalMaxWidth","modalPaddingX","modalPaddingY","inputFontSize","resultGap","resultBorderWidth","resultPaddingX","resultPaddingY","resultBorderRadius","triggerBorderRadius","triggerBorderWidth","triggerPaddingX","triggerPaddingY","triggerFontSize","kbdBorderRadius"],J=["modalMaxHeight"],ye=["modalBg","modalBgDark","modalBorderColor","modalBorderColorDark","inputBg","inputBgDark","inputTextColor","inputTextColorDark","inputPlaceholderColor","inputPlaceholderColorDark","inputBorderColor","inputBorderColorDark","resultBg","resultBgDark","resultBorderColor","resultBorderColorDark","resultActiveBg","resultActiveBgDark","resultActiveBorderColor","resultActiveBorderColorDark","resultTextColor","resultTextColorDark","resultActiveTextColor","resultActiveTextColorDark","resultActiveDescColor","resultActiveDescColorDark","resultActiveMutedColor","resultActiveMutedColorDark","resultDescColor","resultDescColorDark","resultMutedColor","resultMutedColorDark","triggerBg","triggerBgDark","triggerTextColor","triggerTextColorDark","triggerBorderColor","triggerBorderColorDark","kbdBg","kbdBgDark","kbdTextColor","kbdTextColorDark","highlightBgLight","highlightColorLight","highlightBgDark","highlightColorDark","promotedBg","promotedBgDark","promotedColor","promotedColorDark","spinnerColor","spinnerColorDark"],At={...be,highlightBgLight:"#fef08a",highlightColorLight:"#854d0e",highlightBgDark:"#854d0e",highlightColorDark:"#fef08a"};function et(e){return/^[0-9a-fA-F]{6}$/.test(e)}function tt(e,r){if(r==null||r==="")return null;let t=String(r);return ye.includes(e)&&et(t)&&(t="#"+t),X.includes(e)&&(t=t+"px"),J.includes(e)&&(t=t+"vh"),t}function ve(e,r,t="light"){if(!r||typeof r!="object")return;let n=t==="dark",s=Object.entries(fe),a=new Set([...X,...J]);for(let[o,l]of s){let i=o.endsWith("Dark");if(n){if(!i&&!a.has(o))continue}else if(i)continue;if(r[o]!==void 0&&r[o]!==null&&r[o]!==""){let d=tt(o,r[o]);d&&e.style.setProperty(l,d)}}}function h(e){if(!e)return"";let r=document.createElement("div");return r.textContent=e,r.innerHTML}function xe(e){return e?e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"):""}function Z(e){if(!e)return[];let r=[],t=/"([^"]+)"/g,n;for(;(n=t.exec(e))!==null;)n[1].trim()&&r.push(n[1].trim());let s=e.replace(/"[^"]*"/g,""),a=new Set(["and","or","not","und","oder","nicht","et","ou","sauf","y","o","no"]);s.split(/\s+/).filter(l=>l.length>0).forEach(l=>{l=l.replace(/^[a-zA-Z]+:/,""),l=l.replace(/\*/g,""),l=l.replace(/\^\d+(\.\d+)?/,""),l=l.replace(/"/g,""),!(!l||a.has(l.toLowerCase()))&&r.push(l)});let o=[];return r.forEach(l=>{o.push(l);let i=l.split(/(?<=[a-z])(?=[A-Z])/);i.length>1&&i.forEach(d=>{d.length>=3&&o.push(d)})}),o}function $(e,r,t={}){let{enabled:n=!0,tag:s="mark",className:a="",terms:o=null}=t;if(!n)return h(e);let l=["sm-highlight"];a&&l.push(a);let i=` class="${l.join(" ")}"`,d=rt(r,o);return d.length===0?h(e):nt(e,d,s,i)}function rt(e,r){return Array.isArray(r)&&r.length>0?ke(r):e?ke(Z(e)):[]}function ke(e){let r=new Set;return e.filter(t=>typeof t=="string"&&t.length>0).sort((t,n)=>n.length-t.length).filter(t=>{let n=t.toLowerCase();return r.has(n)?!1:(r.add(n),!0)})}function nt(e,r,t,n){let s=e.toLowerCase(),a=[];if(r.forEach(c=>{let g=c.toLowerCase();if(!g)return;let u=0;for(;u<s.length;){let m=s.indexOf(g,u);if(m===-1)break;a.push({start:m,end:m+g.length}),u=m+g.length}}),a.length===0)return h(e);a.sort((c,g)=>c.start!==g.start?c.start-g.start:g.end-g.start-(c.end-c.start));let o=[],l=-1;a.forEach(c=>{c.start>=l&&(o.push(c),l=c.end)});let i="",d=0;return o.forEach(c=>{d<c.start&&(i+=h(e.slice(d,c.start))),i+=`<${t}${n}>${h(e.slice(c.start,c.end))}</${t}>`,d=c.end}),d<e.length&&(i+=h(e.slice(d))),i}function N(e,r,t="smq"){if(!e||e==="#")return e;let n=(r||"").trim();if(!n||!t||/^(mailto:|tel:|javascript:)/i.test(e))return e;let[s,a]=e.split("#",2),[o,l]=s.split("?",2),i=new URLSearchParams(l||"");i.set(t,n);let d=i.toString(),c=a?`#${a}`:"";return`${o}${d?`?${d}`:""}${c}`}var st=0;function ee(e="sm"){return`${e}-${++st}-${Date.now().toString(36)}`}function we(e){let r=document.createElement("div");return r.setAttribute("role","status"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-atomic","true"),r.className="sm-sr-only",e.appendChild(r),r}function U(e,r,t=100){e&&(e.textContent="",setTimeout(()=>{e.textContent=r},t))}function te(e,r){return e===0?`No results found for "${r}"`:e===1?`1 result found for "${r}"`:`${e} results found for "${r}"`}function Ce(){return"Searching..."}function Se(e){return e===0?"No recent searches":e===1?"1 recent search available":`${e} recent searches available`}function W(e,{expanded:r,activeDescendant:t,listboxId:n}){e.setAttribute("aria-expanded",String(r)),e.setAttribute("aria-controls",n),t?e.setAttribute("aria-activedescendant",t):e.removeAttribute("aria-activedescendant")}function L(e,r){return`${e}-option-${r}`}function Ae(e,r){if(!e||!r)return;let t=e.getBoundingClientRect(),n=r.getBoundingClientRect();t.top<n.top?e.scrollIntoView({block:"nearest",behavior:"smooth"}):t.bottom>n.bottom&&e.scrollIntoView({block:"nearest",behavior:"smooth"})}function ot(e,r,t={}){let{groupResults:n=!1,resultLayout:s="default",listboxId:a}=t;if(!e||e.length===0)return"";if(s==="hierarchical")return dt(e,r,t);if(n){let o=ue(e),l=0;return Object.entries(o).map(([i,d])=>`
    ...
    `}function Ee(e){let r=[],t=e.backend?e.backend.toLowerCase():"";if((e._index||e.index)&&r.push(S("index",e._index||e.index,"index")),e.backend&&r.push(S("backend",t,"backend",t)),e.id&&r.push(S("id",e.id,"generic")),e.score!==void 0&&e.score!==null){let n=typeof e.score=="number"?e.score.toFixed(2):e.score;r.push(S("score",n,"score"))}if(e.site&&r.push(S("site",e.site,"generic")),e.language&&r.push(S("lang",e.language,"generic")),e.matchedIn&&Array.isArray(e.matchedIn)&&e.matchedIn.length>0){let n=e.matchedIn.join(", ");r.push(S("matched",n,"matched"))}return e.promoted&&r.push(S("promoted","yes","promoted")),e.boosted&&r.push(S("boosted","yes","boosted")),r.length===0?"":`<div class="sm-debug-info">${r.join("")}</div>`}function F(e,r){let t=Array.isArray(e.matchedPhrases)?e.matchedPhrases:[],n=e.matchedTerms,s=[];n&&(r==="title"&&Array.isArray(n.title)&&n.title.length>0?s=n.title:r==="description"&&Array.isArray(n.content)&&n.content.length>0?s=n.content:s=[...Array.isArray(n.title)?n.title:[],...Array.isArray(n.content)?n.content:[]]);let a=[...t,...s];return a.length>0?a:null}function S(e,r,t,n=""){let s=n?` data-backend="${h(n)}"`:"";return`<span class="sm-debug-item"><span class="sm-debug-label">${h(e)}</span><span class="sm-debug-value" data-type="${h(t)}"${s}>${h(String(r))}</span></span>`}function at(e,r={}){let{showBadge:t=!0,badgeText:n="Featured",badgePosition:s="top-right"}=r;return!e.promoted||!t?"":`<span class="sm-promoted-badge ${`sm-promoted-badge--${s}`}">${h(n)}</span>`}function P(){return`<svg class="sm-result-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
    ...
    </svg>`}function dt(e,r,t={}){let{hierarchyGroupBy:n="section",hierarchyStyle:s="tree",hierarchyDisplay:a="individual",maxHeadingsPerResult:o=3,listboxId:l}=t,i=s==="tree",d=s!=="none",g=ge(e,n||"section"),u=0;return Object.entries(g).map(([m,y])=>{let p=y.map(v=>{let T=u++,b=ct(v,T,r,t),k="",x=(v._matchedHeadings||[]).slice(0,o);if(x.length>0){let B=Math.min(...x.map(w=>w.level||2)),R=x.map(w=>i?(w.level||2)-B:0);k=x.map((w,M)=>{let O=R[M],_=!R.slice(M+1).some(Y=>Y===O),E=[];if(i){let Y=R.slice(M+1);for(let q=0;q<O;q++)Y.some(Ue=>Ue===q)&&E.push(q)}return ht(v,w,u++,r,t,_,O,E)}).join("")}let A=!!k;return`
                <div class="sm-hierarchy-block${A?" sm-hierarchy-block--has-children":""}${a==="unified"?" sm-hierarchy-block--unified":""}">
        ...
        `}).join("")}function ct(e,r,t,n={}){let{listboxId:s,enableHighlighting:a=!0,highlightTag:o="mark",highlightClass:l="",debug:i=!1,persistQueryInUrl:d=!1,queryParamName:c="smq"}=n,g=e.title||e.name||"Untitled",u=e.description||e.excerpt||"",m=e.url||"#",y=N(m,t,d?c:""),p=L(s,r),v={enabled:a,tag:o,className:l},T=$(g,t,{...v,terms:F(e,"title")}),b=u?$(u,t,{...v,terms:F(e,"description")}):"",k=i?Ee(e):"",x=e._matchedHeadings&&e._matchedHeadings.length>0?it():lt();return i?`
    ...
    `}function ht(e,r,t,n,s={},a=!1,o=0,l=[]){let{listboxId:i,enableHighlighting:d=!0,highlightTag:c="mark",highlightClass:g="",debug:u=!1,persistQueryInUrl:m=!1,queryParamName:y="smq"}=s,v=(r.text||"").replace(/^#+\s*/,""),T=r.description||"",b=r.level||2,k=r.id||(v?ut(v):""),I=e.url||"#",x=k?`${I}#${k}`:I,A=N(x,n,m?y:""),H=L(i,t),B={enabled:d,tag:c,className:g},R=$(v,n,{...B,terms:F(e,"title")}),w=T?$(T,n,{...B,terms:F(e,"description")}):"",M=a?" sm-hierarchy-child-row-last":"",O=l.map(E=>`<div class="sm-hierarchy-guide" style="--sm-guide-depth:${E}" aria-hidden="true"></div>`).join(""),_="";if(u){let E=[];E.push(S("h",b,"generic")),k&&E.push(S("anchor",k,"generic")),e.id&&E.push(S("parent",e.id,"generic")),_=`<div class="sm-debug-info">${E.join("")}</div>`}return u?`
            <div class="sm-hierarchy-child-row sm-hierarchy-level-${b} sm-hierarchy-depth-${o}${M}" style="--sm-hierarchy-depth:${o}">
                ${O}
    ...
    `}function Ie(e,r){let{query:t,results:n,recentSearches:s,loading:a,showRecent:o}=e,{showLoadingIndicator:l=!0}=r,i=t&&t.trim();return a&&l?{html:mt(),hasResults:!1,showListbox:!1}:i?!n||n.length===0?{html:Re(t),hasResults:!1,showListbox:!1}:{html:ot(n,t,r),hasResults:!0,showListbox:!0}:o&&s&&s.length>0?{html:gt(s,r.listboxId),hasResults:!0,showListbox:!0}:{html:Re(""),hasResults:!1,showListbox:!1}}function re(e,r,t=!1){if(!e)return"";let n=[];if(n.push(D("results",r,"generic")),e.took!==void 0){let i=e.took<1?"<1ms":`${Math.round(e.took)}ms`;n.push(D("time",i,"time"))}if(e.cacheEnabled!==void 0&&(e.cacheEnabled?e.cached?n.push(D("cache","hit","cache-hit")):n.push(D("cache","miss","cache-miss")):n.push(D("cache","off","cache-off"))),e.cacheDriver&&n.push(D("storage",e.cacheDriver,"cache-driver",e.cacheDriver)),e.indices&&e.indices.length>0){let i=e.indices.length>2?`${e.indices.length} indices`:e.indices.join(", ");n.push(D("indices",i,"generic"))}if(e.synonymsExpanded){let i=e.expandedQueries?e.expandedQueries.length-1:0;n.push(D("synonyms",`+${i}`,"synonyms"))}let s=e.rulesMatched?.length||0;n.push(D("rules",s,s>0?"rules":"generic"));let a=e.promotionsMatched?.length||0;n.push(D("promoted",a,a>0?"promotions":"generic"));let l=`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">${t?'<path d="M6 9l6 6 6-6"/>':'<path d="M18 15l-6-6-6 6"/>'}</svg>`;return t?`<div class="sm-toolbar-collapsed-bar"><span class="sm-toolbar-collapsed-label">Debug</span>${l}</div>`:`<div class="sm-toolbar-content">${n.join("")}</div><button class="sm-toolbar-toggle" aria-label="Collapse debug panel" aria-expanded="true">${l}</button>`}function D(e,r,t,n=""){let s=n?` data-backend="${h(n)}"`:"";return`<span class="sm-toolbar-item"><span class="sm-toolbar-label">${h(e)}</span><span class="sm-toolbar-value" data-type="${h(t)}"${s}>${h(String(r))}</span></span>`}function Be(e,r){let{onSelect:t,onIndexChange:n,onEscape:s}=e,{listboxId:a}=r;return{handleKeydown(o,l,i){let d=i;switch(o.key){case"ArrowDown":return o.preventDefault(),d=Math.min(i+1,l-1),d!==i&&n&&n(d),d;case"ArrowUp":return o.preventDefault(),d=Math.max(i-1,-1),d!==i&&n&&n(d),d;case"Enter":return o.preventDefault(),i>=0&&t&&t(i),null;case"Escape":return o.preventDefault(),s&&s(),null;default:return null}},getListboxId(){return a}}}function $e(e,r,t={}){let{scrollContainer:n,inputElement:s,listboxId:a,selectedClass:o="sm-selected"}=t,l=r>=0?L(a,r):null;s&&W(s,{expanded:e.length>0,activeDescendant:l,listboxId:a}),e.forEach((i,d)=>{let c=d===r;i.classList.toggle(o,c),i.setAttribute("aria-selected",String(c)),c&&n&&Ae(i,n)})}function Le(e,r){e.forEach((t,n)=>{t.addEventListener("mouseenter",()=>{r&&r(n)})})}var Pe="sm-page-highlight-style",He="__smPageHighlightRegistry",ne=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.config=null,this.state=le({...z},this.handleStateChange.bind(this)),this.abortController=null,this.debounceTimer=null,this.analyticsIdleTimer=null,this.lastTrackedQuery=null,this.listboxId=ee("sm-listbox"),this.inputId=ee("sm-input"),this.liveRegion=null,this.keyboardNavigator=null,this.elements={},this.handleInput=this.handleInput.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.handleResultClick=this.handleResultClick.bind(this)}get widgetType(){throw new Error("Subclass must implement widgetType getter")}render(){throw new Error("Subclass must implement render()")}getResultsContainer(){throw new Error("Subclass must implement getResultsContainer()")}getInputElement(){throw new Error("Subclass must implement getInputElement()")}getLoadingElement(){return this.elements.loading||null}getDebugToolbarElement(){return this.elements.debugToolbar||null}connectedCallback(){this.config=V(this,this.widgetType),this.state.set({recentSearches:G(this.config.index)}),this.keyboardNavigator=Be({onSelect:r=>this.selectResultAtIndex(r),onIndexChange:r=>this.state.set({selectedIndex:r}),onEscape:()=>this.handleEscape()},{listboxId:this.listboxId}),this.applyDestinationPageHighlight()}disconnectedCallback(){this.abortController&&(this.abortController.abort(),this.abortController=null),this.debounceTimer&&(clearTimeout(this.debounceTimer),this.debounceTimer=null)}attributeChangedCallback(r,t,n){t!==n&&this.shadowRoot.children.length>0&&(this.config=V(this,this.widgetType),this.render(),this.applyCustomStyles())}handleStateChange(r,t){(t.includes("results")||t.includes("query")||t.includes("recentSearches"))&&this.renderResultsContent(),(t.includes("results")||t.includes("meta"))&&this.updateDebugToolbar(),t.includes("selectedIndex")&&this.updateSelectionVisual(),t.includes("loading")&&this.updateLoadingVisual()}handleInput(r){let t=r.target.value;if(this.state.set({query:t,selectedIndex:-1}),this.debounceTimer&&clearTimeout(this.debounceTimer),this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null),!t.trim()){this.state.set({results:[]});return}t.length<this.config.minChars||(this.debounceTimer=setTimeout(()=>{this.executeSearch(t)},this.config.debounce))}async executeSearch(r){this.abortController&&this.abortController.abort(),this.abortController=new AbortController,this.state.set({loading:!0,error:null}),this.liveRegion&&U(this.liveRegion,Ce());try{let{results:t,meta:n}=await de({query:r,endpoint:this.config.searchEndpoint,indices:this.config.indices,siteId:this.config.siteId,maxResults:this.config.maxResults,hideResultsWithoutUrl:this.config.hideResultsWithoutUrl,showCodeSnippets:this.config.showCodeSnippets,snippetMode:this.config.snippetMode,snippetLength:this.config.snippetLength,parseMarkdownSnippets:this.config.parseMarkdownSnippets,debug:this.config.debug,signal:this.abortController.signal});this.state.set({results:t,meta:n,loading:!1,selectedIndex:t.length>0?0:-1}),this.liveRegion&&U(this.liveRegion,te(t.length,r)),this.dispatchWidgetEvent("search",{query:r,results:t,meta:n}),this.startAnalyticsIdleTimer(r,t.length)}catch(t){if(t.name==="AbortError")return;console.error("Search error:",t),this.state.set({results:[],loading:!1,error:t.message}),this.dispatchWidgetEvent("error",{query:r,error:t.message})}}renderResultsContent(){let r=this.getResultsContainer();if(!r)return;let t=this.state.getAll(),{showRecent:n,groupResults:s,enableHighlighting:a,highlightTag:o,highlightClass:l,showLoadingIndicator:i,debug:d}=this.config,{html:c,hasResults:g,showListbox:u}=Ie({query:t.query,results:t.results,recentSearches:t.recentSearches,loading:t.loading,showRecent:n},{listboxId:this.listboxId,groupResults:s,enableHighlighting:a,highlightTag:o,highlightClass:l,showLoadingIndicator:i,debug:d,persistQueryInUrl:this.config.highlightDestinationPage&&this.config.persistQueryInUrl,queryParamName:this.config.queryParamName,promotions:this.config.promotions,resultLayout:this.config.resultLayout,hierarchyGroupBy:this.config.hierarchyGroupBy,hierarchyStyle:this.config.hierarchyStyle,hierarchyDisplay:this.config.hierarchyDisplay,maxHeadingsPerResult:this.config.maxHeadingsPerResult});r.innerHTML=c,u?r.setAttribute("role","listbox"):r.removeAttribute("role");let m=this.getInputElement();m&&W(m,{expanded:g,activeDescendant:null,listboxId:this.listboxId}),this.liveRegion&&!t.loading&&(t.query&&t.results.length===0?U(this.liveRegion,te(0,t.query)):!t.query&&t.recentSearches.length>0&&n&&U(this.liveRegion,Se(t.recentSearches.length))),this.attachResultHandlers();let y=r.querySelector(".sm-clear-recent");y&&y.addEventListener("click",p=>{p.stopPropagation(),pe(this.config.index),this.state.set({recentSearches:[]})}),g&&t.results.length>0&&this.state.set({selectedIndex:0})}attachResultHandlers(){let r=this.getResultsContainer();if(!r)return;let t=r.querySelectorAll(".sm-result-item");t.forEach(n=>{n.addEventListener("click",s=>this.handleResultClick(s,n))}),Le(t,n=>{this.state.set({selectedIndex:n})})}updateSelectionVisual(){let r=this.getResultsContainer(),t=this.getInputElement();if(!r)return;let n=r.querySelectorAll(".sm-result-item"),s=this.state.get("selectedIndex");$e(n,s,{scrollContainer:r,inputElement:t,listboxId:this.listboxId})}handleKeydown(r){let t=this.getResultsContainer();if(!t)return;let n=t.querySelectorAll(".sm-result-item"),s=this.state.get("selectedIndex");if(r.key==="Enter"){let a=this.state.get("query"),o=this.state.get("results")||[];a&&o.length>0&&this.trackSearchAnalytics(a,o.length,"enter")}this.keyboardNavigator.handleKeydown(r,n.length,s)}selectResultAtIndex(r){let t=this.getResultsContainer();if(!t)return;let n=t.querySelectorAll(".sm-result-item");r>=0&&n[r]&&n[r].click()}handleEscape(){}handleResultClick(r,t){let n=t.getAttribute("href"),s=t.dataset.url,a=n||s,o=t.dataset.title||t.querySelector(".sm-result-title")?.textContent,l=t.dataset.id,i=t.dataset.query||this.state.get("query"),d=t.classList.contains("sm-recent-item"),c=N(a,i,this.config.highlightDestinationPage&&this.config.persistQueryInUrl?this.config.queryParamName:"");if(!d&&i){let g=me(this.config.index,i,{title:o,url:a},this.config.maxRecentSearches);this.state.set({recentSearches:g})}if(l&&this.config.index&&ce({endpoint:this.config.trackClickEndpoint,elementId:l,query:i,index:this.config.index}),!d&&i&&this.trackSearchAnalytics(i,this.state.get("results")?.length||0,"click"),this.dispatchWidgetEvent("result-click",{id:l,title:o,url:c,query:i,isRecent:d}),a&&a!=="#")d&&(r.preventDefault(),window.location.href=c),this.onResultSelected(c,o,l);else if(i){r.preventDefault();let g=this.getInputElement();g&&(g.value=i,this.state.set({query:i}),this.executeSearch(i))}}onResultSelected(r,t,n){}applyDestinationPageHighlight(){if(!this.config.highlightDestinationPage||typeof window>"u"||typeof document>"u")return;let r=this.config.queryParamName||"smq",t=this.config.destinationHighlightSelector||"main, article, [data-search-content]",n=new URLSearchParams(window.location.search).get(r);if(!n||!n.trim())return;let s=this.getPageHighlightRegistry(),a=`${r}::${t}`;if(s.has(a))return;s.add(a);let o=()=>{this.ensurePageHighlightStyles(),this.highlightDestinationNodes(n.trim(),t,a)};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",o,{once:!0}):window.requestAnimationFrame(o)}ensurePageHighlightStyles(){if(document.getElementById(Pe))return;let r=document.createElement("style");r.id=Pe,r.textContent=`
        ...
        `,document.head.appendChild(r)}highlightDestinationNodes(r,t,n){let s=Array.from(document.querySelectorAll(t));if(s.length===0)return;let a=[...new Set(Z(r).map(i=>i.trim()).filter(i=>i.length>=2))];if(a.length===0)return;let o=a.map(i=>xe(i)).filter(Boolean).sort((i,d)=>d.length-i.length).join("|");if(!o)return;let l=new RegExp(`(${o})`,"gi");s.forEach(i=>{i.getAttribute("data-sm-highlighted")!==n&&(this.highlightTextNodesInScope(i,l),i.setAttribute("data-sm-highlighted",n))})}highlightTextNodesInScope(r,t){let n=document.createTreeWalker(r,NodeFilter.SHOW_TEXT,{acceptNode:a=>{let o=a.nodeValue;if(!o||!o.trim())return NodeFilter.FILTER_REJECT;let l=a.parentElement;return!l||l.closest("script, style, noscript, textarea, code, pre, mark, .sm-highlight, .sm-page-highlight, search-modal")?NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT}}),s=[];for(;n.nextNode();)s.push(n.currentNode);s.forEach(a=>{let o=a.nodeValue||"";if(t.lastIndex=0,!t.test(o))return;let l=document.createDocumentFragment(),i=0;t.lastIndex=0;let d=o.matchAll(t);for(let c of d){let g=c[0],u=c.index??-1;if(u<0)continue;u>i&&l.appendChild(document.createTextNode(o.slice(i,u)));let m=document.createElement("mark");m.className="sm-highlight sm-page-highlight",m.textContent=g,l.appendChild(m),i=u+g.length}i<o.length&&l.appendChild(document.createTextNode(o.slice(i))),a.parentNode?.replaceChild(l,a)})}getPageHighlightRegistry(){let r=window[He];if(r instanceof Set)return r;let t=new Set;return window[He]=t,t}updateLoadingVisual(){let r=this.getLoadingElement();if(r){let t=this.state.get("loading"),n=this.config?.showLoadingIndicator!==!1;r.hidden=!t||!n}}updateDebugToolbar(){let r=this.getDebugToolbarElement();if(!r)return;let{debug:t}=this.config,n=this.state.getAll();if(!t||!n.meta||n.results.length===0){r.hidden=!0;return}let s=r.classList.contains("sm-collapsed");r.innerHTML=re(n.meta,n.results.length,s),r.hidden=!1,s&&r.classList.add("sm-collapsed"),this.attachDebugToolbarHandlers(r)}attachDebugToolbarHandlers(r){let t=r.querySelector(".sm-toolbar-toggle");t&&t.addEventListener("click",s=>{s.preventDefault(),s.stopPropagation(),this.toggleDebugToolbar()});let n=r.querySelector(".sm-toolbar-collapsed-bar");n&&n.addEventListener("click",s=>{s.preventDefault(),s.stopPropagation(),this.toggleDebugToolbar()})}toggleDebugToolbar(){let r=this.getDebugToolbarElement();if(!r)return;let t=r.classList.toggle("sm-collapsed"),n=this.state.getAll();r.innerHTML=re(n.meta,n.results.length,t),t&&r.classList.add("sm-collapsed"),this.attachDebugToolbarHandlers(r)}applyCustomStyles(){if(!this.config)return;let r=this.shadowRoot.host,{theme:t,styles:n,resultTitleLines:s,resultDescLines:a}=this.config;ve(r,n,t),s&&r.style.setProperty("--sm-result-title-lines",String(s)),a&&r.style.setProperty("--sm-result-desc-lines",String(a))}initializeLiveRegion(){this.liveRegion=we(this.shadowRoot)}startAnalyticsIdleTimer(r,t){this.analyticsIdleTimer&&clearTimeout(this.analyticsIdleTimer);let n=this.config.idleTimeout;!n||n<=0||(this.analyticsIdleTimer=setTimeout(()=>{this.trackSearchAnalytics(r,t,"idle")},n))}trackSearchAnalytics(r,t,n){!r||r===this.lastTrackedQuery||(this.lastTrackedQuery=r,this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null),he({endpoint:this.config.trackSearchEndpoint,query:r,indices:this.config.indices,resultsCount:t,trigger:n,source:this.config.source,siteId:this.config.siteId}))}resetAnalyticsTracking(){this.lastTrackedQuery=null,this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null)}dispatchWidgetEvent(r,t={}){this.dispatchEvent(new CustomEvent(`search-${r}`,{bubbles:!0,composed:!0,detail:t}))}},Me=ne;var Oe=`/**
