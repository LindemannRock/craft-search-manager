var SearchModalWidget=(()=>{var q=Object.defineProperty;var He=Object.getOwnPropertyDescriptor;var Oe=Object.getOwnPropertyNames;var Fe=Object.prototype.hasOwnProperty;var Ne=(e,r)=>{for(var t in r)q(e,t,{get:r[t],enumerable:!0})},ze=(e,r,t,n)=>{if(r&&typeof r=="object"||typeof r=="function")for(let o of Oe(r))!Fe.call(e,o)&&o!==t&&q(e,o,{get:()=>r[o],enumerable:!(n=He(r,o))||n.enumerable});return e};var Ue=e=>ze(q({},"__esModule",{value:!0}),e);var ut={};Ne(ut,{default:()=>ht});var je={indices:[],placeholder:"Search...",theme:"light",maxResults:20,debounce:200,minChars:2,showRecent:!0,maxRecentSearches:5,groupResults:!0,siteId:"",searchEndpoint:"/actions/search-manager/api/search",trackClickEndpoint:"/actions/search-manager/search/track-click",trackSearchEndpoint:"/actions/search-manager/search/track-search",idleTimeout:1500,source:"",enableHighlighting:!0,highlightTag:"mark",highlightClass:"",hideResultsWithoutUrl:!1,allowCodeSnippets:!1,snippetMode:"balanced",showLoadingIndicator:!0,debug:!1,resultTitleLines:1,resultDescLines:1,snippetLength:150,parseMarkdownSnippets:!1,resultLayout:"default",hierarchyGroupBy:"",hierarchyStyle:"tree",hierarchyDisplay:"individual",maxHeadingsPerResult:3,styles:{},promotions:{showBadge:!0,badgeText:"Featured",badgePosition:"top-right"}},_e={hotkey:"k",showTrigger:!0,triggerSelector:"",backdropOpacity:50,enableBackdropBlur:!0,preventBodyScroll:!0},Ge={showFilters:!0,paginationType:"numbered",resultsPerPage:20,updateUrl:!0,sortOptions:["relevance","date-desc","date-asc","title"]},qe={dropdownPosition:"below",dropdownMaxHeight:400,showOnFocus:!0};function We(e){return{...je,...{modal:_e,page:Ge,inline:qe}[e]||{}}}function f(e,r=!1){return e==null?r:e===""?!0:e!=="false"&&e!=="0"}function k(e,r=0){if(e==null)return r;let t=Number.parseInt(e,10);return Number.isNaN(t)?r:t}function re(e,r={}){if(!e)return r;try{return JSON.parse(e)}catch(t){return console.warn("SearchWidget: Invalid JSON attribute",t),r}}function ne(e){return e?e.split(",").map(r=>r.trim()).filter(Boolean):[]}function W(e,r="modal"){let t=We(r),n=e.getAttribute("indices")||"",o=ne(n),s={indices:o,index:o[0]||"",placeholder:e.getAttribute("placeholder")||t.placeholder,theme:e.getAttribute("theme")||t.theme,siteId:e.getAttribute("site-id")||t.siteId,source:e.getAttribute("source")||t.source,highlightTag:e.getAttribute("highlight-tag")||t.highlightTag,highlightClass:e.getAttribute("highlight-class")||t.highlightClass,searchEndpoint:t.searchEndpoint,trackClickEndpoint:t.trackClickEndpoint,trackSearchEndpoint:t.trackSearchEndpoint,maxResults:k(e.getAttribute("max-results"),t.maxResults),debounce:k(e.getAttribute("debounce"),t.debounce),minChars:k(e.getAttribute("min-chars"),t.minChars),maxRecentSearches:k(e.getAttribute("max-recent-searches"),t.maxRecentSearches),idleTimeout:k(e.getAttribute("idle-timeout"),t.idleTimeout),showRecent:f(e.getAttribute("show-recent"),t.showRecent),groupResults:f(e.getAttribute("group-results"),t.groupResults),enableHighlighting:f(e.getAttribute("enable-highlighting"),t.enableHighlighting),showLoadingIndicator:f(e.getAttribute("show-loading-indicator"),t.showLoadingIndicator),hideResultsWithoutUrl:f(e.getAttribute("hide-results-without-url"),t.hideResultsWithoutUrl),allowCodeSnippets:f(e.getAttribute("allow-code-snippets"),t.allowCodeSnippets),debug:f(e.getAttribute("debug"),t.debug),snippetMode:e.getAttribute("snippet-mode")||t.snippetMode,snippetLength:k(e.getAttribute("snippet-length"),t.snippetLength),parseMarkdownSnippets:f(e.getAttribute("parse-markdown-snippets"),t.parseMarkdownSnippets),resultTitleLines:k(e.getAttribute("result-title-lines"),t.resultTitleLines),resultDescLines:k(e.getAttribute("result-desc-lines"),t.resultDescLines),resultLayout:e.getAttribute("result-layout")||t.resultLayout,hierarchyGroupBy:e.getAttribute("hierarchy-group-by")||t.hierarchyGroupBy,hierarchyStyle:e.getAttribute("hierarchy-style")||t.hierarchyStyle,hierarchyDisplay:e.getAttribute("hierarchy-display")||t.hierarchyDisplay,maxHeadingsPerResult:k(e.getAttribute("max-headings-per-result"),t.maxHeadingsPerResult),styles:re(e.getAttribute("styles"),t.styles),promotions:re(e.getAttribute("promotions"),t.promotions)};return r==="modal"&&Object.assign(s,{hotkey:e.getAttribute("hotkey")||t.hotkey,triggerSelector:e.getAttribute("trigger-selector")||t.triggerSelector,backdropOpacity:k(e.getAttribute("backdrop-opacity"),t.backdropOpacity),showTrigger:f(e.getAttribute("show-trigger"),t.showTrigger),enableBackdropBlur:f(e.getAttribute("enable-backdrop-blur"),t.enableBackdropBlur),preventBodyScroll:f(e.getAttribute("prevent-body-scroll"),t.preventBodyScroll)}),r==="page"&&Object.assign(s,{resultsPerPage:k(e.getAttribute("results-per-page"),t.resultsPerPage),paginationType:e.getAttribute("pagination-type")||t.paginationType,showFilters:f(e.getAttribute("show-filters"),t.showFilters),updateUrl:f(e.getAttribute("update-url"),t.updateUrl),sortOptions:ne(e.getAttribute("sort-options"))||t.sortOptions}),r==="inline"&&Object.assign(s,{dropdownPosition:e.getAttribute("dropdown-position")||t.dropdownPosition,dropdownMaxHeight:k(e.getAttribute("dropdown-max-height"),t.dropdownMaxHeight),showOnFocus:f(e.getAttribute("show-on-focus"),t.showOnFocus)}),s}function oe(e="modal"){let r=["indices","placeholder","theme","max-results","debounce","min-chars","show-recent","max-recent-searches","group-results","site-id","idle-timeout","source","enable-highlighting","highlight-tag","highlight-class","hide-results-without-url","allow-code-snippets","snippet-mode","show-loading-indicator","debug","styles","promotions","result-layout","hierarchy-group-by","hierarchy-style","hierarchy-display","max-headings-per-result","result-title-lines","result-desc-lines","snippet-length","parse-markdown-snippets"],s={modal:["hotkey","show-trigger","trigger-selector","backdrop-opacity","enable-backdrop-blur","prevent-body-scroll"],page:["show-filters","pagination-type","results-per-page","update-url","sort-options"],inline:["dropdown-position","dropdown-max-height","show-on-focus"]};return[...r,...s[e]||[]]}var N={isOpen:!1,query:"",results:[],recentSearches:[],selectedIndex:-1,loading:!1,error:null,meta:null};function se(e={},r=null){let t={...N,...e};return{get(n){return t[n]},getAll(){return{...t}},set(n){let o=[];return Object.keys(n).forEach(s=>{let a=t[s],l=n[s];z(a,l)||o.push(s)}),o.length>0&&(t={...t,...n},r&&r(t,o)),o},reset(n=e){let o={...N,...n},s=Object.keys(o).filter(a=>!z(t[a],o[a]));s.length>0&&(t=o,r&&r(t,s))},is(n,o){return t[n]===o},toggle(n){let o=!t[n];return this.set({[n]:o}),o}}}function z(e,r){if(e===r)return!0;if(e==null||r==null)return!1;if(Array.isArray(e)&&Array.isArray(r))return e.length!==r.length?!1:e.every((t,n)=>z(t,r[n]));if(typeof e=="object"&&typeof r=="object"){let t=Object.keys(e),n=Object.keys(r);return t.length!==n.length?!1:t.every(o=>z(e[o],r[o]))}return!1}async function ae({query:e,endpoint:r,indices:t=[],siteId:n="",maxResults:o=10,hideResultsWithoutUrl:s=!1,allowCodeSnippets:a=!1,snippetMode:l="balanced",snippetLength:i=150,parseMarkdownSnippets:d=!1,debug:c=!1,signal:g}){let u=new URLSearchParams({q:e,hitsPerPage:o.toString()});u.append("enrich","1"),t.length>0&&u.append("indices",t.join(",")),n&&u.append("siteId",n),s&&u.append("hideResultsWithoutUrl","1"),a&&u.append("allowCodeSnippets","1"),l&&l!=="balanced"&&u.append("snippetMode",l),i&&i!==150&&u.append("snippetLength",String(i)),d&&u.append("parseMarkdownSnippets","1"),c&&u.append("debug","1"),u.append("skipAnalytics","1");let p=r.includes("?")?"&":"?",b=await fetch(`${r}${p}${u}`,{signal:g,headers:{Accept:"application/json"}});if(!b.ok)throw new Error("Search failed");let m=await b.json();return m.error&&console.warn("Search warning:",m.error),{results:m.results||m.hits||[],total:m.total||0,meta:m.meta||null,error:m.error||null}}function ie({endpoint:e,elementId:r,query:t,index:n}){if(!(!r||!e))try{let o=new FormData;o.append("elementId",r),o.append("query",t),o.append("index",n),fetch(e,{method:"POST",body:o,headers:{Accept:"application/json"}}).catch(()=>{})}catch{}}function le({endpoint:e,query:r,indices:t=[],resultsCount:n=0,trigger:o="unknown",source:s="",siteId:a=""}){if(!(!r||!e))try{let l=new FormData;l.append("q",r),l.append("indices",t.join(",")),l.append("resultsCount",n.toString()),l.append("trigger",o),l.append("source",s||"frontend-widget"),a&&l.append("siteId",a),fetch(e,{method:"POST",body:l,headers:{Accept:"application/json"}}).catch(()=>{})}catch{}}function de(e){let r={};return e.forEach(t=>{let n=t.section||t.type||"Results";r[n]||(r[n]=[]),r[n].push(t)}),r}function ce(e,r){let t={};return e.forEach(n=>{let o=n[r]||n.section||n.type||"Results";t[o]||(t[o]=[]),t[o].push(n)}),t}var Ke="sm-recent-";function K(e){return`${Ke}${e||"default"}`}function U(e){try{let r=K(e),t=localStorage.getItem(r);return t?JSON.parse(t):[]}catch{return[]}}function he(e,r,t=null,n=5){if(!r||!r.trim())return U(e);let o=K(e),s={query:r.trim(),title:t?.title||r,url:t?.url||null,timestamp:Date.now()},a=U(e);a=a.filter(l=>l.query!==s.query),a.unshift(s),a=a.slice(0,n);try{localStorage.setItem(o,JSON.stringify(a))}catch{}return a}function ue(e){try{let r=K(e);localStorage.removeItem(r)}catch{}}var ge={spinnerColor:"#3b82f6",spinnerColorDark:"#60a5fa",modalBg:"#ffffff",modalBgDark:"#1f2937",modalBorderRadius:"12",modalBorderWidth:"1",modalBorderColor:"#e5e7eb",modalBorderColorDark:"#374151",modalShadow:"0 25px 50px -12px rgba(0, 0, 0, 0.25)",modalShadowDark:"0 25px 50px -12px rgba(0, 0, 0, 0.5)",modalMaxWidth:"640",modalMaxHeight:"80",modalPaddingX:"16",modalPaddingY:"16",inputBg:"#ffffff",inputBgDark:"#1f2937",inputTextColor:"#111827",inputTextColorDark:"#f9fafb",inputPlaceholderColor:"#9ca3af",inputPlaceholderColorDark:"#9ca3af",inputBorderColor:"#e5e7eb",inputBorderColorDark:"#374151",inputFontSize:"16",resultBg:"transparent",resultBgDark:"transparent",resultBorderColor:"#e5e7eb",resultBorderColorDark:"#374151",resultActiveBg:"#e5e7eb",resultActiveBgDark:"#4b5563",resultActiveBorderColor:"#e5e7eb",resultActiveBorderColorDark:"#374151",resultActiveTextColor:"#111827",resultActiveTextColorDark:"#f9fafb",resultActiveDescColor:"#4b5563",resultActiveDescColorDark:"#d1d5db",resultActiveMutedColor:"#6b7280",resultActiveMutedColorDark:"#d1d5db",resultTextColor:"#111827",resultTextColorDark:"#f9fafb",resultDescColor:"#4b5563",resultDescColorDark:"#d1d5db",resultMutedColor:"#6b7280",resultMutedColorDark:"#d1d5db",resultGap:"8",resultBorderWidth:"0",resultPaddingX:"12",resultPaddingY:"12",resultBorderRadius:"8",triggerBg:"#ffffff",triggerBgDark:"#374151",triggerTextColor:"#374151",triggerTextColorDark:"#d1d5db",triggerBorderRadius:"8",triggerBorderWidth:"1",triggerBorderColor:"#d1d5db",triggerBorderColorDark:"#4b5563",triggerPaddingX:"12",triggerPaddingY:"8",triggerFontSize:"14",kbdBg:"#f3f4f6",kbdBgDark:"#4b5563",kbdTextColor:"#4b5563",kbdTextColorDark:"#e5e7eb",kbdBorderRadius:"4",backdropOpacity:"50",backdropBlur:"1",highlightEnabled:"1",highlightTag:"",highlightClass:"",highlightBgLight:"fef08a",highlightColorLight:"854d0e",highlightBgDark:"854d0e",highlightColorDark:"fef08a",promotedBg:"#2563eb",promotedBgDark:"#3b82f6",promotedColor:"#ffffff",promotedColorDark:"#ffffff"};var me={modalBg:"--sm-modal-bg",modalBgDark:"--sm-modal-bg-dark",modalBorderRadius:"--sm-modal-radius",modalBorderWidth:"--sm-modal-border-width",modalBorderColor:"--sm-modal-border-color",modalBorderColorDark:"--sm-modal-border-color-dark",modalShadow:"--sm-modal-shadow",modalShadowDark:"--sm-modal-shadow-dark",modalMaxWidth:"--sm-modal-width",modalMaxHeight:"--sm-modal-max-height",modalPaddingX:"--sm-modal-px",modalPaddingY:"--sm-modal-py",inputBg:"--sm-input-bg",inputBgDark:"--sm-input-bg-dark",inputTextColor:"--sm-input-color",inputTextColorDark:"--sm-input-color-dark",inputPlaceholderColor:"--sm-input-placeholder",inputPlaceholderColorDark:"--sm-input-placeholder-dark",inputBorderColor:"--sm-input-border-color",inputBorderColorDark:"--sm-input-border-color-dark",inputFontSize:"--sm-input-font-size",resultBg:"--sm-result-bg",resultBgDark:"--sm-result-bg-dark",resultBorderColor:"--sm-result-border-color",resultBorderColorDark:"--sm-result-border-color-dark",resultActiveBg:"--sm-result-active-bg",resultActiveBgDark:"--sm-result-active-bg-dark",resultActiveBorderColor:"--sm-result-active-border-color",resultActiveBorderColorDark:"--sm-result-active-border-color-dark",resultActiveTextColor:"--sm-result-active-text-color",resultActiveTextColorDark:"--sm-result-active-text-color-dark",resultActiveDescColor:"--sm-result-active-desc-color",resultActiveDescColorDark:"--sm-result-active-desc-color-dark",resultActiveMutedColor:"--sm-result-active-muted-color",resultActiveMutedColorDark:"--sm-result-active-muted-color-dark",resultTextColor:"--sm-result-text-color",resultTextColorDark:"--sm-result-text-color-dark",resultDescColor:"--sm-result-desc-color",resultDescColorDark:"--sm-result-desc-color-dark",resultMutedColor:"--sm-result-muted-color",resultMutedColorDark:"--sm-result-muted-color-dark",resultGap:"--sm-result-gap",resultBorderWidth:"--sm-result-border-width",resultPaddingX:"--sm-result-px",resultPaddingY:"--sm-result-py",resultBorderRadius:"--sm-result-radius",triggerBg:"--sm-trigger-bg",triggerBgDark:"--sm-trigger-bg-dark",triggerTextColor:"--sm-trigger-text-color",triggerTextColorDark:"--sm-trigger-text-color-dark",triggerBorderRadius:"--sm-trigger-radius",triggerBorderWidth:"--sm-trigger-border-width",triggerBorderColor:"--sm-trigger-border-color",triggerBorderColorDark:"--sm-trigger-border-color-dark",triggerPaddingX:"--sm-trigger-px",triggerPaddingY:"--sm-trigger-py",triggerFontSize:"--sm-trigger-font-size",kbdBg:"--sm-kbd-bg",kbdBgDark:"--sm-kbd-bg-dark",kbdTextColor:"--sm-kbd-text-color",kbdTextColorDark:"--sm-kbd-text-color-dark",kbdBorderRadius:"--sm-kbd-radius",highlightBgLight:"--sm-highlight-bg",highlightColorLight:"--sm-highlight-color",highlightBgDark:"--sm-highlight-bg-dark",highlightColorDark:"--sm-highlight-color-dark",promotedBg:"--sm-promoted-bg",promotedBgDark:"--sm-promoted-bg-dark",promotedColor:"--sm-promoted-color",promotedColorDark:"--sm-promoted-color-dark",spinnerColor:"--sm-spinner-color-light",spinnerColorDark:"--sm-spinner-color-dark"},Y=["modalBorderRadius","modalBorderWidth","modalMaxWidth","modalPaddingX","modalPaddingY","inputFontSize","resultGap","resultBorderWidth","resultPaddingX","resultPaddingY","resultBorderRadius","triggerBorderRadius","triggerBorderWidth","triggerPaddingX","triggerPaddingY","triggerFontSize","kbdBorderRadius"],V=["modalMaxHeight"],pe=["modalBg","modalBgDark","modalBorderColor","modalBorderColorDark","inputBg","inputBgDark","inputTextColor","inputTextColorDark","inputPlaceholderColor","inputPlaceholderColorDark","inputBorderColor","inputBorderColorDark","resultBg","resultBgDark","resultBorderColor","resultBorderColorDark","resultActiveBg","resultActiveBgDark","resultActiveBorderColor","resultActiveBorderColorDark","resultTextColor","resultTextColorDark","resultActiveTextColor","resultActiveTextColorDark","resultActiveDescColor","resultActiveDescColorDark","resultActiveMutedColor","resultActiveMutedColorDark","resultDescColor","resultDescColorDark","resultMutedColor","resultMutedColorDark","triggerBg","triggerBgDark","triggerTextColor","triggerTextColorDark","triggerBorderColor","triggerBorderColorDark","kbdBg","kbdBgDark","kbdTextColor","kbdTextColorDark","highlightBgLight","highlightColorLight","highlightBgDark","highlightColorDark","promotedBg","promotedBgDark","promotedColor","promotedColorDark","spinnerColor","spinnerColorDark"],yt={...ge,highlightBgLight:"#fef08a",highlightColorLight:"#854d0e",highlightBgDark:"#854d0e",highlightColorDark:"#fef08a"};function Ve(e){return/^[0-9a-fA-F]{6}$/.test(e)}function Xe(e,r){if(r==null||r==="")return null;let t=String(r);return pe.includes(e)&&Ve(t)&&(t="#"+t),Y.includes(e)&&(t=t+"px"),V.includes(e)&&(t=t+"vh"),t}function be(e,r,t="light"){if(!r||typeof r!="object")return;let n=t==="dark",o=Object.entries(me),s=new Set([...Y,...V]);for(let[a,l]of o){let i=a.endsWith("Dark");if(n){if(!i&&!s.has(a))continue}else if(i)continue;if(r[a]!==void 0&&r[a]!==null&&r[a]!==""){let d=Xe(a,r[a]);d&&e.style.setProperty(l,d)}}}function h(e){if(!e)return"";let r=document.createElement("div");return r.textContent=e,r.innerHTML}function E(e,r,t={}){let{enabled:n=!0,tag:o="mark",className:s="",terms:a=null}=t;if(!n)return h(e);let l=["sm-highlight"];s&&l.push(s);let i=` class="${l.join(" ")}"`,d=Qe(r,a);return d.length===0?h(e):Je(e,d,o,i)}function Qe(e,r){if(Array.isArray(r)&&r.length>0)return fe(r);if(!e)return[];let t=e.split(/\s+/).filter(o=>o.length>0),n=[];return t.forEach(o=>{n.push(o);let s=o.split(/(?<=[a-z])(?=[A-Z])/);s.length>1&&s.forEach(a=>{a.length>=3&&n.push(a)})}),fe(n)}function fe(e){let r=new Set;return e.filter(t=>typeof t=="string"&&t.length>0).sort((t,n)=>n.length-t.length).filter(t=>{let n=t.toLowerCase();return r.has(n)?!1:(r.add(n),!0)})}function Je(e,r,t,n){let o=e.toLowerCase(),s=[];if(r.forEach(c=>{let g=c.toLowerCase();if(!g)return;let u=0;for(;u<o.length;){let p=o.indexOf(g,u);if(p===-1)break;s.push({start:p,end:p+g.length}),u=p+g.length}}),s.length===0)return h(e);s.sort((c,g)=>c.start!==g.start?c.start-g.start:g.end-g.start-(c.end-c.start));let a=[],l=-1;s.forEach(c=>{c.start>=l&&(a.push(c),l=c.end)});let i="",d=0;return a.forEach(c=>{d<c.start&&(i+=h(e.slice(d,c.start))),i+=`<${t}${n}>${h(e.slice(c.start,c.end))}</${t}>`,d=c.end}),d<e.length&&(i+=h(e.slice(d))),i}var Ze=0;function X(e="sm"){return`${e}-${++Ze}-${Date.now().toString(36)}`}function ve(e){let r=document.createElement("div");return r.setAttribute("role","status"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-atomic","true"),r.className="sm-sr-only",e.appendChild(r),r}function H(e,r,t=100){e&&(e.textContent="",setTimeout(()=>{e.textContent=r},t))}function Q(e,r){return e===0?`No results found for "${r}"`:e===1?`1 result found for "${r}"`:`${e} results found for "${r}"`}function ke(){return"Searching..."}function ye(e){return e===0?"No recent searches":e===1?"1 recent search available":`${e} recent searches available`}function j(e,{expanded:r,activeDescendant:t,listboxId:n}){e.setAttribute("aria-expanded",String(r)),e.setAttribute("aria-controls",n),t?e.setAttribute("aria-activedescendant",t):e.removeAttribute("aria-activedescendant")}function $(e,r){return`${e}-option-${r}`}function xe(e,r){if(!e||!r)return;let t=e.getBoundingClientRect(),n=r.getBoundingClientRect();t.top<n.top?e.scrollIntoView({block:"nearest",behavior:"smooth"}):t.bottom>n.bottom&&e.scrollIntoView({block:"nearest",behavior:"smooth"})}function et(e,r,t={}){let{groupResults:n=!1,resultLayout:o="default",listboxId:s}=t;if(!e||e.length===0)return"";if(o==="hierarchical")return ot(e,r,t);if(n){let a=de(e),l=0;return Object.entries(a).map(([i,d])=>`
            <div class="sm-section" role="group" aria-label="${h(i)}">
                <div class="sm-section-header">${h(i)}</div>
                ${d.map(c=>we(c,l++,r,t)).join("")}
            </div>
        `).join("")}return e.map((a,l)=>we(a,l,r,t)).join("")}function we(e,r,t,n={}){let{listboxId:o,enableHighlighting:s=!0,highlightTag:a="mark",highlightClass:l="",groupResults:i=!1,promotions:d={},debug:c=!1}=n,g=e.title||e.name||"Untitled",u=e.description||e.excerpt||e.snippet||"",p=e.url||e.href||"#",b=e.section||e.type||"",m=$(o,r),v=e.promoted===!0,C={enabled:s,tag:a,className:l},x=E(g,t,{...C,terms:P(e,"title")}),w=u?E(u,t,{...C,terms:P(e,"description")}):"",L=tt(e,d),S=v?" sm-promoted":"",D=b&&!i?`<span class="sm-result-type">${h(b)}</span>`:"",B=c?Ae(e):"";return c?`
            <a class="sm-result-item sm-debug-enabled${S}" id="${m}" role="option" aria-selected="false" href="${h(p)}" data-index="${r}" data-id="${e.id||""}" data-title="${h(g)}">
        ...
        `:`
        <a class="sm-result-item${S}" id="${m}" role="option" aria-selected="false" href="${h(p)}" data-index="${r}" data-id="${e.id||""}" data-title="${h(g)}">
            ${L}
            <div class="sm-result-content">
                <span class="sm-result-title">${x}</span>
                ${w?`<span class="sm-result-desc">${w}</span>`:""}
    ...
    `}function Ae(e){let r=[],t=e.backend?e.backend.toLowerCase():"";if((e._index||e.index)&&r.push(y("index",e._index||e.index,"index")),e.backend&&r.push(y("backend",t,"backend",t)),e.id&&r.push(y("id",e.id,"generic")),e.score!==void 0&&e.score!==null){let n=typeof e.score=="number"?e.score.toFixed(2):e.score;r.push(y("score",n,"score"))}if(e.site&&r.push(y("site",e.site,"generic")),e.language&&r.push(y("lang",e.language,"generic")),e.matchedIn&&Array.isArray(e.matchedIn)&&e.matchedIn.length>0){let n=e.matchedIn.join(", ");r.push(y("matched",n,"matched"))}return e.promoted&&r.push(y("promoted","yes","promoted")),e.boosted&&r.push(y("boosted","yes","boosted")),r.length===0?"":`<div class="sm-debug-info">${r.join("")}</div>`}function P(e,r){let t=Array.isArray(e.matchedPhrases)?e.matchedPhrases:[],n=e.matchedTerms,o=[];n&&(r==="title"&&Array.isArray(n.title)&&n.title.length>0?o=n.title:r==="description"&&Array.isArray(n.content)&&n.content.length>0?o=n.content:o=[...Array.isArray(n.title)?n.title:[],...Array.isArray(n.content)?n.content:[]]);let s=[...t,...o];return s.length>0?s:null}function y(e,r,t,n=""){let o=n?` data-backend="${h(n)}"`:"";return`<span class="sm-debug-item"><span class="sm-debug-label">${h(e)}</span><span class="sm-debug-value" data-type="${h(t)}"${o}>${h(String(r))}</span></span>`}function tt(e,r={}){let{showBadge:t=!0,badgeText:n="Featured",badgePosition:o="top-right"}=r;return!e.promoted||!t?"":`<span class="sm-promoted-badge ${`sm-promoted-badge--${o}`}">${h(n)}</span>`}function I(){return`<svg class="sm-result-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
        <path d="M5 12h14M12 5l7 7-7 7"/>
    </svg>`}function rt(){return`<svg class="sm-hierarchy-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
    ...
    </svg>`}function ot(e,r,t={}){let{hierarchyGroupBy:n="section",hierarchyStyle:o="tree",hierarchyDisplay:s="individual",maxHeadingsPerResult:a=3,listboxId:l}=t,i=o==="tree",d=o!=="none",g=ce(e,n||"section"),u=0;return Object.entries(g).map(([p,b])=>{let m=b.map(v=>{let C=u++,x=st(v,C,r,t),w="",S=(v._matchedHeadings||[]).slice(0,a);if(S.length>0){let O=Math.min(...S.map(R=>R.level||2)),M=S.map(R=>i?(R.level||2)-O:0);w=S.map((R,A)=>{let _=M[A],Me=!M.slice(A+1).some(G=>G===_),te=[];if(i){let G=M.slice(A+1);for(let F=0;F<_;F++)G.some(Pe=>Pe===F)&&te.push(F)}return at(v,R,u++,r,t,Me,_,te)}).join("")}let D=!!w;return`
        ...
        `}).join("")}function st(e,r,t,n={}){let{listboxId:o,enableHighlighting:s=!0,highlightTag:a="mark",highlightClass:l="",debug:i=!1}=n,d=e.title||e.name||"Untitled",c=e.description||e.excerpt||"",g=e.url||"#",u=$(o,r),p={enabled:s,tag:a,className:l},b=E(d,t,{...p,terms:P(e,"title")}),m=c?E(c,t,{...p,terms:P(e,"description")}):"",v=i?Ae(e):"",x=e._matchedHeadings&&e._matchedHeadings.length>0?rt():nt();return i?`
            <a class="sm-result-item sm-hierarchy-parent sm-debug-enabled" id="${u}" role="option" aria-selected="false" href="${h(g)}" data-index="${r}" data-id="${e.id||""}" data-title="${h(d)}">
                <div class="sm-result-main">
                    ${x}
                    <div class="sm-result-content">
        ...
        `:`
        <a class="sm-result-item sm-hierarchy-parent" id="${u}" role="option" aria-selected="false" href="${h(g)}" data-index="${r}" data-id="${e.id||""}" data-title="${h(d)}">
            ${x}
            <div class="sm-result-content">
                <span class="sm-result-title">${b}</span>
                ${m?`<span class="sm-result-desc">${m}</span>`:""}
    ...
    `}function at(e,r,t,n,o={},s=!1,a=0,l=[]){let{listboxId:i,enableHighlighting:d=!0,highlightTag:c="mark",highlightClass:g="",debug:u=!1}=o,b=(r.text||"").replace(/^#+\s*/,""),m=r.description||"",v=r.level||2,C=r.id||(b?it(b):""),x=e.url||"#",w=C?`${x}#${C}`:x,L=$(i,t),S={enabled:d,tag:c,className:g},D=E(b,n,{...S,terms:P(e,"title")}),B=m?E(m,n,{...S,terms:P(e,"description")}):"",O=s?" sm-hierarchy-child-row-last":"",M=l.map(A=>`<div class="sm-hierarchy-guide" style="--sm-guide-depth:${A}" aria-hidden="true"></div>`).join(""),R="";if(u){let A=[];A.push(y("h",v,"generic")),C&&A.push(y("anchor",C,"generic")),e.id&&A.push(y("parent",e.id,"generic")),R=`<div class="sm-debug-info">${A.join("")}</div>`}return u?`
            <div class="sm-hierarchy-child-row sm-hierarchy-level-${v} sm-hierarchy-depth-${a}${O}" style="--sm-hierarchy-depth:${a}">
                ${M}
                <a class="sm-result-item sm-hierarchy-child sm-hierarchy-level-${v} sm-debug-enabled" id="${L}" role="option" aria-selected="false" href="${h(w)}" data-index="${t}" data-id="${e.id||""}" data-title="${h(b)}">
                    <div class="sm-result-main">
                        ${Ce()}
                        <div class="sm-result-content">
        ...
        <div class="sm-hierarchy-child-row sm-hierarchy-level-${v} sm-hierarchy-depth-${a}${O}" style="--sm-hierarchy-depth:${a}">
            ${M}
            <a class="sm-result-item sm-hierarchy-child sm-hierarchy-level-${v}" id="${L}" role="option" aria-selected="false" href="${h(w)}" data-index="${t}" data-id="${e.id||""}" data-title="${h(b)}">
                ${Ce()}
                <div class="sm-result-content">
                    <span class="sm-result-title">${D}</span>
                    ${B?`<span class="sm-result-desc">${B}</span>`:""}
    ...
    `}function it(e){let r=e.normalize("NFKD").toLowerCase();try{return r.replace(/[^\p{L}\p{N}]+/gu,"-").replace(/^-+|-+$/g,"")}catch{return r.replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}}function lt(e,r){return!e||e.length===0?"":`
        <div class="sm-section">
            ...
            ${e.map((t,n)=>`
                <div class="sm-result-item sm-recent-item" id="${$(r,n)}" role="option" aria-selected="false" data-index="${n}" data-url="${t.url||""}" data-query="${h(t.query)}">
    ...
    `}function Te(e,r){let{query:t,results:n,recentSearches:o,loading:s,showRecent:a}=e,{showLoadingIndicator:l=!0}=r,i=t&&t.trim();return s&&l?{html:dt(),hasResults:!1,showListbox:!1}:i?!n||n.length===0?{html:Se(t),hasResults:!1,showListbox:!1}:{html:et(n,t,r),hasResults:!0,showListbox:!0}:a&&o&&o.length>0?{html:lt(o,r.listboxId),hasResults:!0,showListbox:!0}:{html:Se(""),hasResults:!1,showListbox:!1}}function J(e,r,t=!1){if(!e)return"";let n=[];if(n.push(T("results",r,"generic")),e.took!==void 0){let i=e.took<1?"<1ms":`${Math.round(e.took)}ms`;n.push(T("time",i,"time"))}if(e.cacheEnabled!==void 0&&(e.cacheEnabled?e.cached?n.push(T("cache","hit","cache-hit")):n.push(T("cache","miss","cache-miss")):n.push(T("cache","off","cache-off"))),e.cacheDriver&&n.push(T("storage",e.cacheDriver,"cache-driver",e.cacheDriver)),e.indices&&e.indices.length>0){let i=e.indices.length>2?`${e.indices.length} indices`:e.indices.join(", ");n.push(T("indices",i,"generic"))}if(e.synonymsExpanded){let i=e.expandedQueries?e.expandedQueries.length-1:0;n.push(T("synonyms",`+${i}`,"synonyms"))}let o=e.rulesMatched?.length||0;n.push(T("rules",o,o>0?"rules":"generic"));let s=e.promotionsMatched?.length||0;n.push(T("promoted",s,s>0?"promotions":"generic"));let l=`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">${t?'<path d="M6 9l6 6 6-6"/>':'<path d="M18 15l-6-6-6 6"/>'}</svg>`;return t?`<div class="sm-toolbar-collapsed-bar"><span class="sm-toolbar-collapsed-label">Debug</span>${l}</div>`:`<div class="sm-toolbar-content">${n.join("")}</div><button class="sm-toolbar-toggle" aria-label="Collapse debug panel" aria-expanded="true">${l}</button>`}function T(e,r,t,n=""){let o=n?` data-backend="${h(n)}"`:"";return`<span class="sm-toolbar-item"><span class="sm-toolbar-label">${h(e)}</span><span class="sm-toolbar-value" data-type="${h(t)}"${o}>${h(String(r))}</span></span>`}function De(e,r){let{onSelect:t,onIndexChange:n,onEscape:o}=e,{listboxId:s}=r;return{handleKeydown(a,l,i){let d=i;switch(a.key){case"ArrowDown":return a.preventDefault(),d=Math.min(i+1,l-1),d!==i&&n&&n(d),d;case"ArrowUp":return a.preventDefault(),d=Math.max(i-1,-1),d!==i&&n&&n(d),d;case"Enter":return a.preventDefault(),i>=0&&t&&t(i),null;case"Escape":return a.preventDefault(),o&&o(),null;default:return null}},getListboxId(){return s}}}function Re(e,r,t={}){let{scrollContainer:n,inputElement:o,listboxId:s,selectedClass:a="sm-selected"}=t,l=r>=0?$(s,r):null;o&&j(o,{expanded:e.length>0,activeDescendant:l,listboxId:s}),e.forEach((i,d)=>{let c=d===r;i.classList.toggle(a,c),i.setAttribute("aria-selected",String(c)),c&&n&&xe(i,n)})}function Be(e,r){e.forEach((t,n)=>{t.addEventListener("mouseenter",()=>{r&&r(n)})})}var Z=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.config=null,this.state=se({...N},this.handleStateChange.bind(this)),this.abortController=null,this.debounceTimer=null,this.analyticsIdleTimer=null,this.lastTrackedQuery=null,this.listboxId=X("sm-listbox"),this.inputId=X("sm-input"),this.liveRegion=null,this.keyboardNavigator=null,this.elements={},this.handleInput=this.handleInput.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.handleResultClick=this.handleResultClick.bind(this)}get widgetType(){throw new Error("Subclass must implement widgetType getter")}render(){throw new Error("Subclass must implement render()")}getResultsContainer(){throw new Error("Subclass must implement getResultsContainer()")}getInputElement(){throw new Error("Subclass must implement getInputElement()")}getLoadingElement(){return this.elements.loading||null}getDebugToolbarElement(){return this.elements.debugToolbar||null}connectedCallback(){this.config=W(this,this.widgetType),this.state.set({recentSearches:U(this.config.index)}),this.keyboardNavigator=De({onSelect:r=>this.selectResultAtIndex(r),onIndexChange:r=>this.state.set({selectedIndex:r}),onEscape:()=>this.handleEscape()},{listboxId:this.listboxId})}disconnectedCallback(){this.abortController&&(this.abortController.abort(),this.abortController=null),this.debounceTimer&&(clearTimeout(this.debounceTimer),this.debounceTimer=null)}attributeChangedCallback(r,t,n){t!==n&&this.shadowRoot.children.length>0&&(this.config=W(this,this.widgetType),this.render(),this.applyCustomStyles())}handleStateChange(r,t){(t.includes("results")||t.includes("query")||t.includes("recentSearches"))&&this.renderResultsContent(),(t.includes("results")||t.includes("meta"))&&this.updateDebugToolbar(),t.includes("selectedIndex")&&this.updateSelectionVisual(),t.includes("loading")&&this.updateLoadingVisual()}handleInput(r){let t=r.target.value;if(this.state.set({query:t,selectedIndex:-1}),this.debounceTimer&&clearTimeout(this.debounceTimer),this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null),!t.trim()){this.state.set({results:[]});return}t.length<this.config.minChars||(this.debounceTimer=setTimeout(()=>{this.executeSearch(t)},this.config.debounce))}async executeSearch(r){this.abortController&&this.abortController.abort(),this.abortController=new AbortController,this.state.set({loading:!0,error:null}),this.liveRegion&&H(this.liveRegion,ke());try{let{results:t,meta:n}=await ae({query:r,endpoint:this.config.searchEndpoint,indices:this.config.indices,siteId:this.config.siteId,maxResults:this.config.maxResults,hideResultsWithoutUrl:this.config.hideResultsWithoutUrl,allowCodeSnippets:this.config.allowCodeSnippets,snippetMode:this.config.snippetMode,snippetLength:this.config.snippetLength,parseMarkdownSnippets:this.config.parseMarkdownSnippets,debug:this.config.debug,signal:this.abortController.signal});this.state.set({results:t,meta:n,loading:!1,selectedIndex:t.length>0?0:-1}),this.liveRegion&&H(this.liveRegion,Q(t.length,r)),this.dispatchWidgetEvent("search",{query:r,results:t,meta:n}),this.startAnalyticsIdleTimer(r,t.length)}catch(t){if(t.name==="AbortError")return;console.error("Search error:",t),this.state.set({results:[],loading:!1,error:t.message}),this.dispatchWidgetEvent("error",{query:r,error:t.message})}}renderResultsContent(){let r=this.getResultsContainer();if(!r)return;let t=this.state.getAll(),{showRecent:n,groupResults:o,enableHighlighting:s,highlightTag:a,highlightClass:l,showLoadingIndicator:i,debug:d}=this.config,{html:c,hasResults:g,showListbox:u}=Te({query:t.query,results:t.results,recentSearches:t.recentSearches,loading:t.loading,showRecent:n},{listboxId:this.listboxId,groupResults:o,enableHighlighting:s,highlightTag:a,highlightClass:l,showLoadingIndicator:i,debug:d,promotions:this.config.promotions,resultLayout:this.config.resultLayout,hierarchyGroupBy:this.config.hierarchyGroupBy,hierarchyStyle:this.config.hierarchyStyle,hierarchyDisplay:this.config.hierarchyDisplay,maxHeadingsPerResult:this.config.maxHeadingsPerResult});r.innerHTML=c,u?r.setAttribute("role","listbox"):r.removeAttribute("role");let p=this.getInputElement();p&&j(p,{expanded:g,activeDescendant:null,listboxId:this.listboxId}),this.liveRegion&&!t.loading&&(t.query&&t.results.length===0?H(this.liveRegion,Q(0,t.query)):!t.query&&t.recentSearches.length>0&&n&&H(this.liveRegion,ye(t.recentSearches.length))),this.attachResultHandlers();let b=r.querySelector(".sm-clear-recent");b&&b.addEventListener("click",m=>{m.stopPropagation(),ue(this.config.index),this.state.set({recentSearches:[]})}),g&&t.results.length>0&&this.state.set({selectedIndex:0})}attachResultHandlers(){let r=this.getResultsContainer();if(!r)return;let t=r.querySelectorAll(".sm-result-item");t.forEach(n=>{n.addEventListener("click",o=>this.handleResultClick(o,n))}),Be(t,n=>{this.state.set({selectedIndex:n})})}updateSelectionVisual(){let r=this.getResultsContainer(),t=this.getInputElement();if(!r)return;let n=r.querySelectorAll(".sm-result-item"),o=this.state.get("selectedIndex");Re(n,o,{scrollContainer:r,inputElement:t,listboxId:this.listboxId})}handleKeydown(r){let t=this.getResultsContainer();if(!t)return;let n=t.querySelectorAll(".sm-result-item"),o=this.state.get("selectedIndex");if(r.key==="Enter"){let s=this.state.get("query"),a=this.state.get("results")||[];s&&a.length>0&&this.trackSearchAnalytics(s,a.length,"enter")}this.keyboardNavigator.handleKeydown(r,n.length,o)}selectResultAtIndex(r){let t=this.getResultsContainer();if(!t)return;let n=t.querySelectorAll(".sm-result-item");r>=0&&n[r]&&n[r].click()}handleEscape(){}handleResultClick(r,t){let n=t.getAttribute("href"),o=t.dataset.url,s=n||o,a=t.dataset.title||t.querySelector(".sm-result-title")?.textContent,l=t.dataset.id,i=t.dataset.query||this.state.get("query"),d=t.classList.contains("sm-recent-item");if(!d&&i){let c=he(this.config.index,i,{title:a,url:s},this.config.maxRecentSearches);this.state.set({recentSearches:c})}if(l&&this.config.index&&ie({endpoint:this.config.trackClickEndpoint,elementId:l,query:i,index:this.config.index}),!d&&i&&this.trackSearchAnalytics(i,this.state.get("results")?.length||0,"click"),this.dispatchWidgetEvent("result-click",{id:l,title:a,url:s,query:i,isRecent:d}),s&&s!=="#")d&&(r.preventDefault(),window.location.href=s),this.onResultSelected(s,a,l);else if(i){r.preventDefault();let c=this.getInputElement();c&&(c.value=i,this.state.set({query:i}),this.executeSearch(i))}}onResultSelected(r,t,n){}updateLoadingVisual(){let r=this.getLoadingElement();if(r){let t=this.state.get("loading"),n=this.config?.showLoadingIndicator!==!1;r.hidden=!t||!n}}updateDebugToolbar(){let r=this.getDebugToolbarElement();if(!r)return;let{debug:t}=this.config,n=this.state.getAll();if(!t||!n.meta||n.results.length===0){r.hidden=!0;return}let o=r.classList.contains("sm-collapsed");r.innerHTML=J(n.meta,n.results.length,o),r.hidden=!1,o&&r.classList.add("sm-collapsed"),this.attachDebugToolbarHandlers(r)}attachDebugToolbarHandlers(r){let t=r.querySelector(".sm-toolbar-toggle");t&&t.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),this.toggleDebugToolbar()});let n=r.querySelector(".sm-toolbar-collapsed-bar");n&&n.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),this.toggleDebugToolbar()})}toggleDebugToolbar(){let r=this.getDebugToolbarElement();if(!r)return;let t=r.classList.toggle("sm-collapsed"),n=this.state.getAll();r.innerHTML=J(n.meta,n.results.length,t),t&&r.classList.add("sm-collapsed"),this.attachDebugToolbarHandlers(r)}applyCustomStyles(){if(!this.config)return;let r=this.shadowRoot.host,{theme:t,styles:n,resultTitleLines:o,resultDescLines:s}=this.config;be(r,n,t),o&&r.style.setProperty("--sm-result-title-lines",String(o)),s&&r.style.setProperty("--sm-result-desc-lines",String(s))}initializeLiveRegion(){this.liveRegion=ve(this.shadowRoot)}startAnalyticsIdleTimer(r,t){this.analyticsIdleTimer&&clearTimeout(this.analyticsIdleTimer);let n=this.config.idleTimeout;!n||n<=0||(this.analyticsIdleTimer=setTimeout(()=>{this.trackSearchAnalytics(r,t,"idle")},n))}trackSearchAnalytics(r,t,n){!r||r===this.lastTrackedQuery||(this.lastTrackedQuery=r,this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null),le({endpoint:this.config.trackSearchEndpoint,query:r,indices:this.config.indices,resultsCount:t,trigger:n,source:this.config.source,siteId:this.config.siteId}))}resetAnalyticsTracking(){this.lastTrackedQuery=null,this.analyticsIdleTimer&&(clearTimeout(this.analyticsIdleTimer),this.analyticsIdleTimer=null)}dispatchWidgetEvent(r,t={}){this.dispatchEvent(new CustomEvent(`search-${r}`,{bubbles:!0,composed:!0,detail:t}))}},Ee=Z;var $e=`/**
