(()=>{var k={modalBg:"--sm-modal-bg",modalBgDark:"--sm-modal-bg-dark",modalBorderRadius:"--sm-modal-radius",modalBorderWidth:"--sm-modal-border-width",modalBorderColor:"--sm-modal-border-color",modalBorderColorDark:"--sm-modal-border-color-dark",modalShadow:"--sm-modal-shadow",modalShadowDark:"--sm-modal-shadow-dark",modalMaxWidth:"--sm-modal-width",inputBg:"--sm-input-bg",inputBgDark:"--sm-input-bg-dark",inputTextColor:"--sm-input-color",inputTextColorDark:"--sm-input-color-dark",inputPlaceholderColor:"--sm-input-placeholder",inputPlaceholderColorDark:"--sm-input-placeholder-dark",inputBorderColor:"--sm-input-border-color",inputBorderColorDark:"--sm-input-border-color-dark",inputFontSize:"--sm-input-font-size",resultBg:"--sm-result-bg",resultBgDark:"--sm-result-bg-dark",resultHoverBg:"--sm-result-hover-bg",resultHoverBgDark:"--sm-result-hover-bg-dark",resultActiveBg:"--sm-result-active-bg",resultActiveBgDark:"--sm-result-active-bg-dark",resultTextColor:"--sm-result-text-color",resultTextColorDark:"--sm-result-text-color-dark",resultDescColor:"--sm-result-desc-color",resultDescColorDark:"--sm-result-desc-color-dark",resultMutedColor:"--sm-result-muted-color",resultMutedColorDark:"--sm-result-muted-color-dark",resultBorderRadius:"--sm-result-radius",triggerBg:"--sm-trigger-bg",triggerBgDark:"--sm-trigger-bg-dark",triggerTextColor:"--sm-trigger-text-color",triggerTextColorDark:"--sm-trigger-text-color-dark",triggerBorderRadius:"--sm-trigger-radius",triggerBorderWidth:"--sm-trigger-border-width",triggerBorderColor:"--sm-trigger-border-color",triggerBorderColorDark:"--sm-trigger-border-color-dark",triggerPaddingX:"--sm-trigger-px",triggerPaddingY:"--sm-trigger-py",triggerFontSize:"--sm-trigger-font-size",kbdBg:"--sm-kbd-bg",kbdBgDark:"--sm-kbd-bg-dark",kbdTextColor:"--sm-kbd-text-color",kbdTextColorDark:"--sm-kbd-text-color-dark",kbdBorderRadius:"--sm-kbd-radius",highlightBgLight:"--sm-highlight-bg",highlightColorLight:"--sm-highlight-color",highlightBgDark:"--sm-highlight-bg-dark",highlightColorDark:"--sm-highlight-color-dark"},v=["modalBorderRadius","modalBorderWidth","modalMaxWidth","inputFontSize","resultBorderRadius","triggerBorderRadius","triggerBorderWidth","triggerPaddingX","triggerPaddingY","triggerFontSize","kbdBorderRadius"],y=["modalBg","modalBgDark","modalBorderColor","modalBorderColorDark","inputBg","inputBgDark","inputTextColor","inputTextColorDark","inputPlaceholderColor","inputPlaceholderColorDark","inputBorderColor","inputBorderColorDark","resultBg","resultBgDark","resultHoverBg","resultHoverBgDark","resultActiveBg","resultActiveBgDark","resultTextColor","resultTextColorDark","resultDescColor","resultDescColorDark","resultMutedColor","resultMutedColorDark","triggerBg","triggerBgDark","triggerTextColor","triggerTextColorDark","triggerBorderColor","triggerBorderColorDark","kbdBg","kbdBgDark","kbdTextColor","kbdTextColorDark","highlightBgLight","highlightColorLight","highlightBgDark","highlightColorDark"];function M(r){return/^[0-9a-fA-F]{6}$/.test(r)}function H(r,e){if(e==null||e==="")return null;let t=String(e);return y.includes(r)&&M(t)&&(t="#"+t),v.includes(r)&&(t=t+"px"),t}function w(r,e,t="light"){if(!e||typeof e!="object")return;let s=t==="dark";for(let[n,o]of Object.entries(k)){let i=n.endsWith("Dark");if(!(s&&!i)&&!(!s&&i)&&e[n]!==void 0&&e[n]!==null&&e[n]!==""){let a=H(n,e[n]);a&&r.style.setProperty(o,a)}}}var q="sm-recent-";function b(r){return`${q}${r||"default"}`}function g(r){try{let e=b(r),t=localStorage.getItem(e);return t?JSON.parse(t):[]}catch{return[]}}function C(r,e,t=null){if(!e||!e.trim())return g(r);let s=b(r),n={query:e.trim(),title:t?.title||e,url:t?.url||null,timestamp:Date.now()},o=g(r);o=o.filter(i=>i.query!==n.query),o.unshift(n),o=o.slice(0,5);try{localStorage.setItem(s,JSON.stringify(o))}catch{}return o}function B(r){try{let e=b(r);localStorage.removeItem(e)}catch{}}async function S({query:r,endpoint:e,indices:t=[],siteId:s="",maxResults:n=10,signal:o}){let i=new URLSearchParams({q:r,limit:n.toString()});t.length>0&&i.append("indices",t.join(",")),s&&i.append("siteId",s);let a=e.includes("?")?"&":"?",d=await fetch(`${e}${a}${i}`,{signal:o,headers:{Accept:"application/json"}});if(!d.ok)throw new Error("Search failed");let l=await d.json();return l.results||l.hits||[]}function R({endpoint:r,elementId:e,query:t,index:s}){if(!(!e||!r))try{let n=new FormData;n.append("elementId",e),n.append("query",t),n.append("index",s),fetch(r,{method:"POST",body:n}).catch(()=>{})}catch{}}function D(r){let e={};return r.forEach(t=>{let s=t.section||t.type||"Results";e[s]||(e[s]=[]),e[s].push(t)}),e}var z=0;function f(r="sm"){return`${r}-${++z}-${Date.now().toString(36)}`}function A(r){let e=document.createElement("div");return e.setAttribute("role","status"),e.setAttribute("aria-live","polite"),e.setAttribute("aria-atomic","true"),e.className="sm-sr-only",r.appendChild(e),e}function c(r,e,t=100){r&&(r.textContent="",setTimeout(()=>{r.textContent=e},t))}function x(r,e){return r===0?`No results found for "${e}"`:r===1?`1 result found for "${e}"`:`${r} results found for "${e}"`}function I(){return"Searching..."}function T(r){return r===0?"No recent searches":r===1?"1 recent search available":`${r} recent searches available`}function h(r,{expanded:e,activeDescendant:t,listboxId:s}){r.setAttribute("aria-expanded",String(e)),r.setAttribute("aria-controls",s),t?r.setAttribute("aria-activedescendant",t):r.removeAttribute("aria-activedescendant")}function m(r,e){return`${r}-option-${e}`}function E(r,e){if(!r||!e)return;let t=r.getBoundingClientRect(),s=e.getBoundingClientRect();t.top<s.top?r.scrollIntoView({block:"nearest",behavior:"smooth"}):t.bottom>s.bottom&&r.scrollIntoView({block:"nearest",behavior:"smooth"})}var $=`/**
...
`;var u=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.isOpen=!1,this.results=[],this.recentSearches=[],this.selectedIndex=-1,this.loading=!1,this.query="",this.debounceTimer=null,this.abortController=null,this.listboxId=f("sm-listbox"),this.inputId=f("sm-input"),this.liveRegion=null,this.open=this.open.bind(this),this.close=this.close.bind(this),this.toggle=this.toggle.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.handleGlobalKeydown=this.handleGlobalKeydown.bind(this),this.handleInput=this.handleInput.bind(this),this.handleResultClick=this.handleResultClick.bind(this),this.handleBackdropClick=this.handleBackdropClick.bind(this)}static get observedAttributes(){return["indices","placeholder","endpoint","theme","max-results","debounce","min-chars","show-recent","group-results","hotkey","site-id","enable-highlighting","highlight-tag","highlight-class","backdrop-opacity","enable-backdrop-blur","prevent-body-scroll","show-trigger","trigger-selector","styles"]}get styles(){let e=this.getAttribute("styles");if(e)try{return JSON.parse(e)}catch(t){console.warn("SearchWidget: Invalid styles JSON",t)}return{}}get config(){let e=this.getAttribute("indices")||"",t=e?e.split(",").map(s=>s.trim()).filter(Boolean):[];return{indices:t,index:t[0]||"",placeholder:this.getAttribute("placeholder")||"Search...",endpoint:this.getAttribute("endpoint")||"/actions/search-manager/search/query",theme:this.getAttribute("theme")||"light",maxResults:parseInt(this.getAttribute("max-results"))||10,debounce:parseInt(this.getAttribute("debounce"))||200,minChars:parseInt(this.getAttribute("min-chars"))||2,showRecent:this.getAttribute("show-recent")!=="false",groupResults:this.getAttribute("group-results")!=="false",hotkey:this.getAttribute("hotkey")||"k",siteId:this.getAttribute("site-id")||"",analyticsEndpoint:this.getAttribute("analytics-endpoint")||"/actions/search-manager/search/track-click",enableHighlighting:this.getAttribute("enable-highlighting")!=="false",highlightTag:this.getAttribute("highlight-tag")||"mark",highlightClass:this.getAttribute("highlight-class")||"",backdropOpacity:parseInt(this.getAttribute("backdrop-opacity"))||50,enableBackdropBlur:this.getAttribute("enable-backdrop-blur")!=="false",preventBodyScroll:this.getAttribute("prevent-body-scroll")!=="false",showTrigger:this.getAttribute("show-trigger")!=="false",triggerSelector:this.getAttribute("trigger-selector")||""}}connectedCallback(){this.render(),this.recentSearches=g(this.config.index),this.attachEventListeners()}disconnectedCallback(){this.detachEventListeners()}attributeChangedCallback(e,t,s){t!==s&&this.shadowRoot.querySelector(".sm-modal")&&this.render()}render(){let{theme:e,placeholder:t,showTrigger:s}=this.config;this.shadowRoot.innerHTML=`
        ...
        `,this.elements={trigger:this.shadowRoot.querySelector(".sm-trigger"),backdrop:this.shadowRoot.querySelector(".sm-backdrop"),modal:this.shadowRoot.querySelector(".sm-modal"),input:this.shadowRoot.querySelector(".sm-input"),results:this.shadowRoot.querySelector(".sm-results"),loading:this.shadowRoot.querySelector(".sm-loading"),close:this.shadowRoot.querySelector(".sm-close")},this.liveRegion=A(this.shadowRoot),this.shadowRoot.host.setAttribute("data-theme",e),this.applyCustomStyles()}applyCustomStyles(){let{backdropOpacity:e,enableBackdropBlur:t,theme:s}=this.config,n=this.shadowRoot.host;n.style.setProperty("--sm-backdrop-opacity",e/100),n.style.setProperty("--sm-backdrop-blur",t?"blur(4px)":"none"),w(n,this.styles,s)}getHotkeyDisplay(){let e=navigator.platform.toUpperCase().indexOf("MAC")>=0,t=this.config.hotkey.toUpperCase();return e?`\u2318${t}`:`Ctrl+${t}`}attachEventListeners(){this.elements.trigger.addEventListener("click",this.toggle),this.elements.close.addEventListener("click",this.close),this.elements.backdrop.addEventListener("click",this.handleBackdropClick),this.elements.input.addEventListener("input",this.handleInput),this.elements.input.addEventListener("keydown",this.handleKeydown),document.addEventListener("keydown",this.handleGlobalKeydown);let{triggerSelector:e}=this.config;e&&(this.externalTrigger=document.querySelector(e),this.externalTrigger&&this.externalTrigger.addEventListener("click",this.toggle))}detachEventListeners(){document.removeEventListener("keydown",this.handleGlobalKeydown),this.externalTrigger&&(this.externalTrigger.removeEventListener("click",this.toggle),this.externalTrigger=null)}handleGlobalKeydown(e){let t=this.config.hotkey.toLowerCase();(navigator.platform.toUpperCase().indexOf("MAC")>=0?e.metaKey:e.ctrlKey)&&e.key.toLowerCase()===t&&(e.preventDefault(),this.toggle()),e.key==="Escape"&&this.isOpen&&(e.preventDefault(),this.close())}handleKeydown(e){let t=this.shadowRoot.querySelectorAll(".sm-result-item"),s=t.length;switch(e.key){case"ArrowDown":e.preventDefault(),this.selectedIndex=Math.min(this.selectedIndex+1,s-1),this.updateSelection();break;case"ArrowUp":e.preventDefault(),this.selectedIndex=Math.max(this.selectedIndex-1,-1),this.updateSelection();break;case"Enter":e.preventDefault(),this.selectedIndex>=0&&t[this.selectedIndex]&&t[this.selectedIndex].click();break;case"Escape":e.preventDefault(),this.close();break}}updateSelection(){let e=this.shadowRoot.querySelectorAll(".sm-result-item"),t=this.selectedIndex>=0?m(this.listboxId,this.selectedIndex):null;h(this.elements.input,{expanded:e.length>0,activeDescendant:t,listboxId:this.listboxId}),e.forEach((s,n)=>{let o=n===this.selectedIndex;s.classList.toggle("sm-selected",o),s.setAttribute("aria-selected",String(o)),o&&E(s,this.elements.results)})}handleBackdropClick(e){e.target===this.elements.backdrop&&this.close()}handleInput(e){if(this.query=e.target.value,this.selectedIndex=-1,this.debounceTimer&&clearTimeout(this.debounceTimer),!this.query.trim()){this.results=[],this.renderResults();return}this.query.length<this.config.minChars||(this.debounceTimer=setTimeout(()=>{this.search(this.query)},this.config.debounce))}async search(e){this.abortController&&this.abortController.abort(),this.abortController=new AbortController,this.loading=!0,this.elements.loading.hidden=!1,c(this.liveRegion,I());try{this.results=await S({query:e,endpoint:this.config.endpoint,indices:this.config.indices,siteId:this.config.siteId,maxResults:this.config.maxResults,signal:this.abortController.signal}),this.renderResults()}catch(t){t.name!=="AbortError"&&(console.error("Search error:",t),this.results=[],this.renderResults())}finally{this.loading=!1,this.elements.loading.hidden=!0}}renderResults(){let e=this.elements.results,{showRecent:t,groupResults:s}=this.config;if(!this.query.trim()&&t&&this.recentSearches.length>0){e.innerHTML=`
                <div class="sm-section">
                    ...
                    ${this.recentSearches.map((o,i)=>`
                        <div class="sm-result-item sm-recent-item" id="${m(this.listboxId,i)}" role="option" aria-selected="false" data-index="${i}" data-url="${o.url||""}" data-query="${this.escapeHtml(o.query)}">
            ...
            `,c(this.liveRegion,T(this.recentSearches.length));let n=e.querySelector(".sm-clear-recent");n&&n.addEventListener("click",o=>{o.stopPropagation(),B(this.config.index),this.recentSearches=[],this.renderResults()}),this.attachResultHandlers();return}if(!this.query.trim()){e.removeAttribute("role"),e.innerHTML=`
            ...
            `,h(this.elements.input,{expanded:!1,activeDescendant:null,listboxId:this.listboxId});return}if(this.results.length===0){e.removeAttribute("role"),e.innerHTML=`
                <div class="sm-empty" part="empty">
                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                        <circle cx="12" cy="12" r="10"/>
            ...
            `,c(this.liveRegion,x(0,this.query)),h(this.elements.input,{expanded:!1,activeDescendant:null,listboxId:this.listboxId});return}if(e.setAttribute("role","listbox"),s){let n=D(this.results),o=0;e.innerHTML=Object.entries(n).map(([i,a])=>`
                <div class="sm-section" role="group" aria-label="${this.escapeHtml(i)}">
                    <div class="sm-section-header">${this.escapeHtml(i)}</div>
                    ${a.map(d=>this.renderResultItem(d,o++)).join("")}
                </div>
            `).join("")}else e.innerHTML=this.results.map((n,o)=>this.renderResultItem(n,o)).join("");c(this.liveRegion,x(this.results.length,this.query)),h(this.elements.input,{expanded:!0,activeDescendant:null,listboxId:this.listboxId}),this.results.length>0&&(this.selectedIndex=0,this.updateSelection()),this.attachResultHandlers()}renderResultItem(e,t){let s=e.title||e.name||"Untitled",n=e.description||e.excerpt||e.snippet||"",o=e.url||e.href||"#",i=e.section||e.type||"",a=m(this.listboxId,t),d=this.highlightMatches(s,this.query),l=n?this.highlightMatches(n,this.query):"";return`
            <a class="sm-result-item" id="${a}" role="option" aria-selected="false" href="${this.escapeHtml(o)}" data-index="${t}" data-id="${e.id||""}" data-title="${this.escapeHtml(s)}">
        ...
        `}highlightMatches(e,t){if(!t)return this.escapeHtml(e);let s=this.escapeHtml(e);if(!this.config.enableHighlighting)return s;let n=t.toLowerCase().split(/\s+/).filter(p=>p.length>0),{highlightTag:o,highlightClass:i}=this.config,a=["sm-highlight"];i&&a.push(i);let d=` class="${a.join(" ")}"`,l=s;return n.forEach(p=>{let L=new RegExp(`\\b(${this.escapeRegex(p)})\\b`,"gi");l=l.replace(L,`<${o}${d}>$1</${o}>`)}),l}attachResultHandlers(){this.shadowRoot.querySelectorAll(".sm-result-item").forEach(t=>{t.addEventListener("click",s=>this.handleResultClick(s,t)),t.addEventListener("mouseenter",()=>{this.selectedIndex=parseInt(t.dataset.index)||0,this.updateSelection()})})}handleResultClick(e,t){let s=t.getAttribute("href")||t.dataset.url,n=t.dataset.title||t.querySelector(".sm-result-title")?.textContent,o=t.dataset.id,i=t.dataset.query||this.query;this.recentSearches=C(this.config.index,i,{title:n,url:s}),o&&this.config.index&&R({endpoint:this.config.analyticsEndpoint,elementId:o,query:i,index:this.config.index}),s&&s!=="#"?this.close():i&&(e.preventDefault(),this.elements.input.value=i,this.query=i,this.search(i))}open(){this.isOpen=!0,this.elements.backdrop.hidden=!1,this.elements.input.value="",this.query="",this.results=[],this.selectedIndex=-1,this.renderResults(),requestAnimationFrame(()=>{this.elements.input.focus()}),this.config.preventBodyScroll&&(document.body.style.overflow="hidden"),this.dispatchEvent(new CustomEvent("search-open"))}close(){this.isOpen=!1,this.elements.backdrop.hidden=!0,this.config.preventBodyScroll&&(document.body.style.overflow=""),this.dispatchEvent(new CustomEvent("search-close"))}toggle(){this.isOpen?this.close():this.open()}escapeHtml(e){let t=document.createElement("div");return t.textContent=e,t.innerHTML}escapeRegex(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}};customElements.define("search-widget",u);var X=u;})();
